...
[CqlLibrary("CMS128FHIRAntidepressantMedManagement", "0.3.000")]
public partial class CMS128FHIRAntidepressantMedManagement_0_3_000 : ILibrary, ISingleton<CMS128FHIRAntidepressantMedManagement_0_3_000>
{
    private CMS128FHIRAntidepressantMedManagement_0_3_000() {}

    public static CMS128FHIRAntidepressantMedManagement_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS128FHIRAntidepressantMedManagement";
    ...
    {
        object a_ = context.ResolveParameter("CMS128FHIRAntidepressantMedManagement-0.3.000", "Measurement Period", null);
    ...
    public bool? Has_IPSD_and_Major_Depression_Diagnosis(CqlContext context)
    {
        ...
        bool? f_(object MajorDepression)
        {
            ...
            CqlQuantity o_ = context.Operators.Quantity(60m, "days");
            CqlDate p_ = context.Operators.Subtract(i_, o_);
            CqlDate s_ = context.Operators.Add(i_, o_);
            CqlInterval<CqlDate> t_ = context.Operators.Interval(p_, s_, true, true);
            bool? u_ = context.Operators.In<CqlDate>(m_, t_, default);
            bool? w_ = context.Operators.Not((bool?)(i_ is null));
            bool? x_ = context.Operators.And(u_, w_);
            bool? y_ = context.Operators.And(j_, x_);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
    {
        ...
        bool? ae_(Encounter ValidEncounter)
        {
            ...
            CqlInterval<CqlDateTime> ai_ = QICoreCommon_4_0_000.Instance.toInterval(context, ah_ as object);
