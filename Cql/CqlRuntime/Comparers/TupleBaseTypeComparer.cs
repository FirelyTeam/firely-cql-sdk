...
namespace Ncqa.Cql.Runtime.Comparers
{
    ...
    {
        public TupleBaseTypeComparer(CqlComparers comparers)
        {
            Comparers = comparers;
        }
        ...
        public int? Compare(TupleBaseType? x, TupleBaseType? y, string? precision = null)
        {
            ...
            {
                var compare = Comparers.Compare(prop.XValue, prop.YValue, precision);
                if (compare == null)
                    return null;
        ...
        public bool Equivalent(TupleBaseType? x, TupleBaseType? y, string? precision = null)
        {
            ...
            foreach (var prop in joined)
            {
                if (!Comparers.Equivalent(prop.XValue, prop.YValue, precision))
                    return false;
            }
            return true;
        }
