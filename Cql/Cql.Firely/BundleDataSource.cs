...
namespace Hl7.Cql.Fhir
{
    ...
    internal class BundleDataSource : IDataSource
    {
        ...
        /// <summary>
        /// The result of a retrieve, fully evaluated. Callers walk a retrieve repeatedly — a cached definition read
        /// from several expressions, the inner source of a cross join — and this bundle's contents do not change
        /// during an evaluation, so a lazy result would keep re-deciding the same membership question.
        /// </summary>
