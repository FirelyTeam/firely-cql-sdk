...
{
    public static class ValueSetExtensionsLegacy
    {
        public static IValueSetDictionary ToValueSetDictionaryLegacy(this IEnumerable<ValueSet> values,
            bool activeOnly = true,
            Func<ValueSet, bool>? onInvalidValueSet = null) =>
                new ValueSetLoaderLegacy(values, activeOnly, onInvalidValueSet).Load();
    }

    internal class ValueSetLoaderLegacy
    {

        public ValueSetLoaderLegacy(IEnumerable<ValueSet> valuesets,
            bool activeOnly = true,
            Func<ValueSet, bool>? onInvalidValueSet = null)
        {
