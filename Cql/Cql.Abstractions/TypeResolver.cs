...
namespace Hl7.Cql.Abstractions
{
    ...
    public abstract class TypeResolver
    {
        ...
        /// <param name="throwError">If <see langword="true"/>, this method will throw an <see cref="ArgumentException"/> if the type does not have an element type.</param>
        /// <returns>The element type, or <see langword="null"/> if <paramref name="throwError"/> is <see langword="false"/>.</returns>
        public abstract Type? GetListElementType(Type type, bool throwError = false);
        ...
        /// It causes an unnecessary string parse into a CqlDateTime object when we have a FhirDateTime to CqlDateTime converter
