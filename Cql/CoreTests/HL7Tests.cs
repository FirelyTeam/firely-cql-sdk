...
namespace CoreTests
{
    ...
    public partial class HL7Tests
    {
        ...
        public static void ClassInitialize(TestContext context)
        {
            ...
            var fhirHelpersBuilder =  ExpressionBuilder.ForSingleLibrary(binding, typeManager, fhirHelpersPackage, CreateLogger());
            ...
            foreach (var file in hl7TestDirectory.GetFiles("*.json"))
            {
                ...
                var builder = ExpressionBuilder.ForSingleLibrary(binding, typeManager, elmPackage, CreateLogger());
