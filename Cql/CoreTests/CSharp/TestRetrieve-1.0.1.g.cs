...
public partial class TestRetrieve_1_0_1 : ILibrary, ISingleton<TestRetrieve_1_0_1>
{
    ...
    public object MeasurementPeriod(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute(-1330982091404890269L, () => {
    ...
    public Patient Patient(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute(5883656244868291583L, () => {
    ...
    public IEnumerable<Patient> InDemographic(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute(-5866081596940255586L, () => {
            IEnumerable<Patient> a_ = context.Operators.Retrieve<Patient>(new RetrieveParameters(default, default, default, "http://hl7.org/fhir/StructureDefinition/Patient"));
            return a_;
        });
    ...
    public bool? SexuallyActive(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute(-2845095848902788831L, () => {
