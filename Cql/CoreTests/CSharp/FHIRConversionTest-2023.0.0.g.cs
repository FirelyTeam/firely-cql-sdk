    ...
    public AllergyIntolerance? AllergyIntoleranceResource(CqlContext context, AllergyIntolerance? arg)
    {
        ...
        AllergyIntolerance? b_(AllergyIntolerance? a) {
            ...
            AllergyIntolerance? u_ = new AllergyIntolerance
            {
                ...
                TypeElement = h_!,
                CategoryElement = (new List<Code<AllergyIntolerance.AllergyIntoleranceCategory>>((IEnumerable<Code<AllergyIntolerance.AllergyIntoleranceCategory>>)((IEnumerable<Code<AllergyIntolerance.AllergyIntoleranceCategory>?>?)i_)!))!,
    ...
    public CoverageEligibilityRequest? CoverageEligibilityRequestResource(CqlContext context, CoverageEligibilityRequest? arg)
    {
        ...
        CoverageEligibilityRequest? b_(CoverageEligibilityRequest? a) {
            ...
            CoverageEligibilityRequest? s_ = new CoverageEligibilityRequest
            {
                ...
                StatusElement = f_!,
                Priority = g_!,
                PurposeElement = (new List<Code<CoverageEligibilityRequest.EligibilityRequestPurpose>>((IEnumerable<Code<CoverageEligibilityRequest.EligibilityRequestPurpose>>)((IEnumerable<Code<CoverageEligibilityRequest.EligibilityRequestPurpose>?>?)h_)!))!,
                Patient = i_!,
    ...
    public CoverageEligibilityResponse? CoverageEligibilityResponseResource(CqlContext context, CoverageEligibilityResponse? arg)
    {
        ...
        CoverageEligibilityResponse? b_(CoverageEligibilityResponse? a) {
            ...
            CoverageEligibilityResponse? t_ = new CoverageEligibilityResponse
            {
                Identifier = (new List<Identifier>(((IEnumerable<Identifier?>?)e_)!))!,
                StatusElement = f_!,
                PurposeElement = (new List<Code<CoverageEligibilityResponse.EligibilityResponsePurpose>>((IEnumerable<Code<CoverageEligibilityResponse.EligibilityResponsePurpose>>)((IEnumerable<Code<CoverageEligibilityResponse.EligibilityResponsePurpose>?>?)g_)!))!,
                Patient = h_!,
    ...
    public ObservationDefinition? ObservationDefinitionResource(CqlContext context, ObservationDefinition? arg)
    {
        ...
        ObservationDefinition? b_(ObservationDefinition? a) {
            ...
            ObservationDefinition? r_ = new ObservationDefinition
            {
                ...
                PermittedDataTypeElement = (new List<Code<ObservationDefinition.ObservationDataType>>((IEnumerable<Code<ObservationDefinition.ObservationDataType>>)((IEnumerable<Code<ObservationDefinition.ObservationDataType>?>?)h_)!))!,
