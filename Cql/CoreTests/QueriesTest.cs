...
namespace CoreTests
{
    ...
    public class QueriesTest
    {
        ...
        public static void Initialize(TestContext context)
        {
            ...
            DefinitionDictionary<LambdaExpression> definitions = Factory.ExpressionBuilder.ProcessSingleLibrary(elmPackage);
            ...
            Factory.ExpressionBuilder.ProcessSingleLibrary(elmPackage, definitions: definitions);
