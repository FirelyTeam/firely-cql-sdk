...
public class CqlDateTimeTests
{
    ...
    public void Add_Year_By_Units()
    {
        ...
        Assert.IsNotNull(plusTwelveMonths);
        ...
        Assert.IsNotNull(plus366DaysInHours);
        ...
        Assert.IsNotNull(plus365DaysInSeconds);
    ...
    public void Add_Month()
    {
        ...
        Assert.IsNotNull(plus2pt5Months);
        ...
        Assert.IsNotNull(plus1UcumMonth);
    ...
    public void Subtract_Month()
    {
        ...
        Assert.IsNotNull(minus2pt5Months);
        ...
        Assert.IsNotNull(minus1UcumMonth);
    ...
    public void Subtract_Year()
    {
        ...
        Assert.IsNotNull(minus1UcumYear);
    ...
    public void BoundariesBetween_Months()
    {
        ...
        Assert.IsNotNull(cqlStartDate);
        Assert.IsNotNull(cqlEndDate);
