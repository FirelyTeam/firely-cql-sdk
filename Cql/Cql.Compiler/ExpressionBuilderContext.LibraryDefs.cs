                    ...
                    if (function?.external ?? false)
                    {
                        if (_expressionBuilderSettings.AllowUnresolvedExternals)
                        {
                            ...
                            _libraryContext.LibraryDefinitions.Add(
                                ...
                                expressionDefName,
                                paramTypes,
                                new CqlFunctionDefinition(notImplemented, expressionDefName));
    ...
    public void ProcessIncludes(
        ...
        this.CatchRethrowExpressionBuildingException(_ =>
        {
            using (PushElement(includeDef))
            {
                ...
                var libNav = includeDef.GetVersionedLibraryIdentifierString(false) ??
                             throw this.NewExpressionBuildingException(
    ...
    public void ProcessValueSetDef(
        ...
        this.CatchRethrowExpressionBuildingException(_ =>
        {
            using (PushElement(valueSetDef))
            {
                ...
                var def = new CqlValueSetDefinition(lambda, valueSetDef.name!, valueSetDef.id, valueSetDef.version);
