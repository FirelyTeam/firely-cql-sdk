    ...
    internal partial class CqlOperatorsBinder : OperatorsBinder
    {
            ...
            params Expression[] args)
        {
            var result = @operator switch
            {
                ...
                CqlOperator.IntervalAfterInterval            => BindToMethodConvertArgs(nameof(ICqlOperators.IntervalAfterInterval), args),
                CqlOperator.IntervalBeforeInterval           => BindToMethodConvertArgs(nameof(ICqlOperators.IntervalBeforeInterval), args),
                ...
                CqlOperator.ElementAfterInterval             => BindToMethodConvertArgs(nameof(ICqlOperators.ElementAfterInterval), args),
                CqlOperator.ElementBeforeInterval            => BindToMethodConvertArgs(nameof(ICqlOperators.ElementBeforeInterval), args),
                CqlOperator.IntervalAfterElement             => BindToMethodConvertArgs(nameof(ICqlOperators.IntervalAfterElement), args),
                CqlOperator.IntervalBeforeElement            => BindToMethodConvertArgs(nameof(ICqlOperators.IntervalBeforeElement), args),
                ...
                CqlOperator.CrossJoin                        => BindToGenericMethod(methodName:nameof(ICqlOperators.CrossJoin),
                                                                    ...
                                                                    args),
                CqlOperator.Date                             => BindToMethod(nameof(ICqlOperators.Date), args),
                CqlOperator.DateTime                         => BindToMethod(nameof(ICqlOperators.DateTime)!, args),
                ...
                CqlOperator.Time                             => BindToMethod(nameof(ICqlOperators.Time), args),
