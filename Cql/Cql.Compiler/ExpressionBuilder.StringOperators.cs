...
namespace Hl7.Cql.Compiler
{
    internal partial class ExpressionBuilder
    {
        ...
        private Expression? Combine(elm.Combine e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression Concatenate(elm.Concatenate e, ExpressionBuilderContext ctx) =>
            NaryOperator(CqlOperator.Concatenate, e, ctx);

        private Expression? EndsWith(elm.EndsWith e, ExpressionBuilderContext ctx) =>
            BinaryOperator(CqlOperator.EndsWith, e, ctx);

        private Expression Indexer(elm.Indexer e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression? LastPositionOf(elm.LastPositionOf e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression? Length(elm.Length len, ExpressionBuilderContext ctx)
        {
        ...
        private Expression? Lower(elm.Lower e, ExpressionBuilderContext ctx) =>
            UnaryOperator(CqlOperator.Lower, e, ctx);

        private Expression? Matches(elm.Matches e, ExpressionBuilderContext ctx) =>
            BinaryOperator(CqlOperator.Matches, e, ctx);

        private Expression PositionOf(elm.PositionOf e, ExpressionBuilderContext ctx)
        {
            var @string = TranslateExpression(e!.@string!, ctx);
            var pattern = TranslateExpression(e!.pattern!, ctx);
        ...
        private Expression? ReplaceMatches(elm.ReplaceMatches e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression Split(elm.Split e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression? StartsWith(elm.StartsWith e, ExpressionBuilderContext ctx) =>
            BinaryOperator(CqlOperator.StartsWith, e, ctx);

        private Expression? Substring(elm.Substring e, ExpressionBuilderContext ctx)
        {
        ...
        private Expression? Upper(elm.Upper e, ExpressionBuilderContext ctx) =>
