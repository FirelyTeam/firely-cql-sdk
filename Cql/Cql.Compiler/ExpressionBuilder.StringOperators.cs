...
namespace Hl7.Cql.Compiler
{
    internal partial class ExpressionBuilder
    {
        protected Expression? Combine(Elm.Combine e)
        {
            ...
            return _operatorBinder.BindToMethod(CqlOperator.Combine, source, operand);
        }
        ...
        protected Expression Indexer(Elm.Indexer e)
        {
            ...
            {
                return _operatorBinder.BindToMethod(CqlOperator.CharAt, left, right);
            }
            else if (_typeResolver.ImplementsGenericIEnumerable(left.Type))
            {
                return _operatorBinder.BindToMethod(CqlOperator.ListElementAt, left, right);
            }
        ...
        protected Expression? LastPositionOf(Elm.LastPositionOf e)
        {
            ...
            return _operatorBinder.BindToMethod(CqlOperator.LastPositionOf, @string, pattern);
        }
        ...
        protected Expression? Length(Elm.Length len)
        {
            ...
            {
                return _operatorBinder.BindToMethod(CqlOperator.ListLength, operand);
            }
            else if (operand.Type == typeof(string))
            {
                return _operatorBinder.BindToMethod(CqlOperator.StringLength, operand);
            }
            else throw new NotImplementedException().WithContext(this);
        }
        ...
        protected Expression PositionOf(Elm.PositionOf e)
        {
            var @string = TranslateExpression(e!.@string!);
            var pattern = TranslateExpression(e!.pattern!);
            return _operatorBinder.BindToMethod(CqlOperator.PositionOf, pattern, @string);
        ...
        protected Expression? ReplaceMatches(Elm.ReplaceMatches e)
        {
            ...
            return _operatorBinder.BindToMethod(CqlOperator.ReplaceMatches, source, pattern, substitution);
        }
        ...
        protected Expression Split(Elm.Split e)
        {
            ...
            return _operatorBinder.BindToMethod(CqlOperator.Split, stringToSplit, separator);
        }
        ...
        protected Expression? Substring(Elm.Substring e)
        {
            ...
            return _operatorBinder.BindToMethod(CqlOperator.Substring, stringToSub, startIndex, length);
        }
    }
}
