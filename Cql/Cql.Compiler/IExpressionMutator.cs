...
namespace Hl7.Cql.Compiler
{
    ...
    internal interface IExpressionMutator
    {
        ...
        /// <param name="ctx">The build context.  Be careful modifying this value as it can have unexpected side effects (e.g., removing key from <see cref="ExpressionBuilderContext._scopes"/> could break the builder.).</param>
