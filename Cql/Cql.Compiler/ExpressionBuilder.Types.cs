...
namespace Hl7.Cql.Compiler
{
    internal partial class ExpressionBuilder
    {
        private Expression IntervalExpression(elm.Interval ie, ExpressionBuilderContext ctx)
        {
            ...
            var call = OperatorBinding.Bind(CqlOperator.Interval, ctx.CqlContextParameter, low, high, lowClosed, highClosed);
            return call;
        }
        ...
        private Expression Ratio(elm.Ratio re, ExpressionBuilderContext ctx)
        {
            ...
            return OperatorBinding.Bind(CqlOperator.Ratio, ctx.CqlContextParameter, numExprTranslated, denomExprTranslated);
        }

        private Expression Quantity(elm.Quantity quantityExpression, ExpressionBuilderContext ctx) =>
            OperatorBinding.Bind(CqlOperator.Quantity, ctx.CqlContextParameter,
