    ...
    internal partial class CqlOperatorsBinder : OperatorsBinder
    {
            ...
            params Expression[] args)
        {
            var result = @operator switch
            {
                ...
                CqlOperator.PositionOf                       => BindToMethodConvertArgs(nameof(ICqlOperators.IndexOf), resultTypeHint, args),
                ...
                CqlOperator.GetAtIndex                          => BindToMethodConvertArgs(nameof(ICqlOperators.GetAtIndex), resultTypeHint, args),
                CqlOperator.IndexOf                          => BindToMethodConvertArgs(nameof(ICqlOperators.IndexOf), resultTypeHint, args),
