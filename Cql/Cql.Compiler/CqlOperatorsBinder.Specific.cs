...
partial class CqlOperatorsBinder
{
    ...
    /// </summary>
    private CodeExpression ToObjectEnumerable(CodeExpression list, Type elementType)
    {
        ...
        var parameter = new CodeLocal(elementType, "item");
        var boxLambda = new CodeLambda([parameter], new CodeCast(parameter, typeof(object), CodeCastKind.Cast));
