    ...
    public class AsTest : Base
    {
        ...
        public void ValueSet_As_Vocabulary()
        {
            ...
            Assert.IsInstanceOfType(library.statements[0].expression, typeof(As));
            {
                ...
                var delegates = CreateElmFluentToolkit().ProcessLibrary(library).CompileAll();
        ...
        {
            var lambda = CreateElmFluentToolkit().Lambda(@as);
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("cast (1.0 as System.Any) as System.Decimal");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("cast (true as System.Any) as System.Decimal");
            var castAs = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<As>();
        ...
        public void Choice_As()
        {
            ...
            var lib = CreateCqlFluentToolkit().MakeLibrary("""
                ...
                """);
            _ = CreateElmFluentToolkit().ProcessLibrary(lib);
        }
    }
}
