...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class EqualsTest : Base
    {
        ...
        {
            var library = CreateCqlToolkit().MakeLibraryFromExpression("@2023 = null");
            var equal = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Equal>();
            AssertNullResult(equal);
        }
        ...
        {
            var library = CreateCqlToolkit().MakeLibraryFromExpression("null = @2023");
            var equal = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Equal>();
            AssertNullResult(equal);
        }
        ...
        {
            var lib = CreateCqlToolkit().MakeLibraryFromExpression("{ DateTime(2016), DateTime(2015), DateTime(2010)} = { @2016T, @2015T, @2010T }");
            var equal = lib.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Equal>();
