...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class TimingExpressionTest : Base
    {
        ...
        public void OnOrAfterMonthOf()
        {
            ...
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("Interval[@2012-12-01, @2013-12-01] on or after month of @2012-11-15");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("Interval[@2012-10-01, @2012-11-01] on or before month of @2012-11-15");
