...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class LiteralTest : Base
    {
        ...
        {
            var lib = CreateFluentCqlToolkit().MakeLibraryFromExpression("-9223372036854775808L");
        ...
        public void Boolean_Literal()
        {
            ...
            library = CreateFluentCqlToolkit().MakeLibrary("""
        ...
        {
            var lib = CreateFluentCqlToolkit().MakeLibraryFromExpression("@2016T");
        ...
        {
            var input = CreateFluentCqlToolkit().MakeLibraryFromExpression("Ceiling(1.0)");
            var ceiling = input.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Ceiling>();
            var output = CreateFluentCqlToolkit().MakeLibraryFromExpression("1");
