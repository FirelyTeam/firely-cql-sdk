...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class BooleanTest : Base
    {
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("true is true");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("true is false");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("true is null");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("null is true");
            var isTrue = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<IsTrue>();
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("null is null");
            var isNull = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<IsNull>();
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("true is not false");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("true is not null");
            var isNot = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Not>();
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("null is not null");
            var isNot = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Not>();
            var isNull = isNot.operand.Should().BeOfType<IsNull>().Subject;
            isNull.operand.Should().BeNullLiteral();
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("null is not false");
            var isNot = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<Not>();
            var isFalse = isNot.operand.Should().BeOfType<IsFalse>().Subject;
        ...
        {
            var library = CreateCqlFluentToolkit(EnableListDemotion:true ).MakeLibraryFromExpression("{true} is true");
            var isTrue = library.Should().BeACorrectlyInitializedLibraryWithStatementOfType<IsTrue>();
