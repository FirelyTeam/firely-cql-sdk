...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class LibraryTest : Base
    {
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibrary("library String version '4.0.1'");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibrary("library Namespace.Lib version '4.0.1'");
            Assert.IsNotNull(library);
            Assert.IsNotNull(library.identifier);
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibrary("library Lib");
            Assert.IsNotNull(library);
            Assert.IsNotNull(library.identifier);
            Assert.AreEqual("Lib", library.identifier.id);
            Assert.IsTrue(string.IsNullOrWhiteSpace(library.identifier.system));
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibrary("library Namespace.Lib");
            Assert.IsNotNull(library);
            Assert.IsNotNull(library.identifier);
            Assert.AreEqual("Lib", library.identifier.id);
            Assert.AreEqual("Namespace", library.identifier.system);
        ...
        public void Using_AllTerms()
        {
            ...
            var library = CreateCqlFluentToolkit(ModelInfos: [modelInfo], Models: [])
                .MakeLibrary("""
        ...
        public void Concept_Build()
        {
            var library = CreateCqlFluentToolkit().MakeLibrary("""
                ...
                """);
            _ = CreateElmFluentToolkit().ProcessLibrary(library);
        }
