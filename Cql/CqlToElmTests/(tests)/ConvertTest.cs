...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class ConvertTest : Base
    {
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("convert 5 to String");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("ToDateTime('2014-01-01T12:05:05.955-01:15')");
        ...
        {
            var library = CreateCqlFluentToolkit().MakeLibraryFromExpression("ToConcept(Code { code: '8480-6' })");
