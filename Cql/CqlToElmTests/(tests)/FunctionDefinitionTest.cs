...
namespace Hl7.Cql.CqlToElm.Test
{
    ...
    public class FunctionDefinitionTest : Base
    {
        ...
        public void CSharp_Keyword_Parameter_Name()
        {
            ...
            // CqlContext parameter (see IrLambdaDefinition remarks) -- so its Parameters list is
            ...
            // specifically (see IrExpressionBuilderContext.LibraryDefs.cs's HandleExternalFunction
            ...
            var cqlDefinition = irDefinitionDictionary["FuncTest-1.0.0", new DefinitionSignature("ToInteger", typeof(CqlContext), typeof(decimal?))] is IrLambdaDefinition ld ? ld.Lambda : null;
