...
namespace Hl7.Cql.Operators
{
    ...
    public interface ICqlOperators
    {
        ...
        IEnumerable<(T1,                         T2, T3, T4, T5)> CrossJoin<T1, T2, T3, T4, T5>(IEnumerable<T1>? source1,IEnumerable<T2>? source2,IEnumerable<T3>? source3,IEnumerable<T4>? source4,IEnumerable<T5>? source5);
        IEnumerable<(T1,                         T2, T3, T4)> CrossJoin<T1, T2, T3, T4>(IEnumerable<T1>? source1,IEnumerable<T2>? source2,IEnumerable<T3>? source3,IEnumerable<T4>? source4);
        IEnumerable<(T1,                         T2, T3)> CrossJoin<T1, T2, T3>(IEnumerable<T1>? source1,IEnumerable<T2>? source2,IEnumerable<T3>? source3);
        IEnumerable<(T1,                         T2)> CrossJoin<T1, T2>(IEnumerable<T1>? source1,IEnumerable<T2>? source2);
