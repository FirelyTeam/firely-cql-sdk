...
internal sealed class LibraryInstanceInvoker_3_1 : LibraryInstanceInvoker
{
        ...
        ILibrary library) : base(librarySetInvoker, library)
    {
        Definitions = library
                      ...
                      .ToFrozenDictionary(o => new DefinitionSignatureWithNames(o.DefinitionName, o.ParameterNames, o.ParameterTypes), o => o)
                      .AsReadOnly();
    }

    public override IReadOnlyDictionary<DefinitionSignatureWithNames, DefinitionInvoker> Definitions { get; }
