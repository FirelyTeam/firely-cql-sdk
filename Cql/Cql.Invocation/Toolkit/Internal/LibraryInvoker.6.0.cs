...
internal sealed class LibraryInstanceInvoker_6_0 : LibraryInstanceInvoker
{
    private LibraryInstanceInvoker_6_0(
        ...
        ILibrary library) : base(librarySetInvoker, library)
    {
        Definitions = library
                      ...
                      .SelectWhere(methodInfo => DefinitionInvoker_6_0.TryCreate(Library, this, methodInfo))
    ...
    {
        libraryInvoker = null;
        var logger = librarySetInvoker.CreateLogger<LibraryInstanceInvoker_6_0>();
        ...
        libraryInvoker = new LibraryInstanceInvoker_6_0(librarySetInvoker, asILibrary);
        return true;
    }
    ...
    public static bool SupportsVersion(Version cqlToolVersion) =>
        ...
        && cqlToolVersion < new Version(6, 1, 0, 0);
}

file sealed class DefinitionInvoker_6_0(
    ILibrary library,
              ...
              .ToArray())
{
        ...
        MethodInfo methodInfo)
    {
        ...
        var definitionInvoker = new DefinitionInvoker_6_0(library, libraryInvoker, methodInfo, cqlDefinitionAttribute);
