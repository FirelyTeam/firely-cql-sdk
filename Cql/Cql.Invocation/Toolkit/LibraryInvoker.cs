...
public abstract class LibraryInvoker
{
    ...
    /// </summary>
    public abstract IReadOnlyDictionary<DefinitionSignatureWithNames, DefinitionInvoker> Definitions { get; }
        ...
        [NotNullWhen(true)] out LibraryInvoker? libraryInvoker)
    {
        ...
        if (LibraryInstanceInvoker_3_1.SupportsVersion(cqlToolVersion))
        {
            if (LibraryInstanceInvoker_3_1.TryCreate(librarySetInvoker, libraryType, out libraryInvoker))
                return true;
        }
