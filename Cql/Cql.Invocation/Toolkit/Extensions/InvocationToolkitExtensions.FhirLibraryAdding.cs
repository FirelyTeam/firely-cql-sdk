...
partial class InvocationToolkitExtensions
{
    ...
    public static InvocationToolkit AddFhirLibrariesFromDirectory(
    ...
    private static FhirLibrary LoadFhirLibrary(FileInfo file)
    {
    ...
    private static AssemblyBinary ExtractAssemblyBinary(FhirLibrary library)
    {
        var attachment = library.Content.Single(att =>
                                                    att is
                                                    {
