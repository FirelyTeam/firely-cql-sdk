...
4.5.2 For the full procedure to turn that accumulated content into a versioned release note (template, README version sync, consolidating and clearing **both** `docs/releases/vnext/` fragment files and any transitional content still in `vnext-release-notes.md`), follow [cut-release-notes](../../.claude/skills/cut-release-notes/SKILL.md).
