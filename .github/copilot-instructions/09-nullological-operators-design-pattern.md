...
9.1.3.2 Reason: CQL specification ┬º9.B states these operators always return true or false, never null
...
9.1.5 **Specification Reference**: CQL 1.5.3 ┬º9.B (Nullological Operators)
