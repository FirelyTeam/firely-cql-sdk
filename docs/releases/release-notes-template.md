...
- **<MACRO | MESO | MICRO>** (`X.Y.Z`). _Name the trigger from [versioning.md](../versioning.md) that forced this level. If more than one fired, name them all. If the level was a judgement call, say what was weighed._
