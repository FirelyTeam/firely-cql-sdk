...
- **Hl7.Fhir.Base**: Version 6.2.0 - Base classes and utilities for FHIR support
- **Hl7.Fhir.R4**: Version 6.2.0 - FHIR R4 POCOs and serialization support
...
- **Microsoft.Extensions.Configuration**: Version 10.0.7 - Configuration framework
- **Microsoft.Extensions.DependencyInjection**: Version 10.0.7 - Dependency injection container
- **Microsoft.Extensions.Logging**: Version 10.0.7 - Logging abstractions
- **Microsoft.Extensions.Hosting**: Version 10.0.7 - Generic host for .NET applications
