...
public partial class DocumentationofCurrentMedicationsFHIR_minus_0_2_000 : ILibrary, ISingleton<DocumentationofCurrentMedicationsFHIR_minus_0_2_000>
{
    ...
    public ILibrary[] Dependencies => [FHIRHelpers_minus_4_3_000.Instance, QICoreCommon_minus_2_0_000.Instance, SupplementalDataElements_minus_3_4_000.Instance];
    ...
    {
        (CqlTupleMetadata, IEnumerable<CqlCode> codes, string display)? a_ = SupplementalDataElements_minus_3_4_000.Instance.SDE_Ethnicity(context);
    ...
    {
        IEnumerable<(CqlTupleMetadata, CqlConcept code, CqlInterval<CqlDateTime> period)?> a_ = SupplementalDataElements_minus_3_4_000.Instance.SDE_Payer(context);
    ...
    {
        (CqlTupleMetadata, IEnumerable<CqlCode> codes, string display)? a_ = SupplementalDataElements_minus_3_4_000.Instance.SDE_Race(context);
    ...
    {
        CqlCode a_ = SupplementalDataElements_minus_3_4_000.Instance.SDE_Sex(context);
    ...
    public IEnumerable<Encounter> Qualifying_Encounter_during_day_of_Measurement_Period(CqlContext context)
    {
        ...
        bool? c_(Encounter ValidEncounter)
        {
            ...
            CqlInterval<CqlDateTime> k_ = FHIRHelpers_minus_4_3_000.Instance.ToInterval(context, j_);
    ...
    public IEnumerable<Encounter> Numerator(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter QualifyingEncounter)
        {
            ...
            bool? g_(Procedure MedicationsDocumented)
            {
                ...
                CqlInterval<CqlDateTime> m_ = QICoreCommon_minus_2_0_000.Instance.toInterval(context, l_);
                CqlDateTime n_ = context.Operators.End(m_);
                Period o_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> p_ = FHIRHelpers_minus_4_3_000.Instance.ToInterval(context, o_);
        ...
        IEnumerable<Encounter> b_(Encounter QualifyingEncounter)
        {
            ...
            bool? g_(Procedure MedicationsNotDocumented)
            {
                bool? k_(Extension @this)
                {
                    ...
                    string ag_ = FHIRHelpers_minus_4_3_000.Instance.ToString(context, af_);
                ...
                CqlInterval<CqlDateTime> r_ = FHIRHelpers_minus_4_3_000.Instance.ToInterval(context, q_);
                ...
                {
                    CqlConcept aj_ = FHIRHelpers_minus_4_3_000.Instance.ToConcept(context, @this);
