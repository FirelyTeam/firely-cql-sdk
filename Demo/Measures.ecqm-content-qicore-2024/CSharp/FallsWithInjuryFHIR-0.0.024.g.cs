...
[CqlLibrary("FallsWithInjuryFHIR", "0.0.024")]
public partial class FallsWithInjuryFHIR_0_0_024 : ILibrary, ISingleton<FallsWithInjuryFHIR_0_0_024>
{
    private FallsWithInjuryFHIR_0_0_024() {}

    public static FallsWithInjuryFHIR_0_0_024 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "FallsWithInjuryFHIR";
    ...
    public CqlInterval<CqlDateTime> Measurement_Period(CqlContext context)
    {
        ...
        object d_ = context.ResolveParameter("FallsWithInjuryFHIR-0.0.024", "Measurement Period", c_);
