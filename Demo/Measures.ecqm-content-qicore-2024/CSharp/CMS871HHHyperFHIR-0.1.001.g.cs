...
[CqlLibrary("CMS871HHHyperFHIR", "0.1.001")]
public partial class CMS871HHHyperFHIR_0_1_001 : ILibrary, ISingleton<CMS871HHHyperFHIR_0_1_001>
{
    private CMS871HHHyperFHIR_0_1_001() {}

    public static CMS871HHHyperFHIR_0_1_001 Instance { get; } = new();
    ...
    {
        CqlDateTime a_ = context.Operators.DateTime(2026, 1, 1, 0, 0, 0, 0, default);
        CqlDateTime b_ = context.Operators.DateTime(2026, 12, 31, 23, 59, 59, 999, default);
        CqlInterval<CqlDateTime> c_ = context.Operators.Interval(a_, b_, true, true);
        object d_ = context.ResolveParameter("CMS871HHHyperFHIR-0.1.001", "Measurement Period", c_);
    ...
    [CqlExpressionDefinition("Encounter with First Glucose Greater Than 600")]
    public IEnumerable<Encounter> Encounter_with_First_Glucose_Greater_Than_600(CqlContext context)
    {
        IEnumerable<Encounter> a_ = this.Initial_Population(context);
        IEnumerable<Encounter> b_(Encounter InpatientHospitalization)
        {
            IEnumerable<Observation> d_ = this.Initial_Glucose_Greater_Than_600_within_1_Hour_Prior_To_and_6_Hours_After_Encounter_Start(context);
            bool? e_(Observation FirstGlucoseResult)
            {
                DataType i_ = FirstGlucoseResult?.Value;
                object j_ = FHIRHelpers_4_4_000.Instance.ToValue(context, i_);
                CqlQuantity k_ = context.Operators.Quantity(600m, "mg/dL");
    ...
    {
        IEnumerable<Encounter> a_ = this.Encounter_with_First_Glucose_Greater_Than_600(context);
