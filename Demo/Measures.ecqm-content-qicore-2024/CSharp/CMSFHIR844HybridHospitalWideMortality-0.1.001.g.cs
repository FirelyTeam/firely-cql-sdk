...
[CqlLibrary("CMSFHIR844HybridHospitalWideMortality", "0.1.001")]
public partial class CMSFHIR844HybridHospitalWideMortality_0_1_001 : ILibrary, ISingleton<CMSFHIR844HybridHospitalWideMortality_0_1_001>
{
    private CMSFHIR844HybridHospitalWideMortality_0_1_001() {}

    public static CMSFHIR844HybridHospitalWideMortality_0_1_001 Instance { get; } = new();
    ...
    public CqlInterval<CqlDateTime> Measurement_Period(CqlContext context)
    {
        ...
        object d_ = context.ResolveParameter("CMSFHIR844HybridHospitalWideMortality-0.1.001", "Measurement Period", c_);
    ...
    public IEnumerable<Encounter> Inpatient_Encounters(CqlContext context)
    {
        ...
        IEnumerable<Encounter> c_(Encounter EncounterInpatient)
        {
            ...
            {
                CqlInterval<CqlDateTime> n_ = CQMCommon_2_2_000.Instance.hospitalizationWithObservationAndOutpatientSurgeryService(context, EncounterInpatient);
    ...
    public IEnumerable<(CqlTupleMetadata, string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)?> Encounter_with_First_Systolic_Blood_Pressure(CqlContext context)
    {
        IEnumerable<Encounter> a_ = this.Inpatient_Encounters(context);
        (CqlTupleMetadata, string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)? b_(Encounter EncounterInpatient)
        {
            ...
            bool? h_(Observation BP)
            {
                ...
                CqlInterval<CqlDateTime> af_ = CQMCommon_2_2_000.Instance.hospitalizationWithObservationAndOutpatientSurgeryService(context, EncounterInpatient);
            ...
            bool? t_(Observation BP)
            {
                ...
                CqlDateTime bl_ = QICoreCommon_2_1_000.Instance.earliest(context, bk_);
                CqlInterval<CqlDateTime> bm_ = CQMCommon_2_2_000.Instance.hospitalizationWithObservationAndOutpatientSurgeryService(context, EncounterInpatient);
    ...
    public IEnumerable<(CqlTupleMetadata, string EncounterId, CqlQuantity FirstPlateletResult, CqlDateTime Timing)?> Encounter_with_First_Platelet_Lab_Test(CqlContext context)
    {
        ...
        (CqlTupleMetadata, string EncounterId, CqlQuantity FirstPlateletResult, CqlDateTime Timing)? b_(Encounter EncounterInpatient)
        {
            ...
            {
                DataType aa_ = PlateletLab?.Effective;
                object ab_ = FHIRHelpers_4_4_000.Instance.ToValue(context, aa_);
                CqlDateTime ac_ = QICoreCommon_2_1_000.Instance.earliest(context, ab_);
                CqlInterval<CqlDateTime> ad_ = CQMCommon_2_2_000.Instance.hospitalizationWithObservationAndOutpatientSurgeryService(context, EncounterInpatient);
                bool? ae_ = context.Operators.In<CqlDateTime>(ac_, ad_, default);
                Code<ObservationStatus> af_ = PlateletLab?.StatusElement;
                ObservationStatus? ag_ = af_?.Value;
                string ah_ = context.Operators.Convert<string>(ag_);
                string[] ai_ = [
                    "final",
            ...
            bool? r_(Observation PlateletLab)
            {
                ...
                CqlInterval<CqlDateTime> aw_ = CQMCommon_2_2_000.Instance.hospitalizationWithObservationAndOutpatientSurgeryService(context, EncounterInpatient);
                bool? ax_ = context.Operators.In<CqlDateTime>(av_, aw_, default);
                Code<ObservationStatus> ay_ = PlateletLab?.StatusElement;
                ObservationStatus? az_ = ay_?.Value;
                string ba_ = context.Operators.Convert<string>(az_);
                string[] bb_ = [
                    "final",
