...
[CqlLibrary("CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia", "1.5.000")]
public partial class CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia_1_5_000 : ILibrary, ISingleton<CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia_1_5_000>
{
    private CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia_1_5_000() {}

    public static CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia_1_5_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia";
    ...
    {
        object a_ = context.ResolveParameter("CMS771FHIRUrinarySymptomScoreChangeBenignProstaticHyperplasia-1.5.000", "Measurement Period", null);
    ...
    public object Initial_BPH_Diagnosis_Starts_Within_6_Months_Before_the_Measurement_Period(CqlContext context)
    {
        ...
        bool? h_(object NewBPHDiagnosis)
        {
            ...
            bool? w_ = this.isConfirmedActiveDiagnosis(context, NewBPHDiagnosis);
    ...
    public IEnumerable<object> Urinary_Retention_Diagnosis_Starts_Within_1_Year_After_Initial_BPH_Diagnosis(CqlContext context)
    {
        ...
        {
            bool? ad_ = this.isConfirmedActiveDiagnosis(context, UrinaryRetention);
    ...
    public IEnumerable<object> Morbid_Obesity_Diagnosis_On_or_Before_Follow_Up_USS_Assessment(CqlContext context)
    {
        ...
        {
            bool? x_ = this.isConfirmedActiveDiagnosis(context, MorbidObesityDiagnosis);
