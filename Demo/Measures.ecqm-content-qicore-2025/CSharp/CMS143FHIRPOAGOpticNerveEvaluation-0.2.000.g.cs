...
[CqlLibrary("CMS143FHIRPOAGOpticNerveEvaluation", "0.2.000")]
public partial class CMS143FHIRPOAGOpticNerveEvaluation_0_2_000 : ILibrary, ISingleton<CMS143FHIRPOAGOpticNerveEvaluation_0_2_000>
{
    private CMS143FHIRPOAGOpticNerveEvaluation_0_2_000() {}

    public static CMS143FHIRPOAGOpticNerveEvaluation_0_2_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS143FHIRPOAGOpticNerveEvaluation";
    ...
    {
        object a_ = context.ResolveParameter("CMS143FHIRPOAGOpticNerveEvaluation-0.2.000", "Measurement Period", null);
    ...
    public IEnumerable<Encounter> Primary_Open_Angle_Glaucoma_Encounter(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter ValidQualifyingEncounter)
        {
            ...
            {
                CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, PrimaryOpenAngleGlaucoma as object);
                Period k_ = ValidQualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> l_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, k_);
                bool? m_ = context.Operators.Overlaps(j_, l_, default);
                bool? n_ = QICoreCommon_4_0_000.Instance.isActive(context, PrimaryOpenAngleGlaucoma as object);
                ...
                CqlCode r_ = QICoreCommon_4_0_000.Instance.unconfirmed(context);
