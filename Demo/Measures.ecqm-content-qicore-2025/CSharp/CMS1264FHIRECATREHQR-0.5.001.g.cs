...
[CqlLibrary("CMS1264FHIRECATREHQR", "0.5.001")]
public partial class CMS1264FHIRECATREHQR_0_5_001 : ILibrary, ISingleton<CMS1264FHIRECATREHQR_0_5_001>
{
    private CMS1264FHIRECATREHQR_0_5_001() {}

    public static CMS1264FHIRECATREHQR_0_5_001 Instance { get; } = new();
    ...
    {
        object a_ = context.ResolveParameter("CMS1264FHIRECATREHQR-0.5.001", "Measurement Period", null);
    ...
    public CqlDateTime EDArrivalTime(CqlContext context, Encounter EDEncounter)
    {
        ...
        bool? g_(Encounter.LocationComponent Location)
        {
            ...
            CqlInterval<CqlDateTime> al_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, af_);
            CqlDateTime am_ = context.Operators.Start(al_);
            CqlInterval<CqlDateTime> an_ = context.Operators.Interval(aj_, am_, true, false);
            bool? ao_ = context.Operators.In<CqlDateTime>(ae_, an_, default);
            CqlInterval<CqlDateTime> aq_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, af_);
            CqlDateTime ar_ = context.Operators.Start(aq_);
            bool? as_ = context.Operators.Not((bool?)(ar_ is null));
            bool? at_ = context.Operators.And(ao_, as_);
            CqlInterval<CqlDateTime> av_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, x_);
            CqlInterval<CqlDateTime> ax_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, af_);
            bool? ay_ = context.Operators.OverlapsBefore(av_, ax_, default);
            bool? az_ = context.Operators.Or(at_, ay_);
            CqlInterval<CqlDateTime> bb_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, af_);
            CqlInterval<CqlDateTime> bd_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, x_);
            bool? be_ = context.Operators.OverlapsBefore(bb_, bd_, default);
            bool? bf_ = context.Operators.Or(az_, be_);
            CqlInterval<CqlDateTime> bh_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, x_);
            CqlDateTime bi_ = context.Operators.Start(bh_);
            CqlInterval<CqlDateTime> bk_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, af_);
            CqlDateTime bl_ = context.Operators.Start(bk_);
            bool? bm_ = context.Operators.SameAs(bi_, bl_, default);
            bool? bn_ = context.Operators.Or(bf_, bm_);
            bool? bo_ = context.Operators.And(ab_, bn_);
    ...
    public IEnumerable<Encounter> Boarded_Time_Greater_Than_240_Minutes_and_No_Observation_Stay(CqlContext context)
    {
        ...
        bool? b_(Encounter Boarding)
        {
            ...
            bool? e_(Encounter EDO)
            {
                Period i_ = Boarding?.Period;
                CqlInterval<CqlDateTime> j_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, i_);
                Period k_ = EDO?.Period;
                CqlInterval<CqlDateTime> l_ = FHIRHelpers_4_4_000.Instance.ToInterval(context, k_);
