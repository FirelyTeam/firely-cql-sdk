...
[CqlLibrary("CMS135FHIRHFACEIorARBorARNIforLVSD", "0.4.000")]
public partial class CMS135FHIRHFACEIorARBorARNIforLVSD_0_4_000 : ILibrary, ISingleton<CMS135FHIRHFACEIorARBorARNIforLVSD_0_4_000>
{
    private CMS135FHIRHFACEIorARBorARNIforLVSD_0_4_000() {}

    public static CMS135FHIRHFACEIorARBorARNIforLVSD_0_4_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS135FHIRHFACEIorARBorARNIforLVSD";
    ...
    {
        object a_ = context.ResolveParameter("CMS135FHIRHFACEIorARBorARNIforLVSD-0.4.000", "Measurement Period", null);
    ...
    public bool? Has_ACEI_or_ARB_or_ARNI_Ordered(CqlContext context)
    {
        ...
        {
            bool? f_ = AHAOverall_3_0_000.Instance.isOrderedDuringHeartFailureOutpatientEncounter(context, ACEIOrARBOrARNIOrdered);
    ...
    public bool? Is_Currently_Taking_ACEI_or_ARB_or_ARNI(CqlContext context)
    {
        ...
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, ActiveACEIOrARBOrARNI);
    ...
    public bool? Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI(CqlContext context)
    {
        ...
        {
            bool? f_ = AHAOverall_3_0_000.Instance.isOrderedDuringHeartFailureOutpatientEncounter(context, NoACEIOrARBOrARNIOrdered);
    ...
    public bool? Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient(CqlContext context)
    {
        ...
        {
            bool? r_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, ACEIOrARBOrARNIAllergyIntolerance);
    ...
    public bool? Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB(CqlContext context)
    {
        ...
        {
            bool? i_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, ACEIOrARBAllergyOrIntoleranceDiagnosis as object);
    ...
    public bool? Has_Diagnosis_of_Pregnancy(CqlContext context)
    {
        ...
        IEnumerable<Condition> c_(Condition PregnancyDiagnosis)
        {
            ...
            {
                CqlInterval<CqlDateTime> k_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, PregnancyDiagnosis as object);
    ...
    public bool? Has_Diagnosis_of_Renal_Failure_Due_to_ACEI(CqlContext context)
    {
        ...
        {
            bool? g_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, RenalFailureDueToACEI as object);
