...
[CqlLibrary("CMS159FHIRDepressionRemissionatTwelveMonths", "0.3.000")]
public partial class CMS159FHIRDepressionRemissionatTwelveMonths_0_3_000 : ILibrary, ISingleton<CMS159FHIRDepressionRemissionatTwelveMonths_0_3_000>
{
    private CMS159FHIRDepressionRemissionatTwelveMonths_0_3_000() {}

    public static CMS159FHIRDepressionRemissionatTwelveMonths_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS159FHIRDepressionRemissionatTwelveMonths";
    ...
    {
        CqlDate a_ = context.Operators.Date(2026, 1, 1);
        CqlDate b_ = context.Operators.Date(2027, 1, 1);
        CqlInterval<CqlDate> c_ = context.Operators.Interval(a_, b_, true, false);
        CqlDate d_ = c_?.low;
        CqlDateTime e_ = context.Operators.ConvertDateToDateTime(d_);
        CqlInterval<CqlDate> h_ = context.Operators.Interval(a_, b_, true, false);
        CqlDate i_ = h_?.high;
        CqlDateTime j_ = context.Operators.ConvertDateToDateTime(i_);
        CqlInterval<CqlDate> m_ = context.Operators.Interval(a_, b_, true, false);
        bool? n_ = m_?.lowClosed;
        CqlInterval<CqlDate> q_ = context.Operators.Interval(a_, b_, true, false);
        bool? r_ = q_?.highClosed;
        CqlInterval<CqlDateTime> s_ = context.Operators.Interval(e_, j_, n_, r_);
        object t_ = context.ResolveParameter("CMS159FHIRDepressionRemissionatTwelveMonths-0.3.000", "Measurement Period", s_);

        return (CqlInterval<CqlDateTime>)t_;
    }
    ...
    {
        bool? a_ = QICoreCommon_4_0_000.Instance.isActive(context, condition as object);
    ...
    public IEnumerable<object> Depression_Diagnoses(CqlContext context)
    {
        ...
        {
            bool? n_ = this.isConfirmedActiveDiagnosis(context, Depression as Condition);
    ...
    public bool? Has_Hospice_Services_in_the_Measure_Assessment_Period(CqlContext context)
    {
        ...
        bool? u_(ServiceRequest HospiceOrder)
        {
            ...
            bool? eb_ = ea_?.Value;
            bool? ec_ = context.Operators.IsTrue(eb_);
        ...
        bool? aa_(Procedure HospicePerformed)
        {
            object ef_()
            {
                ...
                if (ev_())
                {
                    DataType fl_ = HospicePerformed?.Performed;
            ...
            CqlInterval<CqlDateTime> eh_ = this.Denominator_Identification_Period(context);
            CqlDateTime ei_ = context.Operators.Start(eh_);
            CqlInterval<CqlDate> ej_ = this.Measure_Assessment_Period(context);
            CqlDate ek_ = context.Operators.End(ej_);
            ...
            bool? en_ = context.Operators.Overlaps(eg_, em_, "day");
            Code<EventStatus> eo_ = HospicePerformed?.StatusElement;
            EventStatus? ep_ = eo_?.Value;
        ...
        {
            CqlInterval<CqlDateTime> ft_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, HospiceCareDiagnosis);
            CqlInterval<CqlDateTime> fu_ = this.Denominator_Identification_Period(context);
            CqlDateTime fv_ = context.Operators.Start(fu_);
            CqlInterval<CqlDate> fw_ = this.Measure_Assessment_Period(context);
            CqlDate fx_ = context.Operators.End(fw_);
            CqlDateTime fy_ = context.Operators.ConvertDateToDateTime(fx_);
            CqlInterval<CqlDateTime> fz_ = context.Operators.Interval(fv_, fy_, true, true);
            bool? ga_ = context.Operators.Overlaps(ft_, fz_, "day");
            bool? gb_ = this.isConfirmedActiveDiagnosis(context, HospiceCareDiagnosis as Condition);
            bool? gc_ = context.Operators.And(ga_, gb_);
    ...
    public bool? Has_Palliative_Care_in_the_Measure_Assessment_Period(CqlContext context)
    {
        ...
        bool? l_(object PalliativeDiagnosis)
        {
            ...
            bool? az_ = this.isConfirmedActiveDiagnosis(context, PalliativeDiagnosis as Condition);
    ...
    public bool? Has_Mental_Health_Disorder_Diagnoses(CqlContext context)
    {
        ...
        IEnumerable<object> w_ = context.Operators.Union<object>(q_, v_);
        bool? x_(object MentalHealthDisorderDiagnoses)
        {
            ...
            CqlDate ac_ = context.Operators.ConvertDateTimeToDate(ab_);
            CqlInterval<CqlDate> ad_ = this.Measure_Assessment_Period(context);
            CqlDate ae_ = context.Operators.End(ad_);
            bool? af_ = context.Operators.SameOrBefore(ac_, ae_, "day");
            bool? ag_ = this.isConfirmedActiveDiagnosis(context, MentalHealthDisorderDiagnoses as Condition);
