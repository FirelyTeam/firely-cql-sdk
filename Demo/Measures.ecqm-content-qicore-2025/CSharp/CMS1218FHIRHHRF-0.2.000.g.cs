...
[CqlLibrary("CMS1218FHIRHHRF", "0.2.000")]
public partial class CMS1218FHIRHHRF_0_2_000 : ILibrary, ISingleton<CMS1218FHIRHHRF_0_2_000>
{
    private CMS1218FHIRHHRF_0_2_000() {}

    public static CMS1218FHIRHHRF_0_2_000 Instance { get; } = new();
    ...
    {
        object a_ = context.ResolveParameter("CMS1218FHIRHHRF-0.2.000", "Measurement Period", null);
    ...
    public IEnumerable<CqlQuantity> Risk_Variable_Body_Mass_Index__BMI_(CqlContext context)
    {
        ...
        IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
        IEnumerable<Observation> c_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, b_, "http://hl7.org/fhir/us/core/StructureDefinition/us-core-bmi"));
        IEnumerable<Observation> d_(Observation BMI)
        {
            ...
            bool? j_(Encounter InpatientEncounter)
            {
                ...
                CqlInterval<CqlDateTime> r_ = CQMCommon_4_1_000.Instance.HospitalizationWithObservation(context, InpatientEncounter);
                bool? s_ = context.Operators.In<CqlDateTime>(q_, r_, default);
                DataType t_ = BMI?.Value;
                CqlQuantity u_ = FHIRHelpers_4_4_000.Instance.ToQuantity(context, t_ as Quantity);
    ...
    public CqlQuantity FirstBMI(CqlContext context, Encounter QualifyingEncounter)
    {
        ...
        {
            Code<ObservationStatus> k_ = FirstBodyMass?.StatusElement;
            ...
            bool? v_ = context.Operators.And(o_, u_);
            DataType w_ = FirstBodyMass?.Value;
