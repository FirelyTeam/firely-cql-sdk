...
[CqlLibrary("CMS155FHIRWeightAssessandCounselforKids", "0.3.000")]
public partial class CMS155FHIRWeightAssessandCounselforKids_0_3_000 : ILibrary, ISingleton<CMS155FHIRWeightAssessandCounselforKids_0_3_000>
{
    private CMS155FHIRWeightAssessandCounselforKids_0_3_000() {}

    public static CMS155FHIRWeightAssessandCounselforKids_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS155FHIRWeightAssessandCounselforKids";
    ...
    {
        object a_ = context.ResolveParameter("CMS155FHIRWeightAssessandCounselforKids-0.3.000", "Measurement Period", null);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
    {
        ...
        bool? v_(Encounter ValidEncounters)
        {
            ...
            CqlInterval<CqlDateTime> aa_ = QICoreCommon_4_0_000.Instance.toInterval(context, z_ as object);
