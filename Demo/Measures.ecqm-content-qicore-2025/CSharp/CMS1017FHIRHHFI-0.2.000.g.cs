...
[CqlLibrary("CMS1017FHIRHHFI", "0.2.000")]
public partial class CMS1017FHIRHHFI_0_2_000 : ILibrary, ISingleton<CMS1017FHIRHHFI_0_2_000>
{
    private CMS1017FHIRHHFI_0_2_000() {}

    public static CMS1017FHIRHHFI_0_2_000 Instance { get; } = new();
    ...
    {
        object a_ = context.ResolveParameter("CMS1017FHIRHHFI-0.2.000", "Measurement Period", null);
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Diagnosis(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            IEnumerable<object> i_ = this.encountersDiagnosis(context, QualifyingEncounter);
            bool? j_(object @this)
            {
    ...
    public bool? hasDiagnosisNotPresentOnAdmissionOrNull(CqlContext context, Encounter encounter, CqlValueSet diagnosisValueSet)
    {
        ...
        IEnumerable<Claim.DiagnosisComponent> b_(Encounter InptEncounter)
        {
            ...
            bool? h_(Claim Claims)
            {
                Code<FinancialResourceStatusCodes> q_ = Claims?.StatusElement;
                ...
                Code<ClaimUseCode> u_ = Claims?.UseElement;
                ...
                List<Claim.ItemComponent> z_ = Claims?.Item;
                bool? aa_(Claim.ItemComponent ClaimsItem)
                {
                    List<ResourceReference> ae_ = ClaimsItem?.Encounter;
                    bool? af_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)ae_, InptEncounter);
            ...
            bool? o_(Claim.DiagnosisComponent ClaimsDiag)
            {
                PositiveInt aj_ = ClaimsDiag?.SequenceElement;
                int? ak_ = aj_?.Value;
                ...
                bool? am_(Claim Claims)
                {
                    Code<FinancialResourceStatusCodes> bn_ = Claims?.StatusElement;
                    FinancialResourceStatusCodes? bo_ = bn_?.Value;
                    Code<FinancialResourceStatusCodes> bp_ = context.Operators.Convert<Code<FinancialResourceStatusCodes>>(bo_);
                    bool? bq_ = context.Operators.Equal(bp_, "active");
                    Code<ClaimUseCode> br_ = Claims?.UseElement;
                    ClaimUseCode? bs_ = br_?.Value;
                    Code<ClaimUseCode> bt_ = context.Operators.Convert<Code<ClaimUseCode>>(bs_);
                    bool? bu_ = context.Operators.Equal(bt_, "claim");
                    bool? bv_ = context.Operators.And(bq_, bu_);
                    List<Claim.ItemComponent> bw_ = Claims?.Item;
                    bool? bx_(Claim.ItemComponent ClaimsItem)
                    {
                        List<ResourceReference> cb_ = ClaimsItem?.Encounter;
                        bool? cc_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)cb_, InptEncounter);

                        return cc_;
                    };
                    IEnumerable<Claim.ItemComponent> by_ = context.Operators.Where<Claim.ItemComponent>((IEnumerable<Claim.ItemComponent>)bw_, bx_);
                    bool? bz_ = context.Operators.Exists<Claim.ItemComponent>(by_);
                ...
                {
                    List<Claim.ItemComponent> cf_ = @this?.Item;
                ...
                bool? at_(Claim.ItemComponent ClaimsItem)
                {
                    List<ResourceReference> cg_ = ClaimsItem?.Encounter;
                    bool? ch_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)cg_, InptEncounter);
                ...
                {
                    List<PositiveInt> ci_ = @this?.DiagnosisSequenceElement;
                    int? cj_(PositiveInt @this)
                    {
                        int? cm_ = @this?.Value;

                        return cm_;
                    };
                    IEnumerable<int?> ck_ = context.Operators.Select<PositiveInt, int?>((IEnumerable<PositiveInt>)ci_, cj_);
                ...
                {
                    List<PositiveInt> cn_ = @this?.DiagnosisSequenceElement;
                    int? co_(PositiveInt @this)
                    {
                        int? cq_ = @this?.Value;

                        return cq_;
                    };
                    IEnumerable<int?> cp_ = context.Operators.Select<PositiveInt, int?>((IEnumerable<PositiveInt>)cn_, co_);
                ...
                CodeableConcept bb_ = ClaimsDiag?.OnAdmission;
                CqlConcept bc_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, bb_);
                bool? bd_ = context.Operators.And(ba_, (bool?)(bc_ is null));
                CqlConcept bf_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, bb_);
                CqlValueSet bg_ = this.Not_Present_On_Admission_or_Documentation_Insufficient_to_Determine(context);
                bool? bh_ = context.Operators.ConceptInValueSet(bf_, bg_);
                DataType bi_ = ClaimsDiag?.Diagnosis;
                object bj_ = FHIRHelpers_4_4_000.Instance.ToValue(context, bi_);
                bool? bk_ = context.Operators.ConceptInValueSet(bj_ as CqlConcept, diagnosisValueSet);
                bool? bl_ = context.Operators.And(bh_, bk_);
                bool? bm_ = context.Operators.Or(bd_, bl_);
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Not_Present_On_Admission(CqlContext context)
    {
        ...
        {
            CqlValueSet d_ = this.Inpatient_Falls(context);
            bool? e_ = this.hasDiagnosisNotPresentOnAdmissionOrNull(context, InpatientEncounter, d_);
    ...
    public IEnumerable<Encounter> Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA(CqlContext context)
    {
        ...
        bool? b_(Encounter FallOccurred)
        {
            ...
            bool? e_(Claim.DiagnosisComponent MajorFallOccurred)
            {
                ...
                DataType n_ = MajorFallOccurred?.Diagnosis;
                object o_ = FHIRHelpers_4_4_000.Instance.ToValue(context, n_);
                CqlValueSet p_ = this.Major_Injuries(context);
                bool? q_ = context.Operators.ConceptInValueSet(o_ as CqlConcept, p_);
                object s_ = FHIRHelpers_4_4_000.Instance.ToValue(context, n_);
                object t_ = CQMCommon_4_1_000.Instance.getCondition(context, s_ as ResourceReference);
                object u_ = context.Operators.LateBoundProperty<object>(t_, "code");
                CqlConcept v_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, u_ as CodeableConcept);
                bool? x_ = context.Operators.ConceptInValueSet(v_, p_);
                bool? y_ = context.Operators.Or(q_, x_);
                bool? z_ = context.Operators.And(m_, y_);
                bool? aa_ = context.Operators.Or((bool?)(i_ is null), z_);
    ...
    public IEnumerable<Encounter> Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA(CqlContext context)
    {
        ...
        bool? b_(Encounter FallOccurred)
        {
            ...
            bool? e_(Claim.DiagnosisComponent ModerateFallOccurred)
            {
                ...
                CqlValueSet l_ = this.Not_Present_On_Admission_or_Documentation_Insufficient_to_Determine(context);
                bool? m_ = context.Operators.ConceptInValueSet(k_, l_);
                DataType n_ = ModerateFallOccurred?.Diagnosis;
                object o_ = FHIRHelpers_4_4_000.Instance.ToValue(context, n_);
                CqlValueSet p_ = this.Moderate_Injuries(context);
                bool? q_ = context.Operators.ConceptInValueSet(o_ as CqlConcept, p_);
                object s_ = FHIRHelpers_4_4_000.Instance.ToValue(context, n_);
                object t_ = CQMCommon_4_1_000.Instance.getCondition(context, s_ as ResourceReference);
                object u_ = context.Operators.LateBoundProperty<object>(t_, "code");
    ...
    public bool? hasDiagnosisPresentOnAdmission(CqlContext context, Encounter encounter, CqlValueSet diagnosisValueSet)
    {
        ...
        IEnumerable<Claim.DiagnosisComponent> b_(Encounter InptEncounter)
        {
            ...
            bool? o_(Claim.DiagnosisComponent ClaimsDiag)
            {
                ...
                bool? am_(Claim Claims)
                {
                    Code<FinancialResourceStatusCodes> bk_ = Claims?.StatusElement;
                    ...
                    Code<ClaimUseCode> bo_ = Claims?.UseElement;
                    ...
                    List<Claim.ItemComponent> bt_ = Claims?.Item;
                    bool? bu_(Claim.ItemComponent ClaimsItem)
                    {
                        List<ResourceReference> by_ = ClaimsItem?.Encounter;
                        bool? bz_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)by_, InptEncounter);
                ...
                bool? at_(Claim.ItemComponent ClaimsItem)
                {
                    List<ResourceReference> cd_ = ClaimsItem?.Encounter;
                    bool? ce_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)cd_, InptEncounter);
                ...
                DataType bg_ = ClaimsDiag?.Diagnosis;
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Present_On_Admission(CqlContext context)
    {
        ...
        {
            CqlValueSet d_ = this.Inpatient_Falls(context);
            bool? e_ = this.hasDiagnosisPresentOnAdmission(context, InpatientEncounter, d_);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission(CqlContext context)
    {
        ...
        bool? b_(Encounter InpatientEncounter)
        {
            ...
            bool? e_ = this.hasDiagnosisPresentOnAdmission(context, InpatientEncounter, d_);
            CqlValueSet f_ = this.Malnutrition(context);
            bool? g_ = this.hasDiagnosisPresentOnAdmission(context, InpatientEncounter, f_);
    ...
    public bool? hasDiagnosisNotPresentOnAdmission(CqlContext context, Encounter encounter, CqlValueSet diagnosisValueSet)
    {
        ...
        IEnumerable<Claim.DiagnosisComponent> b_(Encounter InpatientEncounter)
        {
            IEnumerable<Claim> g_ = context.Operators.Retrieve<Claim>(new RetrieveParameters(default, default, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-claim"));
            bool? h_(Claim Claims)
            {
                ...
                {
                    List<ResourceReference> ae_ = ClaimsItem?.Encounter;
                    bool? af_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)ae_, InpatientEncounter);
            ...
            bool? o_(Claim.DiagnosisComponent ClaimsDiag)
            {
                ...
                bool? am_(Claim Claims)
                {
                    ...
                    {
                        List<ResourceReference> by_ = ClaimsItem?.Encounter;
                        bool? bz_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)by_, InpatientEncounter);
                ...
                {
                    List<ResourceReference> cd_ = ClaimsItem?.Encounter;
                    bool? ce_ = QICoreCommon_4_0_000.Instance.references(context, (IEnumerable<ResourceReference>)cd_, InpatientEncounter);
