...
[CqlLibrary("CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer", "1.5.000")]
public partial class CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer_1_5_000 : ILibrary, ISingleton<CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer_1_5_000>
{
    private CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer_1_5_000() {}

    public static CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer_1_5_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer";
    ...
    {
        object a_ = context.ResolveParameter("CMS646FHIRIntravesicalBacillusCalmetteGuerinForBladderCancer-1.5.000", "Measurement Period", null);
    ...
    public IEnumerable<object> Bladder_Cancer_Diagnosis(CqlContext context)
    {
        ...
        bool? f_(object BladderCancer)
        {
            ...
            bool? m_ = this.isConfirmedActiveDiagnosis(context, BladderCancer);
    ...
    public Procedure First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period(CqlContext context)
    {
        ...
        bool? c_(Procedure FirstBladderCancerStaging)
        {
            ...
            object i_()
            {
                bool l_()
                {
                    DataType p_ = FirstBladderCancerStaging?.Performed;
    ...
    public IEnumerable<object> Acute_Tuberculosis_Diagnosis(CqlContext context)
    {
        ...
        {
            bool? ar_ = this.isConfirmedActiveDiagnosis(context, ActiveTuberculosis);
    ...
    public bool? Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging(CqlContext context)
    {
        ...
        {
            bool? bg_ = this.isConfirmedActiveDiagnosis(context, ExclusionDiagnosis);
    ...
    public bool? Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging(CqlContext context)
    {
        ...
        bool? p_(Procedure ExclusionProcedure)
        {
            ...
            bool? ki_ = context.Operators.Equal(kh_, "completed");
    ...
    public MedicationAdministration First_BCG_Administered(CqlContext context)
    {
        ...
        IEnumerable<MedicationAdministration> g_(MedicationAdministration BCG)
        {
            ...
            bool? ae_(Procedure FirstBladderCancerStaging)
            {
                ...
                bool? bg_ = context.Operators.In<CqlDateTime>(be_, bf_, default);
