...
[CqlLibrary("CMS117FHIRChildhoodImmunizationStatus", "0.3.000")]
public partial class CMS117FHIRChildhoodImmunizationStatus_0_3_000 : ILibrary, ISingleton<CMS117FHIRChildhoodImmunizationStatus_0_3_000>
{
    private CMS117FHIRChildhoodImmunizationStatus_0_3_000() {}

    public static CMS117FHIRChildhoodImmunizationStatus_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS117FHIRChildhoodImmunizationStatus";
    ...
    {
        object a_ = context.ResolveParameter("CMS117FHIRChildhoodImmunizationStatus-0.3.000", "Measurement Period", null);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
    {
        ...
        bool? w_(Encounter ValidEncounters)
        {
            ...
            CqlInterval<CqlDateTime> al_ = QICoreCommon_4_0_000.Instance.toInterval(context, ak_ as object);
    ...
    public bool? Has_Severe_Combined_Immunodeficiency(CqlContext context)
    {
        ...
        bool? f_(object SevereImmuneDisorder)
        {
    ...
    public bool? Has_Lymphoreticular_Cancer__Multiple_Myeloma_or_Leukemia(CqlContext context)
    {
        ...
        IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> e_ = context.Operators.Union<object>(b_ as IEnumerable<object>, d_ as IEnumerable<object>);
        bool? f_(object LymphaticMalignantNeoplasm)
        {
    ...
    public bool? Has_Intussusception(CqlContext context)
    {
        ...
        IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> e_ = context.Operators.Union<object>(b_ as IEnumerable<object>, d_ as IEnumerable<object>);
        bool? f_(object IntussusceptionDisorder)
        {
    ...
    public IEnumerable<object> DTaP_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        bool? l_(object DTaPConditions)
        {
            CqlInterval<CqlDateTime> n_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, DTaPConditions);
    ...
    public IEnumerable<object> Polio_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        bool? h_(object PolioConditions)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, PolioConditions);
    ...
    public IEnumerable<object> MMR_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, e_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> g_ = context.Operators.Union<object>(c_ as IEnumerable<object>, f_ as IEnumerable<object>);
        bool? h_(object MMRConditions)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, MMRConditions);
            CqlDateTime k_ = context.Operators.Start(j_);
            CqlDate l_ = context.Operators.DateFrom(k_);
            CqlInterval<CqlDate> m_ = this.First_Two_Years(context);
            bool? n_ = context.Operators.In<CqlDate>(l_, m_, "day");
    ...
    public IEnumerable<Condition> Measles_Indicators(CqlContext context)
    {
        ...
        bool? f_(Condition MeaslesDiagnosis)
        {
            CqlInterval<CqlDateTime> h_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, MeaslesDiagnosis as object);
    ...
    public IEnumerable<object> Rubella_Indicators(CqlContext context)
    {
        ...
        IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> e_ = context.Operators.Union<object>(b_ as IEnumerable<object>, d_ as IEnumerable<object>);
        bool? f_(object RubellaDiagnosis)
        {
    ...
    public IEnumerable<object> Hib_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, e_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> g_ = context.Operators.Union<object>(c_ as IEnumerable<object>, f_ as IEnumerable<object>);
        bool? h_(object HibReaction)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, HibReaction);
            CqlDateTime k_ = context.Operators.Start(j_);
            CqlDate l_ = context.Operators.DateFrom(k_);
            CqlInterval<CqlDate> m_ = this.First_Two_Years(context);
            bool? n_ = context.Operators.In<CqlDate>(l_, m_, "day");
    ...
    public IEnumerable<object> Hepatitis_B_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        bool? n_(object HepBConditions)
        {
            CqlInterval<CqlDateTime> p_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, HepBConditions);
            CqlDateTime q_ = context.Operators.Start(p_);
            CqlDate r_ = context.Operators.DateFrom(q_);
            CqlInterval<CqlDate> s_ = this.First_Two_Years(context);
            bool? t_ = context.Operators.In<CqlDate>(r_, s_, "day");
    ...
    public IEnumerable<object> Varicella_Zoster_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        bool? n_(object VaricellaZoster)
        {
            CqlInterval<CqlDateTime> p_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, VaricellaZoster);
            CqlDateTime q_ = context.Operators.Start(p_);
            CqlDate r_ = context.Operators.DateFrom(q_);
            CqlInterval<CqlDate> s_ = this.First_Two_Years(context);
            bool? t_ = context.Operators.In<CqlDate>(r_, s_, "day");
    ...
    public IEnumerable<object> Pneumococcal_Conjugate_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, e_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> g_ = context.Operators.Union<object>(c_ as IEnumerable<object>, f_ as IEnumerable<object>);
        bool? h_(object PneumococcalReaction)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, PneumococcalReaction);
            CqlDateTime k_ = context.Operators.Start(j_);
            CqlDate l_ = context.Operators.DateFrom(k_);
            CqlInterval<CqlDate> m_ = this.First_Two_Years(context);
            bool? n_ = context.Operators.In<CqlDate>(l_, m_, "day");
    ...
    public IEnumerable<object> Hepatitis_A_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> l_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, k_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> m_ = context.Operators.Union<object>(i_ as IEnumerable<object>, l_ as IEnumerable<object>);
        bool? n_(object HepatitisADiagnosis)
        {
            CqlInterval<CqlDateTime> p_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, HepatitisADiagnosis);
            CqlDateTime q_ = context.Operators.Start(p_);
            CqlDate r_ = context.Operators.DateFrom(q_);
            CqlInterval<CqlDate> s_ = this.First_Two_Years(context);
            bool? t_ = context.Operators.In<CqlDate>(r_, s_, "day");
    ...
    public IEnumerable<object> Rotavirus_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, e_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> g_ = context.Operators.Union<object>(c_ as IEnumerable<object>, f_ as IEnumerable<object>);
        bool? h_(object RotavirusConditions)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, RotavirusConditions);
            CqlDateTime k_ = context.Operators.Start(j_);
            CqlDate l_ = context.Operators.DateFrom(k_);
            CqlInterval<CqlDate> m_ = this.First_Two_Years(context);
            bool? n_ = context.Operators.In<CqlDate>(l_, m_, "day");
    ...
    public IEnumerable<object> Influenza_Numerator_Inclusion_Conditions(CqlContext context)
    {
        ...
        IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, e_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        IEnumerable<object> g_ = context.Operators.Union<object>(c_ as IEnumerable<object>, f_ as IEnumerable<object>);
        bool? h_(object InfluenzaConditions)
        {
            CqlInterval<CqlDateTime> j_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, InfluenzaConditions);
            CqlDateTime k_ = context.Operators.Start(j_);
            CqlDate l_ = context.Operators.DateFrom(k_);
            CqlInterval<CqlDate> m_ = this.First_Two_Years(context);
            bool? n_ = context.Operators.In<CqlDate>(l_, m_, "day");
