...
[CqlLibrary("CMS146FHIRAppropriateTestingforPharyngitis", "0.3.000")]
public partial class CMS146FHIRAppropriateTestingforPharyngitis_0_3_000 : ILibrary, ISingleton<CMS146FHIRAppropriateTestingforPharyngitis_0_3_000>
{
    private CMS146FHIRAppropriateTestingforPharyngitis_0_3_000() {}

    public static CMS146FHIRAppropriateTestingforPharyngitis_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS146FHIRAppropriateTestingforPharyngitis";
    public string Version => "0.3.000";
    public ILibrary[] Dependencies => [FHIRHelpers_4_4_000.Instance, SupplementalDataElements_5_1_000.Instance, Hospice_6_18_000.Instance, Antibiotic_1_9_000.Instance, Status_1_15_000.Instance, QICoreCommon_4_0_000.Instance];
    ...
    {
        object a_ = context.ResolveParameter("CMS146FHIRAppropriateTestingforPharyngitis-0.3.000", "Measurement Period", null);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
    {
        ...
        bool? ar_(Encounter ValidEncounter)
        {
            ...
            CqlInterval<CqlDateTime> bf_ = QICoreCommon_4_0_000.Instance.toInterval(context, be_ as object);
    ...
    public IEnumerable<Encounter> Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic(CqlContext context)
    {
        ...
        {
            CqlInterval<CqlDateTime> l_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, tuple_ypyxedbbcqbdavhxvckuwmfh?.AcutePharyngitisTonsillitis as object);
    ...
    public IEnumerable<Encounter> Denominator_Exclusions(CqlContext context)
    {
        ...
        IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, c_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-encounter-diagnosis"));
        IEnumerable<Encounter> e_ = Antibiotic_1_9_000.Instance.Has_Comorbid_Condition_History(context, b_, d_);
        ...
        IEnumerable<MedicationRequest> n_ = Status_1_15_000.Instance.isMedicationActive(context, m_);
        IEnumerable<Encounter> o_ = Antibiotic_1_9_000.Instance.Has_Antibiotic_Medication_History(context, b_, n_);
        CqlValueSet q_ = this.Competing_Conditions_for_Respiratory_Conditions(context);
        IEnumerable<Condition> r_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, q_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-encounter-diagnosis"));
        IEnumerable<Encounter> s_ = Antibiotic_1_9_000.Instance.Has_Competing_Diagnosis_History(context, b_, r_);
