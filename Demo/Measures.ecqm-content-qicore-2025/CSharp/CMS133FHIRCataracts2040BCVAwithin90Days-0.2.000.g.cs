...
[CqlLibrary("CMS133FHIRCataracts2040BCVAwithin90Days", "0.2.000")]
public partial class CMS133FHIRCataracts2040BCVAwithin90Days_0_2_000 : ILibrary, ISingleton<CMS133FHIRCataracts2040BCVAwithin90Days_0_2_000>
{
    private CMS133FHIRCataracts2040BCVAwithin90Days_0_2_000() {}

    public static CMS133FHIRCataracts2040BCVAwithin90Days_0_2_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS133FHIRCataracts2040BCVAwithin90Days";
    ...
    {
        object a_ = context.ResolveParameter("CMS133FHIRCataracts2040BCVAwithin90Days-0.2.000", "Measurement Period", null);
    ...
    public IEnumerable<Procedure> Cataract_Surgery_Between_January_and_September_of_Measurement_Period(CqlContext context)
    {
        ...
        bool? c_(Procedure CataractSurgery)
        {
            ...
            bool? h_ = context.Operators.IntervalIncludesInterval<CqlDateTime>(e_, g_, default);
            object i_()
            {
                bool au_()
                {
            ...
            bool? p_ = context.Operators.SameOrBefore(k_, o_, default);
    ...
    public IEnumerable<Procedure> Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery(CqlContext context)
    {
        ...
        IEnumerable<Procedure> b_(Procedure CataractSurgeryPerformed)
        {
            ...
            bool? lu_(object ComorbidDiagnosis)
            {
                ...
                bool? mb_ = context.Operators.OverlapsBefore(ly_, ma_, default);
                bool? mc_ = QICoreCommon_4_0_000.Instance.isActive(context, ComorbidDiagnosis);
