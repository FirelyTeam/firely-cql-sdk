...
[CqlLibrary("CMS165FHIRControllingHighBloodPressure", "0.5.000")]
public partial class CMS165FHIRControllingHighBloodPressure_0_5_000 : ILibrary, ISingleton<CMS165FHIRControllingHighBloodPressure_0_5_000>
{
    private CMS165FHIRControllingHighBloodPressure_0_5_000() {}

    public static CMS165FHIRControllingHighBloodPressure_0_5_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS165FHIRControllingHighBloodPressure";
    public string Version => "0.5.000";
    ...
    {
        object a_ = context.ResolveParameter("CMS165FHIRControllingHighBloodPressure-0.5.000", "Measurement Period", null);
    ...
    public IEnumerable<Observation> Qualifying_Systolic_Blood_Pressure_Reading(CqlContext context)
    {
        ...
        {
            CqlValueSet m_ = this.Encounter_Inpatient(context);
            ...
            CqlValueSet o_ = this.Emergency_Department_Evaluation_and_Management_Visit(context);
            ...
            Observation u_(Encounter DisqualifyingEncounter) =>
                BloodPressure;
            IEnumerable<Observation> v_ = context.Operators.Select<Encounter, Observation>(t_, u_);
        ...
        IEnumerable<Observation> i_ = Status_1_15_000.Instance.isObservationBP(context, a_);
        bool? j_(Observation BloodPressure)
        {
        ...
        IEnumerable<Observation> l_ = context.Operators.Union<Observation>(g_, k_);
