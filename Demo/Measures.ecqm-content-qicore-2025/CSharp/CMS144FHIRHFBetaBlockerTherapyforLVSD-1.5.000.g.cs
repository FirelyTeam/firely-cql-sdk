...
[CqlLibrary("CMS144FHIRHFBetaBlockerTherapyforLVSD", "1.5.000")]
public partial class CMS144FHIRHFBetaBlockerTherapyforLVSD_1_5_000 : ILibrary, ISingleton<CMS144FHIRHFBetaBlockerTherapyforLVSD_1_5_000>
{
    private CMS144FHIRHFBetaBlockerTherapyforLVSD_1_5_000() {}

    public static CMS144FHIRHFBetaBlockerTherapyforLVSD_1_5_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS144FHIRHFBetaBlockerTherapyforLVSD";
    ...
    {
        object a_ = context.ResolveParameter("CMS144FHIRHFBetaBlockerTherapyforLVSD-1.5.000", "Measurement Period", null);
    ...
    {
        bool? a_ = AHAOverall_3_0_000.Instance.Is_Adults_With_Two_Qualifying_Outpatient_Encounters_and_One_Heart_Failure_Outpatient_Encounter_During_the_Measurement_Period(context);
    ...
    public bool? Denominator(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_ = AHAOverall_3_0_000.Instance.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
    ...
    {
        bool? a_ = AHAOverall_3_0_000.Instance.Has_Heart_Transplant(context);
        bool? b_ = AHAOverall_3_0_000.Instance.Has_Heart_Transplant_Complications(context);
        bool? c_ = context.Operators.Or(a_, b_);
        bool? d_ = AHAOverall_3_0_000.Instance.Has_Left_Ventricular_Assist_Device(context);
        bool? e_ = context.Operators.Or(c_, d_);
        bool? f_ = AHAOverall_3_0_000.Instance.Has_Left_Ventricular_Assist_Device_Complications(context);
    ...
    [CqlFunctionDefinition("isOrderedDuringHeartFailureOutpatientEncounter2")]
    public bool? isOrderedDuringHeartFailureOutpatientEncounter2(CqlContext context, MedicationRequest MedicationRequest)
    {
        IEnumerable<Encounter> a_ = AHAOverall_3_0_000.Instance.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
    ...
    public bool? Has_Beta_Blocker_Therapy_for_LVSD_Ordered(CqlContext context)
    {
        ...
        {
            bool? f_ = this.isOrderedDuringHeartFailureOutpatientEncounter2(context, BetaBlockerOrdered);
    ...
    public bool? Is_Currently_Taking_Beta_Blocker_Therapy_for_LVSD(CqlContext context)
    {
        ...
        {
            bool? y_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, ActiveBetaBlocker);
    ...
    public bool? Has_Medical_or_Patient_Reason_for_Not_Ordering_Beta_Blocker_for_LVSD(CqlContext context)
    {
        ...
        {
            IEnumerable<Encounter> f_ = AHAOverall_3_0_000.Instance.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
            bool? g_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter)
            {
                FhirDateTime k_ = NoBetaBlockerOrdered?.AuthoredOnElement;
            ...
            MedicationRequest i_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter) =>
                NoBetaBlockerOrdered;
            IEnumerable<MedicationRequest> j_ = context.Operators.Select<Encounter, MedicationRequest>(h_, i_);
    ...
    public bool? Has_Arrhythmia_Diagnosis(CqlContext context)
    {
        ...
        bool? c_(Condition ArrhythmiaAlias)
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, ArrhythmiaAlias as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, ArrhythmiaAlias as object);
    ...
    public bool? Has_Hypotension_Diagnosis(CqlContext context)
    {
        ...
        IEnumerable<Condition> b_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        bool? c_(Condition HypotensionAlias)
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, HypotensionAlias as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, HypotensionAlias as object);
            bool? h_ = context.Operators.And(f_, g_);
    ...
    public bool? Has_Asthma_Diagnosis(CqlContext context)
    {
        ...
        IEnumerable<Condition> b_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        bool? c_(Condition AsthmaAlias)
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, AsthmaAlias as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, AsthmaAlias as object);
            bool? h_ = context.Operators.And(f_, g_);
    ...
    public bool? Has_Diagnosis_of_Allergy_or_Intolerance_to_Beta_Blocker_Therapy(CqlContext context)
    {
        ...
        {
            bool? i_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, BetaBlockerAllergyOrIntoleranceDiagnosis as object);
            bool? j_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, BetaBlockerAllergyOrIntoleranceDiagnosis as object);
    ...
    public bool? Has_Bradycardia_Diagnosis(CqlContext context)
    {
        ...
        IEnumerable<Condition> b_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-condition-problems-health-concerns"));
        bool? c_(Condition BradycardiaAlias)
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, BradycardiaAlias as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, BradycardiaAlias as object);
            bool? h_ = context.Operators.And(f_, g_);
    ...
    [CqlTag("commentedOutEarlier", "implies logic")]
    ...
    public bool? Has_Allergy_or_Intolerance_to_Beta_Blocker_Therapy_Ingredient(CqlContext context)
    {
        ...
        {
            bool? j_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, BetaBlockerAllergyIntolerance);
            ...
            CqlConcept o_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, k_);
            CqlCode p_ = QICoreCommon_4_0_000.Instance.allergy_inactive(context);
            CqlConcept q_ = context.Operators.ConvertCodeToConcept(p_);
            bool? r_ = context.Operators.Equivalent(o_, q_);
            bool? s_ = context.Operators.Not(r_);
            bool? t_ = context.Operators.Implies(m_, s_);
            CqlConcept v_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, k_);
            CqlCode w_ = QICoreCommon_4_0_000.Instance.allergy_active(context);
            CqlConcept x_ = context.Operators.ConvertCodeToConcept(w_);
            bool? y_ = context.Operators.Equivalent(v_, x_);
            bool? z_ = context.Operators.Or(t_, y_);
            bool? aa_ = context.Operators.And(j_, z_);
    ...
    public bool? Has_Atrioventricular_Block_Diagnosis(CqlContext context)
    {
        ...
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsHeartFailureOutpatientEncounter(context, AtrioventricularBlock as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, AtrioventricularBlock as object);
            bool? h_ = context.Operators.And(f_, g_);
    ...
    public bool? Has_Diagnosis_of_Cardiac_Pacer_in_Situ(CqlContext context)
    {
        ...
        {
            bool? f_ = AHAOverall_3_0_000.Instance.overlapsAfterHeartFailureOutpatientEncounter(context, CardiacPacerDiagnosis as object);
            bool? g_ = AHAOverall_3_0_000.Instance.isConfirmedActiveDiagnosis(context, CardiacPacerDiagnosis as object);
            bool? h_ = context.Operators.And(f_, g_);
    ...
    public bool? Has_Cardiac_Pacer_Device_Implanted(CqlContext context)
    {
        ...
        {
            IEnumerable<Encounter> h_ = AHAOverall_3_0_000.Instance.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
