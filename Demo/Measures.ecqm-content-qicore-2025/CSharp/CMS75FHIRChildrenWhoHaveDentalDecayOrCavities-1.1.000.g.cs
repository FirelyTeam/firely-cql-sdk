...
[CqlLibrary("CMS75FHIRChildrenWhoHaveDentalDecayOrCavities", "1.1.000")]
public partial class CMS75FHIRChildrenWhoHaveDentalDecayOrCavities_1_1_000 : ILibrary, ISingleton<CMS75FHIRChildrenWhoHaveDentalDecayOrCavities_1_1_000>
{
    private CMS75FHIRChildrenWhoHaveDentalDecayOrCavities_1_1_000() {}

    public static CMS75FHIRChildrenWhoHaveDentalDecayOrCavities_1_1_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS75FHIRChildrenWhoHaveDentalDecayOrCavities";
    ...
    public CqlInterval<CqlDateTime> Measurement_Period(CqlContext context)
    {
        ...
        object t_ = context.ResolveParameter("CMS75FHIRChildrenWhoHaveDentalDecayOrCavities-1.1.000", "Measurement Period", s_);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
    {
        ...
        bool? d_(Encounter ValidEncounter)
        {
            ...
            CqlInterval<CqlDateTime> i_ = QICoreCommon_4_0_000.Instance.toInterval(context, h_ as object);
