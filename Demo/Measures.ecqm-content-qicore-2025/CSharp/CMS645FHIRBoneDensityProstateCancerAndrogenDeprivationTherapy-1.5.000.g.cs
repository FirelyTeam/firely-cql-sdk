...
[CqlLibrary("CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy", "1.5.000")]
public partial class CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy_1_5_000 : ILibrary, ISingleton<CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy_1_5_000>
{
    private CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy_1_5_000() {}

    public static CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy_1_5_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy";
    ...
    {
        object a_ = context.ResolveParameter("CMS645FHIRBoneDensityProstateCancerAndrogenDeprivationTherapy-1.5.000", "Measurement Period", null);
    ...
    public IEnumerable<CqlDateTime> Androgen_Deprivation_Therapy_for_Urology_Care_Medication_Active_Start_Dates(CqlContext context)
    {
        ...
        CqlDateTime i_(MedicationRequest ADTActive)
        {
            ...
            CqlDateTime bq_ = QICoreCommon_4_0_000.Instance.earliest(context, bp_ as object);
    ...
    public IEnumerable<CqlDateTime> Androgen_Deprivation_Therapy_for_Urology_Care_Medication_Order_Start_Dates(CqlContext context)
    {
        ...
        CqlDateTime i_(MedicationRequest ADTOrder)
        {
            ...
            CqlDateTime bi_ = QICoreCommon_4_0_000.Instance.earliest(context, bh_ as object);
    ...
    public IEnumerable<object> Prostate_Cancer_Diagnosis(CqlContext context)
    {
        ...
        bool? f_(object ProstateCancer)
        {
            ...
            object k_ = context.Operators.LateBoundProperty<object>(ProstateCancer, "clinicalStatus");
            CqlConcept l_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, k_ as CodeableConcept);
            CqlCode m_ = QICoreCommon_4_0_000.Instance.active(context);
            CqlConcept n_ = context.Operators.ConvertCodeToConcept(m_);
            bool? o_ = context.Operators.Equivalent(l_, n_);
            bool? p_ = context.Operators.And(j_, o_);
            object q_ = context.Operators.LateBoundProperty<object>(ProstateCancer, "verificationStatus");
            CqlConcept r_ = FHIRHelpers_4_4_000.Instance.ToConcept(context, q_ as CodeableConcept);
            CqlCode s_ = QICoreCommon_4_0_000.Instance.confirmed(context);
    ...
    public bool? Has_Baseline_DEXA_Scan_Two_Years_Prior_to_the_Start_of_or_Less_than_Three_Months_After_the_Start_of_ADT(CqlContext context)
    {
        ...
        IEnumerable<Observation> h_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, a_, default, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-observation-lab"));
    ...
    [CqlTag("commmentedOutReason", "\"No Bone Density Scan Ordered Due to Patient Refusal\")")]
