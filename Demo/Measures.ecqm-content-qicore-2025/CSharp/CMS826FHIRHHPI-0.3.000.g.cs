...
[CqlLibrary("CMS826FHIRHHPI", "0.3.000")]
public partial class CMS826FHIRHHPI_0_3_000 : ILibrary, ISingleton<CMS826FHIRHHPI_0_3_000>
{
    private CMS826FHIRHHPI_0_3_000() {}

    public static CMS826FHIRHHPI_0_3_000 Instance { get; } = new();
    ...
    {
        object a_ = context.ResolveParameter("CMS826FHIRHHPI-0.3.000", "Measurement Period", null);
    ...
    public bool? isIn(CqlContext context, object observation, CqlValueSet vset)
    {
        ...
        bool? i_ = context.Operators.And(d_, h_);
        bool? j_()
        {
            if (observation is Observation)
            {
                DataType l_ = (observation as Observation)?.Value;
                object m_ = FHIRHelpers_4_4_000.Instance.ToValue(context, l_);
                bool? n_ = context.Operators.ConceptInValueSet(m_ as CqlConcept, vset);

                return n_;
            }
            else if (observation is Observation)
            {
                DataType o_ = (observation as Observation)?.Value;
                object p_ = FHIRHelpers_4_4_000.Instance.ToValue(context, o_);
                bool? q_ = context.Operators.ConceptInValueSet(p_ as CqlConcept, vset);
    ...
    [CqlExpressionDefinition("Clinical SkinExams with Pressure Injury")]
    public IEnumerable<Observation> Clinical_SkinExams_with_Pressure_Injury(CqlContext context)
    {
    ...
    [CqlExpressionDefinition("Simple SkinExams with Pressure Injury")]
    public IEnumerable<Observation> Simple_SkinExams_with_Pressure_Injury(CqlContext context)
    {
        CqlCode a_ = this.Physical_findings_of_Skin(context);
        IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
    ...
    [CqlExpressionDefinition("SkinExams with Pressure Injury")]
    public IEnumerable<object> SkinExams_with_Pressure_Injury(CqlContext context)
    {
        IEnumerable<Observation> a_ = this.Clinical_SkinExams_with_Pressure_Injury(context);
        IEnumerable<Observation> b_ = this.Simple_SkinExams_with_Pressure_Injury(context);
    ...
    public IEnumerable<Encounter> Encounter_with_Deep_Tissue_Pressure_Injury_POA_by_Skin_Exam_within_First_72_Hours(CqlContext context)
    {
        ...
        {
            IEnumerable<object> d_ = this.SkinExams_with_Pressure_Injury(context);
