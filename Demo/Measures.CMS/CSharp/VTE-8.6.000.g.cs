...
public partial class VTE_8_6_000 : ILibrary, ISingleton<VTE_8_6_000>
{
    private VTE_8_6_000() {}

    public static VTE_8_6_000 Instance { get; } = new();

    #region Library Members
    public string Name => "VTE";
    public string Version => "8.6.000";
    public ILibrary[] Dependencies => [FHIRHelpers_4_3_000.Instance, CQMCommon_2_0_000.Instance];
    ...
    public IEnumerable<Encounter> Admission_without_VTE_or_Obstetrical_Conditions(CqlContext context)
    {
        ...
        {
            IEnumerable<Condition> d_ = CQMCommon_2_0_000.Instance.encounterDiagnosis(context, InpatientEncounter);
            bool? e_(Condition EncDx)
            {
                ...
                CqlConcept n_ = FHIRHelpers_4_3_000.Instance.ToConcept(context, i_);
                ...
                CqlConcept s_ = FHIRHelpers_4_3_000.Instance.ToConcept(context, i_);
    ...
    {
        CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.Instance.hospitalizationWithObservation(context, Encounter);
    ...
    {
        Encounter.LocationComponent a_ = CQMCommon_2_0_000.Instance.firstInpatientIntensiveCareUnit(context, Encounter);
        Period b_ = a_?.Period;
        CqlInterval<CqlDateTime> c_ = FHIRHelpers_4_3_000.Instance.ToInterval(context, b_);
