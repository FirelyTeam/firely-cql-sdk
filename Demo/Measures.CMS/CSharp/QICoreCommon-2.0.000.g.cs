...
public static class QICoreCommon_2_0_000
{
	...
	public static CqlCode field(CqlContext context) => 
	...
	public static CqlCode inpatient_encounter(CqlContext context) => 
	...
	public static CqlCode health_concern(CqlContext context) => 
	...
	public static CqlCode social_history(CqlContext context) => 
	...
	public static CqlCode imaging(CqlContext context) => 
	...
	public static CqlCode procedure(CqlContext context) => 
	...
	public static CqlCode clinical_test(CqlContext context) => 
...
;
	...
	public static CqlCode[] USCoreObservationCategoryExtensionCodes(CqlContext context)
	{
		CqlCode[] a_ = [
			new CqlCode("clinical-test", "http://hl7.org/fhir/us/core/CodeSystem/us-core-observation-category", default, default),
		];
	...
	public static CqlCode[] ConditionCategory(CqlContext context)
	{
		CqlCode[] a_ = [
			new CqlCode("problem-list-item", "http://terminology.hl7.org/CodeSystem/condition-category", default, default),
			new CqlCode("encounter-diagnosis", "http://terminology.hl7.org/CodeSystem/condition-category", default, default),
	...
	public static CqlCode[] USCoreConditionCategoryExtensionCodes(CqlContext context)
	{
		CqlCode[] a_ = [
			new CqlCode("health-concern", "http://hl7.org/fhir/us/core/CodeSystem/condition-category", default, default),
		];
	...
	public static bool? isActive(CqlContext context, Condition condition)
	{
		CodeableConcept a_ = condition?.ClinicalStatus;
		CqlConcept b_ = FHIRHelpers_4_3_000.ToConcept(context, a_);
		CqlCode c_ = QICoreCommon_2_0_000.active(context);
		CqlConcept d_ = context.Operators.ConvertCodeToConcept(c_);
		bool? e_ = context.Operators.Equivalent(b_, d_);
		CqlConcept g_ = FHIRHelpers_4_3_000.ToConcept(context, a_);
		CqlCode h_ = QICoreCommon_2_0_000.recurrence(context);
		...
		CqlConcept m_ = FHIRHelpers_4_3_000.ToConcept(context, a_);
		CqlCode n_ = QICoreCommon_2_0_000.relapse(context);
	...
	public static bool? hasCategory(CqlContext context, Condition condition, CqlCode category)
	{
		List<CodeableConcept> a_ = condition?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
			CqlConcept g_ = FHIRHelpers_4_3_000.ToConcept(context, @this);
	...
	public static bool? hasCategory(CqlContext context, Observation observation, CqlCode category)
	{
	...
	public static bool? isProblemListItem(CqlContext context, Condition condition)
	{
		List<CodeableConcept> a_ = condition?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.problem_list_item(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
	...
	public static bool? isEncounterDiagnosis(CqlContext context, Condition condition)
	{
		List<CodeableConcept> a_ = condition?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.encounter_diagnosis(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isHealthConcern(CqlContext context, Condition condition)
	{
		List<CodeableConcept> a_ = condition?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.health_concern(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isSocialHistory(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.social_history(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isVitalSign(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.vital_signs(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isImaging(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.imaging(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isLaboratory(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.laboratory(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isProcedure(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.procedure(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isSurvey(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.survey(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isExam(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.exam(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isTherapy(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.therapy(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isActivity(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.activity(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isClinicalTest(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.clinical_test(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isCommunity(CqlContext context, MedicationRequest medicationRequest)
	{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.Community(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? isDischarge(CqlContext context, MedicationRequest medicationRequest)
	{
		List<CodeableConcept> a_ = medicationRequest?.Category;
		CqlConcept b_(CodeableConcept @this)
		{
		...
		bool? d_(CqlConcept C)
		{
			CqlCode h_ = QICoreCommon_2_0_000.Discharge(context);
			CqlConcept i_ = context.Operators.ConvertCodeToConcept(h_);
			bool? j_ = context.Operators.Equivalent(C, i_);
	...
	public static bool? doNotPerform(CqlContext context, DeviceRequest deviceRequest)
	{
		bool? a_(Extension E)
		{
			string f_ = E?.Url;
	...
	public static CqlInterval<CqlDateTime> ToInterval(CqlContext context, object choice)
	{
		CqlInterval<CqlDateTime> a_()
		{
			...
			{
				Patient c_ = QICoreCommon_2_0_000.Patient(context);
			...
			{
				Patient bj_ = QICoreCommon_2_0_000.Patient(context);
	...
	public static CqlInterval<CqlDateTime> ToAbatementInterval(CqlContext context, Condition condition)
	{
		CqlInterval<CqlDateTime> a_()
		{
			bool b_()
			...
			if (b_())
			{
				...
				object u_ = FHIRHelpers_4_3_000.ToValue(context, r_);
			...
			{
				Patient w_ = QICoreCommon_2_0_000.Patient(context);
				...
				object ai_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				...
				object au_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				...
				object bb_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				...
				object bn_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				CqlDate bo_ = context.Operators.Add(bl_, bn_ as CqlQuantity);
				Date bq_ = w_?.BirthDateElement;
				string br_ = bq_?.Value;
				CqlDate bs_ = context.Operators.ConvertStringToDate(br_);
				object bu_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				...
				string cc_ = cb_?.Value;
				CqlDate cd_ = context.Operators.ConvertStringToDate(cc_);
				object cf_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
				...
				object cm_ = FHIRHelpers_4_3_000.ToValue(context, aa_);
			...
			{
				Patient ct_ = QICoreCommon_2_0_000.Patient(context);
				...
				object dg_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object dt_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object eb_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object eo_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object ew_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object fi_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
				...
				object fq_ = FHIRHelpers_4_3_000.ToValue(context, cx_);
			...
			else if (e_())
			{
				...
				object fz_ = FHIRHelpers_4_3_000.ToValue(context, fy_);
				object ga_ = context.Operators.LateBoundProperty<object>(fz_, "low");
				object gc_ = FHIRHelpers_4_3_000.ToValue(context, fy_);
    ...
    [CqlTag("description", "Returns an interval representing the normalized abatement of a given Condition.")]
    [CqlTag("comment", "If the abatement element of the Condition is represented as a DateTime, the result is an interval beginning and ending on that DateTime. If the abatement is represented as a Quantity, the quantity is expected to be a calendar-duration and is interpreted as the age of the patient. The result is an interval from the date the patient turned that age to immediately before one year later. If the abatement is represented as a Quantity Interval, the quantities are expected to be calendar-durations and are interpreted as an age range during which the abatement occurred. The result is an interval from the date the patient turned the starting age of the quantity interval, and ending immediately before one year later than the date the patient turned the ending age of the quantity interval.")]
	public static CqlInterval<CqlDateTime> abatementInterval(CqlContext context, Condition condition)
	{
		CqlInterval<CqlDateTime> a_()
		{
			bool b_()
	...
	public static CqlInterval<CqlDateTime> ToPrevalenceInterval(CqlContext context, Condition condition)
	{
		CqlInterval<CqlDateTime> a_()
		{
			bool b_()
			{
				...
				CqlCode e_ = QICoreCommon_2_0_000.active(context);
				CqlConcept f_ = context.Operators.ConvertCodeToConcept(e_);
				bool? g_ = context.Operators.Equivalent(d_, f_);
				CqlConcept i_ = FHIRHelpers_4_3_000.ToConcept(context, c_);
				CqlCode j_ = QICoreCommon_2_0_000.recurrence(context);
				CqlConcept k_ = context.Operators.ConvertCodeToConcept(j_);
				bool? l_ = context.Operators.Equivalent(i_, k_);
				bool? m_ = context.Operators.Or(g_, l_);
				CqlConcept o_ = FHIRHelpers_4_3_000.ToConcept(context, c_);
				CqlCode p_ = QICoreCommon_2_0_000.relapse(context);
			...
			if (b_())
			{
				...
				CqlInterval<CqlDateTime> x_ = QICoreCommon_2_0_000.ToAbatementInterval(context, condition);
			...
			{
				CqlInterval<CqlDateTime> aa_ = QICoreCommon_2_0_000.ToAbatementInterval(context, condition);
    ...
    [CqlTag("description", "Returns an interval representing the normalized prevalence period of a given Condition.")]
    [CqlTag("comment", "Uses the ToInterval and ToAbatementInterval functions to determine the widest potential interval from onset to abatement as specified in the given Condition. If the condition is active, or has an abatement date the resulting interval will have a closed ending boundary. Otherwise, the resulting interval will have an open ending boundary.")]
	public static CqlInterval<CqlDateTime> prevalenceInterval(CqlContext context, Condition condition)
	{
		CqlInterval<CqlDateTime> a_()
		{
			bool b_()
			...
			if (b_())
			{
				...
				CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.toInterval(context, u_);
				CqlDateTime w_ = context.Operators.Start(v_);
				CqlInterval<CqlDateTime> x_ = QICoreCommon_2_0_000.abatementInterval(context, condition);
				CqlDateTime y_ = context.Operators.End(x_);
				CqlInterval<CqlDateTime> z_ = context.Operators.Interval(w_, y_, true, true);
	...
	{
		CqlInterval<CqlDateTime> a_ = QICoreCommon_2_0_000.toInterval(context, choice);
		...
		CqlDateTime c_(CqlInterval<CqlDateTime> period)
		{
			CqlDateTime f_()
			{
				if ((QICoreCommon_2_0_000.HasEnd(context, period)) ?? false)
				{
	...
	public static CqlDateTime Earliest(CqlContext context, object choice)
	{
		...
		CqlDateTime c_(CqlInterval<CqlDateTime> period)
		{
			CqlDateTime f_()
			{
				if ((QICoreCommon_2_0_000.HasStart(context, period)) ?? false)
				{
    ...
    [CqlTag("description", "Creates a list of integers from 1 to how many days are in the interval. Note, this wont create an index for the final day if it is less than 24 hours. This also includes the first 24 hour period.")]
	public static IEnumerable<int?> toDayNumbers(CqlContext context, CqlInterval<CqlDateTime> Period)
	{
		CqlDateTime a_ = context.Operators.Start(Period);
		CqlDateTime b_ = context.Operators.End(Period);
		int? c_ = context.Operators.DurationBetween(a_, b_, "day");
	...
	{
		IEnumerable<int?> a_ = QICoreCommon_2_0_000.Interval_To_Day_Numbers(context, Period);
    ...
    [CqlTag("description", "Creates a list of 24 hour long intervals in an interval paired with the index (1 indexed) to which 24 hour interval it is. Note that the result will include intervals that are closed at the beginning and open at the end")]
	public static IEnumerable<(int? dayIndex, CqlInterval<CqlDateTime> dayPeriod)?> daysInPeriod(CqlContext context, CqlInterval<CqlDateTime> Period)
	{
		IEnumerable<int?> a_ = QICoreCommon_2_0_000.Interval_To_Day_Numbers(context, Period);
		(int? dayIndex, CqlInterval<CqlDateTime> dayPeriod)? b_(int? DayIndex)
		{
