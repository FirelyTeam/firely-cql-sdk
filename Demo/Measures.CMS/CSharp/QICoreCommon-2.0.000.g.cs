...
;
	...
	public bool? doNotPerform(DeviceRequest deviceRequest)
	{
		...
		bool? c_(Extension E)
		{
			...
			bool? l_ = context.Operators.Convert<bool?>(k_);
	...
	public CqlInterval<CqlDateTime> ToInterval(object choice)
	{
		CqlInterval<CqlDateTime> a_()
		{
			...
			{
				CqlDateTime b_ = context.Operators.Convert<CqlDateTime>(choice);
			...
			{
				CqlInterval<CqlDateTime> e_ = context.Operators.Convert<CqlInterval<CqlDateTime>>(choice);
			...
			else if (choice is CqlQuantity)
			{
				...
				CqlQuantity j_ = context.Operators.Convert<CqlQuantity>(choice);
			...
			else if (choice is CqlInterval<CqlQuantity>)
			{
				...
				CqlQuantity bz_ = context.Operators.Convert<CqlQuantity>(by_);
				...
				CqlQuantity cg_ = context.Operators.Convert<CqlQuantity>(cf_);
				CqlDate ch_ = context.Operators.Add(ce_, cg_);
				...
				CqlQuantity cs_ = context.Operators.Convert<CqlQuantity>(by_);
				CqlDate ct_ = context.Operators.Add(cq_, cs_);
				Date cv_ = bu_?.BirthDateElement;
				string cw_ = cv_?.Value;
				CqlDate cx_ = context.Operators.ConvertStringToDate(cw_);
				CqlQuantity cz_ = context.Operators.Convert<CqlQuantity>(cf_);
				...
				CqlQuantity dl_ = context.Operators.Convert<CqlQuantity>(by_);
				CqlDate dm_ = context.Operators.Add(dj_, dl_);
				Date do_ = bu_?.BirthDateElement;
				string dp_ = do_?.Value;
				CqlDate dq_ = context.Operators.ConvertStringToDate(dp_);
				CqlQuantity ds_ = context.Operators.Convert<CqlQuantity>(cf_);
				...
				CqlQuantity ed_ = context.Operators.Convert<CqlQuantity>(by_);
				CqlDate ee_ = context.Operators.Add(eb_, ed_);
				Date eg_ = bu_?.BirthDateElement;
				string eh_ = eg_?.Value;
				CqlDate ei_ = context.Operators.ConvertStringToDate(eh_);
				CqlQuantity ek_ = context.Operators.Convert<CqlQuantity>(cf_);
				CqlDate el_ = context.Operators.Add(ei_, ek_);
	...
	public CqlInterval<CqlDateTime> ToAbatementInterval(Condition condition)
	{
		CqlInterval<CqlDateTime> a_()
		{
			...
			else if (c_())
			{
				...
				CqlQuantity ae_ = context.Operators.Convert<CqlQuantity>(ad_);
				...
				CqlQuantity am_ = context.Operators.Convert<CqlQuantity>(al_);
				...
				CqlQuantity az_ = context.Operators.Convert<CqlQuantity>(ay_);
				CqlDate ba_ = context.Operators.Add(aw_, az_);
				...
				CqlQuantity bh_ = context.Operators.Convert<CqlQuantity>(bg_);
				...
				CqlQuantity bu_ = context.Operators.Convert<CqlQuantity>(bt_);
				CqlDate bv_ = context.Operators.Add(br_, bu_);
				...
				CqlQuantity cc_ = context.Operators.Convert<CqlQuantity>(cb_);
				...
				CqlQuantity co_ = context.Operators.Convert<CqlQuantity>(cn_);
				...
				CqlQuantity cw_ = context.Operators.Convert<CqlQuantity>(cv_);
				CqlDate cx_ = context.Operators.Add(ct_, cw_);
			...
			else if (d_())
			{
				...
				CqlQuantity dk_ = context.Operators.Convert<CqlQuantity>(dj_);
				...
				CqlQuantity dt_ = context.Operators.Convert<CqlQuantity>(ds_);
				CqlDate du_ = context.Operators.Add(dp_, dt_);
				...
				CqlQuantity eh_ = context.Operators.Convert<CqlQuantity>(eg_);
				CqlDate ei_ = context.Operators.Add(ed_, eh_);
				...
				CqlQuantity eq_ = context.Operators.Convert<CqlQuantity>(ep_);
				CqlDate er_ = context.Operators.Add(em_, eq_);
				...
				CqlQuantity fe_ = context.Operators.Convert<CqlQuantity>(fd_);
				CqlDate ff_ = context.Operators.Add(fa_, fe_);
				...
				CqlQuantity fn_ = context.Operators.Convert<CqlQuantity>(fm_);
				CqlDate fo_ = context.Operators.Add(fj_, fn_);
				...
				CqlQuantity ga_ = context.Operators.Convert<CqlQuantity>(fz_);
				CqlDate gb_ = context.Operators.Add(fw_, ga_);
				...
				CqlQuantity gj_ = context.Operators.Convert<CqlQuantity>(gi_);
				CqlDate gk_ = context.Operators.Add(gf_, gj_);
			...
			else if (e_())
			{
				...
				CqlDateTime gt_ = context.Operators.Convert<CqlDateTime>(gs_);
				object gv_ = FHIRHelpers_4_3_000.ToValue(gq_);
				object gw_ = context.Operators.LateBoundProperty<object>(gv_, "high");
				CqlDateTime gx_ = context.Operators.Convert<CqlDateTime>(gw_);
				CqlInterval<CqlDateTime> gy_ = context.Operators.Interval(gt_, gx_, true, false);
