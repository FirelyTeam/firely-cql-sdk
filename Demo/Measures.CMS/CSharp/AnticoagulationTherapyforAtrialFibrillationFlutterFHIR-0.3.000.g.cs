...
public partial class AnticoagulationTherapyforAtrialFibrillationFlutterFHIR_minus_0_3_000 : ILibrary, ISingleton<AnticoagulationTherapyforAtrialFibrillationFlutterFHIR_minus_0_3_000>
{
    private AnticoagulationTherapyforAtrialFibrillationFlutterFHIR_minus_0_3_000() {}

    public static AnticoagulationTherapyforAtrialFibrillationFlutterFHIR_minus_0_3_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "AnticoagulationTherapyforAtrialFibrillationFlutterFHIR";
    public string Version => "0.3.000";
    public ILibrary[] Dependencies => [FHIRHelpers_minus_4_4_000.Instance, CQMCommon_minus_2_2_000.Instance, QICoreCommon_minus_2_1_000.Instance, SupplementalDataElements_minus_3_5_000.Instance, TJCOverall_minus_8_14_000.Instance];
    ...
    {
        IEnumerable<Encounter> a_ = TJCOverall_minus_8_14_000.Instance.Ischemic_Stroke_Encounter(context);
    ...
    public IEnumerable<Encounter> Encounter_with_a_History_of_Atrial_Ablation(CqlContext context)
    {
        ...
        IEnumerable<Encounter> e_(Encounter IschemicStrokeEncounter)
        {
            ...
            bool? af_(Condition AtrialAblationDiagnosis)
            {
                ...
                CqlConcept an_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, aj_);
                CqlCode ao_ = QICoreCommon_minus_2_1_000.Instance.confirmed(context);
        ...
        IEnumerable<Encounter> i_(Encounter IschemicStrokeEncounter)
        {
            ...
            bool? bd_(Observation AtrialAblationObservation)
            {
                ...
                CqlDateTime bo_ = QICoreCommon_minus_2_1_000.Instance.earliest(context, bn_());
                Period bp_ = IschemicStrokeEncounter?.Period;
                CqlInterval<CqlDateTime> bq_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bp_);
    ...
    public IEnumerable<Encounter> Encounter_with_Prior_or_Present_Diagnosis_of_Atrial_Fibrillation_or_Flutter(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter IschemicStrokeEncounter)
        {
            ...
            bool? j_(Condition AtrialFibrillationFlutter)
            {
                ...
                CqlConcept r_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, n_);
                CqlCode s_ = QICoreCommon_minus_2_1_000.Instance.confirmed(context);
        ...
        {
            IEnumerable<Condition> af_ = CQMCommon_minus_2_2_000.Instance.encounterDiagnosis(context, IschemicStrokeEncounter);
    ...
    public IEnumerable<Encounter> Encounter_with_Comfort_Measures_during_Hospitalization_for_Patients_with_Documented_Atrial_Fibrillation_or_Flutter(CqlContext context)
    {
        ...
        {
            IEnumerable<object> d_ = TJCOverall_minus_8_14_000.Instance.Intervention_Comfort_Measures(context);
            bool? e_(object ComfortMeasure)
            {
                ...
                CqlInterval<CqlDateTime> o_ = CQMCommon_minus_2_2_000.Instance.hospitalizationWithObservation(context, Encounter);
    ...
    public IEnumerable<Encounter> Denominator_Exclusions(CqlContext context)
    {
        ...
        bool? b_(Encounter Encounter)
        {
            ...
            CqlConcept q_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, p_);
            ...
            CqlConcept ac_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, ab_);
            ...
            CqlConcept ai_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, ah_);
    ...
    public IEnumerable<Encounter> Numerator(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter Encounter)
        {
            ...
            {
                bool? ac_ = QICoreCommon_minus_2_1_000.Instance.isCommunity(context, DischargeAnticoagulant);
                bool? ad_ = QICoreCommon_minus_2_1_000.Instance.isDischarge(context, DischargeAnticoagulant);
                bool? ae_ = context.Operators.Or(ac_, ad_);
                Code<MedicationRequest.MedicationrequestStatus> af_ = DischargeAnticoagulant?.StatusElement;
    ...
    public IEnumerable<MedicationRequest> Documented_Reason_for_Not_Giving_Anticoagulant_at_Discharge(CqlContext context)
    {
        ...
        bool? c_(MedicationRequest NoAnticoagulant)
        {
            ...
            {
                CqlConcept aa_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, @this);
            ...
            bool? p_ = QICoreCommon_minus_2_1_000.Instance.isCommunity(context, NoAnticoagulant);
            bool? q_ = QICoreCommon_minus_2_1_000.Instance.isDischarge(context, NoAnticoagulant);
