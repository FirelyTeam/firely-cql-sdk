...
public class AnticoagulationTherapyforAtrialFibrillationFlutterFHIR_0_3_000
{
	...
	private IEnumerable<Encounter> Encounter_with_a_History_of_Atrial_Ablation_Value()
	{
		...
		bool? b_(Encounter IschemicStrokeEncounter)
		{
			...
			IEnumerable<Procedure> m_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, l_, default));
		...
		IEnumerable<Encounter> e_(Encounter IschemicStrokeEncounter)
		{
			...
			IEnumerable<Condition> ae_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ad_, default));
		...
		IEnumerable<Encounter> i_(Encounter IschemicStrokeEncounter)
		{
			...
			IEnumerable<Observation> bc_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, bb_, default));
