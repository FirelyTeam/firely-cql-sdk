...
public partial class HospitalHarmPressureInjuryFHIR_minus_0_1_000 : ILibrary, ISingleton<HospitalHarmPressureInjuryFHIR_minus_0_1_000>
{
    private HospitalHarmPressureInjuryFHIR_minus_0_1_000() {}

    public static HospitalHarmPressureInjuryFHIR_minus_0_1_000 Instance { get; } = new();
    ...
    public IEnumerable<Encounter> Encounter_with_Diagnosis_of_COVID19_Infection(CqlContext context)
    {
        ...
        bool? b_(Encounter InpatientHospitalization)
        {
            IEnumerable<Condition> d_ = CQMCommon_minus_2_2_000.Instance.EncounterDiagnosis(context, InpatientHospitalization);
        ...
        IEnumerable<Encounter> b_(Encounter InpatientHospitalization)
        {
            ...
            bool? g_(Observation SkinExam)
            {
                ...
                CqlConcept ak_(Observation.ComponentComponent @this)
                {
                    ...
                    CqlConcept au_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, at_);
