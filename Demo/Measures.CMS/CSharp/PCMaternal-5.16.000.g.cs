...
public static partial class PCMaternal_5_16_000ServiceCollectionExtensions
{
    public static IServiceCollection AddPCMaternal_5_16_000(this IServiceCollection services)
    {
        services.TryAddSingleton<PCMaternal_5_16_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["PCMaternal_5_16_000"]);
            return ActivatorUtilities.CreateInstance<PCMaternal_5_16_000>(sp);
        });
