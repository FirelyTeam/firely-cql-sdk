...
public partial class PCSBPScreeningFollowUpFHIR_minus_0_2_000 : ILibrary, ISingleton<PCSBPScreeningFollowUpFHIR_minus_0_2_000>
{
    private PCSBPScreeningFollowUpFHIR_minus_0_2_000() {}

    public static PCSBPScreeningFollowUpFHIR_minus_0_2_000 Instance { get; } = new();
    ...
    public IEnumerable<Encounter> Qualifying_Encounter_during_Measurement_Period(CqlContext context)
    {
        ...
        bool? c_(Encounter ValidEncounter)
        {
            ...
            CqlCode o_ = FHIRHelpers_minus_4_4_000.Instance.ToCode(context, n_);
    ...
    public IEnumerable<Encounter> Denominator_Exclusions(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter QualifyingEncounter)
        {
            ...
            {
                bool? j_ = QICoreCommon_minus_2_1_000.Instance.isProblemListItem(context, Hypertension);
                bool? k_ = QICoreCommon_minus_2_1_000.Instance.isHealthConcern(context, Hypertension);
                bool? l_ = context.Operators.Or(j_, k_);
                CqlInterval<CqlDateTime> m_()
                {
                    bool r_()
                    {
                        CqlInterval<CqlDateTime> s_ = QICoreCommon_minus_2_1_000.Instance.prevalenceInterval(context, Hypertension);
                    ...
                    {
                        CqlInterval<CqlDateTime> u_ = QICoreCommon_minus_2_1_000.Instance.prevalenceInterval(context, Hypertension);
    ...
    public IEnumerable<Encounter> Encounter_with_Normal_Blood_Pressure_Reading(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            bool? e_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> ap_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ao_);
            ...
            bool? k_(Observation.ComponentComponent @this)
            {
                ...
                string bf_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, be_);
                ...
                string bl_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, bk_);
            ...
            bool? u_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> bq_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, bp_);
                CqlDateTime br_ = context.Operators.End(bq_);
                Period bs_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> bt_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bs_);
            ...
            object w_(Observation @this)
            {
                ...
                object cc_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, cb_);
                CqlInterval<CqlDateTime> cd_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, cc_);
            ...
            bool? aa_(Observation.ComponentComponent @this)
            {
                ...
                string cj_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ci_);
                ...
                string cp_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, co_);
    ...
    public IEnumerable<Encounter> Encounter_with_Hypertensive_Reading_Within_Year_Prior(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            bool? e_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> bm_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, bl_);
                CqlDateTime bn_ = context.Operators.End(bm_);
                Period bo_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> bp_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bo_);
                ...
                CqlInterval<CqlDateTime> bu_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bo_);
                ...
                CqlInterval<CqlDateTime> bz_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bo_);
            ...
            bool? k_(Observation.ComponentComponent @this)
            {
                ...
                string cr_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cq_);
                ...
                string cx_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cw_);
            ...
            bool? s_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> dc_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, db_);
                ...
                CqlInterval<CqlDateTime> dk_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, de_);
                ...
                CqlInterval<CqlDateTime> dp_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, de_);
            ...
            object u_(Observation @this)
            {
                ...
                object ea_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, dz_);
                CqlInterval<CqlDateTime> eb_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, ea_);
            ...
            bool? y_(Observation.ComponentComponent @this)
            {
                ...
                string eh_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, eg_);
                ...
                string en_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, em_);
            ...
            bool? ah_(Observation BloodPressure)
            {
                ...
                object er_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, eq_);
                CqlInterval<CqlDateTime> es_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, er_);
                CqlDateTime et_ = context.Operators.End(es_);
                Period eu_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> ev_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, eu_);
                ...
                CqlInterval<CqlDateTime> fa_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, eu_);
                ...
                CqlInterval<CqlDateTime> ff_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, eu_);
            ...
            object aj_(Observation @this)
            {
                ...
                object fq_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, fp_);
                CqlInterval<CqlDateTime> fr_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, fq_);
            ...
            bool? an_(Observation.ComponentComponent @this)
            {
                ...
                string fx_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, fw_);
                ...
                string gd_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, gc_);
            ...
            bool? av_(Observation BloodPressure)
            {
                ...
                object gh_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, gg_);
                CqlInterval<CqlDateTime> gi_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, gh_);
                CqlDateTime gj_ = context.Operators.End(gi_);
                Period gk_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> gl_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, gk_);
                ...
                CqlInterval<CqlDateTime> gq_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, gk_);
                ...
                CqlInterval<CqlDateTime> gv_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, gk_);
            ...
            object ax_(Observation @this)
            {
                ...
                object hg_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, hf_);
                CqlInterval<CqlDateTime> hh_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, hg_);
            ...
            bool? bb_(Observation.ComponentComponent @this)
            {
                ...
                string hn_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, hm_);
                ...
                string ht_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, hs_);
    ...
    public IEnumerable<Encounter> Encounter_with_First_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_130_OR_DBP_Greater_than_or_Equal_to_80(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            bool? g_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> bo_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, bn_);
                CqlDateTime bp_ = context.Operators.End(bo_);
                Period bq_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> br_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bq_);
            ...
            object i_(Observation @this)
            {
                ...
                object bu_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, bt_);
                CqlInterval<CqlDateTime> bv_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, bu_);
            ...
            bool? m_(Observation.ComponentComponent @this)
            {
                ...
                string cb_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ca_);
                ...
                string ch_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cg_);
            ...
            bool? u_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> cm_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, cl_);
            ...
            bool? aa_(Observation.ComponentComponent @this)
            {
                ...
                string cz_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cy_);
                ...
                string df_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, de_);
            ...
            bool? aj_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> dk_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, dj_);
                CqlDateTime dl_ = context.Operators.End(dk_);
                Period dm_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> dn_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, dm_);
            ...
            object al_(Observation @this)
            {
                ...
                CqlInterval<CqlDateTime> dr_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, dq_);
            ...
            bool? ap_(Observation.ComponentComponent @this)
            {
                ...
                string dx_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, dw_);
                ...
                string ed_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ec_);
            ...
            bool? ax_(Observation BloodPressure)
            {
                ...
                object eh_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, eg_);
                CqlInterval<CqlDateTime> ei_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, eh_);
                CqlDateTime ej_ = context.Operators.End(ei_);
                Period ek_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> el_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ek_);
            ...
            object az_(Observation @this)
            {
                ...
                object eo_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, en_);
                CqlInterval<CqlDateTime> ep_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, eo_);
            ...
            bool? bd_(Observation.ComponentComponent @this)
            {
                ...
                string ev_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, eu_);
                ...
                string fb_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, fa_);
    ...
    public IEnumerable<Encounter> Encounter_with_First_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_130_OR_DBP_Greater_than_or_Equal_to_80_and_Interventions(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter FirstHTNEncounter)
        {
            ...
            bool? e_(ServiceRequest FirstHTNIntervention)
            {
                ...
                CqlInterval<CqlDateTime> l_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, k_);
    ...
    public IEnumerable<Encounter> Encounter_with_Second_Hypertensive_Reading_SBP_130_to_139_OR_DBP_80_to_89(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            bool? e_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> bu_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, bt_);
                CqlDateTime bv_ = context.Operators.End(bu_);
                Period bw_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> bx_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, bw_);
            ...
            object g_(Observation @this)
            {
                ...
                CqlInterval<CqlDateTime> ch_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, cg_);
            ...
            bool? k_(Observation.ComponentComponent @this)
            {
                ...
                string cn_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cm_);
                ...
                string ct_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cs_);
            ...
            bool? u_(Observation BloodPressure)
            {
                ...
                object cx_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, cw_);
                CqlInterval<CqlDateTime> cy_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, cx_);
                CqlDateTime cz_ = context.Operators.End(cy_);
                Period da_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> db_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, da_);
            ...
            object w_(Observation @this)
            {
                ...
                CqlInterval<CqlDateTime> dl_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, dk_);
            ...
            bool? aa_(Observation.ComponentComponent @this)
            {
                ...
                string dr_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, dq_);
            ...
            bool? al_(Observation BloodPressure)
            {
                ...
                object eb_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, ea_);
                CqlInterval<CqlDateTime> ec_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, eb_);
            ...
            object av_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, au_);
            ...
            bool? az_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> fg_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, ff_);
            ...
            object bb_(Observation @this)
            {
                ...
                object fs_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, fr_);
                CqlInterval<CqlDateTime> ft_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, fs_);
            ...
            bool? bf_(Observation.ComponentComponent @this)
            {
                ...
                string fz_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, fy_);
                ...
                string gf_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ge_);
    ...
    public IEnumerable<Encounter> Encounter_with_Second_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_140_OR_DBP_Greater_than_or_Equal_to_90(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            bool? e_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> bs_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, br_);
            ...
            object g_(Observation @this)
            {
                ...
                CqlInterval<CqlDateTime> cc_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, cb_);
            ...
            bool? k_(Observation.ComponentComponent @this)
            {
                ...
                string ci_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ch_);
                ...
                string co_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, cn_);
            ...
            bool? s_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> cw_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, cv_);
            ...
            bool? y_(Observation.ComponentComponent @this)
            {
                ...
                string dm_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, dl_);
                ...
                string ds_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, dr_);
            ...
            bool? ah_(Observation BloodPressure)
            {
                ...
                object dw_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, dv_);
                CqlInterval<CqlDateTime> dx_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, dw_);
                CqlDateTime dy_ = context.Operators.End(dx_);
                Period dz_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> ea_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, dz_);
            ...
            object aj_(Observation @this)
            {
                ...
                object ej_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, ei_);
                CqlInterval<CqlDateTime> ek_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, ej_);
            ...
            bool? an_(Observation.ComponentComponent @this)
            {
                ...
                string eq_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ep_);
                ...
                string ew_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ev_);
            ...
            bool? av_(Observation BloodPressure)
            {
                ...
                CqlInterval<CqlDateTime> fb_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, fa_);
                CqlDateTime fc_ = context.Operators.End(fb_);
                Period fd_ = QualifyingEncounter?.Period;
                CqlInterval<CqlDateTime> fe_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, fd_);
            ...
            object ax_(Observation @this)
            {
                ...
                object fn_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, fm_);
                CqlInterval<CqlDateTime> fo_ = QICoreCommon_minus_2_1_000.Instance.toInterval(context, fn_);
            ...
            bool? bb_(Observation.ComponentComponent @this)
            {
                ...
                string fu_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ft_);
                ...
                string ga_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, fz_);
        ...
        IEnumerable<ServiceRequest> g_(ServiceRequest WeeksRescreen)
        {
            ...
            IEnumerable<MedicationRequest> as_(MedicationRequest MR)
            {
                ...
                bool? ba_(Medication M)
                {
                    ...
                    CqlConcept bk_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, bj_);
        ...
        IEnumerable<Encounter> b_(Encounter QualifyingEncounter)
        {
            ...
            bool? k_(Observation NoBPScreen)
            {
                ...
                bool? u_(Extension @this)
                {
                    ...
                    string at_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, as_);
                ...
                CqlConcept z_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, y_ as CodeableConcept);
                ...
                bool? ac_(Extension @this)
                {
                    ...
                    string ay_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, ax_);
                ...
                CqlConcept ah_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, ag_ as CodeableConcept);
    ...
    public IEnumerable<ServiceRequest> NonPharmacological_Intervention_Not_Ordered(CqlContext context)
    {
        ...
        bool? ad_(ServiceRequest NonPharmIntervention)
        {
            bool? af_(Extension @this)
            {
                ...
                string au_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, at_);
            ...
            CqlConcept ak_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, aj_ as CodeableConcept);
    ...
    public IEnumerable<ServiceRequest> Laboratory_Test_or_ECG_for_Hypertension_Not_Ordered(CqlContext context)
    {
        ...
        bool? n_(ServiceRequest LabECGNotDone)
        {
            bool? p_(Extension @this)
            {
                ...
                string z_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, y_);
            ...
            CqlConcept u_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, t_ as CodeableConcept);
    ...
    public IEnumerable<ServiceRequest> Second_Hypertensive_Reading_SBP_130_to_139_OR_DBP_80_to_89_Interventions_Declined(CqlContext context)
    {
        ...
        bool? l_(ServiceRequest SecondHTNDeclinedReferralAndFollowUp)
        {
            ...
            IEnumerable<Extension> s_ = context.Operators.Where<Extension>((IEnumerable<Extension>)(SecondHTNDeclinedReferralAndFollowUp is DomainResource
            ...
            CqlConcept w_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, v_ as CodeableConcept);
            CqlValueSet x_ = this.Patient_Declined(context);
            bool? y_ = context.Operators.ConceptInValueSet(w_, x_);
            Code<RequestStatus> z_ = SecondHTNDeclinedReferralAndFollowUp?.StatusElement;
    ...
    public IEnumerable<object> Second_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_140_OR_DBP_Greater_than_or_Equal_to_90_Interventions_Declined(CqlContext context)
    {
        ...
        bool? l_(ServiceRequest SecondHTN140Over90ReferralFollowUpNotDone)
        {
            bool? z_(Extension @this)
            {
                ...
                string ao_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, an_);
            ...
            CqlConcept ae_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, ad_ as CodeableConcept);
    ...
    public IEnumerable<Encounter> Encounter_with_Order_for_Hypertension_Follow_Up_Declined_by_Patient(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter ElevatedBPEncounter)
        {
            ...
            {
                bool? am_(Extension @this)
                {
                    string bf_ = @this?.Url;
                    FhirString bg_ = context.Operators.Convert<FhirString>(bf_);
                    string bh_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, bg_);
                    bool? bi_ = context.Operators.Equal(bh_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-doNotPerformReason");

                    return bi_;
                };
                IEnumerable<Extension> an_ = context.Operators.Where<Extension>((IEnumerable<Extension>)(ElevatedBPDeclinedInterventions is DomainResource
                        ? (ElevatedBPDeclinedInterventions as DomainResource).Extension
                        : default), am_);
                object ao_(Extension @this)
                {
                    DataType bj_ = @this?.Value;

                    return bj_;
                };
                IEnumerable<object> ap_ = context.Operators.Select<Extension, object>(an_, ao_);
                object aq_ = context.Operators.SingletonFrom<object>(ap_);
                CqlConcept ar_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, aq_ as CodeableConcept);
                CqlValueSet as_ = this.Patient_Declined(context);
                bool? at_ = context.Operators.ConceptInValueSet(ar_, as_);
                FhirDateTime au_ = ElevatedBPDeclinedInterventions?.AuthoredOnElement;
                CqlDateTime av_ = context.Operators.Convert<CqlDateTime>(au_);
                Period aw_ = ElevatedBPEncounter?.Period;
                ...
                Code<RequestStatus> ba_ = ElevatedBPDeclinedInterventions?.StatusElement;
                RequestStatus? bb_ = ba_?.Value;
                Code<RequestStatus> bc_ = context.Operators.Convert<Code<RequestStatus>>(bb_);
        ...
        IEnumerable<Encounter> i_(Encounter FirstHTNEncounter)
        {
            ...
            bool? cf_(ServiceRequest FirstHTNDeclinedInterventions)
            {
                bool? cj_(Extension @this)
                {
                    ...
                    string de_ = FHIRHelpers_minus_4_4_000.Instance.ToString(context, dd_);
                ...
                CqlConcept co_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, cn_ as CodeableConcept);
                CqlValueSet cp_ = this.Patient_Declined(context);
                bool? cq_ = context.Operators.ConceptInValueSet(co_, cp_);
                FhirDateTime cr_ = FirstHTNDeclinedInterventions?.AuthoredOnElement;
                CqlDateTime cs_ = context.Operators.Convert<CqlDateTime>(cr_);
                Period ct_ = FirstHTNEncounter?.Period;
                CqlInterval<CqlDateTime> cu_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ct_);
                bool? cv_ = context.Operators.In<CqlDateTime>(cs_, cu_, "day");
                bool? cw_ = context.Operators.And(cq_, cv_);
                Code<RequestStatus> cx_ = FirstHTNDeclinedInterventions?.StatusElement;
                RequestStatus? cy_ = cx_?.Value;
                Code<RequestStatus> cz_ = context.Operators.Convert<Code<RequestStatus>>(cy_);
                bool? da_ = context.Operators.Equal(cz_, "completed");
        ...
        IEnumerable<Encounter> q_(Encounter SecondHTNEncounter)
        {
            ...
            bool? ds_(ServiceRequest SecondHTNDeclinedInterventions)
            {
                ...
                CqlInterval<CqlDateTime> dz_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, dy_);
        ...
        IEnumerable<Encounter> t_(Encounter SecondHTN140Over90Encounter)
        {
            ...
            bool? ec_(object SecondHTN140Over90DeclinedInterventions)
            {
                ...
                CqlInterval<CqlDateTime> ej_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ei_);
