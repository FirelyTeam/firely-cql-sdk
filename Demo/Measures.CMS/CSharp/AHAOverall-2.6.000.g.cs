...
public static class AHAOverall_2_6_000
{
	...
	public static CqlValueSet Ejection_Fraction(CqlContext context) => 
	...
	public static CqlValueSet Heart_Transplant(CqlContext context) => 
	...
	public static CqlValueSet Heart_Transplant_Complications(CqlContext context) => 
	...
	public static CqlValueSet Left_Ventricular_Assist_Device_Complications(CqlContext context) => 
	...
	public static CqlValueSet Moderate_or_Severe(CqlContext context) => 
	...
	public static CqlValueSet Moderate_or_Severe_LVSD(CqlContext context) => 
	...
	public static CqlValueSet Patient_Provider_Interaction(CqlContext context) => 
	...
	public static CqlCode Left_ventricular_systolic_dysfunction__disorder_(CqlContext context) => 
		new CqlCode("134401001", "http://snomed.info/sct", default, default);

    [CqlDeclaration("allergy-entered-in-error")]
	public static CqlCode allergy_entered_in_error(CqlContext context) => 
	...
	public static bool? isFinished(CqlContext context, Encounter Visit)
	{
	...
	public static IEnumerable<Encounter> Heart_Failure_Outpatient_Encounter(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Care_Services_in_Long_Term_Residential_Facility(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = AHAOverall_2_6_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = AHAOverall_2_6_000.Nursing_Facility_Visit(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = AHAOverall_2_6_000.Office_Visit(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = AHAOverall_2_6_000.Outpatient_Consultation(context);
		...
		{
			CqlValueSet s_ = AHAOverall_2_6_000.Heart_Failure(context);
			IEnumerable<Condition> t_ = context.Operators.RetrieveByValueSet<Condition>(s_, default);
			bool? u_(Condition HeartFailure)
			{
				CqlInterval<CqlDateTime> y_ = QICoreCommon_2_0_000.prevalenceInterval(context, HeartFailure);
				...
				bool? ac_ = AHAOverall_2_6_000.isConfirmedActiveDiagnosis(context, HeartFailure);
		...
		{
			CqlInterval<CqlDateTime> ae_ = AHAOverall_2_6_000.Measurement_Period(context);
			...
			bool? ai_ = AHAOverall_2_6_000.isFinished(context, QualifyingEncounter);
	...
	public static IEnumerable<object> Moderate_or_Severe_LVSD_Findings(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Ejection_Fraction(context);
		...
		CqlValueSet e_ = AHAOverall_2_6_000.Moderate_or_Severe_LVSD(context);
		...
		CqlCode h_ = AHAOverall_2_6_000.Left_ventricular_systolic_dysfunction__disorder_(context);
		...
		bool? k_(Condition LVSDDiagnosis)
		{
			...
			CqlConcept z_ = FHIRHelpers_4_3_000.ToConcept(context, y_);
			CqlValueSet aa_ = AHAOverall_2_6_000.Moderate_or_Severe(context);
	...
	public static IEnumerable<Encounter> Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(CqlContext context)
	{
		IEnumerable<Encounter> a_ = AHAOverall_2_6_000.Heart_Failure_Outpatient_Encounter(context);
		IEnumerable<Encounter> b_(Encounter HFOutpatientEncounter)
		{
			IEnumerable<object> d_ = AHAOverall_2_6_000.Moderate_or_Severe_LVSD_Findings(context);
			bool? e_(object LVSDFindings)
			{
				CqlInterval<CqlDateTime> i_ = QICoreCommon_2_0_000.prevalenceInterval(context, LVSDFindings as Condition);
	...
	public static bool? Has_Heart_Transplant_Complications(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Heart_Transplant_Complications(context);
		...
		IEnumerable<Condition> c_(Condition HeartTransplantComplications)
		{
			...
			bool? i_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter)
			{
				...
				CqlInterval<CqlDateTime> p_ = QICoreCommon_2_0_000.prevalenceInterval(context, HeartTransplantComplications);
		...
		{
			bool? v_ = AHAOverall_2_6_000.isConfirmedActiveDiagnosis(context, HeartTransplantComplications);
	...
	public static bool? Has_Left_Ventricular_Assist_Device(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Left_Ventricular_Assist_Device_Placement(context);
	...
	public static bool? Has_Left_Ventricular_Assist_Device_Complications(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Left_Ventricular_Assist_Device_Complications(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		IEnumerable<Condition> c_(Condition LVADComplications)
		{
			...
			bool? i_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter)
			{
				...
				CqlDateTime n_ = context.Operators.Convert<CqlDateTime>(m_);
				CqlInterval<CqlDateTime> o_ = QICoreCommon_2_0_000.toInterval(context, n_ as object);
				CqlInterval<CqlDateTime> p_ = QICoreCommon_2_0_000.prevalenceInterval(context, LVADComplications);
				CqlDateTime q_ = context.Operators.Start(o_ ?? p_);
				Period r_ = ModerateOrSevereLVSDHFOutpatientEncounter?.Period;
				CqlInterval<CqlDateTime> s_ = FHIRHelpers_4_3_000.ToInterval(context, r_);
				CqlDateTime t_ = context.Operators.End(s_);
		...
		{
			bool? v_ = AHAOverall_2_6_000.isConfirmedActiveDiagnosis(context, LVADComplications);
	...
	public static IEnumerable<Encounter> Qualifying_Outpatient_Encounter_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Care_Services_in_Long_Term_Residential_Facility(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = AHAOverall_2_6_000.Home_Healthcare_Services(context);
		...
		CqlValueSet l_ = AHAOverall_2_6_000.Outpatient_Consultation(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = AHAOverall_2_6_000.Patient_Provider_Interaction(context);
		...
		{
			CqlInterval<CqlDateTime> t_ = AHAOverall_2_6_000.Measurement_Period(context);
			...
			bool? x_ = AHAOverall_2_6_000.isFinished(context, ValidEncounter);
	...
	public static bool? Has_Two_Qualifying_Outpatient_Encounters_and_Heart_Failure_Outpatient_Encounter_During_the_Measurement_Period(CqlContext context)
	{
		Patient a_ = AHAOverall_2_6_000.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = AHAOverall_2_6_000.Measurement_Period(context);
		...
		{
			IEnumerable<Encounter> r_ = AHAOverall_2_6_000.Qualifying_Outpatient_Encounter_During_Measurement_Period(context);
		...
		IEnumerable<Encounter> o_ = AHAOverall_2_6_000.Heart_Failure_Outpatient_Encounter(context);
	...
	public static bool? Has_Heart_Transplant(CqlContext context)
	{
		CqlValueSet a_ = AHAOverall_2_6_000.Heart_Transplant(context);
		IEnumerable<Procedure> b_ = context.Operators.RetrieveByValueSet<Procedure>(a_, default);
	...
	public static bool? isOrderedDuringHeartFailureOutpatientEncounter(CqlContext context, MedicationRequest Order)
	{
		IEnumerable<Encounter> a_ = AHAOverall_2_6_000.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
	...
	public static bool? overlapsHeartFailureOutpatientEncounter(CqlContext context, Condition Diagnosis)
	{
		IEnumerable<Encounter> a_ = AHAOverall_2_6_000.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
		bool? b_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter)
		{
			CqlInterval<CqlDateTime> e_ = QICoreCommon_2_0_000.prevalenceInterval(context, Diagnosis);
			...
			bool? i_ = AHAOverall_2_6_000.isConfirmedActiveDiagnosis(context, Diagnosis);
	...
	public static bool? overlapsAfterHeartFailureOutpatientEncounter(CqlContext context, object Event)
	{
		IEnumerable<Encounter> a_ = AHAOverall_2_6_000.Heart_Failure_Outpatient_Encounter_with_History_of_Moderate_or_Severe_LVSD(context);
		bool? b_(Encounter ModerateOrSevereLVSDHFOutpatientEncounter)
		{
			bool? e_()
			{
				...
				{
					CqlInterval<CqlDateTime> f_ = QICoreCommon_2_0_000.prevalenceInterval(context, Event as Condition);
					Period g_ = ModerateOrSevereLVSDHFOutpatientEncounter?.Period;
					CqlInterval<CqlDateTime> h_ = FHIRHelpers_4_3_000.ToInterval(context, g_);
					bool? i_ = context.Operators.OverlapsAfter(f_, h_, "day");
					bool? j_ = AHAOverall_2_6_000.isConfirmedActiveDiagnosis(context, Event as Condition);
				...
				else if (Event is AllergyIntolerance)
				{
					...
					CqlConcept ah_ = FHIRHelpers_4_3_000.ToConcept(context, ag_);
					CqlCode ai_ = QICoreCommon_2_0_000.allergy_active(context);
					...
					CqlConcept an_ = FHIRHelpers_4_3_000.ToConcept(context, am_);
					CqlCode ao_ = QICoreCommon_2_0_000.allergy_unconfirmed(context);
					CqlConcept ap_ = context.Operators.ConvertCodeToConcept(ao_);
					bool? aq_ = context.Operators.Equivalent(an_, ap_);
					CqlConcept as_ = FHIRHelpers_4_3_000.ToConcept(context, am_);
					CqlCode at_ = QICoreCommon_2_0_000.allergy_refuted(context);
					...
					CqlConcept ay_ = FHIRHelpers_4_3_000.ToConcept(context, am_);
					CqlCode az_ = AHAOverall_2_6_000.allergy_entered_in_error(context);
				...
				else if (Event is MedicationRequest)
				{
					...
					{
						CqlInterval<CqlDateTime> dk_ = QICoreCommon_2_0_000.toInterval(context, DoseTime);
					...
					CqlInterval<CqlDateTime> cg_ = FHIRHelpers_4_3_000.ToInterval(context, cf_);
				...
				else if (Event is Observation)
				{
					...
					object dn_ = FHIRHelpers_4_3_000.ToValue(context, dm_);
					CqlInterval<CqlDateTime> do_ = QICoreCommon_2_0_000.toInterval(context, dn_);
					Period dp_ = ModerateOrSevereLVSDHFOutpatientEncounter?.Period;
					CqlInterval<CqlDateTime> dq_ = FHIRHelpers_4_3_000.ToInterval(context, dp_);
