...
public class CQMCommon_2_0_000
{
	...
	{
		IEnumerable<Location> a_ = context.Operators.Retrieve<Location>(default);
		bool? b_(Location L)
		{
			Id e_ = L?.IdElement;
			string f_ = e_?.Value;
	...
	public CqlInterval<CqlDateTime> HospitalizationWithObservationAndOutpatientSurgeryService(Encounter TheEncounter)
	{
		...
		CqlInterval<CqlDateTime> b_(Encounter Visit)
		{
			...
			IEnumerable<Encounter> f_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, e_, default));
			bool? g_(Encounter LastSurgeryOP)
			{
				...
				IEnumerable<Encounter> at_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, as_, default));
				bool? au_(Encounter LastED)
				{
					...
					IEnumerable<Encounter> dx_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, dw_, default));
					...
					IEnumerable<Encounter> em_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, dw_, default));
					...
					IEnumerable<Encounter> fb_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, dw_, default));
				...
				IEnumerable<Encounter> bd_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, bc_, default));
				...
				IEnumerable<Encounter> bs_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, as_, default));
				bool? bt_(Encounter LastED)
				{
					...
					IEnumerable<Encounter> kb_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ka_, default));
					...
					IEnumerable<Encounter> kq_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ka_, default));
					...
					IEnumerable<Encounter> lf_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ka_, default));
				...
				IEnumerable<Encounter> cc_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, bc_, default));
				...
				IEnumerable<Encounter> cr_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, as_, default));
				bool? cs_(Encounter LastED)
				{
					...
					IEnumerable<Encounter> qf_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, qe_, default));
					...
					IEnumerable<Encounter> qu_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, qe_, default));
					...
					IEnumerable<Encounter> rj_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, qe_, default));
				...
				IEnumerable<Encounter> db_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, bc_, default));
			...
			bool? q_(Encounter LastED)
			{
				...
				IEnumerable<Encounter> wm_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, wl_, default));
				...
				IEnumerable<Encounter> xb_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, wl_, default));
				...
				IEnumerable<Encounter> xq_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, wl_, default));
			...
			IEnumerable<Encounter> z_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, y_, default));
	...
	public CqlInterval<CqlDateTime> HospitalizationWithObservation(Encounter TheEncounter)
	{
		...
		CqlInterval<CqlDateTime> b_(Encounter Visit)
		{
			...
			bool? g_(Encounter LastED)
			{
				...
				IEnumerable<Encounter> an_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, am_, default));
				...
				IEnumerable<Encounter> bc_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, am_, default));
				...
				IEnumerable<Encounter> br_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, am_, default));
	...
	public IEnumerable<Condition> EncounterDiagnosis(Encounter Encounter)
	{
		...
		{
			IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(default);
			bool? e_(Condition C)
			{
				Id h_ = C?.IdElement;
				string i_ = h_?.Value;
	...
	public Condition PrincipalDiagnosis(Encounter Encounter)
	{
		...
		{
			IEnumerable<Condition> j_ = context.Operators.Retrieve<Condition>(default);
			bool? k_(Condition C)
			{
				Id n_ = C?.IdElement;
				string o_ = n_?.Value;
	...
	public CqlConcept GetMedicationCode(MedicationRequest request)
	{
		CqlConcept a_()
		{
			...
			{
				IEnumerable<Medication> h_ = context.Operators.Retrieve<Medication>(default);
