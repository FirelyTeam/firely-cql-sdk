    ...
    QICoreCommon_2_0_000 _QICoreCommon_2_0_000)
{
	...
	public  IEnumerable<Encounter> Inpatient_Encounter(CqlContext context)
	{
		...
		bool? c_(Encounter EncounterInpatient)
		{
			...
			CqlInterval<CqlDateTime> j_ = _FHIRHelpers_4_3_000.ToInterval(context, i_);
	...
	public  Encounter ED_Visit(CqlContext context, Encounter TheEncounter)
	{
		...
		bool? c_(Encounter EDVisit)
		{
			...
			CqlInterval<CqlDateTime> z_ = _FHIRHelpers_4_3_000.ToInterval(context, o_);
		...
		object e_(Encounter @this)
		{
			...
			CqlInterval<CqlDateTime> af_ = _FHIRHelpers_4_3_000.ToInterval(context, ae_);
	...
	public  CqlDateTime Hospital_Discharge_Time(CqlContext context, Encounter TheEncounter)
	{
		...
		CqlInterval<CqlDateTime> b_ = _FHIRHelpers_4_3_000.ToInterval(context, a_);
	...
	public  CqlDateTime Hospital_Arrival_Time(CqlContext context, Encounter TheEncounter)
	{
		...
		object b_(Encounter.LocationComponent @this)
		{
			...
			CqlInterval<CqlDateTime> i_ = _FHIRHelpers_4_3_000.ToInterval(context, h_);
	...
	public  Location GetLocation(CqlContext context, ResourceReference reference)
	{
		...
		bool? b_(Location L)
		{
			...
			string h_ = g_?.Value;
			string i_ = _QICoreCommon_2_0_000.getId(context, h_);
		...
		CqlInterval<CqlDateTime> b_(Encounter Visit)
		{
			...
			bool? g_(Encounter LastSurgeryOP)
			{
				...
				bool? au_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> du_ = _FHIRHelpers_4_3_000.ToInterval(context, dt_);
					...
					bool? dy_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> fv_ = _FHIRHelpers_4_3_000.ToInterval(context, fu_);
						CqlDateTime fw_ = context.Operators.End(fv_);
						Period fx_ = Visit?.Period;
						CqlInterval<CqlDateTime> fy_ = _FHIRHelpers_4_3_000.ToInterval(context, fx_);
						...
						CqlInterval<CqlDateTime> gd_ = _FHIRHelpers_4_3_000.ToInterval(context, fx_);
						...
						CqlInterval<CqlDateTime> gi_ = _FHIRHelpers_4_3_000.ToInterval(context, fx_);
					...
					object ea_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> go_ = _FHIRHelpers_4_3_000.ToInterval(context, gn_);
					...
					CqlInterval<CqlDateTime> ee_ = _FHIRHelpers_4_3_000.ToInterval(context, ed_);
					CqlDateTime ef_ = context.Operators.Start(ee_);
					Period eg_ = Visit?.Period;
					CqlInterval<CqlDateTime> eh_ = _FHIRHelpers_4_3_000.ToInterval(context, eg_);
					...
					bool? en_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> gv_ = _FHIRHelpers_4_3_000.ToInterval(context, gu_);
						CqlDateTime gw_ = context.Operators.End(gv_);
						Period gx_ = Visit?.Period;
						CqlInterval<CqlDateTime> gy_ = _FHIRHelpers_4_3_000.ToInterval(context, gx_);
						...
						CqlInterval<CqlDateTime> hd_ = _FHIRHelpers_4_3_000.ToInterval(context, gx_);
						...
						CqlInterval<CqlDateTime> hi_ = _FHIRHelpers_4_3_000.ToInterval(context, gx_);
					...
					object ep_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ho_ = _FHIRHelpers_4_3_000.ToInterval(context, hn_);
					...
					CqlInterval<CqlDateTime> et_ = _FHIRHelpers_4_3_000.ToInterval(context, es_);
					CqlDateTime eu_ = context.Operators.Start(et_);
					CqlInterval<CqlDateTime> ew_ = _FHIRHelpers_4_3_000.ToInterval(context, eg_);
					...
					bool? fc_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> hv_ = _FHIRHelpers_4_3_000.ToInterval(context, hu_);
						CqlDateTime hw_ = context.Operators.End(hv_);
						Period hx_ = Visit?.Period;
						CqlInterval<CqlDateTime> hy_ = _FHIRHelpers_4_3_000.ToInterval(context, hx_);
						...
						CqlInterval<CqlDateTime> id_ = _FHIRHelpers_4_3_000.ToInterval(context, hx_);
						...
						CqlInterval<CqlDateTime> ii_ = _FHIRHelpers_4_3_000.ToInterval(context, hx_);
					...
					object fe_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> io_ = _FHIRHelpers_4_3_000.ToInterval(context, in_);
					...
					CqlInterval<CqlDateTime> fi_ = _FHIRHelpers_4_3_000.ToInterval(context, fh_);
					CqlDateTime fj_ = context.Operators.Start(fi_);
					CqlInterval<CqlDateTime> fl_ = _FHIRHelpers_4_3_000.ToInterval(context, eg_);
				...
				object aw_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> ir_ = _FHIRHelpers_4_3_000.ToInterval(context, iq_);
				...
				CqlInterval<CqlDateTime> ba_ = _FHIRHelpers_4_3_000.ToInterval(context, az_);
				...
				bool? be_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> iy_ = _FHIRHelpers_4_3_000.ToInterval(context, ix_);
					CqlDateTime iz_ = context.Operators.End(iy_);
					Period ja_ = Visit?.Period;
					CqlInterval<CqlDateTime> jb_ = _FHIRHelpers_4_3_000.ToInterval(context, ja_);
					...
					CqlInterval<CqlDateTime> jg_ = _FHIRHelpers_4_3_000.ToInterval(context, ja_);
					...
					CqlInterval<CqlDateTime> jl_ = _FHIRHelpers_4_3_000.ToInterval(context, ja_);
				...
				object bg_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> jr_ = _FHIRHelpers_4_3_000.ToInterval(context, jq_);
				...
				bool? bt_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> jy_ = _FHIRHelpers_4_3_000.ToInterval(context, jx_);
					...
					bool? kc_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> lz_ = _FHIRHelpers_4_3_000.ToInterval(context, ly_);
						CqlDateTime ma_ = context.Operators.End(lz_);
						Period mb_ = Visit?.Period;
						CqlInterval<CqlDateTime> mc_ = _FHIRHelpers_4_3_000.ToInterval(context, mb_);
						...
						CqlInterval<CqlDateTime> mh_ = _FHIRHelpers_4_3_000.ToInterval(context, mb_);
						...
						CqlInterval<CqlDateTime> mm_ = _FHIRHelpers_4_3_000.ToInterval(context, mb_);
					...
					object ke_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ms_ = _FHIRHelpers_4_3_000.ToInterval(context, mr_);
					...
					CqlInterval<CqlDateTime> ki_ = _FHIRHelpers_4_3_000.ToInterval(context, kh_);
					CqlDateTime kj_ = context.Operators.Start(ki_);
					Period kk_ = Visit?.Period;
					CqlInterval<CqlDateTime> kl_ = _FHIRHelpers_4_3_000.ToInterval(context, kk_);
					...
					bool? kr_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> mz_ = _FHIRHelpers_4_3_000.ToInterval(context, my_);
						CqlDateTime na_ = context.Operators.End(mz_);
						Period nb_ = Visit?.Period;
						CqlInterval<CqlDateTime> nc_ = _FHIRHelpers_4_3_000.ToInterval(context, nb_);
						...
						CqlInterval<CqlDateTime> nh_ = _FHIRHelpers_4_3_000.ToInterval(context, nb_);
						...
						CqlInterval<CqlDateTime> nm_ = _FHIRHelpers_4_3_000.ToInterval(context, nb_);
					...
					object kt_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ns_ = _FHIRHelpers_4_3_000.ToInterval(context, nr_);
					...
					CqlInterval<CqlDateTime> kx_ = _FHIRHelpers_4_3_000.ToInterval(context, kw_);
					CqlDateTime ky_ = context.Operators.Start(kx_);
					CqlInterval<CqlDateTime> la_ = _FHIRHelpers_4_3_000.ToInterval(context, kk_);
					...
					bool? lg_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> nz_ = _FHIRHelpers_4_3_000.ToInterval(context, ny_);
						CqlDateTime oa_ = context.Operators.End(nz_);
						Period ob_ = Visit?.Period;
						CqlInterval<CqlDateTime> oc_ = _FHIRHelpers_4_3_000.ToInterval(context, ob_);
						...
						CqlInterval<CqlDateTime> oh_ = _FHIRHelpers_4_3_000.ToInterval(context, ob_);
						...
						CqlInterval<CqlDateTime> om_ = _FHIRHelpers_4_3_000.ToInterval(context, ob_);
					...
					object li_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> os_ = _FHIRHelpers_4_3_000.ToInterval(context, or_);
					...
					CqlInterval<CqlDateTime> lm_ = _FHIRHelpers_4_3_000.ToInterval(context, ll_);
					CqlDateTime ln_ = context.Operators.Start(lm_);
					CqlInterval<CqlDateTime> lp_ = _FHIRHelpers_4_3_000.ToInterval(context, kk_);
				...
				object bv_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> ov_ = _FHIRHelpers_4_3_000.ToInterval(context, ou_);
				...
				CqlInterval<CqlDateTime> bz_ = _FHIRHelpers_4_3_000.ToInterval(context, by_);
				...
				bool? cd_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> pc_ = _FHIRHelpers_4_3_000.ToInterval(context, pb_);
					CqlDateTime pd_ = context.Operators.End(pc_);
					Period pe_ = Visit?.Period;
					CqlInterval<CqlDateTime> pf_ = _FHIRHelpers_4_3_000.ToInterval(context, pe_);
					...
					CqlInterval<CqlDateTime> pk_ = _FHIRHelpers_4_3_000.ToInterval(context, pe_);
					...
					CqlInterval<CqlDateTime> pp_ = _FHIRHelpers_4_3_000.ToInterval(context, pe_);
				...
				object cf_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> pv_ = _FHIRHelpers_4_3_000.ToInterval(context, pu_);
				...
				CqlInterval<CqlDateTime> cj_ = _FHIRHelpers_4_3_000.ToInterval(context, ci_);
				CqlDateTime ck_ = context.Operators.Start(cj_);
				CqlInterval<CqlDateTime> cm_ = _FHIRHelpers_4_3_000.ToInterval(context, bm_);
				...
				bool? cs_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> qc_ = _FHIRHelpers_4_3_000.ToInterval(context, qb_);
					...
					bool? qg_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> sd_ = _FHIRHelpers_4_3_000.ToInterval(context, sc_);
						CqlDateTime se_ = context.Operators.End(sd_);
						Period sf_ = Visit?.Period;
						CqlInterval<CqlDateTime> sg_ = _FHIRHelpers_4_3_000.ToInterval(context, sf_);
						...
						CqlInterval<CqlDateTime> sl_ = _FHIRHelpers_4_3_000.ToInterval(context, sf_);
						...
						CqlInterval<CqlDateTime> sq_ = _FHIRHelpers_4_3_000.ToInterval(context, sf_);
					...
					object qi_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> sw_ = _FHIRHelpers_4_3_000.ToInterval(context, sv_);
					...
					CqlInterval<CqlDateTime> qm_ = _FHIRHelpers_4_3_000.ToInterval(context, ql_);
					CqlDateTime qn_ = context.Operators.Start(qm_);
					Period qo_ = Visit?.Period;
					CqlInterval<CqlDateTime> qp_ = _FHIRHelpers_4_3_000.ToInterval(context, qo_);
					...
					bool? qv_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> td_ = _FHIRHelpers_4_3_000.ToInterval(context, tc_);
						CqlDateTime te_ = context.Operators.End(td_);
						Period tf_ = Visit?.Period;
						CqlInterval<CqlDateTime> tg_ = _FHIRHelpers_4_3_000.ToInterval(context, tf_);
						...
						CqlInterval<CqlDateTime> tl_ = _FHIRHelpers_4_3_000.ToInterval(context, tf_);
						...
						CqlInterval<CqlDateTime> tq_ = _FHIRHelpers_4_3_000.ToInterval(context, tf_);
					...
					object qx_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> tw_ = _FHIRHelpers_4_3_000.ToInterval(context, tv_);
					...
					CqlInterval<CqlDateTime> rb_ = _FHIRHelpers_4_3_000.ToInterval(context, ra_);
					CqlDateTime rc_ = context.Operators.Start(rb_);
					CqlInterval<CqlDateTime> re_ = _FHIRHelpers_4_3_000.ToInterval(context, qo_);
					...
					bool? rk_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> ud_ = _FHIRHelpers_4_3_000.ToInterval(context, uc_);
						CqlDateTime ue_ = context.Operators.End(ud_);
						Period uf_ = Visit?.Period;
						CqlInterval<CqlDateTime> ug_ = _FHIRHelpers_4_3_000.ToInterval(context, uf_);
						...
						CqlInterval<CqlDateTime> ul_ = _FHIRHelpers_4_3_000.ToInterval(context, uf_);
						...
						CqlInterval<CqlDateTime> uq_ = _FHIRHelpers_4_3_000.ToInterval(context, uf_);
					...
					object rm_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> uw_ = _FHIRHelpers_4_3_000.ToInterval(context, uv_);
					...
					CqlInterval<CqlDateTime> rq_ = _FHIRHelpers_4_3_000.ToInterval(context, rp_);
					CqlDateTime rr_ = context.Operators.Start(rq_);
					CqlInterval<CqlDateTime> rt_ = _FHIRHelpers_4_3_000.ToInterval(context, qo_);
				...
				object cu_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> uz_ = _FHIRHelpers_4_3_000.ToInterval(context, uy_);
				...
				CqlInterval<CqlDateTime> cy_ = _FHIRHelpers_4_3_000.ToInterval(context, cx_);
				...
				bool? dc_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> vg_ = _FHIRHelpers_4_3_000.ToInterval(context, vf_);
					CqlDateTime vh_ = context.Operators.End(vg_);
					Period vi_ = Visit?.Period;
					CqlInterval<CqlDateTime> vj_ = _FHIRHelpers_4_3_000.ToInterval(context, vi_);
					...
					CqlInterval<CqlDateTime> vo_ = _FHIRHelpers_4_3_000.ToInterval(context, vi_);
					...
					CqlInterval<CqlDateTime> vt_ = _FHIRHelpers_4_3_000.ToInterval(context, vi_);
				...
				object de_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> vz_ = _FHIRHelpers_4_3_000.ToInterval(context, vy_);
				...
				CqlInterval<CqlDateTime> di_ = _FHIRHelpers_4_3_000.ToInterval(context, dh_);
				CqlDateTime dj_ = context.Operators.Start(di_);
				CqlInterval<CqlDateTime> dl_ = _FHIRHelpers_4_3_000.ToInterval(context, bm_);
			...
			object i_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> wc_ = _FHIRHelpers_4_3_000.ToInterval(context, wb_);
			...
			bool? q_(Encounter LastED)
			{
				...
				CqlInterval<CqlDateTime> wj_ = _FHIRHelpers_4_3_000.ToInterval(context, wi_);
				...
				bool? wn_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> yk_ = _FHIRHelpers_4_3_000.ToInterval(context, yj_);
					CqlDateTime yl_ = context.Operators.End(yk_);
					Period ym_ = Visit?.Period;
					CqlInterval<CqlDateTime> yn_ = _FHIRHelpers_4_3_000.ToInterval(context, ym_);
					...
					CqlInterval<CqlDateTime> ys_ = _FHIRHelpers_4_3_000.ToInterval(context, ym_);
					...
					CqlInterval<CqlDateTime> yx_ = _FHIRHelpers_4_3_000.ToInterval(context, ym_);
				...
				object wp_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> zd_ = _FHIRHelpers_4_3_000.ToInterval(context, zc_);
				...
				CqlInterval<CqlDateTime> wt_ = _FHIRHelpers_4_3_000.ToInterval(context, ws_);
				CqlDateTime wu_ = context.Operators.Start(wt_);
				Period wv_ = Visit?.Period;
				CqlInterval<CqlDateTime> ww_ = _FHIRHelpers_4_3_000.ToInterval(context, wv_);
				...
				bool? xc_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> zk_ = _FHIRHelpers_4_3_000.ToInterval(context, zj_);
					CqlDateTime zl_ = context.Operators.End(zk_);
					Period zm_ = Visit?.Period;
					CqlInterval<CqlDateTime> zn_ = _FHIRHelpers_4_3_000.ToInterval(context, zm_);
					...
					CqlInterval<CqlDateTime> zs_ = _FHIRHelpers_4_3_000.ToInterval(context, zm_);
					...
					CqlInterval<CqlDateTime> zx_ = _FHIRHelpers_4_3_000.ToInterval(context, zm_);
				...
				object xe_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> azd_ = _FHIRHelpers_4_3_000.ToInterval(context, azc_);
				...
				CqlInterval<CqlDateTime> xi_ = _FHIRHelpers_4_3_000.ToInterval(context, xh_);
				CqlDateTime xj_ = context.Operators.Start(xi_);
				CqlInterval<CqlDateTime> xl_ = _FHIRHelpers_4_3_000.ToInterval(context, wv_);
				...
				bool? xr_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> azk_ = _FHIRHelpers_4_3_000.ToInterval(context, azj_);
					CqlDateTime azl_ = context.Operators.End(azk_);
					Period azm_ = Visit?.Period;
					CqlInterval<CqlDateTime> azn_ = _FHIRHelpers_4_3_000.ToInterval(context, azm_);
					...
					CqlInterval<CqlDateTime> azs_ = _FHIRHelpers_4_3_000.ToInterval(context, azm_);
					...
					CqlInterval<CqlDateTime> azx_ = _FHIRHelpers_4_3_000.ToInterval(context, azm_);
				...
				object xt_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> bzd_ = _FHIRHelpers_4_3_000.ToInterval(context, bzc_);
				...
				CqlInterval<CqlDateTime> xx_ = _FHIRHelpers_4_3_000.ToInterval(context, xw_);
				CqlDateTime xy_ = context.Operators.Start(xx_);
				CqlInterval<CqlDateTime> ya_ = _FHIRHelpers_4_3_000.ToInterval(context, wv_);
			...
			object s_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> bzg_ = _FHIRHelpers_4_3_000.ToInterval(context, bzf_);
			...
			bool? aa_(Encounter LastObs)
			{
				...
				CqlInterval<CqlDateTime> bzn_ = _FHIRHelpers_4_3_000.ToInterval(context, bzm_);
				CqlDateTime bzo_ = context.Operators.End(bzn_);
				Period bzp_ = Visit?.Period;
				CqlInterval<CqlDateTime> bzq_ = _FHIRHelpers_4_3_000.ToInterval(context, bzp_);
				...
				CqlInterval<CqlDateTime> bzv_ = _FHIRHelpers_4_3_000.ToInterval(context, bzp_);
				...
				CqlInterval<CqlDateTime> cza_ = _FHIRHelpers_4_3_000.ToInterval(context, bzp_);
			...
			object ac_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> czg_ = _FHIRHelpers_4_3_000.ToInterval(context, czf_);
			...
			CqlInterval<CqlDateTime> aj_ = _FHIRHelpers_4_3_000.ToInterval(context, ai_);
			CqlDateTime ak_ = context.Operators.Start(aj_);
			CqlInterval<CqlDateTime> am_ = _FHIRHelpers_4_3_000.ToInterval(context, ai_);
		...
		CqlInterval<CqlDateTime> b_(Encounter Visit)
		{
			...
			bool? g_(Encounter LastED)
			{
				...
				bool? ao_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> cl_ = _FHIRHelpers_4_3_000.ToInterval(context, ck_);
					CqlDateTime cm_ = context.Operators.End(cl_);
					Period cn_ = Visit?.Period;
					CqlInterval<CqlDateTime> co_ = _FHIRHelpers_4_3_000.ToInterval(context, cn_);
					...
					CqlInterval<CqlDateTime> ct_ = _FHIRHelpers_4_3_000.ToInterval(context, cn_);
					...
					CqlInterval<CqlDateTime> cy_ = _FHIRHelpers_4_3_000.ToInterval(context, cn_);
					CqlDateTime cz_ = context.Operators.Start(cy_);
				...
				object aq_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> de_ = _FHIRHelpers_4_3_000.ToInterval(context, dd_);
				...
				CqlInterval<CqlDateTime> au_ = _FHIRHelpers_4_3_000.ToInterval(context, at_);
				...
				bool? bd_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> dl_ = _FHIRHelpers_4_3_000.ToInterval(context, dk_);
					CqlDateTime dm_ = context.Operators.End(dl_);
					Period dn_ = Visit?.Period;
					CqlInterval<CqlDateTime> do_ = _FHIRHelpers_4_3_000.ToInterval(context, dn_);
					...
					CqlInterval<CqlDateTime> dt_ = _FHIRHelpers_4_3_000.ToInterval(context, dn_);
					...
					CqlInterval<CqlDateTime> dy_ = _FHIRHelpers_4_3_000.ToInterval(context, dn_);
				...
				CqlInterval<CqlDateTime> bj_ = _FHIRHelpers_4_3_000.ToInterval(context, bi_);
				CqlDateTime bk_ = context.Operators.Start(bj_);
				CqlInterval<CqlDateTime> bm_ = _FHIRHelpers_4_3_000.ToInterval(context, aw_);
				...
				bool? bs_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> eo_ = _FHIRHelpers_4_3_000.ToInterval(context, en_);
					...
					CqlInterval<CqlDateTime> et_ = _FHIRHelpers_4_3_000.ToInterval(context, en_);
					CqlDateTime eu_ = context.Operators.Start(et_);
					...
					CqlInterval<CqlDateTime> ey_ = _FHIRHelpers_4_3_000.ToInterval(context, en_);
				...
				CqlInterval<CqlDateTime> by_ = _FHIRHelpers_4_3_000.ToInterval(context, bx_);
				CqlDateTime bz_ = context.Operators.Start(by_);
				CqlInterval<CqlDateTime> cb_ = _FHIRHelpers_4_3_000.ToInterval(context, aw_);
			...
			object i_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> fh_ = _FHIRHelpers_4_3_000.ToInterval(context, fg_);
			...
			bool? q_(Encounter LastObs)
			{
				...
				CqlInterval<CqlDateTime> fo_ = _FHIRHelpers_4_3_000.ToInterval(context, fn_);
				CqlDateTime fp_ = context.Operators.End(fo_);
				Period fq_ = Visit?.Period;
				CqlInterval<CqlDateTime> fr_ = _FHIRHelpers_4_3_000.ToInterval(context, fq_);
				...
				CqlInterval<CqlDateTime> fw_ = _FHIRHelpers_4_3_000.ToInterval(context, fq_);
				...
				CqlInterval<CqlDateTime> gb_ = _FHIRHelpers_4_3_000.ToInterval(context, fq_);
			...
			object s_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> gh_ = _FHIRHelpers_4_3_000.ToInterval(context, gg_);
			...
			CqlDateTime aa_ = context.Operators.Start(z_);
			CqlInterval<CqlDateTime> ac_ = _FHIRHelpers_4_3_000.ToInterval(context, y_);
	...
	public  Encounter.LocationComponent FirstInpatientIntensiveCareUnit(CqlContext context, Encounter Encounter)
	{
		...
		bool? b_(Encounter.LocationComponent HospitalLocation)
		{
			...
			{
				CqlConcept t_ = _FHIRHelpers_4_3_000.ToConcept(context, @this);
		...
		object d_(Encounter.LocationComponent @this)
		{
			...
			CqlInterval<CqlDateTime> v_ = _FHIRHelpers_4_3_000.ToInterval(context, u_);
	...
	public  Condition PrincipalDiagnosis(CqlContext context, Encounter Encounter)
	{
		...
		Condition d_(Encounter.DiagnosisComponent PD)
		{
			...
			bool? k_(Condition C)
			{
				...
				string r_ = q_?.Value;
				string s_ = _QICoreCommon_2_0_000.getId(context, r_);
	...
	public  CqlConcept GetMedicationCode(CqlContext context, MedicationRequest request)
	{
		CqlConcept a_()
		{
			bool b_()
			{
				...
				object d_ = _FHIRHelpers_4_3_000.ToValue(context, c_);
			...
			else
			{
				...
				bool? i_(Medication M)
				{
					...
					string s_ = r_?.Value;
					string t_ = _QICoreCommon_2_0_000.getId(context, s_);
				...
				CqlConcept m_ = _FHIRHelpers_4_3_000.ToConcept(context, l_);
