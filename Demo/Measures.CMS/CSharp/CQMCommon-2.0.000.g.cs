...
public static partial class CQMCommon_2_0_000ServiceCollectionExtensions
{
    public static IServiceCollection AddCQMCommon_2_0_000(this IServiceCollection services)
    {
        services.TryAddSingleton<CQMCommon_2_0_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["CQMCommon_2_0_000"]);
            return ActivatorUtilities.CreateInstance<CQMCommon_2_0_000>(sp);
        });
