...
public static class CQMCommon_2_0_000
{
	...
	public static CqlValueSet Intensive_Care_Unit(CqlContext context) => 
	...
	public static CqlValueSet Outpatient_Surgery_Service(CqlContext context) => 
	...
	public static IEnumerable<Encounter> Inpatient_Encounter(CqlContext context)
	{
		CqlValueSet a_ = CQMCommon_2_0_000.Encounter_Inpatient(context);
		...
		bool? c_(Encounter EncounterInpatient)
		{
			...
			CqlInterval<CqlDateTime> l_ = CQMCommon_2_0_000.Measurement_Period(context);
	...
	public static CqlInterval<CqlDate> ToDateInterval(CqlContext context, CqlInterval<CqlDateTime> period)
	{
	...
	public static int? LengthInDays(CqlContext context, CqlInterval<CqlDateTime> Value)
	{
	...
	public static Encounter ED_Visit(CqlContext context, Encounter TheEncounter)
	{
		CqlValueSet a_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		bool? c_(Encounter EDVisit)
		{
			...
			CqlInterval<CqlDateTime> z_ = FHIRHelpers_4_3_000.ToInterval(context, o_);
		...
		object e_(Encounter @this)
		{
			...
			CqlInterval<CqlDateTime> af_ = FHIRHelpers_4_3_000.ToInterval(context, ae_);
    ...
    [CqlTag("description", "Returns the most recent emergency department visit, if any, that occurs 1 hour or less prior to the given encounter.")]
	public static Encounter edVisit(CqlContext context, Encounter TheEncounter)
	{
		CqlValueSet a_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		bool? c_(Encounter EDVisit)
	...
	public static CqlInterval<CqlDateTime> Hospitalization(CqlContext context, Encounter TheEncounter)
	{
		Encounter a_ = CQMCommon_2_0_000.ED_Visit(context, TheEncounter);
		Encounter[] b_ = [
			a_,
		];
	...
	public static CqlInterval<CqlDateTime> hospitalization(CqlContext context, Encounter TheEncounter)
	{
		Encounter a_ = CQMCommon_2_0_000.edVisit(context, TheEncounter);
		Encounter[] b_ = [
			a_,
		];
		CqlInterval<CqlDateTime> c_(Encounter X)
	...
	public static IEnumerable<Encounter.LocationComponent> Hospitalization_Locations(CqlContext context, Encounter TheEncounter)
	{
		Encounter a_ = CQMCommon_2_0_000.ED_Visit(context, TheEncounter);
		Encounter[] b_ = [
			a_,
    ...
    [CqlTag("description", "Returns list of all locations within an encounter, including locations for immediately prior ED visit.")]
	public static IEnumerable<Encounter.LocationComponent> hospitalizationLocations(CqlContext context, Encounter TheEncounter)
	{
		Encounter a_ = CQMCommon_2_0_000.edVisit(context, TheEncounter);
		Encounter[] b_ = [
			a_,
	...
	public static int? Hospitalization_Length_of_Stay(CqlContext context, Encounter TheEncounter)
	{
		CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.Hospitalization(context, TheEncounter);
		int? b_ = CQMCommon_2_0_000.LengthInDays(context, a_);
    ...
    [CqlTag("description", "Returns the length of stay in days (i.e. the number of days between admission and discharge) for the given encounter, or from the admission of any immediately prior emergency department visit to the discharge of the encounter")]
	public static int? hospitalizationLengthOfStay(CqlContext context, Encounter TheEncounter)
	{
		CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.hospitalization(context, TheEncounter);
		int? b_ = CQMCommon_2_0_000.lengthInDays(context, a_);
	...
	public static CqlDateTime Hospital_Admission_Time(CqlContext context, Encounter TheEncounter)
	{
		CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.Hospitalization(context, TheEncounter);
    ...
    [CqlTag("description", "Returns admission time for an encounter or for immediately prior emergency department visit.")]
	public static CqlDateTime hospitalAdmissionTime(CqlContext context, Encounter TheEncounter)
	{
		CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.hospitalization(context, TheEncounter);
		CqlDateTime b_ = context.Operators.Start(a_);
	...
	public static CqlDateTime Hospital_Discharge_Time(CqlContext context, Encounter TheEncounter)
	{
		Period a_ = TheEncounter?.Period;
		CqlInterval<CqlDateTime> b_ = FHIRHelpers_4_3_000.ToInterval(context, a_);
    ...
    [CqlTag("description", "Hospital Discharge Time returns the discharge time for an encounter")]
	public static CqlDateTime hospitalDischargeTime(CqlContext context, Encounter TheEncounter)
	{
		Period a_ = TheEncounter?.Period;
		CqlInterval<CqlDateTime> b_ = FHIRHelpers_4_3_000.ToInterval(context, a_);
		CqlDateTime c_ = context.Operators.End(b_);
	...
	public static CqlDateTime Hospital_Arrival_Time(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.Hospitalization_Locations(context, TheEncounter);
    ...
    [CqlTag("description", "Returns earliest arrival time for an encounter including any prior ED visit.")]
	public static CqlDateTime hospitalArrivalTime(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.hospitalizationLocations(context, TheEncounter);
		object b_(Encounter.LocationComponent @this)
		{
			Period h_ = @this?.Period;
			CqlInterval<CqlDateTime> i_ = FHIRHelpers_4_3_000.ToInterval(context, h_);
	...
	public static CqlDateTime Hospital_Departure_Time(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.Hospitalization_Locations(context, TheEncounter);
		object b_(Encounter.LocationComponent @this)
		{
    ...
    [CqlTag("description", "Returns the latest departure time for encounter including any prior ED visit.")]
	public static CqlDateTime hospitalDepartureTime(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.hospitalizationLocations(context, TheEncounter);
		object b_(Encounter.LocationComponent @this)
		{
	...
	public static Location GetLocation(CqlContext context, ResourceReference reference)
	{
		...
		bool? b_(Location L)
		{
			...
			string h_ = g_?.Value;
			string i_ = QICoreCommon_2_0_000.getId(context, h_);
	...
	public static CqlDateTime Emergency_Department_Arrival_Time(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.Hospitalization_Locations(context, TheEncounter);
		bool? b_(Encounter.LocationComponent HospitalLocation)
		{
			ResourceReference h_ = HospitalLocation?.Location;
			Location i_ = CQMCommon_2_0_000.GetLocation(context, h_);
			...
			CqlValueSet m_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
    ...
    [CqlTag("description", "Returns the emergency department arrival time for the encounter.")]
	public static CqlDateTime emergencyDepartmentArrivalTime(CqlContext context, Encounter TheEncounter)
	{
		IEnumerable<Encounter.LocationComponent> a_ = CQMCommon_2_0_000.hospitalizationLocations(context, TheEncounter);
		bool? b_(Encounter.LocationComponent HospitalLocation)
		{
	...
	public static CqlInterval<CqlDateTime> HospitalizationWithObservationAndOutpatientSurgeryService(CqlContext context, Encounter TheEncounter)
	{
		Encounter[] a_ = [
			TheEncounter,
		];
		...
		{
			CqlValueSet e_ = CQMCommon_2_0_000.Outpatient_Surgery_Service(context);
			...
			bool? g_(Encounter LastSurgeryOP)
			{
				...
				CqlValueSet as_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
				...
				bool? au_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> du_ = FHIRHelpers_4_3_000.ToInterval(context, dt_);
					CqlDateTime dv_ = context.Operators.End(du_);
					CqlValueSet dw_ = CQMCommon_2_0_000.Observation_Services(context);
					...
					bool? dy_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> fv_ = FHIRHelpers_4_3_000.ToInterval(context, fu_);
						CqlDateTime fw_ = context.Operators.End(fv_);
						Period fx_ = Visit?.Period;
						CqlInterval<CqlDateTime> fy_ = FHIRHelpers_4_3_000.ToInterval(context, fx_);
						...
						CqlInterval<CqlDateTime> gd_ = FHIRHelpers_4_3_000.ToInterval(context, fx_);
						...
						CqlInterval<CqlDateTime> gi_ = FHIRHelpers_4_3_000.ToInterval(context, fx_);
					...
					object ea_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> go_ = FHIRHelpers_4_3_000.ToInterval(context, gn_);
					...
					CqlInterval<CqlDateTime> ee_ = FHIRHelpers_4_3_000.ToInterval(context, ed_);
					CqlDateTime ef_ = context.Operators.Start(ee_);
					Period eg_ = Visit?.Period;
					CqlInterval<CqlDateTime> eh_ = FHIRHelpers_4_3_000.ToInterval(context, eg_);
					...
					bool? en_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> gv_ = FHIRHelpers_4_3_000.ToInterval(context, gu_);
						CqlDateTime gw_ = context.Operators.End(gv_);
						Period gx_ = Visit?.Period;
						CqlInterval<CqlDateTime> gy_ = FHIRHelpers_4_3_000.ToInterval(context, gx_);
						...
						CqlInterval<CqlDateTime> hd_ = FHIRHelpers_4_3_000.ToInterval(context, gx_);
						...
						CqlInterval<CqlDateTime> hi_ = FHIRHelpers_4_3_000.ToInterval(context, gx_);
					...
					object ep_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ho_ = FHIRHelpers_4_3_000.ToInterval(context, hn_);
					...
					CqlInterval<CqlDateTime> et_ = FHIRHelpers_4_3_000.ToInterval(context, es_);
					CqlDateTime eu_ = context.Operators.Start(et_);
					CqlInterval<CqlDateTime> ew_ = FHIRHelpers_4_3_000.ToInterval(context, eg_);
					...
					bool? fc_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> hv_ = FHIRHelpers_4_3_000.ToInterval(context, hu_);
						CqlDateTime hw_ = context.Operators.End(hv_);
						Period hx_ = Visit?.Period;
						CqlInterval<CqlDateTime> hy_ = FHIRHelpers_4_3_000.ToInterval(context, hx_);
						...
						CqlInterval<CqlDateTime> id_ = FHIRHelpers_4_3_000.ToInterval(context, hx_);
						...
						CqlInterval<CqlDateTime> ii_ = FHIRHelpers_4_3_000.ToInterval(context, hx_);
					...
					object fe_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> io_ = FHIRHelpers_4_3_000.ToInterval(context, in_);
					...
					CqlInterval<CqlDateTime> fi_ = FHIRHelpers_4_3_000.ToInterval(context, fh_);
					CqlDateTime fj_ = context.Operators.Start(fi_);
					CqlInterval<CqlDateTime> fl_ = FHIRHelpers_4_3_000.ToInterval(context, eg_);
				...
				object aw_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> ir_ = FHIRHelpers_4_3_000.ToInterval(context, iq_);
				...
				CqlInterval<CqlDateTime> ba_ = FHIRHelpers_4_3_000.ToInterval(context, az_);
				CqlDateTime bb_ = context.Operators.Start(ba_);
				CqlValueSet bc_ = CQMCommon_2_0_000.Observation_Services(context);
				...
				bool? be_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> iy_ = FHIRHelpers_4_3_000.ToInterval(context, ix_);
					CqlDateTime iz_ = context.Operators.End(iy_);
					Period ja_ = Visit?.Period;
					CqlInterval<CqlDateTime> jb_ = FHIRHelpers_4_3_000.ToInterval(context, ja_);
					...
					CqlInterval<CqlDateTime> jg_ = FHIRHelpers_4_3_000.ToInterval(context, ja_);
					...
					CqlInterval<CqlDateTime> jl_ = FHIRHelpers_4_3_000.ToInterval(context, ja_);
				...
				object bg_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> jr_ = FHIRHelpers_4_3_000.ToInterval(context, jq_);
				...
				bool? bt_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> jy_ = FHIRHelpers_4_3_000.ToInterval(context, jx_);
					CqlDateTime jz_ = context.Operators.End(jy_);
					CqlValueSet ka_ = CQMCommon_2_0_000.Observation_Services(context);
					...
					bool? kc_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> lz_ = FHIRHelpers_4_3_000.ToInterval(context, ly_);
						CqlDateTime ma_ = context.Operators.End(lz_);
						Period mb_ = Visit?.Period;
						CqlInterval<CqlDateTime> mc_ = FHIRHelpers_4_3_000.ToInterval(context, mb_);
						...
						CqlInterval<CqlDateTime> mh_ = FHIRHelpers_4_3_000.ToInterval(context, mb_);
						...
						CqlInterval<CqlDateTime> mm_ = FHIRHelpers_4_3_000.ToInterval(context, mb_);
					...
					object ke_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ms_ = FHIRHelpers_4_3_000.ToInterval(context, mr_);
					...
					CqlInterval<CqlDateTime> ki_ = FHIRHelpers_4_3_000.ToInterval(context, kh_);
					CqlDateTime kj_ = context.Operators.Start(ki_);
					Period kk_ = Visit?.Period;
					CqlInterval<CqlDateTime> kl_ = FHIRHelpers_4_3_000.ToInterval(context, kk_);
					...
					bool? kr_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> mz_ = FHIRHelpers_4_3_000.ToInterval(context, my_);
						CqlDateTime na_ = context.Operators.End(mz_);
						Period nb_ = Visit?.Period;
						CqlInterval<CqlDateTime> nc_ = FHIRHelpers_4_3_000.ToInterval(context, nb_);
						...
						CqlInterval<CqlDateTime> nh_ = FHIRHelpers_4_3_000.ToInterval(context, nb_);
						...
						CqlInterval<CqlDateTime> nm_ = FHIRHelpers_4_3_000.ToInterval(context, nb_);
					...
					object kt_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> ns_ = FHIRHelpers_4_3_000.ToInterval(context, nr_);
					...
					CqlInterval<CqlDateTime> kx_ = FHIRHelpers_4_3_000.ToInterval(context, kw_);
					CqlDateTime ky_ = context.Operators.Start(kx_);
					CqlInterval<CqlDateTime> la_ = FHIRHelpers_4_3_000.ToInterval(context, kk_);
					...
					bool? lg_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> nz_ = FHIRHelpers_4_3_000.ToInterval(context, ny_);
						CqlDateTime oa_ = context.Operators.End(nz_);
						Period ob_ = Visit?.Period;
						CqlInterval<CqlDateTime> oc_ = FHIRHelpers_4_3_000.ToInterval(context, ob_);
						...
						CqlInterval<CqlDateTime> oh_ = FHIRHelpers_4_3_000.ToInterval(context, ob_);
						...
						CqlInterval<CqlDateTime> om_ = FHIRHelpers_4_3_000.ToInterval(context, ob_);
					...
					object li_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> os_ = FHIRHelpers_4_3_000.ToInterval(context, or_);
					...
					CqlInterval<CqlDateTime> lm_ = FHIRHelpers_4_3_000.ToInterval(context, ll_);
					CqlDateTime ln_ = context.Operators.Start(lm_);
					CqlInterval<CqlDateTime> lp_ = FHIRHelpers_4_3_000.ToInterval(context, kk_);
				...
				object bv_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> ov_ = FHIRHelpers_4_3_000.ToInterval(context, ou_);
				...
				CqlInterval<CqlDateTime> bz_ = FHIRHelpers_4_3_000.ToInterval(context, by_);
				...
				bool? cd_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> pc_ = FHIRHelpers_4_3_000.ToInterval(context, pb_);
					CqlDateTime pd_ = context.Operators.End(pc_);
					Period pe_ = Visit?.Period;
					CqlInterval<CqlDateTime> pf_ = FHIRHelpers_4_3_000.ToInterval(context, pe_);
					...
					CqlInterval<CqlDateTime> pk_ = FHIRHelpers_4_3_000.ToInterval(context, pe_);
					...
					CqlInterval<CqlDateTime> pp_ = FHIRHelpers_4_3_000.ToInterval(context, pe_);
				...
				object cf_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> pv_ = FHIRHelpers_4_3_000.ToInterval(context, pu_);
				...
				CqlInterval<CqlDateTime> cj_ = FHIRHelpers_4_3_000.ToInterval(context, ci_);
				CqlDateTime ck_ = context.Operators.Start(cj_);
				CqlInterval<CqlDateTime> cm_ = FHIRHelpers_4_3_000.ToInterval(context, bm_);
				...
				bool? cs_(Encounter LastED)
				{
					...
					CqlInterval<CqlDateTime> qc_ = FHIRHelpers_4_3_000.ToInterval(context, qb_);
					CqlDateTime qd_ = context.Operators.End(qc_);
					CqlValueSet qe_ = CQMCommon_2_0_000.Observation_Services(context);
					...
					bool? qg_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> sd_ = FHIRHelpers_4_3_000.ToInterval(context, sc_);
						CqlDateTime se_ = context.Operators.End(sd_);
						Period sf_ = Visit?.Period;
						CqlInterval<CqlDateTime> sg_ = FHIRHelpers_4_3_000.ToInterval(context, sf_);
						...
						CqlInterval<CqlDateTime> sl_ = FHIRHelpers_4_3_000.ToInterval(context, sf_);
						...
						CqlInterval<CqlDateTime> sq_ = FHIRHelpers_4_3_000.ToInterval(context, sf_);
					...
					object qi_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> sw_ = FHIRHelpers_4_3_000.ToInterval(context, sv_);
					...
					CqlInterval<CqlDateTime> qm_ = FHIRHelpers_4_3_000.ToInterval(context, ql_);
					CqlDateTime qn_ = context.Operators.Start(qm_);
					Period qo_ = Visit?.Period;
					CqlInterval<CqlDateTime> qp_ = FHIRHelpers_4_3_000.ToInterval(context, qo_);
					...
					bool? qv_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> td_ = FHIRHelpers_4_3_000.ToInterval(context, tc_);
						CqlDateTime te_ = context.Operators.End(td_);
						Period tf_ = Visit?.Period;
						CqlInterval<CqlDateTime> tg_ = FHIRHelpers_4_3_000.ToInterval(context, tf_);
						...
						CqlInterval<CqlDateTime> tl_ = FHIRHelpers_4_3_000.ToInterval(context, tf_);
						...
						CqlInterval<CqlDateTime> tq_ = FHIRHelpers_4_3_000.ToInterval(context, tf_);
					...
					object qx_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> tw_ = FHIRHelpers_4_3_000.ToInterval(context, tv_);
					...
					CqlInterval<CqlDateTime> rb_ = FHIRHelpers_4_3_000.ToInterval(context, ra_);
					CqlDateTime rc_ = context.Operators.Start(rb_);
					CqlInterval<CqlDateTime> re_ = FHIRHelpers_4_3_000.ToInterval(context, qo_);
					...
					bool? rk_(Encounter LastObs)
					{
						...
						CqlInterval<CqlDateTime> ud_ = FHIRHelpers_4_3_000.ToInterval(context, uc_);
						CqlDateTime ue_ = context.Operators.End(ud_);
						Period uf_ = Visit?.Period;
						CqlInterval<CqlDateTime> ug_ = FHIRHelpers_4_3_000.ToInterval(context, uf_);
						...
						CqlInterval<CqlDateTime> ul_ = FHIRHelpers_4_3_000.ToInterval(context, uf_);
						...
						CqlInterval<CqlDateTime> uq_ = FHIRHelpers_4_3_000.ToInterval(context, uf_);
					...
					object rm_(Encounter @this)
					{
						...
						CqlInterval<CqlDateTime> uw_ = FHIRHelpers_4_3_000.ToInterval(context, uv_);
					...
					CqlInterval<CqlDateTime> rq_ = FHIRHelpers_4_3_000.ToInterval(context, rp_);
					CqlDateTime rr_ = context.Operators.Start(rq_);
					CqlInterval<CqlDateTime> rt_ = FHIRHelpers_4_3_000.ToInterval(context, qo_);
				...
				object cu_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> uz_ = FHIRHelpers_4_3_000.ToInterval(context, uy_);
				...
				CqlInterval<CqlDateTime> cy_ = FHIRHelpers_4_3_000.ToInterval(context, cx_);
				...
				bool? dc_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> vg_ = FHIRHelpers_4_3_000.ToInterval(context, vf_);
					CqlDateTime vh_ = context.Operators.End(vg_);
					Period vi_ = Visit?.Period;
					CqlInterval<CqlDateTime> vj_ = FHIRHelpers_4_3_000.ToInterval(context, vi_);
					...
					CqlInterval<CqlDateTime> vo_ = FHIRHelpers_4_3_000.ToInterval(context, vi_);
					...
					CqlInterval<CqlDateTime> vt_ = FHIRHelpers_4_3_000.ToInterval(context, vi_);
				...
				object de_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> vz_ = FHIRHelpers_4_3_000.ToInterval(context, vy_);
				...
				CqlInterval<CqlDateTime> di_ = FHIRHelpers_4_3_000.ToInterval(context, dh_);
				CqlDateTime dj_ = context.Operators.Start(di_);
				CqlInterval<CqlDateTime> dl_ = FHIRHelpers_4_3_000.ToInterval(context, bm_);
			...
			object i_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> wc_ = FHIRHelpers_4_3_000.ToInterval(context, wb_);
			...
			CqlValueSet o_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
			...
			bool? q_(Encounter LastED)
			{
				...
				CqlInterval<CqlDateTime> wj_ = FHIRHelpers_4_3_000.ToInterval(context, wi_);
				CqlDateTime wk_ = context.Operators.End(wj_);
				CqlValueSet wl_ = CQMCommon_2_0_000.Observation_Services(context);
				...
				bool? wn_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> yk_ = FHIRHelpers_4_3_000.ToInterval(context, yj_);
					CqlDateTime yl_ = context.Operators.End(yk_);
					Period ym_ = Visit?.Period;
					CqlInterval<CqlDateTime> yn_ = FHIRHelpers_4_3_000.ToInterval(context, ym_);
					...
					CqlInterval<CqlDateTime> ys_ = FHIRHelpers_4_3_000.ToInterval(context, ym_);
					...
					CqlInterval<CqlDateTime> yx_ = FHIRHelpers_4_3_000.ToInterval(context, ym_);
				...
				object wp_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> zd_ = FHIRHelpers_4_3_000.ToInterval(context, zc_);
				...
				CqlInterval<CqlDateTime> wt_ = FHIRHelpers_4_3_000.ToInterval(context, ws_);
				CqlDateTime wu_ = context.Operators.Start(wt_);
				Period wv_ = Visit?.Period;
				CqlInterval<CqlDateTime> ww_ = FHIRHelpers_4_3_000.ToInterval(context, wv_);
				...
				bool? xc_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> zk_ = FHIRHelpers_4_3_000.ToInterval(context, zj_);
					CqlDateTime zl_ = context.Operators.End(zk_);
					Period zm_ = Visit?.Period;
					CqlInterval<CqlDateTime> zn_ = FHIRHelpers_4_3_000.ToInterval(context, zm_);
					...
					CqlInterval<CqlDateTime> zs_ = FHIRHelpers_4_3_000.ToInterval(context, zm_);
					...
					CqlInterval<CqlDateTime> zx_ = FHIRHelpers_4_3_000.ToInterval(context, zm_);
				...
				object xe_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> azd_ = FHIRHelpers_4_3_000.ToInterval(context, azc_);
				...
				CqlInterval<CqlDateTime> xi_ = FHIRHelpers_4_3_000.ToInterval(context, xh_);
				CqlDateTime xj_ = context.Operators.Start(xi_);
				CqlInterval<CqlDateTime> xl_ = FHIRHelpers_4_3_000.ToInterval(context, wv_);
				...
				bool? xr_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> azk_ = FHIRHelpers_4_3_000.ToInterval(context, azj_);
					CqlDateTime azl_ = context.Operators.End(azk_);
					Period azm_ = Visit?.Period;
					CqlInterval<CqlDateTime> azn_ = FHIRHelpers_4_3_000.ToInterval(context, azm_);
					...
					CqlInterval<CqlDateTime> azs_ = FHIRHelpers_4_3_000.ToInterval(context, azm_);
					...
					CqlInterval<CqlDateTime> azx_ = FHIRHelpers_4_3_000.ToInterval(context, azm_);
				...
				object xt_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> bzd_ = FHIRHelpers_4_3_000.ToInterval(context, bzc_);
				...
				CqlInterval<CqlDateTime> xx_ = FHIRHelpers_4_3_000.ToInterval(context, xw_);
				CqlDateTime xy_ = context.Operators.Start(xx_);
				CqlInterval<CqlDateTime> ya_ = FHIRHelpers_4_3_000.ToInterval(context, wv_);
			...
			object s_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> bzg_ = FHIRHelpers_4_3_000.ToInterval(context, bzf_);
			...
			CqlValueSet y_ = CQMCommon_2_0_000.Observation_Services(context);
			...
			bool? aa_(Encounter LastObs)
			{
				...
				CqlInterval<CqlDateTime> bzn_ = FHIRHelpers_4_3_000.ToInterval(context, bzm_);
				CqlDateTime bzo_ = context.Operators.End(bzn_);
				Period bzp_ = Visit?.Period;
				CqlInterval<CqlDateTime> bzq_ = FHIRHelpers_4_3_000.ToInterval(context, bzp_);
				...
				CqlInterval<CqlDateTime> bzv_ = FHIRHelpers_4_3_000.ToInterval(context, bzp_);
				...
				CqlInterval<CqlDateTime> cza_ = FHIRHelpers_4_3_000.ToInterval(context, bzp_);
			...
			object ac_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> czg_ = FHIRHelpers_4_3_000.ToInterval(context, czf_);
			...
			CqlInterval<CqlDateTime> am_ = FHIRHelpers_4_3_000.ToInterval(context, ai_);
	...
	public static CqlInterval<CqlDateTime> HospitalizationWithObservation(CqlContext context, Encounter TheEncounter)
	{
		Encounter[] a_ = [
			TheEncounter,
		];
		CqlInterval<CqlDateTime> b_(Encounter Visit)
		{
			CqlValueSet e_ = CQMCommon_2_0_000.Emergency_Department_Visit(context);
			IEnumerable<Encounter> f_ = context.Operators.RetrieveByValueSet<Encounter>(e_, default);
			bool? g_(Encounter LastED)
			{
				...
				CqlValueSet am_ = CQMCommon_2_0_000.Observation_Services(context);
				...
				bool? ao_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> cl_ = FHIRHelpers_4_3_000.ToInterval(context, ck_);
					CqlDateTime cm_ = context.Operators.End(cl_);
					Period cn_ = Visit?.Period;
					CqlInterval<CqlDateTime> co_ = FHIRHelpers_4_3_000.ToInterval(context, cn_);
					...
					CqlInterval<CqlDateTime> ct_ = FHIRHelpers_4_3_000.ToInterval(context, cn_);
					...
					CqlInterval<CqlDateTime> cy_ = FHIRHelpers_4_3_000.ToInterval(context, cn_);
					CqlDateTime cz_ = context.Operators.Start(cy_);
				...
				object aq_(Encounter @this)
				{
					...
					CqlInterval<CqlDateTime> de_ = FHIRHelpers_4_3_000.ToInterval(context, dd_);
				...
				CqlInterval<CqlDateTime> au_ = FHIRHelpers_4_3_000.ToInterval(context, at_);
				...
				bool? bd_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> dl_ = FHIRHelpers_4_3_000.ToInterval(context, dk_);
					CqlDateTime dm_ = context.Operators.End(dl_);
					Period dn_ = Visit?.Period;
					CqlInterval<CqlDateTime> do_ = FHIRHelpers_4_3_000.ToInterval(context, dn_);
					...
					CqlInterval<CqlDateTime> dt_ = FHIRHelpers_4_3_000.ToInterval(context, dn_);
					...
					CqlInterval<CqlDateTime> dy_ = FHIRHelpers_4_3_000.ToInterval(context, dn_);
				...
				CqlInterval<CqlDateTime> bm_ = FHIRHelpers_4_3_000.ToInterval(context, aw_);
				...
				bool? bs_(Encounter LastObs)
				{
					...
					CqlInterval<CqlDateTime> eo_ = FHIRHelpers_4_3_000.ToInterval(context, en_);
					...
					CqlInterval<CqlDateTime> et_ = FHIRHelpers_4_3_000.ToInterval(context, en_);
					CqlDateTime eu_ = context.Operators.Start(et_);
					...
					CqlInterval<CqlDateTime> ey_ = FHIRHelpers_4_3_000.ToInterval(context, en_);
				...
				CqlInterval<CqlDateTime> by_ = FHIRHelpers_4_3_000.ToInterval(context, bx_);
				CqlDateTime bz_ = context.Operators.Start(by_);
				CqlInterval<CqlDateTime> cb_ = FHIRHelpers_4_3_000.ToInterval(context, aw_);
			...
			object i_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> fh_ = FHIRHelpers_4_3_000.ToInterval(context, fg_);
			...
			CqlInterval<CqlDateTime> m_ = FHIRHelpers_4_3_000.ToInterval(context, l_);
			CqlDateTime n_ = context.Operators.Start(m_);
			CqlValueSet o_ = CQMCommon_2_0_000.Observation_Services(context);
			IEnumerable<Encounter> p_ = context.Operators.RetrieveByValueSet<Encounter>(o_, default);
			bool? q_(Encounter LastObs)
			{
				...
				CqlInterval<CqlDateTime> fo_ = FHIRHelpers_4_3_000.ToInterval(context, fn_);
				CqlDateTime fp_ = context.Operators.End(fo_);
				Period fq_ = Visit?.Period;
				CqlInterval<CqlDateTime> fr_ = FHIRHelpers_4_3_000.ToInterval(context, fq_);
				...
				CqlInterval<CqlDateTime> fw_ = FHIRHelpers_4_3_000.ToInterval(context, fq_);
				...
				CqlInterval<CqlDateTime> gb_ = FHIRHelpers_4_3_000.ToInterval(context, fq_);
			...
			object s_(Encounter @this)
			{
				...
				CqlInterval<CqlDateTime> gh_ = FHIRHelpers_4_3_000.ToInterval(context, gg_);
			...
			CqlDateTime aa_ = context.Operators.Start(z_);
			CqlInterval<CqlDateTime> ac_ = FHIRHelpers_4_3_000.ToInterval(context, y_);
	...
	public static int? HospitalizationWithObservationLengthofStay(CqlContext context, Encounter TheEncounter)
	{
		CqlInterval<CqlDateTime> a_ = CQMCommon_2_0_000.HospitalizationWithObservation(context, TheEncounter);
		int? b_ = CQMCommon_2_0_000.LengthInDays(context, a_);
	...
	public static Encounter.LocationComponent FirstInpatientIntensiveCareUnit(CqlContext context, Encounter Encounter)
	{
		List<Encounter.LocationComponent> a_ = Encounter?.Location;
		bool? b_(Encounter.LocationComponent HospitalLocation)
		{
			ResourceReference g_ = HospitalLocation?.Location;
			Location h_ = CQMCommon_2_0_000.GetLocation(context, g_);
			List<CodeableConcept> i_ = h_?.Type;
			CqlConcept j_(CodeableConcept @this)
			{
				CqlConcept t_ = FHIRHelpers_4_3_000.ToConcept(context, @this);

				return t_;
			};
			IEnumerable<CqlConcept> k_ = context.Operators.Select<CodeableConcept, CqlConcept>((IEnumerable<CodeableConcept>)i_, j_);
			CqlValueSet l_ = CQMCommon_2_0_000.Intensive_Care_Unit(context);
		...
		object d_(Encounter.LocationComponent @this)
		{
			...
			CqlInterval<CqlDateTime> v_ = FHIRHelpers_4_3_000.ToInterval(context, u_);
	...
	public static IEnumerable<Condition> EncounterDiagnosis(CqlContext context, Encounter Encounter)
	{
	...
	public static Condition GetCondition(CqlContext context, ResourceReference reference)
	{
	...
	public static Condition PrincipalDiagnosis(CqlContext context, Encounter Encounter)
	{
		List<Encounter.DiagnosisComponent> a_ = Encounter?.Diagnosis;
		...
		Condition d_(Encounter.DiagnosisComponent PD)
		{
			...
			bool? k_(Condition C)
			{
				...
				string r_ = q_?.Value;
				string s_ = QICoreCommon_2_0_000.getId(context, r_);
	...
	public static CqlConcept GetMedicationCode(CqlContext context, MedicationRequest request)
	{
		CqlConcept a_()
		{
			bool b_()
			{
				...
				object d_ = FHIRHelpers_4_3_000.ToValue(context, c_);
			...
			else
			{
				...
				bool? i_(Medication M)
				{
					...
					string s_ = r_?.Value;
					string t_ = QICoreCommon_2_0_000.getId(context, s_);
