...
public class AppropriateTreatmentforSTEMIFHIR_1_0_000
{
	...
	private IEnumerable<Encounter> ED_Encounter_with_Diagnosis_of_STEMI_Value()
	{
		...
		IEnumerable<Encounter> c_(Encounter EDEncounter)
		{
			...
			IEnumerable<Condition> f_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, e_, default));
	...
	private IEnumerable<Encounter> Allergy_or_Intolerance_to_Thrombolytic_Medications_Overlaps_ED_Encounter_Value()
	{
		...
		IEnumerable<Encounter> b_(Encounter EDwSTEMI)
		{
			...
			IEnumerable<AllergyIntolerance> e_ = context.Operators.Retrieve<AllergyIntolerance>(new RetrieveParameters(default, d_, default));
	...
	private IEnumerable<Encounter> Adverse_Effect_to_Thrombolytic_Medications_Before_End_of_ED_Encounter_Value()
	{
		...
		IEnumerable<Encounter> b_(Encounter EDwSTEMI)
		{
			...
			IEnumerable<AdverseEvent> e_ = context.Operators.Retrieve<AdverseEvent>(new RetrieveParameters(default, d_, default));
	...
	private IEnumerable<Encounter> Major_Surgical_Procedure_21_Days_or_Less_Before_Start_of_or_Starts_During_ED_Encounter_Value()
	{
		...
		IEnumerable<Encounter> b_(Encounter EDwithSTEMI)
		{
			...
			IEnumerable<Procedure> e_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, d_, default));
	...
	private IEnumerable<Encounter> Fibrinolytic_Therapy_within_30_Minutes_of_Arrival_Value()
	{
		...
		IEnumerable<Encounter> b_(Encounter EDwithSTEMI)
		{
			...
			IEnumerable<MedicationAdministration> e_ = context.Operators.Retrieve<MedicationAdministration>(new RetrieveParameters(default, d_, default));
			IEnumerable<MedicationAdministration> g_ = context.Operators.Retrieve<MedicationAdministration>(new RetrieveParameters(default, d_, default));
