...
public partial class GlobalMalnutritionCompositeFHIR_0_2_000 : ILibrary, ISingleton<GlobalMalnutritionCompositeFHIR_0_2_000>
{
    ...
    [CqlValueSetDeclaration(
        declarationName: "Hospital Dietitian Referral",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Malnutrition Diagnosis",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Malnutrition Risk Screening",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Malnutrition Screening Finding of At Risk Result",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Malnutrition Screening Finding of Not At Risk Result",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Nutrition Assessment",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Nutrition Assessment Status Finding of Moderately Malnourished",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Nutrition Assessment Status Finding of Well Nourished or Not Malnourished or Mildly Malnourished",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Nutrition Assessment Status Finding of Severely Malnourished",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Nutrition Care Plan",
