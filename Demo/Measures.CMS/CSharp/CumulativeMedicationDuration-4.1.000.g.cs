...
public partial class CumulativeMedicationDuration_minus_4_1_000 : ILibrary, ISingleton<CumulativeMedicationDuration_minus_4_1_000>
{
    private CumulativeMedicationDuration_minus_4_1_000() {}

    public static CumulativeMedicationDuration_minus_4_1_000 Instance { get; } = new();
        ...
        CqlInterval<CqlDate> b_(MedicationRequest R)
        {
            CqlInterval<CqlDate> f_()
            {
                bool g_()
                {
                    ...
                    CqlQuantity ag_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, af_);
                ...
                bool h_()
                {
                    ...
                    CqlInterval<CqlDateTime> dh_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, dg_);
                ...
                if (g_())
                {
                    ...
                    CqlInterval<CqlDateTime> eh_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, eg_);
                    ...
                    CqlInterval<CqlDateTime> ex_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ew_);
                    ...
                    CqlQuantity fc_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, fb_);
                    CqlQuantity fd_ = context.Operators.ConvertQuantity(fc_, "d");
                    decimal? fe_ = fd_?.value;
                    Quantity fg_ = ef_?.Quantity;
                    CqlQuantity fh_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, fg_);
                    ...
                    object fv_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, fu_);
                ...
                else if (h_())
                {
                    ...
                    CqlInterval<CqlDateTime> il_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, ik_);
                    ...
                    object it_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, is_);
        ...
        CqlInterval<CqlDate> b_(MedicationDispense D)
        {
            CqlInterval<CqlDate> f_()
            {
                bool g_()
                {
                    ...
                    CqlQuantity p_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, o_);
                ...
                if (g_())
                {
                    ...
                    CqlQuantity co_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, cn_);
                    CqlQuantity cp_ = context.Operators.ConvertQuantity(co_, "d");
                    decimal? cq_ = cp_?.value;
                    Quantity cr_ = D?.Quantity;
                    CqlQuantity cs_ = FHIRHelpers_minus_4_4_000.Instance.ToQuantity(context, cr_);
