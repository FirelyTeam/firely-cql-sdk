...
public partial class HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_minus_0_1_000 : ILibrary, ISingleton<HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_minus_0_1_000>
{
    private HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_minus_0_1_000() {}

    public static HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_minus_0_1_000 Instance { get; } = new();
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)?> Encounter_with_Hospitalization_Period(CqlContext context)
    {
        ...
        {
            CqlInterval<CqlDateTime> e_ = CQMCommon_minus_2_2_000.Instance.HospitalizationWithObservation(context, QualifyingHospitalization);
    ...
    public IEnumerable<Encounter> Encounter_with_Existing_Diabetes_Diagnosis(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)?> b_((CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)? Hospitalization)
        {
            ...
            {
                CqlInterval<CqlDateTime> m_ = QICoreCommon_minus_2_1_000.Instance.ToPrevalenceInterval(context, Diabetes);
    ...
    public IEnumerable<Encounter> Encounter_with_Hypoglycemic_Medication(CqlContext context)
    {
        ...
        IEnumerable<MedicationAdministration> e_(MedicationAdministration MR)
        {
            ...
            bool? q_(Medication M)
            {
                ...
                CqlConcept aa_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, z_);
        ...
        bool? k_((CqlTupleMetadata, (CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)? Hospitalization, MedicationAdministration HypoglycemicMed)? tuple_brdbxsuhdqixbcfmgdsacwig)
        {
            ...
            Code<MedicationAdministration.MedicationAdministrationStatusCodes> ah_ = context.Operators.Convert<Code<MedicationAdministration.MedicationAdministrationStatusCodes>>(ag_);
            bool? ai_ = context.Operators.Equal(ah_, "completed");
            MedicationAdministration.MedicationAdministrationStatusCodes? ak_ = af_?.Value;
            Code<MedicationAdministration.MedicationAdministrationStatusCodes> al_ = context.Operators.Convert<Code<MedicationAdministration.MedicationAdministrationStatusCodes>>(ak_);
            bool? am_ = context.Operators.Equal(al_, "not-done");
            bool? an_ = context.Operators.Not(am_);
            bool? ao_ = context.Operators.And(ai_, an_);
            CqlInterval<CqlDateTime> ap_ = tuple_brdbxsuhdqixbcfmgdsacwig?.Hospitalization?.hospitalizationPeriod;
            DataType aq_ = tuple_brdbxsuhdqixbcfmgdsacwig?.HypoglycemicMed?.Effective;
        ...
        {
            Encounter av_ = tuple_brdbxsuhdqixbcfmgdsacwig?.Hospitalization?.encounter;
            ...
            bool? i_(Observation GlucoseTest)
            {
                object m_()
                {
                    ...
                    else if (ak_())
                    {
                        ...
                        object az_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, ay_);
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayNumber, CqlInterval<CqlDateTime> dayPeriod)?> relevantDays)?> Days_in_Hospitalization(CqlContext context)
    {
        ...
        {
            CqlInterval<CqlDateTime> e_ = CQMCommon_minus_2_2_000.Instance.HospitalizationWithObservation(context, EligibleInpatientHospitalization);
        ...
        (CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayNumber, CqlInterval<CqlDateTime> dayPeriod, bool? hasSevereResult, bool? hasElevatedResult, bool? hasNoGlucoseTest)?> relevantDays)? b_((CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayNumber, CqlInterval<CqlDateTime> dayPeriod)?> relevantDays)? InpatientHospitalDays)
        {
            ...
            (CqlTupleMetadata, int? dayNumber, CqlInterval<CqlDateTime> dayPeriod, bool? hasSevereResult, bool? hasElevatedResult, bool? hasNoGlucoseTest)? h_((CqlTupleMetadata, int? dayNumber, CqlInterval<CqlDateTime> dayPeriod)? EncounterDay)
            {
                ...
                bool? p_(Observation GlucoseTest)
                {
                    ...
                    CqlDateTime aw_ = QICoreCommon_minus_2_1_000.Instance.Earliest(context, av_());
                ...
                bool? u_(Observation GlucoseTest)
                {
                    ...
                    CqlDateTime ck_ = QICoreCommon_minus_2_1_000.Instance.Earliest(context, cj_());
                ...
                bool? z_(Observation GlucoseTest)
                {
                    ...
                    object ds_()
                    {
                        ...
                        if (dx_())
                        {
                            ...
                            object ek_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, ej_);
                    ...
                    CqlDateTime dt_ = QICoreCommon_minus_2_1_000.Instance.Earliest(context, ds_());
        ...
        bool? g_((CqlTupleMetadata, Encounter InpatientHospitalization, Observation GlucoseTest)? tuple_gldtpgaqprrprerabeflfanwh)
        {
            ...
            object x_()
            {
                ...
                bool am_()
                {
                    ...
                    object au_ = FHIRHelpers_minus_4_4_000.Instance.ToValue(context, at_);
            ...
            CqlInterval<CqlDateTime> z_ = CQMCommon_minus_2_2_000.Instance.HospitalizationWithObservation(context, tuple_gldtpgaqprrprerabeflfanwh?.InpatientHospitalization);
    ...
    public IEnumerable<Observation> Glucose_Tests_Earlier_Than_Glucose_Greater_Than_or_Equal_to_1000_within_1_Hour_Prior_To_and_6_Hours_After_Encounter_Start(CqlContext context)
    {
        ...
        bool? h_((CqlTupleMetadata, Encounter InpatientHospitalization, Observation GlucoseResult1000, Observation EarlierGlucoseTest)? tuple_fdcevedgizpocycjyzijywhai)
        {
            ...
            CqlInterval<CqlDateTime> p_ = CQMCommon_minus_2_2_000.Instance.HospitalizationWithObservation(context, tuple_fdcevedgizpocycjyzijywhai?.InpatientHospitalization);
    ...
    public IEnumerable<Encounter> Encounter_with_First_Glucose_Greater_Than_or_Equal_to_1000(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter InpatientHospitalization)
        {
            ...
            bool? e_(Observation FirstGlucoseResult)
            {
                ...
                CqlDateTime n_ = QICoreCommon_minus_2_1_000.Instance.Earliest(context, m_());
                CqlInterval<CqlDateTime> o_ = CQMCommon_minus_2_2_000.Instance.HospitalizationWithObservation(context, InpatientHospitalization);
