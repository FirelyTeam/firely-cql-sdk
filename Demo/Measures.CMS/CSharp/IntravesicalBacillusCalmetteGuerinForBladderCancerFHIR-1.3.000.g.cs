...
public static class IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000
{
	...
	public static CqlValueSet Active_Tuberculosis_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet BCG_Bacillus_Calmette_Guerin_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet Bladder_Cancer_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet Chemotherapy_Agents_for_Advanced_Cancer(CqlContext context) => 
	...
	public static CqlValueSet Cystectomy_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet Immunocompromised_Conditions(CqlContext context) => 
	...
	public static CqlValueSet Immunosuppressive_Drugs_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet Mixed_histology_urothelial_cell_carcinoma_for_Urology_Care(CqlContext context) => 
	...
	public static CqlValueSet Unavailability_of_Bacillus_Calmette_Guerin_for_urology_care(CqlContext context) => 
	...
	public static CqlCode Carcinoma_in_situ_of_bladder(CqlContext context) => 
		new CqlCode("D09.0", "http://hl7.org/fhir/sid/icd-10-cm", default, default);

    [CqlDeclaration("Combined radiotherapy (procedure)")]
	public static CqlCode Combined_radiotherapy__procedure_(CqlContext context) => 
	...
	public static CqlCode T1__Urinary_tract_tumor_invades_subepithelial_connective_tissue__finding_(CqlContext context) => 
	...
	public static CqlCode Ta__Noninvasive_papillary_carcinoma__urinary_tract___finding_(CqlContext context) => 
	...
	public static CqlCode Tis__Carcinoma_in_situ__flat_tumor_of_urinary_bladder___finding_(CqlContext context) => 
		new CqlCode("369934002", "http://snomed.info/sct", default, default);

    [CqlDeclaration("Tumor staging (tumor staging)")]
	public static CqlCode Tumor_staging__tumor_staging_(CqlContext context) => 
	...
	public static CqlCode Stage_group_pathology_Cancer(CqlContext context) => 
	...
	public static bool? isConfirmedActiveDiagnosis(CqlContext context, Condition Condition)
	{
		Condition[] a_ = [
			Condition,
		];
	...
	public static IEnumerable<Condition> Bladder_Cancer_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Bladder_Cancer_for_Urology_Care(context);
		...
		bool? c_(Condition BladderCancer)
		{
			...
			CqlInterval<CqlDateTime> g_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
			CqlDateTime h_ = context.Operators.End(g_);
			bool? i_ = context.Operators.Before(f_, h_, default);
			bool? j_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.isConfirmedActiveDiagnosis(context, BladderCancer);
	...
	public static Procedure First_Bladder_Cancer_Staging_Procedure(CqlContext context)
	{
		CqlCode a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Tumor_staging__tumor_staging_(context);
		...
		{
			IEnumerable<Condition> k_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Bladder_Cancer_Diagnosis(context);
	...
	public static CqlDateTime July_1_of_Year_Prior_to_the_Measurement_Period(CqlContext context)
	{
		CqlInterval<CqlDateTime> a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
	...
	public static CqlDateTime June_30_of_the_Measurement_Period(CqlContext context)
	{
		CqlInterval<CqlDateTime> a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
		CqlDateTime b_ = context.Operators.Start(a_);
		int? c_ = context.Operators.DateTimeComponentFrom(b_, "year");
	...
	public static Procedure First_Qualifying_Bladder_Cancer_Staging_Procedure(CqlContext context)
	{
		Procedure a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
		Procedure[] b_ = [
			a_,
		];
		bool? c_(Procedure FirstBladderCancerStaging)
		{
			CqlDateTime f_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.July_1_of_Year_Prior_to_the_Measurement_Period(context);
			CqlDateTime g_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.June_30_of_the_Measurement_Period(context);
	...
	public static Procedure First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period(CqlContext context)
	{
		Procedure a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
		Procedure[] b_ = [
			a_,
	...
	public static IEnumerable<Procedure> getStagingProcedure(CqlContext context, Observation StagingObservation)
	{
		List<ResourceReference> a_ = StagingObservation?.PartOf;
		Procedure b_(ResourceReference StagingReference)
		{
			Procedure d_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period(context);
			Procedure[] e_ = [
				d_,
			];
	...
	public static bool? Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_Ta_HG__Tis__T1(CqlContext context)
	{
		CqlCode a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Stage_group_pathology_Cancer(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		...
		{
			IEnumerable<Procedure> g_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.getStagingProcedure(context, StagingObservation);
			bool? h_ = context.Operators.Not((bool?)(g_ is null));
			DataType i_ = StagingObservation?.Value;
			object j_ = FHIRHelpers_4_3_000.ToValue(context, i_);
			CqlCode k_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.T1__Urinary_tract_tumor_invades_subepithelial_connective_tissue__finding_(context);
			CqlConcept l_ = context.Operators.ConvertCodeToConcept(k_);
			bool? m_ = context.Operators.Equivalent(j_ as CqlConcept, l_);
			object o_ = FHIRHelpers_4_3_000.ToValue(context, i_);
			CqlCode p_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Ta__Noninvasive_papillary_carcinoma__urinary_tract___finding_(context);
			...
			CqlCode v_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Tis__Carcinoma_in_situ__flat_tumor_of_urinary_bladder___finding_(context);
			...
			CqlCode ab_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Carcinoma_in_situ_of_bladder(context);
	...
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		bool? c_(Encounter ValidEncounter)
		{
			CqlInterval<CqlDateTime> f_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
			...
			CqlCode l_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.@virtual(context);
	...
	{
		Procedure a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Qualifying_Bladder_Cancer_Staging_Procedure(context);
		bool? b_ = context.Operators.Not((bool?)(a_ is null));
		bool? c_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_Ta_HG__Tis__T1(context);
		bool? d_ = context.Operators.And(b_, c_);
		bool? e_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Has_Qualifying_Encounter(context);
	...
	{
		bool? a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("BCG Not Available Within 6 Months After Bladder Cancer Staging")]
	public static IEnumerable<MedicationAdministration> BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.BCG_Bacillus_Calmette_Guerin_for_Urology_Care(context);
		...
		{
			Procedure j_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] k_ = [
				j_,
			];
			bool? l_(Procedure FirstBladderCancerStaging)
			{
				...
				CqlInterval<CqlDateTime> at_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
		...
		bool? h_(MedicationAdministration BCGNotGiven)
		{
			...
			CqlValueSet bj_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Unavailability_of_Bacillus_Calmette_Guerin_for_urology_care(context);
	...
	public static bool? Denominator_Exception(CqlContext context)
	{
		IEnumerable<MedicationAdministration> a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging(context);
	...
	public static MedicationAdministration First_BCG_Administered(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.BCG_Bacillus_Calmette_Guerin_for_Urology_Care(context);
		IEnumerable<MedicationAdministration> b_ = context.Operators.RetrieveByValueSet<MedicationAdministration>(a_, default);
		IEnumerable<MedicationAdministration> d_ = context.Operators.RetrieveByValueSet<MedicationAdministration>(a_, default);
		...
		{
			Procedure m_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] n_ = [
				m_,
			];
			bool? o_(Procedure FirstBladderCancerStaging)
			{
				...
				CqlInterval<CqlDateTime> as_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Measurement_Period(context);
	...
	{
		MedicationAdministration a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_BCG_Administered(context);
		bool? b_ = context.Operators.Not((bool?)(a_ is null));
	...
	public static IEnumerable<Condition> Acute_Tuberculosis_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Active_Tuberculosis_for_Urology_Care(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		IEnumerable<Condition> c_(Condition ActiveTuberculosis)
		{
			Procedure g_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] h_ = [
				g_,
			];
		...
		{
			bool? r_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.isConfirmedActiveDiagnosis(context, ActiveTuberculosis);
	...
	public static IEnumerable<MedicationRequest> Immunosuppressive_Drugs(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Immunosuppressive_Drugs_for_Urology_Care(context);
		...
		{
			Procedure h_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] i_ = [
				h_,
			];
	...
	public static IEnumerable<Procedure> Cystectomy_Done(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Cystectomy_for_Urology_Care(context);
	...
	public static bool? Has_Excluding__HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.HIV(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Immunocompromised_Conditions(context);
		IEnumerable<Condition> d_ = context.Operators.RetrieveByValueSet<Condition>(c_, default);
		IEnumerable<Condition> e_ = context.Operators.Union<Condition>(b_, d_);
		CqlValueSet f_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Mixed_histology_urothelial_cell_carcinoma_for_Urology_Care(context);
		...
		{
			Procedure n_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] o_ = [
				n_,
			];
		...
		{
			bool? aa_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.isConfirmedActiveDiagnosis(context, ExclusionDiagnosis);
	...
	public static bool? Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging(CqlContext context)
	{
		CqlValueSet a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Chemotherapy_Agents_for_Advanced_Cancer(context);
		IEnumerable<MedicationRequest> b_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		IEnumerable<MedicationRequest> d_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		IEnumerable<MedicationRequest> e_ = context.Operators.Union<MedicationRequest>(b_, d_);
		IEnumerable<MedicationRequest> f_(MedicationRequest ExclusionMed)
		{
			Procedure s_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] t_ = [
				s_,
			];
		...
		CqlCode j_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Combined_radiotherapy__procedure_(context);
		...
		{
			Procedure bi_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.First_Bladder_Cancer_Staging_Procedure(context);
			Procedure[] bj_ = [
				bi_,
			];
	...
	{
		IEnumerable<Condition> a_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Acute_Tuberculosis_Diagnosis(context);
		bool? b_ = context.Operators.Exists<Condition>(a_);
		IEnumerable<MedicationRequest> c_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Immunosuppressive_Drugs(context);
		bool? d_ = context.Operators.Exists<MedicationRequest>(c_);
		bool? e_ = context.Operators.Or(b_, d_);
		IEnumerable<Procedure> f_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Cystectomy_Done(context);
		bool? g_ = context.Operators.Exists<Procedure>(f_);
		bool? h_ = context.Operators.Or(e_, g_);
		bool? i_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Has_Excluding__HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging(context);
		bool? j_ = context.Operators.Or(h_, i_);
		bool? k_ = IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000.Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging(context);
	...
	public static CqlInterval<CqlDateTime> NormalizePeriod(CqlContext context, CqlDateTime pointInTime, CqlInterval<CqlDateTime> dateTimeInterval)
	{
