...
public static partial class IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000ServiceCollectionExtensions
{
    ...
    {
        services.TryAddSingleton<IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000"]);
            return ActivatorUtilities.CreateInstance<IntravesicalBacillusCalmetteGuerinForBladderCancerFHIR_1_3_000>(sp);
        });
