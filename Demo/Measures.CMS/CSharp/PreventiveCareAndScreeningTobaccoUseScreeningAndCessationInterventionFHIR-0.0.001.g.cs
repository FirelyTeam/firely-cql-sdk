...
public class PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001
{
	...
	private IEnumerable<Encounter> Qualifying_Visit_During_Measurement_Period_Value()
	{
		...
		IEnumerable<Encounter> k_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, j_, default));
		...
		IEnumerable<Encounter> q_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, p_, default));
	...
	private IEnumerable<Encounter> Preventive_Visit_During_Measurement_Period_Value()
	{
		...
		IEnumerable<Encounter> h_ = context.Operators.Retrieve<Encounter>(default);
		bool? i_(Encounter E)
		{
	...
	private IEnumerable<object> Tobacco_Cessation_Counseling_Given_Value()
	{
		...
		IEnumerable<Condition> h_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, g_));
