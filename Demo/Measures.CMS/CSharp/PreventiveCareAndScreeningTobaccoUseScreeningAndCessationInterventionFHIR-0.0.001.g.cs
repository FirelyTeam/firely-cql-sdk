...
public static class PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001
{
	...
	public static CqlValueSet Limited_Life_Expectancy(CqlContext context) => 
	...
	public static CqlValueSet Nutrition_Services(CqlContext context) => 
	...
	public static CqlValueSet Speech_and_Hearing_Evaluation(CqlContext context) => 
	...
	public static CqlValueSet Tobacco_Non_User(CqlContext context) => 
	...
	public static CqlValueSet Tobacco_Use_Cessation_Counseling(CqlContext context) => 
	...
	public static CqlValueSet Tobacco_Use_Cessation_Pharmacotherapy(CqlContext context) => 
	...
	public static CqlValueSet Tobacco_Use_Screening(CqlContext context) => 
	...
	public static CqlValueSet Tobacco_User(CqlContext context) => 
	...
	public static CqlCode Health_behavior_assessment__or_re_assessment__ie__health_focused_clinical_interview__behavioral_observations__clinical_decision_making_(CqlContext context) => 
	...
	public static CqlCode Health_behavior_intervention__individual__face_to_face__initial_30_minutes(CqlContext context) => 
	...
	public static CqlCode Tobacco_abuse_counseling(CqlContext context) => 
	...
	public static IEnumerable<Encounter> Qualifying_Visit_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Home_Healthcare_Services(context);
		...
		bool? d_(Encounter E)
		{
			...
			{
				CqlCode ay_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Health_behavior_assessment__or_re_assessment__ie__health_focused_clinical_interview__behavioral_observations__clinical_decision_making_(context);
		...
		bool? h_(Encounter E)
		{
			...
			{
				CqlCode bi_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Health_behavior_intervention__individual__face_to_face__initial_30_minutes(context);
		...
		CqlValueSet j_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Occupational_Therapy_Evaluation(context);
		...
		CqlValueSet n_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Office_Visit(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		CqlValueSet p_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Ophthalmological_Services(context);
		...
		CqlValueSet t_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Physical_Therapy_Evaluation(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		CqlValueSet v_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Psych_Visit_Diagnostic_Evaluation(context);
		...
		CqlValueSet z_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Psych_Visit_Psychotherapy(context);
		IEnumerable<Encounter> aa_ = context.Operators.RetrieveByValueSet<Encounter>(z_, default);
		CqlValueSet ab_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Psychoanalysis(context);
		...
		CqlValueSet af_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Speech_and_Hearing_Evaluation(context);
		IEnumerable<Encounter> ag_ = context.Operators.RetrieveByValueSet<Encounter>(af_, default);
		CqlValueSet ah_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Telephone_Visits(context);
		...
		CqlValueSet al_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Online_Assessments(context);
		...
		{
			CqlInterval<CqlDateTime> bl_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
	...
	public static IEnumerable<Encounter> Preventive_Visit_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Preventive_Care_Services_Group_Counseling(context);
		...
		bool? i_(Encounter E)
		{
			...
			{
				CqlCode aj_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Unlisted_preventive_medicine_service(context);
		...
		CqlValueSet m_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Preventive_Care_Services_Individual_Counseling(context);
		...
		bool? p_(Encounter E)
		{
			...
			{
				CqlCode at_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Postoperative_follow_up_visit__normally_included_in_the_surgical_package__to_indicate_that_an_evaluation_and_management_service_was_performed_during_a_postoperative_period_for_a_reason_s__related_to_the_original_procedure(context);
		...
		CqlValueSet t_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Nutrition_Services(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		CqlValueSet v_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> w_ = context.Operators.RetrieveByValueSet<Encounter>(v_, default);
		IEnumerable<Encounter> x_ = context.Operators.Union<Encounter>(u_, w_);
		IEnumerable<Encounter> y_ = context.Operators.Union<Encounter>(s_, x_);
		...
		{
			CqlInterval<CqlDateTime> aw_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
	...
	{
		Patient a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
		CqlDateTime f_ = context.Operators.Start(e_);
		CqlDate g_ = context.Operators.DateFrom(f_);
		int? h_ = context.Operators.CalculateAgeAt(d_, g_, "year");
		bool? i_ = context.Operators.GreaterOrEqual(h_, 12);
		IEnumerable<Encounter> j_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Qualifying_Visit_During_Measurement_Period(context);
		int? k_ = context.Operators.Count<Encounter>(j_);
		bool? l_ = context.Operators.GreaterOrEqual(k_, 2);
		IEnumerable<Encounter> m_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Preventive_Visit_During_Measurement_Period(context);
	...
	{
		bool? a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Most Recent Tobacco Use Screening Indicates Tobacco User")]
	public static Observation Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_User(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Use_Screening(context);
		...
		{
			CqlInterval<CqlDateTime> m_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
		...
		bool? j_(Observation MostRecentTobaccoUseScreening)
		{
			...
			CqlValueSet x_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_User(context);
	...
	{
		bool? a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Initial_Population(context);
		Observation b_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_User(context);
	...
	public static Observation Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_Non_User(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Use_Screening(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		IEnumerable<Observation> c_ = Status_1_6_000.isAssessmentPerformed(context, b_);
		...
		bool? j_(Observation MostRecentTobaccoUseScreening)
		{
			DataType v_ = MostRecentTobaccoUseScreening?.Value;
			object w_ = FHIRHelpers_4_3_000.ToValue(context, v_);
			CqlValueSet x_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Non_User(context);
			bool? y_ = context.Operators.ConceptInValueSet(w_ as CqlConcept, x_);
	...
	{
		Observation a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_Non_User(context);
		bool? b_ = context.Operators.Not((bool?)(a_ is null));
		Observation c_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_User(context);
	...
	public static IEnumerable<object> Tobacco_Cessation_Counseling_Given(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Use_Cessation_Counseling(context);
		...
		{
			CqlInterval<CqlDateTime> l_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
		...
		CqlCode f_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_abuse_counseling(context);
		...
		bool? i_(Condition TobaccoCounseling)
		{
			...
			CqlInterval<CqlDateTime> y_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
	...
	public static IEnumerable<MedicationRequest> Tobacco_Cessation_Pharmacotherapy_Ordered(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Use_Cessation_Pharmacotherapy(context);
		...
		bool? g_(MedicationRequest CessationPharmacotherapyOrdered)
		{
			...
			CqlInterval<CqlDateTime> k_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Measurement_Period(context);
	...
	public static IEnumerable<MedicationRequest> Active_Pharmacotherapy_for_Tobacco_Cessation(CqlContext context)
	{
		CqlValueSet a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Use_Cessation_Pharmacotherapy(context);
		IEnumerable<MedicationRequest> b_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		IEnumerable<MedicationRequest> d_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
	...
	{
		IEnumerable<object> a_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Cessation_Counseling_Given(context);
		bool? b_ = context.Operators.Exists<object>(a_);
		IEnumerable<MedicationRequest> c_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Cessation_Pharmacotherapy_Ordered(context);
		bool? d_ = context.Operators.Exists<MedicationRequest>(c_);
		bool? e_ = context.Operators.Or(b_, d_);
		IEnumerable<MedicationRequest> f_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Active_Pharmacotherapy_for_Tobacco_Cessation(context);
	...
	public static bool? Numerator_3(CqlContext context)
	{
		...
		Observation c_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Most_Recent_Tobacco_Use_Screening_Indicates_Tobacco_User(context);
		bool? d_ = context.Operators.Not((bool?)(c_ is null));
		IEnumerable<object> e_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Cessation_Counseling_Given(context);
		bool? f_ = context.Operators.Exists<object>(e_);
		IEnumerable<MedicationRequest> g_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Tobacco_Cessation_Pharmacotherapy_Ordered(context);
		bool? h_ = context.Operators.Exists<MedicationRequest>(g_);
		bool? i_ = context.Operators.Or(f_, h_);
		IEnumerable<MedicationRequest> j_ = PreventiveCareAndScreeningTobaccoUseScreeningAndCessationInterventionFHIR_0_0_001.Active_Pharmacotherapy_for_Tobacco_Cessation(context);
