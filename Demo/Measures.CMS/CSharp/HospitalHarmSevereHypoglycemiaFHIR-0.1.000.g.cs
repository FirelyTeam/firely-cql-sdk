...
public static class HospitalHarmSevereHypoglycemiaFHIR_0_1_000
{
	...
	public static CqlValueSet Glucose_Lab_Test_Mass_Per_Volume(CqlContext context) => 
	...
	{
		CqlValueSet a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Encounter_Inpatient(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		bool? c_(Encounter InpatientEncounter)
		{
			Patient e_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Patient(context);
			...
			CqlInterval<CqlDateTime> r_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Measurement_Period(context);
	...
	{
		CqlValueSet a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Hypoglycemics_Severe_Hypoglycemia(context);
	...
	public static IEnumerable<Encounter> Encounter_with_Hypoglycemic_Medication_Administration(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Qualifying_Encounter(context);
		IEnumerable<Encounter> b_(Encounter InpatientHospitalization)
		{
			IEnumerable<MedicationAdministration> d_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Hypoglycemic_Medication_Administration(context);
	...
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Encounter_with_Hypoglycemic_Medication_Administration(context);
	...
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Glucose Test with Result Less Than 40")]
	public static IEnumerable<Observation> Glucose_Test_with_Result_Less_Than_40(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Denominator(context);
		IEnumerable<MedicationAdministration> b_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Hypoglycemic_Medication_Administration(context);
		CqlValueSet c_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Glucose_Lab_Test_Mass_Per_Volume(context);
	...
	public static IEnumerable<Observation> Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Denominator(context);
		IEnumerable<Observation> b_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Glucose_Test_with_Result_Less_Than_40(context);
		CqlValueSet c_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Glucose_Lab_Test_Mass_Per_Volume(context);
		IEnumerable<Observation> d_ = context.Operators.RetrieveByValueSet<Observation>(c_, default);
	...
	public static IEnumerable<Observation> Severe_Hypoglycemic_Harm_Event(CqlContext context)
	{
		IEnumerable<Observation> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Glucose_Test_with_Result_Less_Than_40(context);
		bool? b_(Observation LowGlucoseTest)
		{
			Id d_ = LowGlucoseTest?.IdElement;
			string e_ = d_?.Value;
			IEnumerable<Observation> f_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80(context);
	...
	public static IEnumerable<Encounter> Encounter_with_Severe_Hypoglycemic_Harm_Event(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Denominator(context);
		IEnumerable<Observation> b_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Severe_Hypoglycemic_Harm_Event(context);
	...
	{
		IEnumerable<Encounter> a_ = HospitalHarmSevereHypoglycemiaFHIR_0_1_000.Encounter_with_Severe_Hypoglycemic_Harm_Event(context);
