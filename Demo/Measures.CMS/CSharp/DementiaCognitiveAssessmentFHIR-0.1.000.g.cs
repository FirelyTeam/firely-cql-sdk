...
public partial class DementiaCognitiveAssessmentFHIR_minus_0_1_000 : ILibrary, ISingleton<DementiaCognitiveAssessmentFHIR_minus_0_1_000>
{
    private DementiaCognitiveAssessmentFHIR_minus_0_1_000() {}

    public static DementiaCognitiveAssessmentFHIR_minus_0_1_000 Instance { get; } = new();
    ...
    public IEnumerable<Encounter> Encounter_to_Assess_Cognition(CqlContext context)
    {
        ...
        CqlValueSet n_ = this.Behavioral_Neuropsych_Assessment(context);
    ...
    public IEnumerable<Encounter> Dementia_Encounter_During_Measurement_Period(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter EncounterAssessCognition)
        {
            ...
            bool? f_(Condition Dementia)
            {
                ...
                CqlInterval<CqlDateTime> n_ = QICoreCommon_minus_2_1_000.Instance.prevalenceInterval(context, Dementia);
                CqlInterval<CqlDateTime> p_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, k_);
                bool? q_ = context.Operators.Overlaps(n_, p_, "day");
                bool? r_ = context.Operators.And(m_, q_);
                bool? s_ = QICoreCommon_minus_2_1_000.Instance.isActive(context, Dementia);
                ...
                CqlCode w_ = QICoreCommon_minus_2_1_000.Instance.unconfirmed(context);
                CqlConcept x_ = context.Operators.ConvertCodeToConcept(w_);
                bool? y_ = context.Operators.Equivalent(v_, x_);
                CqlConcept aa_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, u_);
                CqlCode ab_ = QICoreCommon_minus_2_1_000.Instance.refuted(context);
                ...
                CqlConcept ag_ = FHIRHelpers_minus_4_4_000.Instance.ToConcept(context, u_);
                CqlCode ah_ = QICoreCommon_minus_2_1_000.Instance.entered_minus_in_minus_error(context);
    ...
    {
        CqlValueSet a_ = this.Standardized_Tools_Score_for_Assessment_of_Cognition(context);
        ...
        IEnumerable<Observation> f_(Observation CognitiveAssessment)
        {
            ...
            bool? k_(Encounter EncounterDementia)
            {
                ...
                CqlInterval<CqlDateTime> y_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, s_);
                ...
                CqlInterval<CqlDateTime> ad_ = FHIRHelpers_minus_4_4_000.Instance.ToInterval(context, s_);
