...
public static class KidneyHealthEvaluationFHIR_0_1_000
{
	...
	public static CqlValueSet Chronic_Kidney_Disease__Stage_5(CqlContext context) => 
	...
	public static CqlValueSet Estimated_Glomerular_Filtration_Rate(CqlContext context) => 
	...
	public static CqlValueSet Urine_Albumin_Creatinine_Ratio(CqlContext context) => 
	...
	public static bool? Has_Active_Diabetes_Overlaps_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = KidneyHealthEvaluationFHIR_0_1_000.Diabetes(context);
		...
		bool? c_(Condition Diabetes)
		{
			...
			CqlInterval<CqlDateTime> g_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
			...
			CqlCode k_ = KidneyHealthEvaluationFHIR_0_1_000.active(context);
	...
	public static bool? Has_Outpatient_Visit_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = KidneyHealthEvaluationFHIR_0_1_000.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = KidneyHealthEvaluationFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = KidneyHealthEvaluationFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = KidneyHealthEvaluationFHIR_0_1_000.Outpatient_Consultation(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = KidneyHealthEvaluationFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = KidneyHealthEvaluationFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = KidneyHealthEvaluationFHIR_0_1_000.Telephone_Visits(context);
		...
		{
			CqlInterval<CqlDateTime> x_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
	...
	{
		Patient a_ = KidneyHealthEvaluationFHIR_0_1_000.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
		CqlDateTime f_ = context.Operators.Start(e_);
		CqlDate g_ = context.Operators.DateFrom(f_);
		int? h_ = context.Operators.CalculateAgeAt(d_, g_, "year");
		CqlInterval<int?> i_ = context.Operators.Interval(18, 85, true, true);
		bool? j_ = context.Operators.In<int?>(h_, i_, default);
		bool? k_ = KidneyHealthEvaluationFHIR_0_1_000.Has_Active_Diabetes_Overlaps_Measurement_Period(context);
		bool? l_ = context.Operators.And(j_, k_);
		bool? m_ = KidneyHealthEvaluationFHIR_0_1_000.Has_Outpatient_Visit_During_Measurement_Period(context);
	...
	{
		bool? a_ = KidneyHealthEvaluationFHIR_0_1_000.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Has CKD Stage 5 or ESRD Diagnosis Overlaps Measurement Period")]
	public static IEnumerable<Condition> Has_CKD_Stage_5_or_ESRD_Diagnosis_Overlaps_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = KidneyHealthEvaluationFHIR_0_1_000.Chronic_Kidney_Disease__Stage_5(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = KidneyHealthEvaluationFHIR_0_1_000.End_Stage_Renal_Disease(context);
		...
		bool? f_(Condition CKDOrESRD)
		{
			...
			CqlInterval<CqlDateTime> i_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
			...
			CqlCode m_ = KidneyHealthEvaluationFHIR_0_1_000.active(context);
	...
	{
		IEnumerable<Condition> a_ = KidneyHealthEvaluationFHIR_0_1_000.Has_CKD_Stage_5_or_ESRD_Diagnosis_Overlaps_Measurement_Period(context);
	...
	public static bool? Has_Kidney_Panel_Performed_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = KidneyHealthEvaluationFHIR_0_1_000.Estimated_Glomerular_Filtration_Rate(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		bool? c_(Observation eGFRTest)
		{
			CqlInterval<CqlDateTime> l_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
		...
		CqlValueSet f_ = KidneyHealthEvaluationFHIR_0_1_000.Urine_Albumin_Creatinine_Ratio(context);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByValueSet<Observation>(f_, default);
		bool? h_(Observation uACRTest)
		{
			CqlInterval<CqlDateTime> ab_ = KidneyHealthEvaluationFHIR_0_1_000.Measurement_Period(context);
	...
	{
		bool? a_ = KidneyHealthEvaluationFHIR_0_1_000.Has_Kidney_Panel_Performed_During_Measurement_Period(context);
