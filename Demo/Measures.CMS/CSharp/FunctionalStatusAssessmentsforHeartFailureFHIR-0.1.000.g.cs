...
public class FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000
{
	...
	private bool? Initial_Population_Value()
	{
		...
		IEnumerable<Condition> k_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, j_, default));
	...
	private bool? Denominator_Exclusions_Value()
	{
		...
		IEnumerable<Condition> d_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, c_));
	...
	private IEnumerable<CqlDate> Date_PROMIS29_Total_Assessment_Completed_Value()
	{
		...
		IEnumerable<Observation> w_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, v_));
		...
		IEnumerable<Observation> aa_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, z_));
