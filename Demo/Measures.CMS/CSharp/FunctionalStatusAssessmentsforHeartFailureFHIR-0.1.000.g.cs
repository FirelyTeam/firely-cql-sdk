...
public static class FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000
{

    [CqlDeclaration("Heart Failure")]
    [CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.376")]
	public static CqlValueSet Heart_Failure(CqlContext context) => 
	...
	public static CqlCode Emotional_score__MLHFQ_(CqlContext context) => 
	...
	public static CqlCode Kansas_City_Cardiomyopathy_Questionnaire___12_item__KCCQ_12_(CqlContext context) => 
		new CqlCode("86923-0", "http://loinc.org", default, default);

    [CqlDeclaration("Overall summary score [KCCQ-12]")]
	public static CqlCode Overall_summary_score__KCCQ_12_(CqlContext context) => 
		new CqlCode("86924-8", "http://loinc.org", default, default);

    [CqlDeclaration("Overall summary score [KCCQ]")]
	public static CqlCode Overall_summary_score__KCCQ_(CqlContext context) => 
		new CqlCode("71940-1", "http://loinc.org", default, default);

    [CqlDeclaration("Physical limitation score [KCCQ]")]
	public static CqlCode Physical_limitation_score__KCCQ_(CqlContext context) => 
		new CqlCode("72195-1", "http://loinc.org", default, default);

    [CqlDeclaration("Physical score [MLHFQ]")]
	public static CqlCode Physical_score__MLHFQ_(CqlContext context) => 
	...
	public static CqlCode PROMIS_29_Satisfaction_with_participation_in_social_roles_score_T_score(CqlContext context) => 
		new CqlCode("71957-5", "http://loinc.org", default, default);

    [CqlDeclaration("PROMIS-29 Sleep disturbance score T-score")]
	public static CqlCode PROMIS_29_Sleep_disturbance_score_T_score(CqlContext context) => 
		new CqlCode("71955-9", "http://loinc.org", default, default);

    [CqlDeclaration("Quality of life score [KCCQ]")]
	public static CqlCode Quality_of_life_score__KCCQ_(CqlContext context) => 
		new CqlCode("72189-4", "http://loinc.org", default, default);

    [CqlDeclaration("Self-efficacy score [KCCQ]")]
	public static CqlCode Self_efficacy_score__KCCQ_(CqlContext context) => 
	...
	public static CqlCode Social_limitation_score__KCCQ_(CqlContext context) => 
		new CqlCode("72196-9", "http://loinc.org", default, default);

    [CqlDeclaration("Symptom stability score [KCCQ]")]
	public static CqlCode Symptom_stability_score__KCCQ_(CqlContext context) => 
		new CqlCode("72194-4", "http://loinc.org", default, default);

    [CqlDeclaration("Total score [MLHFQ]")]
	public static CqlCode Total_score__MLHFQ_(CqlContext context) => 
		new CqlCode("71938-5", "http://loinc.org", default, default);

    [CqlDeclaration("Total symptom score [KCCQ]")]
	public static CqlCode Total_symptom_score__KCCQ_(CqlContext context) => 
	...
	public static CqlCode VR_36_Mental_component_summary__MCS__score___oblique_method_T_score(CqlContext context) => 
	...
	public static CqlCode VR_36_Mental_component_summary__MCS__score___orthogonal_method_T_score(CqlContext context) => 
	...
	public static CqlCode VR_36_Physical_component_summary__PCS__score___oblique_method_T_score(CqlContext context) => 
	...
	public static CqlCode VR_36_Physical_component_summary__PCS__score___orthogonal_method_T_score(CqlContext context) => 
	...
	{
		CqlValueSet a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Telephone_Visits(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Online_Assessments(context);
		...
		{
			CqlInterval<CqlDateTime> l_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Measurement_Period(context);
	...
	public static IEnumerable<Encounter> Two_Outpatient_Encounters_during_Measurement_Period(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
	...
	{
		Patient a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Measurement_Period(context);
		CqlDateTime f_ = context.Operators.Start(e_);
		CqlDate g_ = context.Operators.DateFrom(f_);
		int? h_ = context.Operators.CalculateAgeAt(d_, g_, "year");
		bool? i_ = context.Operators.GreaterOrEqual(h_, 18);
		CqlValueSet j_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Heart_Failure(context);
		...
		bool? l_(Condition HeartFailure)
		{
			...
			CqlInterval<CqlDateTime> t_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Measurement_Period(context);
		...
		IEnumerable<Encounter> p_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Two_Outpatient_Encounters_during_Measurement_Period(context);
	...
	{
		bool? a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Initial_Population(context);
	...
	public static bool? Denominator_Exclusions(CqlContext context)
	{
		...
		CqlCode b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Severe_cognitive_impairment__finding_(context);
		...
		bool? e_(Condition Dementia)
		{
			...
			CqlInterval<CqlDateTime> j_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Measurement_Period(context);
	...
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_10_Global_Mental_Health__GMH__score_T_score(context);
		...
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_10_Global_Physical_Health__GPH__score_T_score(context);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_PROMIS10_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_PROMIS10_Total_Assessment_Completed(context);
		...
		bool? g_((Encounter ValidEncounters, CqlDate InitialPROMIS10Date, CqlDate FollowupPROMIS10Date)? tuple_dzhwgxhmbfavmzfaszbeksohj)
		{
			...
			CqlInterval<CqlDateTime> q_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Measurement_Period(context);
			CqlDateTime r_ = context.Operators.End(q_);
	...
	public static IEnumerable<CqlDate> Date_PROMIS29_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Sleep_disturbance_score_T_score(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Satisfaction_with_participation_in_social_roles_score_T_score(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		CqlCode i_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Physical_function_score_T_score(context);
		...
		CqlCode m_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Pain_interference_score_T_score(context);
		...
		CqlCode q_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Fatigue_score_T_score(context);
		...
		CqlCode u_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Depression_score_T_score(context);
		...
		CqlCode y_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.PROMIS_29_Anxiety_score_T_score(context);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_PROMIS29_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_PROMIS29_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_12_Mental_component_summary__MCS__score___oblique_method_T_score(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_12_Physical_component_summary__PCS__score___oblique_method_T_score(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_VR12_Oblique_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_VR12_Oblique_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_12_Mental_component_summary__MCS__score___orthogonal_method_T_score(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_12_Physical_component_summary__PCS__score___orthogonal_method_T_score(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_VR12_Orthogonal_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_VR36_Oblique_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_36_Mental_component_summary__MCS__score___oblique_method_T_score(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_36_Physical_component_summary__PCS__score___oblique_method_T_score(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_VR36_Oblique_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_VR36_Oblique_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_VR36_Orthogonal_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_36_Mental_component_summary__MCS__score___orthogonal_method_T_score(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.VR_36_Physical_component_summary__PCS__score___orthogonal_method_T_score(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_VR36_Orthogonal_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_VR36_Orthogonal_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_MLHFQ_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Physical_score__MLHFQ_(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Emotional_score__MLHFQ_(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_MLHFQ_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_MLHFQ_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_KCCQ12_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Kansas_City_Cardiomyopathy_Questionnaire___12_item__KCCQ_12_(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Overall_summary_score__KCCQ_12_(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		IEnumerable<ValueTuple<Observation, Observation>> i_ = context.Operators.CrossJoin<Observation, Observation>(d_, h_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ12_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_KCCQ12_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_KCCQ_Domain_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Quality_of_life_score__KCCQ_(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
		CqlCode e_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Symptom_stability_score__KCCQ_(context);
		IEnumerable<CqlCode> f_ = context.Operators.ToList<CqlCode>(e_);
		IEnumerable<Observation> g_ = context.Operators.RetrieveByCodes<Observation>(f_, default);
		IEnumerable<Observation> h_ = Status_1_6_000.Final_Survey_Observation(context, g_);
		CqlCode i_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Self_efficacy_score__KCCQ_(context);
		IEnumerable<CqlCode> j_ = context.Operators.ToList<CqlCode>(i_);
		IEnumerable<Observation> k_ = context.Operators.RetrieveByCodes<Observation>(j_, default);
		IEnumerable<Observation> l_ = Status_1_6_000.Final_Survey_Observation(context, k_);
		CqlCode m_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Total_symptom_score__KCCQ_(context);
		IEnumerable<CqlCode> n_ = context.Operators.ToList<CqlCode>(m_);
		IEnumerable<Observation> o_ = context.Operators.RetrieveByCodes<Observation>(n_, default);
		IEnumerable<Observation> p_ = Status_1_6_000.Final_Survey_Observation(context, o_);
		CqlCode q_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Physical_limitation_score__KCCQ_(context);
		IEnumerable<CqlCode> r_ = context.Operators.ToList<CqlCode>(q_);
		IEnumerable<Observation> s_ = context.Operators.RetrieveByCodes<Observation>(r_, default);
		IEnumerable<Observation> t_ = Status_1_6_000.Final_Survey_Observation(context, s_);
		CqlCode u_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Social_limitation_score__KCCQ_(context);
		IEnumerable<CqlCode> v_ = context.Operators.ToList<CqlCode>(u_);
		IEnumerable<Observation> w_ = context.Operators.RetrieveByCodes<Observation>(v_, default);
		IEnumerable<Observation> x_ = Status_1_6_000.Final_Survey_Observation(context, w_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Domain_Score_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_KCCQ_Domain_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	public static IEnumerable<CqlDate> Date_KCCQ_Total_Assessment_Completed(CqlContext context)
	{
		CqlCode a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Overall_summary_score__KCCQ_(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<Observation> d_ = Status_1_6_000.Final_Survey_Observation(context, c_);
	...
	public static bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Total_Score_Assessments(CqlContext context)
	{
		IEnumerable<Encounter> a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Qualifying_Encounters(context);
		IEnumerable<CqlDate> b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Date_KCCQ_Total_Assessment_Completed(context);
		IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>> d_ = context.Operators.CrossJoin<Encounter, CqlDate, CqlDate>(a_, b_, b_);
	...
	{
		bool? a_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_PROMIS10_Assessments(context);
		bool? b_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_PROMIS29_Assessments(context);
		bool? c_ = context.Operators.Or(a_, b_);
		bool? d_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_VR12_Oblique_Assessments(context);
		bool? e_ = context.Operators.Or(c_, d_);
		bool? f_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments(context);
		bool? g_ = context.Operators.Or(e_, f_);
		bool? h_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_VR36_Oblique_Assessments(context);
		bool? i_ = context.Operators.Or(g_, h_);
		bool? j_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_VR36_Orthogonal_Assessments(context);
		bool? k_ = context.Operators.Or(i_, j_);
		bool? l_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_MLHFQ_Assessments(context);
		bool? m_ = context.Operators.Or(k_, l_);
		bool? n_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_KCCQ12_Assessments(context);
		bool? o_ = context.Operators.Or(m_, n_);
		bool? p_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Domain_Score_Assessments(context);
		bool? q_ = context.Operators.Or(o_, p_);
		bool? r_ = FunctionalStatusAssessmentsforHeartFailureFHIR_0_1_000.Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Total_Score_Assessments(context);
