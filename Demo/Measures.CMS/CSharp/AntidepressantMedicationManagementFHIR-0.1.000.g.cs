...
public static class AntidepressantMedicationManagementFHIR_0_1_000
{
	...
	public static CqlValueSet Antidepressant_Medication(CqlContext context) => 
	...
	public static CqlValueSet Major_Depression(CqlContext context) => 
	...
	public static CqlDateTime April_30_of_the_Measurement_Period(CqlContext context)
	{
		CqlInterval<CqlDateTime> a_ = AntidepressantMedicationManagementFHIR_0_1_000.Measurement_Period(context);
	...
	public static CqlDateTime May_1_of_the_Year_Prior_to_the_Measurement_Period(CqlContext context)
	{
		CqlInterval<CqlDateTime> a_ = AntidepressantMedicationManagementFHIR_0_1_000.Measurement_Period(context);
		CqlDateTime b_ = context.Operators.Start(a_);
		int? c_ = context.Operators.DateTimeComponentFrom(b_, "year");
	...
	{
		CqlDateTime a_ = AntidepressantMedicationManagementFHIR_0_1_000.May_1_of_the_Year_Prior_to_the_Measurement_Period(context);
		CqlDateTime b_ = AntidepressantMedicationManagementFHIR_0_1_000.April_30_of_the_Measurement_Period(context);
	...
	public static CqlDate Earliest_Antidepressant_Dispensed_During_Intake_Period(CqlContext context)
	{
		CqlValueSet a_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication(context);
		...
		bool? g_(MedicationDispense Antidepressant)
		{
			...
			CqlInterval<CqlDateTime> r_ = AntidepressantMedicationManagementFHIR_0_1_000.Intake_Period(context);
	...
	public static bool? Has_Initial_Major_Depression_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = AntidepressantMedicationManagementFHIR_0_1_000.Major_Depression(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		bool? c_(Condition MajorDepression)
		{
			CqlDate f_ = AntidepressantMedicationManagementFHIR_0_1_000.Earliest_Antidepressant_Dispensed_During_Intake_Period(context);
	...
	{
		CqlValueSet a_ = AntidepressantMedicationManagementFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = AntidepressantMedicationManagementFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = AntidepressantMedicationManagementFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = AntidepressantMedicationManagementFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = AntidepressantMedicationManagementFHIR_0_1_000.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = AntidepressantMedicationManagementFHIR_0_1_000.Nursing_Facility_Visit(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = AntidepressantMedicationManagementFHIR_0_1_000.Psych_Visit_Diagnostic_Evaluation(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = AntidepressantMedicationManagementFHIR_0_1_000.Psych_Visit_Psychotherapy(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		IEnumerable<Encounter> v_ = context.Operators.Union<Encounter>(s_, u_);
		IEnumerable<Encounter> w_ = context.Operators.Union<Encounter>(q_, v_);
		CqlValueSet x_ = AntidepressantMedicationManagementFHIR_0_1_000.Telephone_Visits(context);
		IEnumerable<Encounter> y_ = context.Operators.RetrieveByValueSet<Encounter>(x_, default);
		CqlValueSet z_ = AntidepressantMedicationManagementFHIR_0_1_000.Online_Assessments(context);
		...
		bool? ad_(Encounter ValidEncounter)
		{
			...
			CqlDate ak_ = AntidepressantMedicationManagementFHIR_0_1_000.Earliest_Antidepressant_Dispensed_During_Intake_Period(context);
	...
	{
		Patient a_ = AntidepressantMedicationManagementFHIR_0_1_000.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlDateTime e_ = AntidepressantMedicationManagementFHIR_0_1_000.April_30_of_the_Measurement_Period(context);
		...
		bool? i_ = AntidepressantMedicationManagementFHIR_0_1_000.Has_Initial_Major_Depression_Diagnosis(context);
		bool? j_ = context.Operators.And(h_, i_);
		IEnumerable<Encounter> k_ = AntidepressantMedicationManagementFHIR_0_1_000.Qualifying_Encounters(context);
	...
	{
		bool? a_ = AntidepressantMedicationManagementFHIR_0_1_000.Initial_Population(context);
	...
	public static bool? Denominator_Exclusions(CqlContext context)
	{
		...
		CqlValueSet b_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication(context);
		...
		{
			CqlDate l_ = AntidepressantMedicationManagementFHIR_0_1_000.Earliest_Antidepressant_Dispensed_During_Intake_Period(context);
			...
			{
				CqlInterval<CqlDateTime> af_ = AntidepressantMedicationManagementFHIR_0_1_000.Intake_Period(context);
				CqlDateTime ag_ = context.Operators.Start(af_);
				CqlInterval<CqlDateTime> ah_ = AntidepressantMedicationManagementFHIR_0_1_000.Measurement_Period(context);
	...
	public static IEnumerable<CqlInterval<CqlDate>> Antidepressant_Medication_Period_Between_IPSD_and_114_Days_After_IPSD(CqlContext context)
	{
		CqlValueSet a_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication(context);
		IEnumerable<MedicationDispense> b_ = context.Operators.RetrieveByValueSet<MedicationDispense>(a_, default);
		IEnumerable<MedicationDispense> d_ = context.Operators.RetrieveByValueSet<MedicationDispense>(a_, default);
		...
		CqlInterval<CqlDate> g_(MedicationDispense Antidepressant)
		{
			...
			CqlDate j_ = AntidepressantMedicationManagementFHIR_0_1_000.Earliest_Antidepressant_Dispensed_During_Intake_Period(context);
	...
	public static bool? Cumulative_Medication_Duration_Greater_Than_or_Equal_to_84_Days(CqlContext context)
	{
		IEnumerable<CqlInterval<CqlDate>> a_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication_Period_Between_IPSD_and_114_Days_After_IPSD(context);
	...
	{
		bool? a_ = AntidepressantMedicationManagementFHIR_0_1_000.Cumulative_Medication_Duration_Greater_Than_or_Equal_to_84_Days(context);

		return a_;
	}

    [CqlDeclaration("Antidepressant Medication Period Between IPSD and 231 Days After IPSD")]
	public static IEnumerable<CqlInterval<CqlDate>> Antidepressant_Medication_Period_Between_IPSD_and_231_Days_After_IPSD(CqlContext context)
	{
		CqlValueSet a_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication(context);
		IEnumerable<MedicationDispense> b_ = context.Operators.RetrieveByValueSet<MedicationDispense>(a_, default);
		IEnumerable<MedicationDispense> d_ = context.Operators.RetrieveByValueSet<MedicationDispense>(a_, default);
	...
	public static bool? Cumulative_Medication_Duration_Greater_Than_or_Equal_to_180_Days(CqlContext context)
	{
		IEnumerable<CqlInterval<CqlDate>> a_ = AntidepressantMedicationManagementFHIR_0_1_000.Antidepressant_Medication_Period_Between_IPSD_and_231_Days_After_IPSD(context);
		int? b_ = CumulativeMedicationDuration_4_0_000.CumulativeDuration(context, a_);
	...
	{
		bool? a_ = AntidepressantMedicationManagementFHIR_0_1_000.Cumulative_Medication_Duration_Greater_Than_or_Equal_to_180_Days(context);
