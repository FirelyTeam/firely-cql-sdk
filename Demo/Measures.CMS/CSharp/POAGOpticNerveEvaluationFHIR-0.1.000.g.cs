...
public static partial class POAGOpticNerveEvaluationFHIR_0_1_000ServiceCollectionExtensions
{
    public static IServiceCollection AddPOAGOpticNerveEvaluationFHIR_0_1_000(this IServiceCollection services)
    {
        services.TryAddSingleton<POAGOpticNerveEvaluationFHIR_0_1_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["POAGOpticNerveEvaluationFHIR_0_1_000"]);
            return ActivatorUtilities.CreateInstance<POAGOpticNerveEvaluationFHIR_0_1_000>(sp);
        });
...
public partial class POAGOpticNerveEvaluationFHIR_0_1_000(
