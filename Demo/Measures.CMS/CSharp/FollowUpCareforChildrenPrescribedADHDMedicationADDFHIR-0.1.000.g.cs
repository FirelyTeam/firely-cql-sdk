...
public class FollowUpCareforChildrenPrescribedADHDMedicationADDFHIR_0_1_000
{
	...
	private IEnumerable<(CqlDate startDate, nint _)?> ADHD_Medication_Prescribed_During_Intake_Period_and_Not_Previously_on_ADHD_Medication_Value()
	{
		...
		IEnumerable<MedicationRequest> g_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
		IEnumerable<MedicationRequest> i_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
		...
		IEnumerable<MedicationRequest> m_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, l_, default));
		IEnumerable<MedicationRequest> o_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, l_, default));
		...
		IEnumerable<MedicationRequest> s_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, r_, default));
		IEnumerable<MedicationRequest> u_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, r_, default));
		...
		IEnumerable<MedicationRequest> y_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, x_, default));
		IEnumerable<MedicationRequest> aa_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, x_, default));
		...
		IEnumerable<MedicationRequest> af_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, ae_));
		IEnumerable<CqlCode> ah_ = context.Operators.ToList<CqlCode>(ad_);
		IEnumerable<MedicationRequest> ai_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, ah_));
		...
		IEnumerable<MedicationRequest> am_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, al_, default));
		IEnumerable<MedicationRequest> ao_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, al_, default));
		...
		IEnumerable<MedicationRequest> as_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ar_, default));
		IEnumerable<MedicationRequest> au_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ar_, default));
		...
		IEnumerable<MedicationRequest> ba_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, a_, default));
		IEnumerable<MedicationRequest> bc_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, a_, default));
		IEnumerable<MedicationRequest> bd_ = context.Operators.Union<MedicationRequest>(ba_, bc_);
		IEnumerable<MedicationRequest> bf_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
		IEnumerable<MedicationRequest> bh_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
		...
		IEnumerable<MedicationRequest> bl_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, l_, default));
		IEnumerable<MedicationRequest> bn_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, l_, default));
		...
		IEnumerable<MedicationRequest> br_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, r_, default));
		IEnumerable<MedicationRequest> bt_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, r_, default));
		...
		IEnumerable<MedicationRequest> bx_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, x_, default));
		IEnumerable<MedicationRequest> bz_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, x_, default));
		...
		IEnumerable<MedicationRequest> ce_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, cd_));
		IEnumerable<CqlCode> cg_ = context.Operators.ToList<CqlCode>(ad_);
		IEnumerable<MedicationRequest> ch_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, cg_));
		...
		IEnumerable<MedicationRequest> cl_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, al_, default));
		IEnumerable<MedicationRequest> cn_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, al_, default));
		...
		IEnumerable<MedicationRequest> cr_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ar_, default));
		IEnumerable<MedicationRequest> ct_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ar_, default));
		...
		IEnumerable<MedicationRequest> cy_(MedicationRequest ADHDMedicationOrder)
		{
			...
			IEnumerable<MedicationRequest> dq_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, dp_, default));
			IEnumerable<MedicationRequest> ds_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, dp_, default));
			IEnumerable<MedicationRequest> dt_ = context.Operators.Union<MedicationRequest>(dq_, ds_);
			CqlValueSet du_ = this.Clonidine();
			IEnumerable<MedicationRequest> dv_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, du_, default));
			IEnumerable<MedicationRequest> dx_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, du_, default));
			...
			IEnumerable<MedicationRequest> eb_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ea_, default));
			IEnumerable<MedicationRequest> ed_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ea_, default));
			...
			IEnumerable<MedicationRequest> eh_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, eg_, default));
			IEnumerable<MedicationRequest> ej_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, eg_, default));
			...
			IEnumerable<MedicationRequest> en_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, em_, default));
			IEnumerable<MedicationRequest> ep_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, em_, default));
			...
			IEnumerable<MedicationRequest> eu_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, et_));
			IEnumerable<CqlCode> ew_ = context.Operators.ToList<CqlCode>(es_);
			IEnumerable<MedicationRequest> ex_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, ew_));
			...
			IEnumerable<MedicationRequest> fb_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, fa_, default));
			IEnumerable<MedicationRequest> fd_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, fa_, default));
			...
			IEnumerable<MedicationRequest> fh_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, fg_, default));
			IEnumerable<MedicationRequest> fj_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, fg_, default));
	...
	public IEnumerable<Condition> PrincipalDiagnosis(Encounter Encounter)
	{
		...
		{
			IEnumerable<Condition> i_ = context.Operators.Retrieve<Condition>(default);
			bool? j_(Condition C)
			{
				Id m_ = C?.IdElement;
				string n_ = m_?.Value;
	...
	private IEnumerable<Encounter> Qualifying_Numerator_Encounter_Value()
	{
		...
		IEnumerable<Encounter> u_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, t_, default));
		CqlValueSet v_ = this.Home_Healthcare_Services();
		IEnumerable<Encounter> w_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, v_, default));
		...
		IEnumerable<Encounter> aa_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, z_, default));
		CqlValueSet ab_ = this.Preventive_Care__Established_Office_Visit__0_to_17();
		IEnumerable<Encounter> ac_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ab_, default));
		...
		IEnumerable<Encounter> ag_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, af_, default));
		CqlValueSet ah_ = this.Psych_Visit_Psychotherapy();
		IEnumerable<Encounter> ai_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ah_, default));
		...
		IEnumerable<Encounter> am_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, al_, default));
	...
	private IEnumerable<CqlInterval<CqlDate>> ADHD_Medications_Taken_on_IPSD_or_During_Continuation_and_Maintenance_Phase_Value()
	{
		...
		IEnumerable<MedicationRequest> p_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, o_, default));
		IEnumerable<MedicationRequest> r_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, o_, default));
		...
		IEnumerable<MedicationRequest> ae_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ad_, default));
		IEnumerable<MedicationRequest> ag_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, ad_, default));
		...
		IEnumerable<MedicationRequest> bi_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, bh_, default));
		IEnumerable<MedicationRequest> bk_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, bh_, default));
		...
		IEnumerable<MedicationRequest> bw_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, bv_, default));
		IEnumerable<MedicationRequest> by_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, bv_, default));
		...
		IEnumerable<MedicationRequest> cm_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, cl_, default));
		IEnumerable<MedicationRequest> co_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, cl_, default));
		...
		IEnumerable<MedicationRequest> db_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, da_));
		IEnumerable<CqlCode> dd_ = context.Operators.ToList<CqlCode>(cz_);
		IEnumerable<MedicationRequest> de_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, default, dd_));
