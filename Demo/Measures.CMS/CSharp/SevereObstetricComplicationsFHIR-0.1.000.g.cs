...
;
	...
	public  IEnumerable<Encounter> Delivery_Encounters_with_Severe_Obstetric_Complications_Diagnosis_or_Procedure_Excluding_Blood_Transfusion(CqlContext context)
	{
		...
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? e_(Encounter.DiagnosisComponent EncounterDiagnoses)
			{
				...
				Condition o_ = _CQMCommon_2_0_000.getCondition(context, n_);
			...
			bool? j_(Procedure EncounterSMMProcedures)
			{
				...
				CqlInterval<CqlDateTime> an_ = _QICoreCommon_2_0_000.toInterval(context, am_);
				CqlDateTime ao_ = context.Operators.Start(an_);
				CqlInterval<CqlDateTime> ap_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
	...
	public  IEnumerable<Encounter> Delivery_Encounters_with_Blood_Transfusion(CqlContext context)
	{
		...
		IEnumerable<Encounter> b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? f_(Procedure BloodTransfusion)
			{
				...
				CqlInterval<CqlDateTime> r_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
	...
	public  IEnumerable<Encounter> Delivery_Encounters_with_COVID_and_Respiratory_Condition_or_Procedure(CqlContext context)
	{
		...
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<Condition> d_ = _CQMCommon_2_0_000.encounterDiagnosis(context, TwentyWeeksPlusEncounter);
			bool? e_(Condition EncounterDiagnosis)
			{
				CodeableConcept s_ = EncounterDiagnosis?.Code;
				CqlConcept t_ = _FHIRHelpers_4_3_000.ToConcept(context, s_);
			...
			bool? i_(Condition EncounterDiagnosis)
			{
				...
				CqlConcept x_ = _FHIRHelpers_4_3_000.ToConcept(context, w_);
			...
			bool? n_(Procedure COVIDRespiratoryProcedure)
			{
				...
				CqlInterval<CqlDateTime> ai_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
	...
	public  IEnumerable<CqlConcept> pOAIsYesOrExempt(CqlContext context, Encounter TheEncounter)
	{
		...
		bool? b_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			bool? f_(Extension @this)
			{
				...
				string p_ = _FHIRHelpers_4_3_000.ToString(context, o_);
			...
			CqlConcept k_ = _FHIRHelpers_4_3_000.ToConcept(context, j_ as CodeableConcept);
		...
		CqlConcept d_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			...
			Condition t_ = _CQMCommon_2_0_000.getCondition(context, s_);
			CodeableConcept u_ = t_?.Code;
			CqlConcept v_ = _FHIRHelpers_4_3_000.ToConcept(context, u_);
	...
	public  IEnumerable<Encounter> Risk_Variable_Preterm_Birth(CqlContext context)
	{
		...
		bool? b_(Encounter DeliveryEncounter)
		{
			int? h_ = _PCMaternal_5_16_000.calculatedGestationalAge(context, DeliveryEncounter);
			CqlInterval<int?> i_ = context.Operators.Interval(20, 36, true, true);
			bool? j_ = context.Operators.In<int?>(h_, i_, default);
			CqlQuantity l_ = _PCMaternal_5_16_000.lastEstimatedGestationalAge(context, DeliveryEncounter);
		...
		{
			int? u_ = _PCMaternal_5_16_000.calculatedGestationalAge(context, DeliveryEncounter);
			CqlQuantity v_ = _PCMaternal_5_16_000.lastEstimatedGestationalAge(context, DeliveryEncounter);
	...
	public  IEnumerable<(string EncounterId, CqlQuantity FirstHematocritResult, CqlDateTime Timing)?> Risk_Variable_First_Hematocrit_Lab_Test(CqlContext context)
	{
		...
		(string EncounterId, CqlQuantity FirstHematocritResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? h_(Observation Hematocrit)
			{
				...
				CqlInterval<CqlDateTime> ac_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime ad_ = context.Operators.Start(ac_);
				CqlQuantity ae_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime af_ = context.Operators.Subtract(ad_, ae_);
				CqlDateTime ag_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			object j_(Observation @this)
			{
				...
				CqlDateTime aw_ = _QICoreCommon_2_0_000.earliest(context, av_ as object);
			...
			bool? q_(Observation Hematocrit)
			{
				...
				CqlInterval<CqlDateTime> ba_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime bb_ = context.Operators.Start(ba_);
				CqlQuantity bc_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime bd_ = context.Operators.Subtract(bb_, bc_);
				CqlDateTime be_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			object s_(Observation @this)
			{
				...
				CqlDateTime bu_ = _QICoreCommon_2_0_000.earliest(context, bt_ as object);
	...
	public  IEnumerable<(string EncounterId, CqlQuantity FirstHRResult, CqlDateTime Timing)?> Risk_Variable_Heart_Rate(CqlContext context)
	{
		...
		(string EncounterId, CqlQuantity FirstHRResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? g_(Observation HeartRate)
			{
				...
				CqlInterval<CqlDateTime> aa_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime ab_ = context.Operators.Start(aa_);
				CqlQuantity ac_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime ad_ = context.Operators.Subtract(ab_, ac_);
				CqlDateTime ae_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			object i_(Observation @this)
			{
				...
				CqlDateTime ap_ = _QICoreCommon_2_0_000.earliest(context, ao_);
			...
			bool? o_(Observation HeartRate)
			{
				...
				CqlDateTime as_ = _QICoreCommon_2_0_000.earliest(context, ar_);
				CqlInterval<CqlDateTime> at_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime au_ = context.Operators.Start(at_);
				CqlQuantity av_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime aw_ = context.Operators.Subtract(au_, av_);
				CqlDateTime ax_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			object q_(Observation @this)
			{
				...
				CqlDateTime bi_ = _QICoreCommon_2_0_000.earliest(context, bh_);
	...
	public  IEnumerable<(string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)?> Risk_Variable_Systolic_Blood_Pressure(CqlContext context)
	{
		...
		(string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? g_(Observation BP)
			{
				...
				object ab_ = _FHIRHelpers_4_3_000.ToValue(context, aa_);
				CqlDateTime ac_ = _QICoreCommon_2_0_000.earliest(context, ab_);
				CqlInterval<CqlDateTime> ad_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime ae_ = context.Operators.Start(ad_);
				CqlQuantity af_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime ag_ = context.Operators.Subtract(ae_, af_);
				CqlDateTime ah_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			bool? m_(Observation.ComponentComponent C)
			{
				...
				CqlConcept au_ = _FHIRHelpers_4_3_000.ToConcept(context, at_);
			...
			bool? r_(Observation BP)
			{
				...
				object bb_ = _FHIRHelpers_4_3_000.ToValue(context, ba_);
				CqlDateTime bc_ = _QICoreCommon_2_0_000.earliest(context, bb_);
				CqlInterval<CqlDateTime> bd_ = _PCMaternal_5_16_000.hospitalizationWithEDOBTriageObservation(context, TwentyWeeksPlusEncounter);
				CqlDateTime be_ = context.Operators.Start(bd_);
				CqlQuantity bf_ = context.Operators.Quantity(1440m, "minutes");
				CqlDateTime bg_ = context.Operators.Subtract(be_, bf_);
				CqlDateTime bh_ = _PCMaternal_5_16_000.lastTimeOfDelivery(context, TwentyWeeksPlusEncounter);
			...
			object t_(Observation @this)
			{
				...
				CqlDateTime bs_ = _QICoreCommon_2_0_000.earliest(context, br_);
			...
			CqlDateTime y_ = _QICoreCommon_2_0_000.earliest(context, x_);
