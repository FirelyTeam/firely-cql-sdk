...
public static class SevereObstetricComplicationsFHIR_0_1_000
{

    [CqlDeclaration("20 to 42 Plus Weeks Gestation")]
    [CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1110.67")]
	public static CqlValueSet _20_to_42_Plus_Weeks_Gestation(CqlContext context) => 
	...
	public static CqlValueSet Acute_or_Persistent_Asthma(CqlContext context) => 
	...
	public static CqlValueSet Anemia(CqlContext context) => 
	...
	public static CqlValueSet Autoimmune_Disease(CqlContext context) => 
	...
	public static CqlValueSet Bariatric_Surgery(CqlContext context) => 
	...
	public static CqlValueSet Bleeding_Disorder(CqlContext context) => 
	...
	public static CqlValueSet Blood_Transfusion(CqlContext context) => 
	...
	public static CqlValueSet Cardiac_Disease(CqlContext context) => 
	...
	public static CqlValueSet COVID_19_Confirmed(CqlContext context) => 
	...
	public static CqlValueSet Delivery_Procedures(CqlContext context) => 
	...
	public static CqlValueSet Economic_Housing_Instability(CqlContext context) => 
	...
	public static CqlValueSet ED_Visit_and_OB_Triage(CqlContext context) => 
	...
	public static CqlValueSet Gastrointestinal_Disease(CqlContext context) => 
	...
	public static CqlValueSet Gestational_Diabetes(CqlContext context) => 
	...
	public static CqlValueSet Hematocrit_lab_test(CqlContext context) => 
	...
	public static CqlValueSet HIV_in_Pregnancy_Childbirth_and_Puerperium(CqlContext context) => 
	...
	public static CqlValueSet Hypertension(CqlContext context) => 
	...
	public static CqlValueSet Long_Term_Anticoagulant_Use(CqlContext context) => 
	...
	public static CqlValueSet Mental_Health_Disorder(CqlContext context) => 
	...
	public static CqlValueSet Mild_or_Moderate_Preeclampsia(CqlContext context) => 
	...
	public static CqlValueSet Morbid_or_Severe_Obesity(CqlContext context) => 
	...
	public static CqlValueSet Multiple_Pregnancy(CqlContext context) => 
	...
	public static CqlValueSet Neuromuscular_Disease(CqlContext context) => 
	...
	public static CqlValueSet Placenta_Previa(CqlContext context) => 
	...
	public static CqlValueSet Placental_Abruption(CqlContext context) => 
	...
	public static CqlValueSet Placental_Accreta_Spectrum(CqlContext context) => 
	...
	public static CqlValueSet Preexisting_Diabetes(CqlContext context) => 
	...
	public static CqlValueSet Present_on_Admission_is_No_or_Unable_To_Determine(CqlContext context) => 
	...
	public static CqlValueSet Present_On_Admission_is_Yes_or_Exempt(CqlContext context) => 
	...
	public static CqlValueSet Preterm_Birth(CqlContext context) => 
	...
	public static CqlValueSet Previous_Cesarean(CqlContext context) => 
	...
	public static CqlValueSet Pulmonary_Hypertension(CqlContext context) => 
	...
	public static CqlValueSet Renal_Disease(CqlContext context) => 
	...
	public static CqlValueSet Respiratory_Conditions_Related_to_COVID_19(CqlContext context) => 
	...
	public static CqlValueSet Respiratory_Support_Procedures_Related_to_COVID_19(CqlContext context) => 
	...
	public static CqlValueSet Severe_Maternal_Morbidity_Diagnoses(CqlContext context) => 
	...
	public static CqlValueSet Severe_Maternal_Morbidity_Procedures(CqlContext context) => 
	...
	public static CqlValueSet Severe_Preeclampsia(CqlContext context) => 
	...
	public static CqlValueSet Substance_Abuse(CqlContext context) => 
	...
	public static CqlValueSet Thyrotoxicosis(CqlContext context) => 
	...
	public static CqlValueSet Venous_Thromboembolism_in_Pregnancy(CqlContext context) => 
	...
	public static CqlValueSet White_blood_cells_count_lab_test(CqlContext context) => 
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1045.129", default);

    [CqlDeclaration("Heart rate")]
	public static CqlCode Heart_rate(CqlContext context) => 
...
;
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Calculated_Gestational_Age_Greater_than_or_Equal_to_20_Weeks(CqlContext context)
	{
		IEnumerable<Encounter> a_ = PCMaternal_5_16_000.Delivery_Encounter_with_Age_Range(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Estimated_Gestational_Age_Assessment_Greater_than_or_Equal_to_20_Weeks(CqlContext context)
	{
		IEnumerable<Encounter> a_ = PCMaternal_5_16_000.Delivery_Encounter_with_Age_Range(context);
		bool? b_(Encounter DeliveryEncounter)
		{
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Gestational_Age_Greater_than_or_Equal_to_20_Weeks_Based_on_Coding(CqlContext context)
	{
		IEnumerable<Encounter> a_ = PCMaternal_5_16_000.Delivery_Encounter_with_Age_Range(context);
		bool? b_(Encounter DeliveryEncounter)
		{
			...
			bool? h_(Condition EncounterDiagnosis)
			{
				...
				CqlValueSet n_ = SevereObstetricComplicationsFHIR_0_1_000._20_to_42_Plus_Weeks_Gestation(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Calculated_Gestational_Age_Greater_than_or_Equal_to_20_Weeks(context);
		IEnumerable<Encounter> b_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Estimated_Gestational_Age_Assessment_Greater_than_or_Equal_to_20_Weeks(context);
		IEnumerable<Encounter> c_ = context.Operators.Union<Encounter>(a_, b_);
		IEnumerable<Encounter> d_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Gestational_Age_Greater_than_or_Equal_to_20_Weeks_Based_on_Coding(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Severe_Obstetric_Complications_Diagnosis_or_Procedure_Excluding_Blood_Transfusion(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? e_(Encounter.DiagnosisComponent EncounterDiagnoses)
			{
				...
				CqlValueSet r_ = SevereObstetricComplicationsFHIR_0_1_000.Severe_Maternal_Morbidity_Diagnoses(context);
				...
				CqlValueSet z_ = SevereObstetricComplicationsFHIR_0_1_000.Present_on_Admission_is_No_or_Unable_To_Determine(context);
			...
			CqlValueSet h_ = SevereObstetricComplicationsFHIR_0_1_000.Severe_Maternal_Morbidity_Procedures(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Expiration(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			CqlValueSet g_ = SevereObstetricComplicationsFHIR_0_1_000.Patient_Expired(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Blood_Transfusion(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		IEnumerable<Encounter> b_(Encounter TwentyWeeksPlusEncounter)
		{
			CqlValueSet d_ = SevereObstetricComplicationsFHIR_0_1_000.Blood_Transfusion(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Severe_Obstetric_Complications(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Severe_Obstetric_Complications_Diagnosis_or_Procedure_Excluding_Blood_Transfusion(context);
		IEnumerable<Encounter> b_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Expiration(context);
		IEnumerable<Encounter> c_ = context.Operators.Union<Encounter>(a_, b_);
		IEnumerable<Encounter> d_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Blood_Transfusion(context);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(c_, d_);
	...
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Severe_Obstetric_Complications(context);

		return a_;
	}

    [CqlDeclaration("Delivery Encounters with COVID and Respiratory Condition or Procedure")]
	public static IEnumerable<Encounter> Delivery_Encounters_with_COVID_and_Respiratory_Condition_or_Procedure(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? e_(Condition EncounterDiagnosis)
			{
				...
				CqlValueSet u_ = SevereObstetricComplicationsFHIR_0_1_000.COVID_19_Confirmed(context);
			...
			bool? i_(Condition EncounterDiagnosis)
			{
				...
				CqlValueSet y_ = SevereObstetricComplicationsFHIR_0_1_000.Respiratory_Conditions_Related_to_COVID_19(context);
			...
			CqlValueSet l_ = SevereObstetricComplicationsFHIR_0_1_000.Respiratory_Support_Procedures_Related_to_COVID_19(context);
	...
	public static IEnumerable<Encounter> Denominator_Exclusion(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_COVID_and_Respiratory_Condition_or_Procedure(context);

		return a_;
	}

    [CqlDeclaration("Stratification Encounter")]
	public static IEnumerable<Encounter> Stratification_Encounter(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Numerator(context);
		IEnumerable<Encounter> b_ = SevereObstetricComplicationsFHIR_0_1_000.Denominator_Exclusion(context);
	...
	public static IEnumerable<Encounter> Delivery_Encounters_with_Severe_Obstetric_Complications_Excluding_Blood_Transfusions(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Severe_Obstetric_Complications_Diagnosis_or_Procedure_Excluding_Blood_Transfusion(context);
		IEnumerable<Encounter> b_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Expiration(context);
		IEnumerable<Encounter> c_ = context.Operators.Union<Encounter>(a_, b_);
	...
	public static IEnumerable<Encounter> Stratum_1(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Stratification_Encounter(context);
		IEnumerable<Encounter> b_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_with_Severe_Obstetric_Complications_Excluding_Blood_Transfusions(context);
	...
	public static IEnumerable<(string EncounterID, int? CalculatedCGA)?> Variable_Calculated_Gestational_Age(CqlContext context)
	{
	...
	public static IEnumerable<CqlConcept> pOAIsYesOrExempt(CqlContext context, Encounter TheEncounter)
	{
		...
		bool? b_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			...
			CqlValueSet l_ = SevereObstetricComplicationsFHIR_0_1_000.Present_On_Admission_is_Yes_or_Exempt(context);
	...
	public static IEnumerable<Encounter> Risk_Variable_Anemia(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Anemia(context);
	...
	public static IEnumerable<Encounter> Risk_Variable_Asthma(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Acute_or_Persistent_Asthma(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Autoimmune_Disease(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Autoimmune_Disease(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Bariatric_Surgery(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Bariatric_Surgery(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Bleeding_Disorder(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Bleeding_Disorder(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Morbid_Obesity(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Morbid_or_Severe_Obesity(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Cardiac_Disease(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Cardiac_Disease(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Economic_Housing_Instability(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Economic_Housing_Instability(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Gastrointestinal_Disease(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Gastrointestinal_Disease(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Gestational_Diabetes(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Gestational_Diabetes(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_HIV(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.HIV_in_Pregnancy_Childbirth_and_Puerperium(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Hypertension(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Hypertension(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Long_Term_Anticoagulant_Use(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Long_Term_Anticoagulant_Use(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Mental_Health_Disorder(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Mental_Health_Disorder(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Multiple_Pregnancy(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Multiple_Pregnancy(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Neuromuscular(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Neuromuscular_Disease(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Obstetrical_VTE(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Venous_Thromboembolism_in_Pregnancy(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Placenta_Previa(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Placenta_Previa(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Placental_Abruption(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Placental_Abruption(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Placental_Accreta_Spectrum(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Placental_Accreta_Spectrum(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Preexisting_Diabetes(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Preexisting_Diabetes(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Previous_Cesarean(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Previous_Cesarean(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Pulmonary_Hypertension(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Pulmonary_Hypertension(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Renal_Disease(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Renal_Disease(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Severe_Preeclampsia(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Severe_Preeclampsia(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Substance_Abuse(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Substance_Abuse(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Thyrotoxicosis(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Thyrotoxicosis(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Other_Preeclampsia(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			IEnumerable<CqlConcept> d_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, TwentyWeeksPlusEncounter);
			CqlValueSet e_ = SevereObstetricComplicationsFHIR_0_1_000.Mild_or_Moderate_Preeclampsia(context);
			bool? f_ = context.Operators.ConceptsInValueSet(d_, e_);
	...
	public static IEnumerable<Encounter> Risk_Variable_Preterm_Birth(CqlContext context)
	{
		IEnumerable<Encounter> a_ = PCMaternal_5_16_000.Delivery_Encounter_with_Age_Range(context);
		bool? b_(Encounter DeliveryEncounter)
		{
		...
		bool? e_(Encounter DeliveryEncounter)
		{
			...
			IEnumerable<CqlConcept> x_ = SevereObstetricComplicationsFHIR_0_1_000.pOAIsYesOrExempt(context, DeliveryEncounter);
			CqlValueSet y_ = SevereObstetricComplicationsFHIR_0_1_000.Preterm_Birth(context);
	...
	public static IEnumerable<(string EncounterId, CqlQuantity FirstHematocritResult, CqlDateTime Timing)?> Risk_Variable_First_Hematocrit_Lab_Test(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		(string EncounterId, CqlQuantity FirstHematocritResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			string e_ = d_?.Value;
			CqlValueSet f_ = SevereObstetricComplicationsFHIR_0_1_000.Hematocrit_lab_test(context);
	...
	public static IEnumerable<(string EncounterId, CqlQuantity FirstWBCResult, CqlDateTime Timing)?> Risk_Variable_First_White_Blood_Cell_Count_Lab_Test(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		(string EncounterId, CqlQuantity FirstWBCResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			Id d_ = TwentyWeeksPlusEncounter?.IdElement;
			string e_ = d_?.Value;
			CqlValueSet f_ = SevereObstetricComplicationsFHIR_0_1_000.White_blood_cells_count_lab_test(context);
			IEnumerable<Observation> g_ = context.Operators.RetrieveByValueSet<Observation>(f_, default);
	...
	public static IEnumerable<(string EncounterId, CqlQuantity FirstHRResult, CqlDateTime Timing)?> Risk_Variable_Heart_Rate(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
	...
	public static IEnumerable<(string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)?> Risk_Variable_Systolic_Blood_Pressure(CqlContext context)
	{
		IEnumerable<Encounter> a_ = SevereObstetricComplicationsFHIR_0_1_000.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation(context);
		(string EncounterId, IEnumerable<CqlQuantity> FirstSBPResult, CqlDateTime Timing)? b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			bool? m_(Observation.ComponentComponent C)
			{
				...
				CqlCode av_ = SevereObstetricComplicationsFHIR_0_1_000.Systolic_blood_pressure(context);
	...
	public static IEnumerable<CqlConcept> pOAIsNoOrUTD(CqlContext context, Encounter TheEncounter)
	{
		List<Encounter.DiagnosisComponent> a_ = TheEncounter?.Diagnosis;
		bool? b_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			...
			object j_ = context.Operators.SingletonFrom<object>(i_);
			CqlConcept k_ = FHIRHelpers_4_3_000.ToConcept(context, j_ as CodeableConcept);
			CqlValueSet l_ = SevereObstetricComplicationsFHIR_0_1_000.Present_on_Admission_is_No_or_Unable_To_Determine(context);
			bool? m_ = context.Operators.ConceptInValueSet(k_, l_);
