...
public class AppropriateDXAScansForWomenUnder65FHIR_0_0_000
{
	...
	private IEnumerable<Encounter> Qualifying_Encounter_Value()
	{
		...
		IEnumerable<Encounter> f_ = context.Operators.Retrieve<Encounter>(default);
		bool? g_(Encounter E)
		{
		...
		IEnumerable<Encounter> j_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, i_, default));
		...
		IEnumerable<Encounter> n_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, m_, default));
		CqlValueSet o_ = this.Online_Assessments();
		IEnumerable<Encounter> p_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, o_, default));
		...
		IEnumerable<Encounter> t_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, s_, default));
	...
	private Observation First_Average_Number_of_Drinks_Assessments_Indicating_More_Than_Two_Per_Day_Value()
	{
		...
		IEnumerable<Observation> c_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, b_));
	...
	private bool? Has_Risk_Factor_Any_Time_in_History_Prior_to_Measurement_Period_and_Do_Not_Need_to_be_Active_During_Measurement_Period_Value()
	{
		...
		IEnumerable<MedicationRequest> p_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
		IEnumerable<MedicationRequest> r_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, f_, default));
	...
	private bool? Has_Double_or_Bilateral_Oophorectomy_Value()
	{
		...
		IEnumerable<Procedure> f_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, e_, default));
		...
		IEnumerable<Procedure> k_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, j_, default));
		...
		IEnumerable<Procedure> o_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, n_, default));
		...
		IEnumerable<Procedure> t_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, j_, default));
		...
		IEnumerable<Procedure> x_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, w_, default));
	...
	private bool? Has_Organ_Transplants_Value()
	{
		...
		IEnumerable<Procedure> d_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, c_, default));
		IEnumerable<Procedure> e_ = context.Operators.Union<Procedure>(b_, d_);
		CqlValueSet f_ = this.Bone_Marrow_Transplant();
		IEnumerable<Procedure> g_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, f_, default));
	...
	private bool? Has_Risk_Factor_Any_Time_in_History_or_During_Measurement_Period_Value()
	{
		...
		IEnumerable<Condition> h_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, g_, default));
		...
		IEnumerable<Condition> t_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, s_, default));
		...
		IEnumerable<Condition> z_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, y_, default));
		...
		IEnumerable<Condition> af_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ae_, default));
		...
		IEnumerable<Condition> al_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ak_, default));
		...
		IEnumerable<Condition> ar_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, aq_, default));
		...
		IEnumerable<Condition> ax_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, aw_, default));
		...
		IEnumerable<Condition> bd_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bc_, default));
		...
		IEnumerable<Procedure> bm_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, bl_, default));
	...
	private IEnumerable<Observation> Osteoporosis_Fracture_Risk_Assessment_Prior_to_First_DXA_Scan_Value()
	{
		...
		IEnumerable<Observation> i_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, h_));
		...
		IEnumerable<Observation> p_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, o_));
		...
		IEnumerable<Observation> v_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, u_));
