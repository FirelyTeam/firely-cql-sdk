...
public static class HIVViralSuppressionFHIR_0_1_000
{
	...
	public static CqlCode Below_threshold_level__qualifier_value_(CqlContext context) => 
		new CqlCode("260988000", "http://snomed.info/sct", default, default);

    [CqlDeclaration("Not detected (qualifier value)")]
	public static CqlCode Not_detected__qualifier_value_(CqlContext context) => 
...
;
	...
	public static bool? Has_Active_HIV_Diagnosis_Before_or_in_First_90_Days_of_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = HIVViralSuppressionFHIR_0_1_000.HIV(context);
		...
		bool? c_(Condition HIVDx)
		{
			...
			CqlInterval<CqlDateTime> h_ = HIVViralSuppressionFHIR_0_1_000.Measurement_Period(context);
	...
	{
		CqlValueSet a_ = HIVViralSuppressionFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = HIVViralSuppressionFHIR_0_1_000.Outpatient_Consultation(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = HIVViralSuppressionFHIR_0_1_000.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = HIVViralSuppressionFHIR_0_1_000.Face_to_Face_Interaction(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = HIVViralSuppressionFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = HIVViralSuppressionFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = HIVViralSuppressionFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = HIVViralSuppressionFHIR_0_1_000.Preventive_Care_Services__Initial_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		IEnumerable<Encounter> v_ = context.Operators.Union<Encounter>(s_, u_);
		IEnumerable<Encounter> w_ = context.Operators.Union<Encounter>(q_, v_);
		CqlValueSet x_ = HIVViralSuppressionFHIR_0_1_000.Preventive_Care__Established_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> y_ = context.Operators.RetrieveByValueSet<Encounter>(x_, default);
		CqlValueSet z_ = HIVViralSuppressionFHIR_0_1_000.Telephone_Visits(context);
		IEnumerable<Encounter> aa_ = context.Operators.RetrieveByValueSet<Encounter>(z_, default);
		IEnumerable<Encounter> ab_ = context.Operators.Union<Encounter>(y_, aa_);
		IEnumerable<Encounter> ac_ = context.Operators.Union<Encounter>(w_, ab_);
		CqlValueSet ad_ = HIVViralSuppressionFHIR_0_1_000.Preventive_Care_Services_Other(context);
		...
		{
			CqlInterval<CqlDateTime> aj_ = HIVViralSuppressionFHIR_0_1_000.Measurement_Period(context);
	...
	{
		bool? a_ = HIVViralSuppressionFHIR_0_1_000.Has_Active_HIV_Diagnosis_Before_or_in_First_90_Days_of_Measurement_Period(context);
		bool? b_ = HIVViralSuppressionFHIR_0_1_000.Has_Qualifying_Encounter_During_First_240_Days_of_Measurement_Period(context);
	...
	{
		bool? a_ = HIVViralSuppressionFHIR_0_1_000.Initial_Population(context);
	...
	public static Observation Most_Recent_Viral_Load_Test_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = HIVViralSuppressionFHIR_0_1_000.HIV_Viral_Load(context);
		...
		bool? c_(Observation ViralLoad)
		{
			...
			CqlInterval<CqlDateTime> j_ = HIVViralSuppressionFHIR_0_1_000.Measurement_Period(context);
	...
	{
		Observation a_ = HIVViralSuppressionFHIR_0_1_000.Most_Recent_Viral_Load_Test_During_Measurement_Period(context);
		...
		CqlCode i_ = HIVViralSuppressionFHIR_0_1_000.Below_threshold_level__qualifier_value_(context);
		...
		CqlCode p_ = HIVViralSuppressionFHIR_0_1_000.Not_detected__qualifier_value_(context);
