...
public static partial class ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000ServiceCollectionExtensions
{
    ...
    {
        services.TryAddSingleton<ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000"]);
            return ActivatorUtilities.CreateInstance<ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000>(sp);
        });
