...
public partial class ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000 : ISingleton<ProstateCaAvoidanceBoneScanOveruseFHIR_0_2_000>
{
	...
	public IEnumerable<Condition> Prostate_Cancer_Diagnosis(CqlContext context)
	{
		...
		bool? c_(Condition ProstateCancer)
		{
			...
			bool? h_ = QICoreCommon_2_0_000.Instance.isProblemListItem(context, ProstateCancer);
			bool? i_ = QICoreCommon_2_0_000.Instance.isHealthConcern(context, ProstateCancer);
			bool? j_ = context.Operators.Or(h_, i_);
			bool? k_ = context.Operators.And(g_, j_);
			bool? l_ = QICoreCommon_2_0_000.Instance.isActive(context, ProstateCancer);
	...
	public bool? Has_Diagnosis_of_Pain_related_to_Prostate_Cancer(CqlContext context)
	{
		...
		IEnumerable<Condition> c_(Condition ProstateCancerPain)
		{
			...
			bool? g_(Condition ActiveProstateCancer)
			{
				...
				CqlInterval<CqlDateTime> m_ = QICoreCommon_2_0_000.Instance.prevalenceInterval(context, ActiveProstateCancer);
				CqlDateTime n_ = context.Operators.Start(m_);
				bool? o_ = context.Operators.After(l_, n_, default);
				bool? p_ = QICoreCommon_2_0_000.Instance.isProblemListItem(context, ProstateCancerPain);
				bool? q_ = QICoreCommon_2_0_000.Instance.isHealthConcern(context, ProstateCancerPain);
				bool? r_ = context.Operators.Or(p_, q_);
				bool? s_ = context.Operators.And(o_, r_);
				bool? t_ = QICoreCommon_2_0_000.Instance.isActive(context, ProstateCancerPain);
	...
	public bool? Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis(CqlContext context)
	{
		...
		IEnumerable<Procedure> c_(Procedure SalvageTherapy)
		{
			...
			bool? g_(Condition ActiveProstateCancer)
			{
				...
				CqlDateTime n_ = context.Operators.Start(m_);
				CqlInterval<CqlDateTime> o_ = QICoreCommon_2_0_000.Instance.prevalenceInterval(context, ActiveProstateCancer);
	...
	public IEnumerable<Observation> Bone_Scan_Study_Performed(CqlContext context)
	{
		...
		IEnumerable<Observation> c_(Observation BoneScan)
		{
			...
			bool? f_(Condition ActiveProstateCancer)
			{
				...
				CqlInterval<CqlDateTime> n_ = QICoreCommon_2_0_000.Instance.prevalenceInterval(context, ActiveProstateCancer);
	...
	public Observation Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a(CqlContext context)
	{
		...
		bool? j_(Observation LastProstateCancerStaging)
		{
			...
			object as_ = FHIRHelpers_4_3_000.Instance.ToValue(context, am_);
			...
			object ay_ = FHIRHelpers_4_3_000.Instance.ToValue(context, am_);
			...
			object be_ = FHIRHelpers_4_3_000.Instance.ToValue(context, am_);
