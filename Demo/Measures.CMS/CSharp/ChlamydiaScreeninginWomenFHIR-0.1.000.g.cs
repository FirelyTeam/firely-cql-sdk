...
public static class ChlamydiaScreeninginWomenFHIR_0_1_000
{
	...
	public static CqlValueSet Chlamydia_Screening(CqlContext context) => 
	...
	public static CqlValueSet Complications_of_Pregnancy__Childbirth_and_the_Puerperium(CqlContext context) => 
	...
	public static CqlValueSet Contraceptive_Medications(CqlContext context) => 
	...
	public static CqlValueSet Diagnoses_Used_to_Indicate_Sexual_Activity(CqlContext context) => 
	...
	public static CqlValueSet Diagnostic_Studies_During_Pregnancy(CqlContext context) => 
	...
	public static CqlValueSet Isotretinoin(CqlContext context) => 
	...
	public static CqlValueSet Lab_Tests_During_Pregnancy(CqlContext context) => 
	...
	public static CqlValueSet Lab_Tests_for_Sexually_Transmitted_Infections(CqlContext context) => 
	...
	public static CqlValueSet Pap_Test(CqlContext context) => 
	...
	public static CqlValueSet Pregnancy_Test(CqlContext context) => 
	...
	public static CqlValueSet Procedures_Used_to_Indicate_Sexual_Activity(CqlContext context) => 
	...
	public static CqlValueSet XRay_Study(CqlContext context) => 
	...
	public static CqlCode Have_you_ever_had_vaginal_intercourse__PhenX_(CqlContext context) => 
	...
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Preventive_Care_Services__Initial_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Preventive_Care__Established_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Telephone_Visits(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Online_Assessments(context);
		...
		{
			CqlInterval<CqlDateTime> aa_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Assessments_Identifying_Sexual_Activity(CqlContext context)
	{
		CqlCode a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Have_you_ever_had_vaginal_intercourse__PhenX_(context);
		...
		bool? e_(Observation SexualActivityAssessment)
		{
			...
			CqlCode j_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Yes__qualifier_value_(context);
			...
			CqlInterval<CqlDateTime> p_()
			{
				bool s_()
				{
					CqlInterval<CqlDateTime> t_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
				...
				{
					CqlInterval<CqlDateTime> v_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Diagnoses_Identifying_Sexual_Activity(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Diagnoses_Used_to_Indicate_Sexual_Activity(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = ChlamydiaScreeninginWomenFHIR_0_1_000.HIV(context);
		IEnumerable<Condition> d_ = context.Operators.RetrieveByValueSet<Condition>(c_, default);
		IEnumerable<Condition> e_ = context.Operators.Union<Condition>(b_, d_);
		CqlValueSet f_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Complications_of_Pregnancy__Childbirth_and_the_Puerperium(context);
		...
		bool? i_(Condition SexualActivityDiagnosis)
		{
			...
			CqlInterval<CqlDateTime> m_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Active_Contraceptive_Medications(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Contraceptive_Medications(context);
		...
		bool? g_(MedicationRequest ActiveContraceptives)
		{
			...
			CqlInterval<CqlDateTime> u_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Ordered_Contraceptive_Medications(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Contraceptive_Medications(context);
		IEnumerable<MedicationRequest> b_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		IEnumerable<MedicationRequest> d_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		...
		{
			CqlInterval<CqlDateTime> j_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Laboratory_Tests_Identifying_Sexual_Activity_But_Not_Pregnancy(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Pap_Test(context);
		IEnumerable<ServiceRequest> b_ = context.Operators.RetrieveByValueSet<ServiceRequest>(a_, default);
		CqlValueSet c_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Lab_Tests_During_Pregnancy(context);
		...
		CqlValueSet f_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Lab_Tests_for_Sexually_Transmitted_Infections(context);
	...
	public static bool? Has_Laboratory_Tests_Identifying_Sexual_Activity(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Pregnancy_Test(context);
		IEnumerable<ServiceRequest> b_ = context.Operators.RetrieveByValueSet<ServiceRequest>(a_, default);
		...
		{
			CqlInterval<CqlDateTime> i_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
		...
		bool? g_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Laboratory_Tests_Identifying_Sexual_Activity_But_Not_Pregnancy(context);
	...
	public static bool? Has_Diagnostic_Studies_Identifying_Sexual_Activity(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Diagnostic_Studies_During_Pregnancy(context);
		IEnumerable<ServiceRequest> b_ = context.Operators.RetrieveByValueSet<ServiceRequest>(a_, default);
		IEnumerable<ServiceRequest> c_ = Status_1_6_000.Completed_or_Ongoing_Service_Request(context, b_);
		bool? d_(ServiceRequest SexualActivityDiagnostics)
		{
			CqlInterval<CqlDateTime> g_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_Procedures_Identifying_Sexual_Activity(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Procedures_Used_to_Indicate_Sexual_Activity(context);
	...
	{
		Patient a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
		...
		IEnumerable<Encounter> q_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Qualifying_Encounters(context);
		bool? r_ = context.Operators.Exists<Encounter>(q_);
		bool? s_ = context.Operators.And(p_, r_);
		bool? t_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Assessments_Identifying_Sexual_Activity(context);
		bool? u_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Diagnoses_Identifying_Sexual_Activity(context);
		bool? v_ = context.Operators.Or(t_, u_);
		bool? w_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Active_Contraceptive_Medications(context);
		bool? x_ = context.Operators.Or(v_, w_);
		bool? y_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Ordered_Contraceptive_Medications(context);
		bool? z_ = context.Operators.Or(x_, y_);
		bool? aa_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Laboratory_Tests_Identifying_Sexual_Activity(context);
		bool? ab_ = context.Operators.Or(z_, aa_);
		bool? ac_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Diagnostic_Studies_Identifying_Sexual_Activity(context);
		bool? ad_ = context.Operators.Or(ab_, ac_);
		bool? ae_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Procedures_Identifying_Sexual_Activity(context);
	...
	{
		bool? a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Has Pregnancy Test Exclusion")]
	public static bool? Has_Pregnancy_Test_Exclusion(CqlContext context)
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Pregnancy_Test(context);
		IEnumerable<ServiceRequest> b_ = context.Operators.RetrieveByValueSet<ServiceRequest>(a_, default);
		IEnumerable<ServiceRequest> c_ = Status_1_6_000.Completed_or_Ongoing_Service_Request(context, b_);
		...
		{
			CqlValueSet m_ = ChlamydiaScreeninginWomenFHIR_0_1_000.XRay_Study(context);
			...
			bool? p_(ServiceRequest XrayOrder)
			{
				...
				CqlInterval<CqlDateTime> ap_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
		...
		{
			CqlValueSet av_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Isotretinoin(context);
			...
			bool? bb_(MedicationRequest AccutaneOrder)
			{
				...
				CqlInterval<CqlDateTime> cb_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Denominator_Exclusions(CqlContext context)
	{
		...
		bool? b_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Pregnancy_Test_Exclusion(context);
		bool? c_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Assessments_Identifying_Sexual_Activity(context);
		bool? d_ = context.Operators.Not(c_);
		bool? e_ = context.Operators.And(b_, d_);
		bool? f_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Diagnoses_Identifying_Sexual_Activity(context);
		bool? g_ = context.Operators.Not(f_);
		bool? h_ = context.Operators.And(e_, g_);
		bool? i_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Active_Contraceptive_Medications(context);
		bool? j_ = context.Operators.Not(i_);
		bool? k_ = context.Operators.And(h_, j_);
		bool? l_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Ordered_Contraceptive_Medications(context);
		bool? m_ = context.Operators.Not(l_);
		bool? n_ = context.Operators.And(k_, m_);
		bool? o_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Laboratory_Tests_Identifying_Sexual_Activity_But_Not_Pregnancy(context);
		bool? p_ = context.Operators.Not(o_);
		bool? q_ = context.Operators.And(n_, p_);
		bool? r_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Diagnostic_Studies_Identifying_Sexual_Activity(context);
		bool? s_ = context.Operators.Not(r_);
		bool? t_ = context.Operators.And(q_, s_);
		bool? u_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Has_Procedures_Identifying_Sexual_Activity(context);
	...
	{
		CqlValueSet a_ = ChlamydiaScreeninginWomenFHIR_0_1_000.Chlamydia_Screening(context);
