...
public class ChlamydiaScreeninginWomenFHIR_0_1_000
{
	...
	private bool? Has_Pregnancy_Test_Exclusion_Value()
	{
		...
		IEnumerable<ServiceRequest> d_(ServiceRequest PregnancyTest)
		{
			...
			IEnumerable<ServiceRequest> n_ = context.Operators.Retrieve<ServiceRequest>(new RetrieveParameters(default, m_, default));
		...
		IEnumerable<ServiceRequest> g_ = context.Operators.Retrieve<ServiceRequest>(new RetrieveParameters(default, a_, default));
