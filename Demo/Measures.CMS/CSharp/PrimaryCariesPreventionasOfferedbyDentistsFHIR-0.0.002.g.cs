...
public static class PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002
{
	...
	public static CqlValueSet Discharged_to_Home_for_Hosice_Care(CqlContext context) => 
	...
	{
		CqlValueSet a_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Clinical_Oral_Evaluation(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		IEnumerable<Encounter> c_ = Status_1_6_000.isEncounterPerformed(context, b_);
		bool? d_(Encounter ValidEncounter)
		{
			CqlInterval<CqlDateTime> f_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Measurement_Period(context);
	...
	{
		Patient a_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Measurement_Period(context);
		CqlDateTime f_ = context.Operators.Start(e_);
		CqlDate g_ = context.Operators.DateFrom(f_);
		int? h_ = context.Operators.CalculateAgeAt(d_, g_, "year");
		CqlInterval<int?> i_ = context.Operators.Interval(1, 20, true, true);
		bool? j_ = context.Operators.In<int?>(h_, i_, default);
		IEnumerable<Encounter> k_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Qualifying_Encounters(context);
	...
	{
		bool? a_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Initial_Population(context);
	...
	{
		CqlValueSet a_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Fluoride_Varnish_Application_for_Children(context);
		...
		bool? d_(Procedure FluorideApplication)
		{
			...
			CqlInterval<CqlDateTime> n_ = PrimaryCariesPreventionasOfferedbyDentistsFHIR_0_0_002.Measurement_Period(context);
