...
public class Cataracts2040BCVAwithin90DaysFHIR_0_1_000
{
	...
	private IEnumerable<Procedure> Denominator_Exclusions_Value()
	{
		...
		IEnumerable<Procedure> b_(Procedure CataractSurgeryPerformed)
		{
			...
			IEnumerable<Condition> e_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, d_, default));
			CqlValueSet f_ = this.Amblyopia();
			IEnumerable<Condition> g_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, f_, default));
			IEnumerable<Condition> h_ = context.Operators.Union<Condition>(e_, g_);
			CqlValueSet i_ = this.Burn_Confined_to_Eye_and_Adnexa();
			IEnumerable<Condition> j_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, i_, default));
			CqlValueSet k_ = this.Cataract_Secondary_to_Ocular_Disorders();
			IEnumerable<Condition> l_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, k_, default));
			...
			IEnumerable<Condition> p_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, o_, default));
			CqlValueSet q_ = this.Cataract_Mature_or_Hypermature();
			IEnumerable<Condition> r_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, q_, default));
			...
			IEnumerable<Condition> v_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, u_, default));
			CqlValueSet w_ = this.Central_Corneal_Ulcer();
			IEnumerable<Condition> x_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, w_, default));
			...
			IEnumerable<Condition> ab_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, aa_, default));
			CqlValueSet ac_ = this.Choroidal_Degenerations();
			IEnumerable<Condition> ad_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ac_, default));
			...
			IEnumerable<Condition> ah_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ag_, default));
			CqlValueSet ai_ = this.Choroidal_Hemorrhage_and_Rupture();
			IEnumerable<Condition> aj_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ai_, default));
			...
			IEnumerable<Condition> an_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, am_, default));
			CqlValueSet ao_ = this.Cloudy_Cornea();
			IEnumerable<Condition> ap_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ao_, default));
			...
			IEnumerable<Condition> at_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, as_, default));
			CqlValueSet au_ = this.Disorders_of_Cornea_Including_Corneal_Opacity();
			IEnumerable<Condition> av_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, au_, default));
			...
			IEnumerable<Condition> az_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ay_, default));
			CqlValueSet ba_ = this.Degenerative_Disorders_of_Globe();
			IEnumerable<Condition> bb_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ba_, default));
			...
			IEnumerable<Condition> bf_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, be_, default));
			CqlValueSet bg_ = this.Diabetic_Retinopathy();
			IEnumerable<Condition> bh_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bg_, default));
			...
			IEnumerable<Condition> bl_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bk_, default));
			CqlValueSet bm_ = this.Disorders_of_Visual_Cortex();
			IEnumerable<Condition> bn_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bm_, default));
			...
			IEnumerable<Condition> br_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bq_, default));
			CqlValueSet bs_ = this.Focal_Chorioretinitis_and_Focal_Retinochoroiditis();
			IEnumerable<Condition> bt_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bs_, default));
			...
			IEnumerable<Condition> bx_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, bw_, default));
			CqlValueSet by_ = this.Glaucoma_Associated_with_Congenital_Anomalies_and_Dystrophies_and_Systemic_Syndromes();
			IEnumerable<Condition> bz_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, by_, default));
			...
			IEnumerable<Condition> cd_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, cc_, default));
			CqlValueSet ce_ = this.Hereditary_Corneal_Dystrophies();
			IEnumerable<Condition> cf_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ce_, default));
			...
			IEnumerable<Condition> cj_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ci_, default));
			CqlValueSet ck_ = this.Hypotony_of_Eye();
			IEnumerable<Condition> cl_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ck_, default));
			...
			IEnumerable<Condition> cp_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, co_, default));
			CqlValueSet cq_ = this.Macular_Scar_of_Posterior_Polar();
			IEnumerable<Condition> cr_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, cq_, default));
			...
			IEnumerable<Condition> cv_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, cu_, default));
			CqlValueSet cw_ = this.Nystagmus_and_Other_Irregular_Eye_Movements();
			IEnumerable<Condition> cx_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, cw_, default));
			...
			IEnumerable<Condition> db_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, da_, default));
			CqlValueSet dc_ = this.Optic_Atrophy();
			IEnumerable<Condition> dd_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, dc_, default));
			...
			IEnumerable<Condition> dh_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, dg_, default));
			CqlValueSet di_ = this.Other_and_Unspecified_Forms_of_Chorioretinitis_and_Retinochoroiditis();
			IEnumerable<Condition> dj_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, di_, default));
			...
			IEnumerable<Condition> dn_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, dm_, default));
			CqlValueSet do_ = this.Other_Disorders_of_Optic_Nerve();
			IEnumerable<Condition> dp_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, do_, default));
			...
			IEnumerable<Condition> dt_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ds_, default));
			CqlValueSet du_ = this.Other_Proliferative_Retinopathy();
			IEnumerable<Condition> dv_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, du_, default));
			...
			IEnumerable<Condition> dz_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, dy_, default));
			CqlValueSet ea_ = this.Posterior_Lenticonus();
			IEnumerable<Condition> eb_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ea_, default));
			...
			IEnumerable<Condition> ef_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ee_, default));
			CqlValueSet eg_ = this.Purulent_Endophthalmitis();
			IEnumerable<Condition> eh_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, eg_, default));
			...
			IEnumerable<Condition> el_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ek_, default));
			CqlValueSet em_ = this.Retinal_Vascular_Occlusion();
			IEnumerable<Condition> en_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, em_, default));
			...
			IEnumerable<Condition> er_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, eq_, default));
			CqlValueSet es_ = this.Scleritis();
			IEnumerable<Condition> et_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, es_, default));
			...
			IEnumerable<Condition> ex_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ew_, default));
			CqlValueSet ey_ = this.Traumatic_Cataract();
			IEnumerable<Condition> ez_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, ey_, default));
			...
			IEnumerable<Condition> fd_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, fc_, default));
			CqlValueSet fe_ = this.Vascular_Disorders_of_Iris_and_Ciliary_Body();
			IEnumerable<Condition> ff_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, fe_, default));
			...
			IEnumerable<Condition> fj_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, fi_, default));
	...
	private IEnumerable<Procedure> Numerator_Value()
	{
		...
		IEnumerable<Procedure> b_(Procedure CataractSurgeryPerformed)
		{
			...
			IEnumerable<Observation> f_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, e_));
			CqlValueSet g_ = this.Best_Corrected_Visual_Acuity_Exam_Using_Snellen_Chart();
			IEnumerable<Observation> h_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, g_, default));
