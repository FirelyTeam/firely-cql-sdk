...
public static class AlaraCTIQRFHIR_0_1_000
{
	...
	public static CqlCode Calculated_CT_global_noise(CqlContext context) => 
		new CqlCode("96912-1", "http://loinc.org", default, default);

    [CqlDeclaration("Calculated CT size-adjusted dose")]
	public static CqlCode Calculated_CT_size_adjusted_dose(CqlContext context) => 
		new CqlCode("96913-9", "http://loinc.org", default, default);

    [CqlDeclaration("CT dose and image quality category")]
	public static CqlCode CT_dose_and_image_quality_category(CqlContext context) => 
	...
	public static IEnumerable<Encounter> Qualifying_Inpatient_Encounters(CqlContext context)
	{
		CqlValueSet a_ = AlaraCTIQRFHIR_0_1_000.Encounter_Inpatient(context);
		...
		bool? c_(Encounter InpatientEncounter)
		{
			...
			CqlInterval<CqlDateTime> g_ = AlaraCTIQRFHIR_0_1_000.Measurement_Period(context);
			bool? h_ = context.Operators.Overlaps(f_, g_, default);
			Patient i_ = AlaraCTIQRFHIR_0_1_000.Patient(context);
	...
	public static IEnumerable<Observation> Initial_Population(CqlContext context)
	{
		CqlCode a_ = AlaraCTIQRFHIR_0_1_000.CT_dose_and_image_quality_category(context);
		...
		{
			IEnumerable<Encounter> f_ = AlaraCTIQRFHIR_0_1_000.Qualifying_Inpatient_Encounters(context);
			bool? g_(Encounter InpatientEncounters)
			{
				...
				CqlInterval<CqlDateTime> r_ = AlaraCTIQRFHIR_0_1_000.Measurement_Period(context);
	...
	public static decimal? Global_Noise_Value(CqlContext context, Observation Obs)
	{
		...
		bool? b_(Observation.ComponentComponent C)
		{
			...
			CqlCode i_ = AlaraCTIQRFHIR_0_1_000.Calculated_CT_global_noise(context);
	...
	public static decimal? Size_Adjusted_Value(CqlContext context, Observation Obs)
	{
		List<Observation.ComponentComponent> a_ = Obs?.Component;
		bool? b_(Observation.ComponentComponent C)
		{
			CodeableConcept g_ = C?.Code;
			CqlConcept h_ = FHIRHelpers_4_3_000.ToConcept(context, g_);
			CqlCode i_ = AlaraCTIQRFHIR_0_1_000.Calculated_CT_size_adjusted_dose(context);
			CqlConcept j_ = context.Operators.ConvertCodeToConcept(i_);
			bool? k_ = context.Operators.Equivalent(h_, j_);
			DataType l_ = C?.Value;
			object m_ = FHIRHelpers_4_3_000.ToValue(context, l_);
	...
	public static IEnumerable<Observation> Denominator(CqlContext context)
	{
		IEnumerable<Observation> a_ = AlaraCTIQRFHIR_0_1_000.Initial_Population(context);
		bool? b_(Observation IP)
		{
			decimal? d_ = AlaraCTIQRFHIR_0_1_000.Global_Noise_Value(context, IP);
			bool? e_ = context.Operators.Not((bool?)(d_ is null));
			decimal? f_ = AlaraCTIQRFHIR_0_1_000.Size_Adjusted_Value(context, IP);
	...
	public static bool? Qualifies(CqlContext context, Observation Obs, string code, decimal? noiseThreshold, decimal? sizeDoseThreshold)
	{
		...
		decimal? i_ = AlaraCTIQRFHIR_0_1_000.Global_Noise_Value(context, Obs);
		bool? j_ = context.Operators.GreaterOrEqual(i_, noiseThreshold);
		decimal? k_ = AlaraCTIQRFHIR_0_1_000.Size_Adjusted_Value(context, Obs);
	...
	public static bool? CT_Scan_Qualifies(CqlContext context, Observation IP)
	{
		...
		bool? n_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "CARDIAC LD", l_, m_);
		...
		bool? r_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "CARDIAC RT", p_, q_);
		bool? s_ = context.Operators.Or(o_, r_);
		decimal? u_ = context.Operators.ConvertIntegerToDecimal(377);
		bool? v_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "CHEST LD", l_, u_);
		bool? w_ = context.Operators.Or(s_, v_);
		decimal? x_ = context.Operators.ConvertIntegerToDecimal(49);
		bool? z_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "CHEST RT", x_, u_);
		bool? aa_ = context.Operators.Or(w_, z_);
		decimal? ac_ = context.Operators.ConvertIntegerToDecimal(1282);
		bool? ad_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "CHEST-CARDIAC HD", x_, ac_);
		...
		bool? ah_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "HEAD LD", af_, ag_);
		bool? ai_ = context.Operators.Or(ae_, ah_);
		decimal? ak_ = context.Operators.ConvertIntegerToDecimal(1025);
		bool? al_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "HEAD RT", af_, ak_);
		bool? am_ = context.Operators.Or(ai_, al_);
		decimal? ao_ = context.Operators.ConvertIntegerToDecimal(1832);
		bool? ap_ = AlaraCTIQRFHIR_0_1_000.Qualifies(context, IP, "HEAD HD", af_, ao_);
	...
	public static IEnumerable<Observation> Numerator(CqlContext context)
	{
		IEnumerable<Observation> a_ = AlaraCTIQRFHIR_0_1_000.Denominator(context);
		bool? b_(Observation Denom)
		{
			bool? d_ = AlaraCTIQRFHIR_0_1_000.CT_Scan_Qualifies(context, Denom);
	...
	public static IEnumerable<Observation> Denominator_Exclusion(CqlContext context)
	{
		IEnumerable<Observation> a_ = AlaraCTIQRFHIR_0_1_000.Denominator(context);
		bool? b_(Observation Denom)
		{
