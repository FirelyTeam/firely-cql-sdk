...
public static partial class UrinarySymptomScoreChangeAfterBenignProstaticHyperplasiaFHIR_1_3_000ServiceCollectionExtensions
{
    ...
    {
        services.TryAddSingleton<UrinarySymptomScoreChangeAfterBenignProstaticHyperplasiaFHIR_1_3_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["UrinarySymptomScoreChangeAfterBenignProstaticHyperplasiaFHIR_1_3_000"]);
            return ActivatorUtilities.CreateInstance<UrinarySymptomScoreChangeAfterBenignProstaticHyperplasiaFHIR_1_3_000>(sp);
        });
