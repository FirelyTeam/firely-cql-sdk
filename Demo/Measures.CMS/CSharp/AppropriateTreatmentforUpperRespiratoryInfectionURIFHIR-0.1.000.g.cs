...
public class AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000
{
	...
	private IEnumerable<Encounter> Qualifying_Encounters_Value()
	{
		...
		IEnumerable<Encounter> ak_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, aj_, default));
		...
		IEnumerable<Encounter> aq_ = context.Operators.Retrieve<Encounter>(new RetrieveParameters(default, ap_, default));
		IEnumerable<Encounter> ar_ = context.Operators.Retrieve<Encounter>(default);
	...
	private IEnumerable<Encounter> Denominator_Exclusions_Value()
	{
		...
		IEnumerable<MedicationRequest> i_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, h_, default));
		IEnumerable<MedicationRequest> k_ = context.Operators.Retrieve<MedicationRequest>(new RetrieveParameters(default, h_, default));
