...
public partial class AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000 : ILibrary, ISingleton<AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000>
{
    ...
    public ILibrary[] Dependencies => [FHIRHelpers_4_3_000.Instance, SupplementalDataElements_3_4_000.Instance, CQMCommon_2_0_000.Instance, Hospice_6_9_000.Instance, Status_1_6_000.Instance, QICoreCommon_2_0_000.Instance, Antibiotic_1_5_000.Instance];
	...
	public IEnumerable<Encounter> Qualifying_Encounters(CqlContext context)
	{
		...
		bool? as_(Encounter E)
		{
			...
			{
				CqlConcept bf_ = FHIRHelpers_4_3_000.Instance.ToConcept(context, @this);
		...
		IEnumerable<Encounter> aw_ = Status_1_6_000.Instance.Finished_Encounter(context, av_);
	...
	public IEnumerable<Encounter> Denominator_Exclusions(CqlContext context)
	{
		...
		IEnumerable<Encounter> e_ = Antibiotic_1_5_000.Instance.Has_Comorbid_Condition_History(context, b_, d_);
		...
		IEnumerable<Encounter> m_ = Antibiotic_1_5_000.Instance.Has_Antibiotic_Medication_History(context, b_, l_);
		...
		IEnumerable<Encounter> q_ = Antibiotic_1_5_000.Instance.Has_Competing_Diagnosis_History(context, b_, p_);
	...
	public IEnumerable<Encounter> Numerator(CqlContext context)
	{
		...
		IEnumerable<Encounter> c_(Encounter EncounterWithURI)
		{
			...
			bool? m_(MedicationRequest OrderedAntibiotic)
			{
				...
				CqlInterval<CqlDateTime> x_ = FHIRHelpers_4_3_000.Instance.ToInterval(context, s_);
				...
				CqlInterval<CqlDateTime> af_ = FHIRHelpers_4_3_000.Instance.ToInterval(context, s_);
				CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.Instance.ToInterval(context, af_ as object);
