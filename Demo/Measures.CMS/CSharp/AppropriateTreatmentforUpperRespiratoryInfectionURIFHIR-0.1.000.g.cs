...
public static class AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000
{
	...
	public static CqlValueSet Antibiotic_Medications_for_Upper_Respiratory_Infection(CqlContext context) => 
	...
	public static CqlValueSet Upper_Respiratory_Infection(CqlContext context) => 
	...
	{
		CqlValueSet a_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Emergency_Department_Evaluation_and_Management_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Initial_Hospital_Observation_Care(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Medical_Disability_Exam(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Observation(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Outpatient_Consultation(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care_Services_Group_Counseling(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		IEnumerable<Encounter> v_ = context.Operators.Union<Encounter>(s_, u_);
		IEnumerable<Encounter> w_ = context.Operators.Union<Encounter>(q_, v_);
		CqlValueSet x_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care_Services_Individual_Counseling(context);
		IEnumerable<Encounter> y_ = context.Operators.RetrieveByValueSet<Encounter>(x_, default);
		CqlValueSet z_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care_Services__Initial_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> aa_ = context.Operators.RetrieveByValueSet<Encounter>(z_, default);
		IEnumerable<Encounter> ab_ = context.Operators.Union<Encounter>(y_, aa_);
		IEnumerable<Encounter> ac_ = context.Operators.Union<Encounter>(w_, ab_);
		CqlValueSet ad_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care__Established_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> ae_ = context.Operators.RetrieveByValueSet<Encounter>(ad_, default);
		CqlValueSet af_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		...
		CqlValueSet aj_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> ak_ = context.Operators.RetrieveByValueSet<Encounter>(aj_, default);
		CqlValueSet al_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Telephone_Visits(context);
		...
		CqlValueSet ap_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Online_Assessments(context);
		...
		bool? as_(Encounter E)
		{
			...
			{
				CqlCode bg_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Unlisted_preventive_medicine_service(context);
		...
		bool? ax_(Encounter ValidEncounter)
		{
			...
			CqlInterval<CqlDateTime> bn_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Measurement_Period(context);
	...
	public static IEnumerable<Encounter> Encounter_with_Upper_Respiratory_Infection(CqlContext context)
	{
		IEnumerable<Encounter> a_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Qualifying_Encounters(context);
		CqlValueSet b_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Upper_Respiratory_Infection(context);
	...
	{
		IEnumerable<Encounter> a_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Encounter_with_Upper_Respiratory_Infection(context);
		bool? b_(Encounter EncounterWithURI)
		{
			Patient f_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Patient(context);
			Date g_ = f_?.BirthDateElement;
			string h_ = g_?.Value;
			CqlDate i_ = context.Operators.ConvertStringToDate(h_);
			CqlInterval<CqlDateTime> j_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Measurement_Period(context);
	...
	public static IEnumerable<Encounter> Encounters_and_Assessments_with_Hospice_Patient(CqlContext context)
	{
		IEnumerable<Encounter> a_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Initial_Population(context);
	...
	{
		IEnumerable<Encounter> a_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Encounters_and_Assessments_with_Hospice_Patient(context);
		IEnumerable<Encounter> b_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Encounter_with_Upper_Respiratory_Infection(context);
		CqlValueSet c_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Comorbid_Conditions_for_Respiratory_Conditions(context);
		...
		CqlValueSet h_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Antibiotic_Medications_for_Upper_Respiratory_Infection(context);
		...
		CqlValueSet o_ = AppropriateTreatmentforUpperRespiratoryInfectionURIFHIR_0_1_000.Competing_Conditions_for_Respiratory_Conditions(context);
