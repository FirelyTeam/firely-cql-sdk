...
public static class ALARACTOQRFHIR_0_1_001
{
	...
	public static IEnumerable<Observation> Qualified_Scan(CqlContext context)
	{
		CqlCode a_ = ALARACTOQRFHIR_0_1_001.CT_dose_and_image_quality_category(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		bool? d_(Observation CTScan)
		{
			CqlInterval<CqlDateTime> f_ = ALARACTOQRFHIR_0_1_001.Measurement_Period(context);
			...
			Patient k_ = ALARACTOQRFHIR_0_1_001.Patient(context);
	...
	{
		IEnumerable<Observation> a_ = ALARACTOQRFHIR_0_1_001.Qualified_Scan(context);
		IEnumerable<Observation> c_(Observation CTScan)
		{
			CqlValueSet f_ = ALARACTOQRFHIR_0_1_001.Encounter_Inpatient(context);
			IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
			bool? h_(Encounter InpatientEncounter)
			{
				CqlInterval<CqlDateTime> l_ = ALARACTOQRFHIR_0_1_001.Measurement_Period(context);
	...
	public static decimal? Global_Noise_Value(CqlContext context, Observation Obs)
	{
		...
		bool? b_(Observation.ComponentComponent C)
		{
			...
			CqlCode i_ = ALARACTOQRFHIR_0_1_001.Calculated_CT_global_noise(context);
	...
	public static decimal? Size_Adjusted_Value(CqlContext context, Observation Obs)
	{
		...
		bool? b_(Observation.ComponentComponent C)
		{
			CodeableConcept g_ = C?.Code;
			CqlConcept h_ = FHIRHelpers_4_3_000.ToConcept(context, g_);
			CqlCode i_ = ALARACTOQRFHIR_0_1_001.Calculated_CT_size_adjusted_dose(context);
			CqlConcept j_ = context.Operators.ConvertCodeToConcept(i_);
			bool? k_ = context.Operators.Equivalent(h_, j_);
			DataType l_ = C?.Value;
			object m_ = FHIRHelpers_4_3_000.ToValue(context, l_);
	...
	{
		IEnumerable<Observation> a_ = ALARACTOQRFHIR_0_1_001.Initial_Population(context);
		bool? b_(Observation IP)
		{
			decimal? d_ = ALARACTOQRFHIR_0_1_001.Global_Noise_Value(context, IP);
			bool? e_ = context.Operators.Not((bool?)(d_ is null));
			decimal? f_ = ALARACTOQRFHIR_0_1_001.Size_Adjusted_Value(context, IP);
	...
	{
		IEnumerable<Observation> a_ = ALARACTOQRFHIR_0_1_001.Denominator(context);
	...
	public static bool? Qualifies(CqlContext context, Observation Obs, string code, decimal? noiseThreshold, decimal? sizeDoseThreshold)
	{
		...
		decimal? i_ = ALARACTOQRFHIR_0_1_001.Global_Noise_Value(context, Obs);
		bool? j_ = context.Operators.GreaterOrEqual(i_, noiseThreshold);
		decimal? k_ = ALARACTOQRFHIR_0_1_001.Size_Adjusted_Value(context, Obs);
	...
	public static bool? CT_Scan_Qualifies(CqlContext context, Observation IP)
	{
		...
		bool? c_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "ABDOPEL LD", a_, b_);
		decimal? d_ = context.Operators.ConvertIntegerToDecimal(29);
		decimal? e_ = context.Operators.ConvertIntegerToDecimal(644);
		bool? f_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "ABDOPEL RT", d_, e_);
		bool? g_ = context.Operators.Or(c_, f_);
		decimal? i_ = context.Operators.ConvertIntegerToDecimal(1260);
		bool? j_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "ABDOPEL HD", d_, i_);
		...
		bool? n_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "CARDIAC LD", l_, m_);
		...
		bool? r_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "CARDIAC RT", p_, q_);
		bool? s_ = context.Operators.Or(o_, r_);
		decimal? u_ = context.Operators.ConvertIntegerToDecimal(377);
		bool? v_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "CHEST LD", l_, u_);
		bool? w_ = context.Operators.Or(s_, v_);
		decimal? x_ = context.Operators.ConvertIntegerToDecimal(49);
		bool? z_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "CHEST RT", x_, u_);
		bool? aa_ = context.Operators.Or(w_, z_);
		decimal? ac_ = context.Operators.ConvertIntegerToDecimal(1282);
		bool? ad_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "CHEST-CARDIAC HD", x_, ac_);
		...
		bool? ah_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "HEAD LD", af_, ag_);
		bool? ai_ = context.Operators.Or(ae_, ah_);
		decimal? ak_ = context.Operators.ConvertIntegerToDecimal(1025);
		bool? al_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "HEAD RT", af_, ak_);
		bool? am_ = context.Operators.Or(ai_, al_);
		decimal? ao_ = context.Operators.ConvertIntegerToDecimal(1832);
		bool? ap_ = ALARACTOQRFHIR_0_1_001.Qualifies(context, IP, "HEAD HD", af_, ao_);
	...
	public static IEnumerable<Observation> Numerator(CqlContext context)
	{
		...
		bool? b_(Observation Denominator)
		{
			bool? d_ = ALARACTOQRFHIR_0_1_001.CT_Scan_Qualifies(context, Denominator);
