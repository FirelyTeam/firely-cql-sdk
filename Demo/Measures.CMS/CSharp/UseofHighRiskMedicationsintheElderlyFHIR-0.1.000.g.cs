...
public class UseofHighRiskMedicationsintheElderlyFHIR_0_1_000
{
	...
	public decimal? MedicationRequestPeriodInDays(MedicationRequest Request)
	{
		...
		decimal? b_(MedicationRequest R)
		{
			...
			CqlInterval<CqlQuantity> t_ = context.Operators.Convert<CqlInterval<CqlQuantity>>(s_);
			...
			CqlQuantity bb_ = CumulativeMedicationDuration_4_0_000.Quantity(at_, ba_);
			decimal? bc_ = CumulativeMedicationDuration_4_0_000.ToDaily(ah_ ?? an_, bb_);
