...
public static class HIVRetentionFHIR_0_1_000
{
	...
	public static CqlValueSet HIV_Viral_Load(CqlContext context) => 
	...
	public static CqlValueSet Preventive_Care_Services_Other(CqlContext context) => 
...
;
	...
	public static (IEnumerable<CqlCode> codes, string display)? SDE_Ethnicity(CqlContext context)
	{
		List<Extension> a_()
		{
			bool i_()
			{
				Patient j_ = HIVRetentionFHIR_0_1_000.Patient(context);
			...
			if (i_())
			{
				Patient l_ = HIVRetentionFHIR_0_1_000.Patient(context);
	...
	public static bool? Has_Active_HIV_Diagnosis_Starts_On_or_Before_First_240_Days_of_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = HIVRetentionFHIR_0_1_000.HIV(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		bool? c_(Condition HIVDx)
		{
			CqlInterval<CqlDateTime> f_ = QICoreCommon_2_0_000.prevalenceInterval(context, HIVDx);
			CqlDateTime g_ = context.Operators.Start(f_);
			CqlInterval<CqlDateTime> h_ = HIVRetentionFHIR_0_1_000.Measurement_Period(context);
			...
			bool? o_ = QICoreCommon_2_0_000.isActive(context, HIVDx);
	...
	public static bool? Has_Qualifying_Encounter_During_First_240_Days_of_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = HIVRetentionFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = HIVRetentionFHIR_0_1_000.Outpatient_Consultation(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = HIVRetentionFHIR_0_1_000.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = HIVRetentionFHIR_0_1_000.Face_to_Face_Interaction(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = HIVRetentionFHIR_0_1_000.Home_Healthcare_Services(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = HIVRetentionFHIR_0_1_000.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = HIVRetentionFHIR_0_1_000.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = HIVRetentionFHIR_0_1_000.Preventive_Care_Services__Initial_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> u_ = context.Operators.RetrieveByValueSet<Encounter>(t_, default);
		IEnumerable<Encounter> v_ = context.Operators.Union<Encounter>(s_, u_);
		IEnumerable<Encounter> w_ = context.Operators.Union<Encounter>(q_, v_);
		CqlValueSet x_ = HIVRetentionFHIR_0_1_000.Preventive_Care__Established_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> y_ = context.Operators.RetrieveByValueSet<Encounter>(x_, default);
		CqlValueSet z_ = HIVRetentionFHIR_0_1_000.Telephone_Visits(context);
		IEnumerable<Encounter> aa_ = context.Operators.RetrieveByValueSet<Encounter>(z_, default);
		IEnumerable<Encounter> ab_ = context.Operators.Union<Encounter>(y_, aa_);
		IEnumerable<Encounter> ac_ = context.Operators.Union<Encounter>(w_, ab_);
		CqlValueSet ad_ = HIVRetentionFHIR_0_1_000.Preventive_Care_Services_Other(context);
		...
		{
			CqlInterval<CqlDateTime> aj_ = HIVRetentionFHIR_0_1_000.Measurement_Period(context);
	...
	{
		bool? a_ = HIVRetentionFHIR_0_1_000.Has_Active_HIV_Diagnosis_Starts_On_or_Before_First_240_Days_of_Measurement_Period(context);
		bool? b_ = HIVRetentionFHIR_0_1_000.Has_Qualifying_Encounter_During_First_240_Days_of_Measurement_Period(context);
	...
	{
		bool? a_ = HIVRetentionFHIR_0_1_000.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Encounter During Measurement Period With HIV")]
	public static IEnumerable<Encounter> Encounter_During_Measurement_Period_With_HIV(CqlContext context)
	{
		CqlValueSet a_ = HIVRetentionFHIR_0_1_000.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = HIVRetentionFHIR_0_1_000.Outpatient_Consultation(context);
		...
		{
			CqlValueSet ai_ = HIVRetentionFHIR_0_1_000.HIV(context);
			IEnumerable<Condition> aj_ = context.Operators.RetrieveByValueSet<Condition>(ai_, default);
			bool? ak_(Condition HIVDiagnosis)
			{
				CqlInterval<CqlDateTime> ao_ = HIVRetentionFHIR_0_1_000.Measurement_Period(context);
				...
				CqlInterval<CqlDateTime> as_()
				{
					bool az_()
					{
						CqlInterval<CqlDateTime> ba_ = QICoreCommon_2_0_000.prevalenceInterval(context, HIVDiagnosis);
					...
					{
						CqlInterval<CqlDateTime> bc_ = QICoreCommon_2_0_000.prevalenceInterval(context, HIVDiagnosis);
				...
				CqlInterval<CqlDateTime> au_ = FHIRHelpers_4_3_000.ToInterval(context, ap_);
				bool? av_ = context.Operators.SameOrBefore(as_(), au_, "day");
				bool? aw_ = context.Operators.And(ar_, av_);
				bool? ax_ = QICoreCommon_2_0_000.isActive(context, HIVDiagnosis);
	...
	public static bool? Has_HIV_Viral_Load_Test_During_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = HIVRetentionFHIR_0_1_000.HIV_Viral_Load(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		bool? c_(Observation ViralLoadTest)
		{
			CqlInterval<CqlDateTime> f_ = HIVRetentionFHIR_0_1_000.Measurement_Period(context);
	...
	public static bool? Has_One_Encounter_With_HIV_and_One_Viral_Load_Test_At_Least_90_Days_Apart(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HIVRetentionFHIR_0_1_000.Encounter_During_Measurement_Period_With_HIV(context);
		IEnumerable<Encounter> b_(Encounter EncounterWithHIV)
		{
			CqlValueSet e_ = HIVRetentionFHIR_0_1_000.HIV_Viral_Load(context);
			IEnumerable<Observation> f_ = context.Operators.RetrieveByValueSet<Observation>(e_, default);
			bool? g_(Observation ViralLoadTest)
			{
				CqlInterval<CqlDateTime> k_ = HIVRetentionFHIR_0_1_000.Measurement_Period(context);
				...
				object q_ = FHIRHelpers_4_3_000.ToValue(context, l_);
				...
				CqlInterval<CqlDateTime> aa_ = FHIRHelpers_4_3_000.ToInterval(context, t_);
				CqlDateTime ab_ = context.Operators.Start(aa_);
				object ad_ = FHIRHelpers_4_3_000.ToValue(context, l_);
	...
	public static bool? Has_Two_Encounters_With_HIV_At_Least_90_Days_Apart(CqlContext context)
	{
		IEnumerable<Encounter> a_ = HIVRetentionFHIR_0_1_000.Encounter_During_Measurement_Period_With_HIV(context);
		IEnumerable<Encounter> b_(Encounter EncounterWithHIV)
		{
			IEnumerable<Encounter> e_ = HIVRetentionFHIR_0_1_000.Encounter_During_Measurement_Period_With_HIV(context);
	...
	{
		bool? a_ = HIVRetentionFHIR_0_1_000.Has_One_Encounter_With_HIV_and_One_Viral_Load_Test_At_Least_90_Days_Apart(context);
		bool? b_ = HIVRetentionFHIR_0_1_000.Has_Two_Encounters_With_HIV_At_Least_90_Days_Apart(context);
