...
public static class DiabetesEyeExamFHIR_0_0_001
{
	...
	public static CqlValueSet Retinal_or_Dilated_Eye_Exam(CqlContext context) => 
	...
	{
		CqlValueSet a_ = DiabetesEyeExamFHIR_0_0_001.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = DiabetesEyeExamFHIR_0_0_001.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = DiabetesEyeExamFHIR_0_0_001.Preventive_Care_Services_Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = DiabetesEyeExamFHIR_0_0_001.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = DiabetesEyeExamFHIR_0_0_001.Home_Healthcare_Services(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = DiabetesEyeExamFHIR_0_0_001.Ophthalmological_Services(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = DiabetesEyeExamFHIR_0_0_001.Telephone_Visits(context);
		...
		{
			CqlInterval<CqlDateTime> x_ = DiabetesEyeExamFHIR_0_0_001.Measurement_Period(context);
	...
	{
		Patient a_ = DiabetesEyeExamFHIR_0_0_001.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = DiabetesEyeExamFHIR_0_0_001.Measurement_Period(context);
		CqlDateTime f_ = context.Operators.End(e_);
		CqlDate g_ = context.Operators.DateFrom(f_);
		int? h_ = context.Operators.CalculateAgeAt(d_, g_, "year");
		CqlInterval<int?> i_ = context.Operators.Interval(18, 75, true, true);
		bool? j_ = context.Operators.In<int?>(h_, i_, default);
		IEnumerable<Encounter> k_ = DiabetesEyeExamFHIR_0_0_001.Qualifying_Encounters(context);
		bool? l_ = context.Operators.Exists<Encounter>(k_);
		bool? m_ = context.Operators.And(j_, l_);
		CqlValueSet n_ = DiabetesEyeExamFHIR_0_0_001.Diabetes(context);
		...
		bool? p_(Condition Diabetes)
		{
			...
			CqlInterval<CqlDateTime> u_ = DiabetesEyeExamFHIR_0_0_001.Measurement_Period(context);
	...
	{
		bool? a_ = DiabetesEyeExamFHIR_0_0_001.Initial_Population(context);
	...
	public static bool? Diabetic_Retinopathy_Overlapping_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = DiabetesEyeExamFHIR_0_0_001.Diabetic_Retinopathy(context);
		...
		bool? c_(Condition Retinopathy)
		{
			...
			CqlInterval<CqlDateTime> g_ = DiabetesEyeExamFHIR_0_0_001.Measurement_Period(context);
	...
	public static IEnumerable<Observation> Retinal_Exam_in_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = DiabetesEyeExamFHIR_0_0_001.Retinal_or_Dilated_Eye_Exam(context);
		...
		{
			CqlInterval<CqlDateTime> f_ = DiabetesEyeExamFHIR_0_0_001.Measurement_Period(context);
	...
	public static IEnumerable<Observation> Retinal_Exam_in_Measurement_Period_or_Year_Prior(CqlContext context)
	{
		CqlValueSet a_ = DiabetesEyeExamFHIR_0_0_001.Retinal_or_Dilated_Eye_Exam(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		IEnumerable<Observation> c_ = Status_1_6_000.isAssessmentPerformed(context, b_);
	...
	{
		bool? a_ = DiabetesEyeExamFHIR_0_0_001.Diabetic_Retinopathy_Overlapping_Measurement_Period(context);
		IEnumerable<Observation> b_ = DiabetesEyeExamFHIR_0_0_001.Retinal_Exam_in_Measurement_Period(context);
		bool? c_ = context.Operators.Exists<Observation>(b_);
		bool? d_ = context.Operators.And(a_, c_);
		bool? f_ = context.Operators.Not(a_);
		IEnumerable<Observation> g_ = DiabetesEyeExamFHIR_0_0_001.Retinal_Exam_in_Measurement_Period_or_Year_Prior(context);
