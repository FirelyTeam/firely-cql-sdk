...
public partial class ColonCancerScreeningFHIR_minus_0_1_000 : ILibrary, ISingleton<ColonCancerScreeningFHIR_minus_0_1_000>
{
    private ColonCancerScreeningFHIR_minus_0_1_000() {}

    public static ColonCancerScreeningFHIR_minus_0_1_000 Instance { get; } = new();

    #region ILibrary Implementation

    public string Name => "ColonCancerScreeningFHIR";
    public string Version => "0.1.000";
    public ILibrary[] Dependencies => [FHIRHelpers_minus_4_4_000.Instance, SupplementalDataElements_minus_3_5_000.Instance, Hospice_minus_6_12_000.Instance, PalliativeCare_minus_1_11_000.Instance, AdultOutpatientEncounters_minus_4_11_000.Instance, AdvancedIllnessandFrailty_minus_1_16_000.Instance, Status_minus_1_8_000.Instance, QICoreCommon_minus_2_1_000.Instance];
    ...
    public IEnumerable<Condition> Malignant_Neoplasm(CqlContext context)
    {
        ...
        {
            CqlInterval<CqlDateTime> e_ = QICoreCommon_minus_2_1_000.Instance.prevalenceInterval(context, ColorectalCancer);
    ...
    public bool? Denominator_Exclusion(CqlContext context)
    {
        ...
        bool? h_ = AdvancedIllnessandFrailty_minus_1_16_000.Instance.Is_Age_66_or_Older_with_Advanced_Illness_and_Frailty(context);
        bool? i_ = context.Operators.Or(g_, h_);
        bool? j_ = AdvancedIllnessandFrailty_minus_1_16_000.Instance.Is_Age_66_or_Older_Living_Long_Term_in_a_Nursing_Home(context);
        bool? k_ = context.Operators.Or(i_, j_);
        bool? l_ = PalliativeCare_minus_1_11_000.Instance.Has_Palliative_Care_in_the_Measurement_Period(context);
    ...
    public IEnumerable<Observation> Fecal_Occult_Blood_Test_Performed(CqlContext context)
    {
        ...
        bool? d_(Observation FecalOccultResult)
        {
            ...
            CqlDateTime j_ = QICoreCommon_minus_2_1_000.Instance.latest(context, i_());
