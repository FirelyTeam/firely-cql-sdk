...
public class ColonCancerScreeningFHIR_0_1_000(
    ...
    AdultOutpatientEncounters_4_8_000 _AdultOutpatientEncounters_4_8_000,
    ...
    QICoreCommon_2_0_000 _QICoreCommon_2_0_000)
{
	...
	public  bool? Initial_Population(CqlContext context)
	{
		...
		IEnumerable<Encounter> k_ = _AdultOutpatientEncounters_4_8_000.Qualifying_Encounters(context);
	...
	public  IEnumerable<Condition> Malignant_Neoplasm(CqlContext context)
	{
		...
		{
			CqlInterval<CqlDateTime> f_ = _QICoreCommon_2_0_000.ToPrevalenceInterval(context, ColorectalCancer);
	...
	public  bool? Denominator_Exclusion(CqlContext context)
	{
		...
		bool? h_ = _AdvancedIllnessandFrailty_1_8_000.Is_Age_66_or_Older_with_Advanced_Illness_and_Frailty(context);
		bool? i_ = context.Operators.Or(g_, h_);
		bool? j_ = _AdvancedIllnessandFrailty_1_8_000.Is_Age_66_or_Older_Living_Long_Term_in_a_Nursing_Home(context);
		bool? k_ = context.Operators.Or(i_, j_);
		bool? l_ = _PalliativeCare_1_9_000.Has_Palliative_Care_in_the_Measurement_Period(context);
	...
	public  IEnumerable<Observation> Fecal_Occult_Blood_Test_Performed(CqlContext context)
	{
		...
		bool? d_(Observation FecalOccultResult)
		{
			...
			CqlDateTime j_ = _QICoreCommon_2_0_000.Latest(context, i_());
	...
	public  IEnumerable<Observation> CT_Colonography_Performed(CqlContext context)
	{
		...
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		IEnumerable<Observation> c_ = _Status_1_6_000.Final_Observation(context, b_);
