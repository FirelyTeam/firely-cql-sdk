...
public static partial class ChildandAdolescentMajorDepressiveDisorderMDDSuicideRiskAssessmentFHIR_0_1_000ServiceCollectionExtensions
{
    ...
    {
        services.TryAddSingleton<ChildandAdolescentMajorDepressiveDisorderMDDSuicideRiskAssessmentFHIR_0_1_000>(sp =>
        {
            System.IO.File.AppendAllLines("C:\\temp\\library.txt", ["ChildandAdolescentMajorDepressiveDisorderMDDSuicideRiskAssessmentFHIR_0_1_000"]);
            return ActivatorUtilities.CreateInstance<ChildandAdolescentMajorDepressiveDisorderMDDSuicideRiskAssessmentFHIR_0_1_000>(sp);
        });
