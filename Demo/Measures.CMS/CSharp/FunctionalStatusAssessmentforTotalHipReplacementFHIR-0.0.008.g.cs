...
;
	...
	private bool? Has_Severe_Cognitive_Impairment_Value()
	{
		...
		IEnumerable<Condition> c_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, b_));
	...
	private IEnumerable<CqlDate> Date_HOOS_Total_Assessment_Completed_Value()
	{
		...
		IEnumerable<Observation> o_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, n_));
		...
		IEnumerable<Observation> s_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, r_));
