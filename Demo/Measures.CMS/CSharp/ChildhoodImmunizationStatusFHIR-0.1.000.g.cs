...
public class ChildhoodImmunizationStatusFHIR_0_1_000
{
	...
	private IEnumerable<Encounter> Qualifying_Encounters_Value()
	{
		...
		IEnumerable<Encounter> l_ = context.Operators.Retrieve<Encounter>(default);
		bool? m_(Encounter E)
		{
	...
	private IEnumerable<CqlDate> DTaP_Immunizations_or_Procedures_Value()
	{
		...
		IEnumerable<Immunization> b_ = context.Operators.Retrieve<Immunization>(new RetrieveParameters(default, a_, default));
		...
		IEnumerable<Procedure> i_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, h_, default));
	...
	private IEnumerable<CqlDate> NewBorn_Vaccine_Requirement_Value()
	{
		...
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Procedure> c_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, default, b_));
	...
	private IEnumerable<Condition> Varicella_Zoster_Numerator_Inclusion_Conditions_Value()
	{
		...
		IEnumerable<Condition> e_ = context.Operators.Retrieve<Condition>(new RetrieveParameters(default, default, d_));
	...
	private IEnumerable<CqlDate> Rotavirus_2_Dose_Immunizations_or_Procedures_Value()
	{
		...
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Immunization> c_ = context.Operators.Retrieve<Immunization>(new RetrieveParameters(default, default, b_));
		...
		IEnumerable<Procedure> j_ = context.Operators.Retrieve<Procedure>(new RetrieveParameters(default, i_, default));
