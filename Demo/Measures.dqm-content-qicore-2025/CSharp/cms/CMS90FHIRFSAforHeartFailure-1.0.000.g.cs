...
public partial class CMS90FHIRFSAforHeartFailure_1_0_000 : ILibrary, ISingleton<CMS90FHIRFSAforHeartFailure_1_0_000>
{
    ...
    private IEnumerable<CqlDate?>? Date_PROMIS10_Total_Assessment_Completed_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? PROMIS10MentalScore, Observation? PROMIS10PhysicalScore)?>? l_ = context.Operators.SelectWhere<ValueTuple<Observation?, Observation?>, (CqlTupleMetadata, Observation? PROMIS10MentalScore, Observation? PROMIS10PhysicalScore)?>((IEnumerable<ValueTuple<Observation, Observation>>?)i_, j_, k_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_PROMIS10_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialPROMIS10Date, CqlDate? FollowupPROMIS10Date)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialPROMIS10Date, CqlDate? FollowupPROMIS10Date)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_PROMIS29_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialPROMIS29Date, CqlDate? FollowupPROMIS29Date)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialPROMIS29Date, CqlDate? FollowupPROMIS29Date)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_VR12_Oblique_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR12ObliqueDate, CqlDate? FollowupVR12ObliqueDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR12ObliqueDate, CqlDate? FollowupVR12ObliqueDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR12OrthogonalDate, CqlDate? FollowupVR12OrthogonalDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR12OrthogonalDate, CqlDate? FollowupVR12OrthogonalDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private IEnumerable<CqlDate?>? Date_VR36_Oblique_Total_Assessment_Completed_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? VR36MentalAssessment, Observation? VR36PhysicalAssessment)?>? l_ = context.Operators.SelectWhere<ValueTuple<Observation?, Observation?>, (CqlTupleMetadata, Observation? VR36MentalAssessment, Observation? VR36PhysicalAssessment)?>((IEnumerable<ValueTuple<Observation, Observation>>?)i_, j_, k_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_VR36_Oblique_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR36ObliqueDate, CqlDate? FollowupVR36ObliqueDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR36ObliqueDate, CqlDate? FollowupVR36ObliqueDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_VR36_Orthogonal_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR36OrthogonalDate, CqlDate? FollowupVR36OrthogonalDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialVR36OrthogonalDate, CqlDate? FollowupVR36OrthogonalDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private IEnumerable<CqlDate?>? Date_MLHFQ_Total_Assessment_Completed_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? MLHFQPhysical, Observation? MLHFQEmotional)?>? l_ = context.Operators.SelectWhere<ValueTuple<Observation?, Observation?>, (CqlTupleMetadata, Observation? MLHFQPhysical, Observation? MLHFQEmotional)?>((IEnumerable<ValueTuple<Observation, Observation>>?)i_, j_, k_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_MLHFQ_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialMLHFQDate, CqlDate? FollowupMLHFQDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialMLHFQDate, CqlDate? FollowupMLHFQDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private IEnumerable<CqlDate?>? Date_KCCQ12_Total_Assessment_Completed_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? KCCQ12Item, Observation? KCCQ12Summary)?>? l_ = context.Operators.SelectWhere<ValueTuple<Observation?, Observation?>, (CqlTupleMetadata, Observation? KCCQ12Item, Observation? KCCQ12Summary)?>((IEnumerable<ValueTuple<Observation, Observation>>?)i_, j_, k_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ12_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQ12Date, CqlDate? FollowupKCCQ12Date)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQ12Date, CqlDate? FollowupKCCQ12Date)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Domain_Score_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQAssessmentDate, CqlDate? FollowupKCCQAssessmentDate)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQAssessmentDate, CqlDate? FollowupKCCQAssessmentDate)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Encounter_with_Initial_and_Follow_Up_KCCQ_Total_Score_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQTotalScore, CqlDate? FollowupKCCQTotalScore)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, CqlDate?, CqlDate?>, (CqlTupleMetadata, Encounter? ValidEncounters, CqlDate? InitialKCCQTotalScore, CqlDate? FollowupKCCQTotalScore)?>((IEnumerable<ValueTuple<Encounter, CqlDate, CqlDate>>?)c_, d_, e_);
