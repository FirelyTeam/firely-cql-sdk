...
public partial class CMS56FHIRFuncStatHipReplacement_1_0_000 : ILibrary, ISingleton<CMS56FHIRFuncStatHipReplacement_1_0_000>
{
    ...
    private bool? Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments_Compute(CqlContext context)
    {
        ...
        IEnumerable<CqlInterval<CqlDateTime?>?>? e_ = context.Operators.Where<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)c_, d_);
        ...
        bool? g_ = context.Operators.WhereAny<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)e_, f_);
        return g_;
    }
