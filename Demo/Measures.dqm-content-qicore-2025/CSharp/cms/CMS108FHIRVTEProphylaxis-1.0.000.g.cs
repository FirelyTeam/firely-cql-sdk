...
public partial class CMS108FHIRVTEProphylaxis_1_0_000 : ILibrary, ISingleton<CMS108FHIRVTEProphylaxis_1_0_000>
{
    ...
    private IEnumerable<Encounter?>? Encounter_With_Intervention_Comfort_Measures_On_Day_Of_Or_Day_After_Procedure_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? ComfortMeasure)?>? h_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, object?>, (CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? ComfortMeasure)?>((IEnumerable<ValueTuple<Encounter, Procedure, object>>?)e_, f_, g_);
    ...
    private IEnumerable<Encounter?>? Encounter_With_VTE_Prophylaxis_Received_From_Day_Of_Start_Of_Hospitalization_To_Day_After_Admission_Or_Procedure_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounter, object? VTEProphylaxis)?>? f_ = context.Operators.SelectWhere<ValueTuple<Encounter?, object?>, (CqlTupleMetadata, Encounter? QualifyingEncounter, object? VTEProphylaxis)?>((IEnumerable<ValueTuple<Encounter, object>>?)c_, d_, e_);
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? VTEProphylaxis)?>? n_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, object?>, (CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? VTEProphylaxis)?>((IEnumerable<ValueTuple<Encounter, Procedure, object>>?)k_, l_, m_);
    ...
    private IEnumerable<Encounter?>? Encounter_With_Medication_Oral_Factor_Xa_Inhibitor_Administered_On_Day_Of_Or_Day_After_Admission_Or_Procedure_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounter, MedicationAdministration? FactorXaMedication)?>? k_ = context.Operators.SelectWhere<ValueTuple<Encounter?, MedicationAdministration?>, (CqlTupleMetadata, Encounter? QualifyingEncounter, MedicationAdministration? FactorXaMedication)?>((IEnumerable<ValueTuple<Encounter, MedicationAdministration>>?)h_, i_, j_);
    ...
    private IEnumerable<(CqlTupleMetadata, string? id, IEnumerable<CqlConcept?>? medicationStatusReason, CqlDateTime? authoredOn)?>? No_VTE_Prophylaxis_Medication_Administered_Or_Ordered_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, MedicationRequest? MedicationOrderReject, Task? T)?>? bt_ = context.Operators.SelectWhere<ValueTuple<MedicationRequest?, Task?>, (CqlTupleMetadata, MedicationRequest? MedicationOrderReject, Task? T)?>((IEnumerable<ValueTuple<MedicationRequest, Task>>?)bq_, br_, bs_);
    ...
    private IEnumerable<(CqlTupleMetadata, string? id, CqlConcept? requestStatusReason, CqlDateTime? authoredOn)?>? No_Mechanical_VTE_Prophylaxis_Performed_Or_Ordered_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, ServiceRequest? DeviceOrderReject, Task? T)?>? aa_ = context.Operators.SelectWhere<ValueTuple<ServiceRequest?, Task?>, (CqlTupleMetadata, ServiceRequest? DeviceOrderReject, Task? T)?>((IEnumerable<ValueTuple<ServiceRequest, Task>>?)x_, y_, z_);
    ...
    private IEnumerable<Encounter?>? No_VTE_Prophylaxis_Due_To_Patient_Refusal_On_Day_Of_Or_Day_After_Procedure_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? PatientRefusal)?>? h_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, object?>, (CqlTupleMetadata, Encounter? QualifyingEncounter, Procedure? AnesthesiaProcedure, object? PatientRefusal)?>((IEnumerable<ValueTuple<Encounter, Procedure, object>>?)e_, f_, g_);
