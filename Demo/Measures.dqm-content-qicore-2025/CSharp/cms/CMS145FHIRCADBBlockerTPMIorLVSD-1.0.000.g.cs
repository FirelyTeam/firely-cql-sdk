...
public partial class CMS145FHIRCADBBlockerTPMIorLVSD_1_0_000 : ILibrary, ISingleton<CMS145FHIRCADBBlockerTPMIorLVSD_1_0_000>
{
    ...
    private bool? Has_Consecutive_Heart_Rates_Less_than_50_with_Qualifying_CAD_Encounter_and_Prior_MI_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? HeartRateExam, Encounter? CADEncounterMI)?>? f_ = context.Operators.SelectWhere<ValueTuple<Observation?, Encounter?>, (CqlTupleMetadata, Observation? HeartRateExam, Encounter? CADEncounterMI)?>((IEnumerable<ValueTuple<Observation, Encounter>>?)c_, d_, e_);
    ...
    private bool? Is_Currently_Taking_Beta_Blocker_Therapy_for_LVSD_Compute(CqlContext context)
    {
        ...
        bool? c_(MedicationRequest? ActiveBetaBlockerForLVSD) {
            ...
            bool? h_(Encounter? CADEncounterModerateOrSevereLVSD) {
                ...
                IEnumerable<CqlInterval<CqlDateTime?>?>? x_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)v_, w_, System.ComponentModel.ListSortDirection.Ascending);
                CqlInterval<CqlDateTime?>? y_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)x_)!);
    ...
    private bool? Has_Consecutive_Heart_Rates_Less_than_50_with_Qualifying_CAD_Encounter_and_History_of_Moderate_or_Severe_LVSD_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Observation? HeartRateExam, Encounter? CADEncounterModerateOrSevereLVSD)?>? f_ = context.Operators.SelectWhere<ValueTuple<Observation?, Encounter?>, (CqlTupleMetadata, Observation? HeartRateExam, Encounter? CADEncounterModerateOrSevereLVSD)?>((IEnumerable<ValueTuple<Observation, Encounter>>?)c_, d_, e_);
