...
public partial class CMS1218FHIRHHRF_1_0_000 : ILibrary, ISingleton<CMS1218FHIRHHRF_1_0_000>
{
    ...
    private IEnumerable<Procedure?>? Intubation_During_General_Anesthesia_And_MAC_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? ProceduralIntubation, Procedure? Anesthesia)?>? h_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, Procedure?>, (CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? ProceduralIntubation, Procedure? Anesthesia)?>((IEnumerable<ValueTuple<Encounter, Procedure, Procedure>>?)e_, f_, g_);
    ...
    private IEnumerable<Encounter?>? Encounter_With_Mechanical_Ventilation_Outside_Of_Procedural_Area_Within_30_Days_Of_End_Of_First_OR_Procedure_And_Preceded_By_Non_Invasive_Oxygen_Therapy_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Ventilation, object? OxygenSupport)?>? h_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, object?>, (CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Ventilation, object? OxygenSupport)?>((IEnumerable<ValueTuple<Encounter, Procedure, object>>?)e_, f_, g_);
    ...
    private IEnumerable<Procedure?>? Extubation_With_Preceding_Noninvasive_Oxygen_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Extubation, object? OxygenSupport)?>? i_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, object?>, (CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Extubation, object? OxygenSupport)?>((IEnumerable<ValueTuple<Encounter, Procedure, object>>?)f_, g_, h_);
    ...
    private IEnumerable<Procedure?>? Extubation_During_General_Anesthesia_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Extubation, Procedure? Anesthesia)?>? i_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Procedure?, Procedure?>, (CqlTupleMetadata, Encounter? EncounterWithSurgery, Procedure? Extubation, Procedure? Anesthesia)?>((IEnumerable<ValueTuple<Encounter, Procedure, Procedure>>?)f_, g_, h_);
    ...
    public IEnumerable<Claim.DiagnosisComponent?>? claimDiagnosesWithPOA(CqlContext context, Encounter? encounter)
    {
        ...
        IEnumerable<Claim.DiagnosisComponent?>? b_(Encounter? E) {
            ...
            IEnumerable<Claim.DiagnosisComponent?>? k_ = context.Operators.Flatten<Claim.DiagnosisComponent?>((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)((IEnumerable<IEnumerable<Claim.DiagnosisComponent?>?>?)j_)!);
            ...
            bool? l_(Claim.DiagnosisComponent? D) {
                ...
                IEnumerable<Claim.ItemComponent?>? an_ = context.Operators.Flatten<Claim.ItemComponent?>((IEnumerable<IEnumerable<Claim.ItemComponent>>)((IEnumerable<IEnumerable<Claim.ItemComponent?>?>?)am_)!);
                ...
                IEnumerable<int?>? at_ = context.Operators.Flatten<int?>(((IEnumerable<IEnumerable<int?>>)as_)!);
    ...
    public int? rank(CqlContext context, Procedure? targetProcedure, Encounter? parentEncounter)
    {
        ...
        IEnumerable<int?>? b_(Procedure? P) {
            ...
            IEnumerable<Claim.ProcedureComponent?>? l_ = context.Operators.Flatten<Claim.ProcedureComponent?>((IEnumerable<IEnumerable<Claim.ProcedureComponent>>)((IEnumerable<IEnumerable<Claim.ProcedureComponent?>?>?)k_)!);
    ...
    private IEnumerable<(CqlTupleMetadata, string? encounterId, string? procedureId, CqlConcept? procedureCode, int? procedureRank, CqlInterval<CqlDateTime?>? procedureTime)?>? Risk_Variable_Encounter_Procedures_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Procedure? TheProcedure, Encounter? QualifyingEncounter)?>? f_ = context.Operators.SelectWhere<ValueTuple<Procedure?, Encounter?>, (CqlTupleMetadata, Procedure? TheProcedure, Encounter? QualifyingEncounter)?>((IEnumerable<ValueTuple<Procedure, Encounter>>?)c_, d_, e_);
