...
public partial class CMS131FHIRDiabetesEyeExam_1_0_000 : ILibrary, ISingleton<CMS131FHIRDiabetesEyeExam_1_0_000>
{
    ...
    private bool? Initial_Population_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'and' (41:3-47:5) */ (/* CQL 'and' (41:3-44:42) */ ((CqlBoolean)j_
            && (CqlBoolean)k_())
            && (CqlBoolean)l_()));
    }
    ...
    private bool? Bilateral_Absence_of_Eyes_Compute(CqlContext context)
    {
        ...
        bool? g_(Condition BilateralAbsenceEyes) {
            CqlInterval<CqlDateTime> i_ = QICoreCommon_4_0_000.Instance.prevalenceInterval(context, BilateralAbsenceEyes);
    ...
    private bool? Denominator_Exclusions_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'or' (64:3-68:34) */ (/* CQL 'or' (64:3-67:69) */ (/* CQL 'or' (64:3-66:74) */ (/* CQL 'or' (64:3-65:73) */ ((CqlBoolean)a_
    ...
    private bool? Retinal_Exam_in_Measurement_Period_or_Year_Prior_Compute(CqlContext context)
    {
        ...
        bool? d_(Observation RetinalExam) {
            ...
            CqlDateTime j_ = context.Operators.End(f_);
    ...
    private bool? Autonomous_Eye_Exam_in_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? e_(Observation AutonomousEyeExam) {
            ...
            return (bool?)(/* CQL 'and' (83:5-84:87) */ ((CqlBoolean)j_
                && (CqlBoolean)k_()));
        }
    ...
    private bool? Has_Left_Eye_Retinopathy_Compute(CqlContext context)
    {
        ...
        bool? e_(Observation LeftEyeRetinopathy) {
            ...
            return (bool?)(/* CQL 'and' (113:5-114:88) */ ((CqlBoolean)j_
                && (CqlBoolean)k_()));
        }
    ...
    private bool? Has_Right_Eye_Retinopathy_Compute(CqlContext context)
    {
        ...
        bool? e_(Observation RightEyeRetinopathy) {
            ...
            return (bool?)(/* CQL 'and' (123:5-124:89) */ ((CqlBoolean)j_
                && (CqlBoolean)k_()));
        }
    ...
    private bool? Has_Right_Eye_No_Retinopathy_in_Year_Prior_Compute(CqlContext context)
    {
        ...
        bool? e_(Observation RightEyeNoRetinopathy) {
            DataType g_ = RightEyeNoRetinopathy?.Value;
            object h_ = FHIRHelpers_4_4_000.Instance.ToValue(context, g_);
            ...
            return (bool?)(/* CQL 'and' (118:5-119:157) */ ((CqlBoolean)k_
                && (CqlBoolean)l_()));
        }
    ...
    private bool? Has_Left_Eye_No_Retinopathy_in_Year_Prior_Compute(CqlContext context)
    {
        ...
        bool? e_(Observation LeftEyeNoRetinopathy) {
            DataType g_ = LeftEyeNoRetinopathy?.Value;
            object h_ = FHIRHelpers_4_4_000.Instance.ToValue(context, g_);
            CqlCode i_ = this.No_apparent_retinopathy(context);
            CqlConcept j_ = context.Operators.ConvertCodeToConcept(i_);
            bool? k_ = context.Operators.Equivalent(h_ as CqlConcept, j_);
            ...
            return (bool?)(/* CQL 'and' (108:5-109:156) */ ((CqlBoolean)k_
                && (CqlBoolean)l_()));
        }
    ...
    private bool? Retinal_Exam_Finding_with_Retinopathy_Severity_Level_in_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? b_() {
            ...
            return (bool?)(/* CQL 'and' (135:8-137:5) */ ((CqlBoolean)d_
        ...
        bool? c_() {
            ...
            return (bool?)(/* CQL 'and' (138:8-140:5) */ ((CqlBoolean)e_
                && (CqlBoolean)(this.Has_Left_Eye_No_Retinopathy_in_Year_Prior(context))));
        }

        return (bool?)(/* CQL 'or' (132:3-140:5) */ (/* CQL 'or' (132:3-137:5) */ (/* CQL 'and' (132:3-134:3) */ ((CqlBoolean)a_
    ...
    private bool? Retinal_Exam_Finding_with_No_Retinopathy_Severity_Level_in_Year_Prior_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'and' (127:3-129:3) */ ((CqlBoolean)a_
            && (CqlBoolean)(this.Has_Right_Eye_No_Retinopathy_in_Year_Prior(context))));
    }
    ...
    private bool? Numerator_Compute(CqlContext context)
    {
        ...
        bool? b_() {
            ...
            return (bool?)(/* CQL 'and' (74:8-76:5) */ ((CqlBoolean)!c_
                && (CqlBoolean)(this.Retinal_Exam_in_Measurement_Period_or_Year_Prior(context))));
        }

        return (bool?)(/* CQL 'or' (71:3-79:78) */ (/* CQL 'or' (71:3-78:83) */ (/* CQL 'or' (71:3-77:50) */ (/* CQL 'or' (71:3-76:5) */ (/* CQL 'and' (71:3-73:3) */ ((CqlBoolean)a_
