...
public partial class CMS645FHIRBoneDensityPCADTherapy_1_0_000 : ILibrary, ISingleton<CMS645FHIRBoneDensityPCADTherapy_1_0_000>
{
    ...
    private IEnumerable<CqlDateTime?>? Androgen_Deprivation_Therapy_for_Urology_Care_Medication_Active_Start_Dates_Compute(CqlContext context)
    {
        ...
        CqlDateTime? h_(MedicationRequest? ADTActive) {
            ...
            IEnumerable<CqlInterval<CqlDateTime?>?>? bd_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)bb_, bc_, System.ComponentModel.ListSortDirection.Ascending);
            CqlInterval<CqlDateTime?>? be_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)bd_)!);
            ...
            IEnumerable<CqlInterval<CqlDateTime?>?>? bt_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)br_, bs_, System.ComponentModel.ListSortDirection.Ascending);
            CqlInterval<CqlDateTime?>? bu_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)bt_)!);
    ...
    private IEnumerable<CqlDateTime?>? Androgen_Deprivation_Therapy_for_Urology_Care_Medication_Order_Start_Dates_Compute(CqlContext context)
    {
        ...
        CqlDateTime? h_(MedicationRequest? ADTOrder) {
            ...
            IEnumerable<CqlInterval<CqlDateTime?>?>? ay_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)aw_, ax_, System.ComponentModel.ListSortDirection.Ascending);
            CqlInterval<CqlDateTime?>? az_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)ay_)!);
            ...
            IEnumerable<CqlInterval<CqlDateTime?>?>? bo_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)bm_, bn_, System.ComponentModel.ListSortDirection.Ascending);
            CqlInterval<CqlDateTime?>? bp_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)bo_)!);
