...
public partial class CMS1173FHIRDiagnosticDelayVTE_1_0_000 : ILibrary, ISingleton<CMS1173FHIRDiagnosticDelayVTE_1_0_000>
{
    ...
    private IEnumerable<Encounter> Qualified_VTE_Encounters_Compute(CqlContext context)
    {
        ...
        bool? h_((CqlTupleMetadata, Encounter VTEEncounter, Encounter IndexPCP, DiagnosticReport VTEStudy, MedicationRequest AntiCoagulantOrdered)? tuple_bundjkpliiuyymiejivrqjjcd) {
            ...
            CqlInterval<CqlDateTime> aq_ = context.Operators.Interval(al_ as CqlDateTime, (ap_ as object) as CqlDateTime, false, true);
            ...
            CqlInterval<CqlDateTime> az_ = context.Operators.Interval(au_ as CqlDateTime, (ay_ as object) as CqlDateTime, false, true);
            ...
            CqlInterval<CqlDateTime> bi_ = context.Operators.Interval(bd_ as CqlDateTime, (bh_ as object) as CqlDateTime, false, true);
            ...
            CqlInterval<CqlDateTime> br_ = context.Operators.Interval(bm_ as CqlDateTime, (bq_ as object) as CqlDateTime, false, true);
