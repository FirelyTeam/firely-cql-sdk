...
public partial class CMS22FHIRPCSBPScreeningFollowUp_1_0_000 : ILibrary, ISingleton<CMS22FHIRPCSBPScreeningFollowUp_1_0_000>
{
    ...
    private IEnumerable<Encounter> Qualifying_Encounter_during_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? c_(Encounter ValidEncounter) {
            ...
            return (bool?)(/* CQL 'and' (145:5-147:43) */ (/* CQL 'and' (145:11-146:44) */ ((CqlBoolean)i_
                && (CqlBoolean)j_())
                && (CqlBoolean)k_()));
        }
    ...
    public bool? isVerified(CqlContext context, Condition condition)
    {
        ...
        bool? c_() {
            ...
            return (bool?)(/* CQL 'or' (408:52-412:3) */ (/* CQL 'or' (408:54-410:66) */ (/* CQL 'or' (408:54-409:66) */ ((CqlBoolean)h_
                || (CqlBoolean)i_())
                || (CqlBoolean)j_())
                || (CqlBoolean)k_()));
        }

        return (bool?)(/* CQL 'implies' (408:3-412:3) */ ((CqlBoolean)(!(!((bool?)(b_ is null))))
            || (CqlBoolean)c_()));
    }
    ...
    private IEnumerable<Encounter> Denominator_Exclusions_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? f_(Condition Hypertension) {
                ...
                return (bool?)(/* CQL 'and' (51:17-52:39) */ ((CqlBoolean)k_
    ...
    private IEnumerable<Encounter> Encounter_with_Normal_Blood_Pressure_Reading_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? e_(Observation BloodPressure) {
                ...
                return (bool?)(/* CQL 'and' (164:9-165:73) */ ((CqlBoolean)aa_
                    && (CqlBoolean)ab_()));
            }
            ...
            bool? t_() {
                ...
                bool? ar_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (164:9-165:73) */ ((CqlBoolean)bm_
                        && (CqlBoolean)bn_()));
                }
            ...
            return (bool?)(/* CQL 'and' (168:5-175:51) */ ((CqlBoolean)s_
                && (CqlBoolean)t_()));
        }
    ...
    private IEnumerable<Encounter> Encounter_with_Elevated_Blood_Pressure_Reading_SBP_120_to_129_AND_DBP_less_than_80_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? e_(Observation BloodPressure) {
                ...
                return (bool?)(/* CQL 'and' (180:9-181:73) */ ((CqlBoolean)aa_
                    && (CqlBoolean)ab_()));
            }
            ...
            bool? t_() {
                ...
                bool? ar_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (180:9-181:73) */ ((CqlBoolean)bm_
                        && (CqlBoolean)bn_()));
                }
            ...
            return (bool?)(/* CQL 'and' (184:5-192:5) */ ((CqlBoolean)s_
                && (CqlBoolean)t_()));
        }
    ...
    private IEnumerable<ServiceRequest> Referral_to_Alternate_or_Primary_Healthcare_Professional_for_Hypertensive_Reading_Compute(CqlContext context)
    {
        ...
        bool? c_(ServiceRequest Referral) {
            ...
            return (bool?)(/* CQL 'and' (118:5-119:108) */ ((CqlBoolean)i_
                && (CqlBoolean)j_()));
        }
    ...
    private IEnumerable<Encounter> Encounter_with_Hypertensive_Reading_Within_Year_Prior_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? e_(Observation BloodPressure) {
                ...
                bool? ad_ = context.Operators.In<CqlDateTime>(w_, ac_, (string)default);
                ...
                return (bool?)(/* CQL 'and' (285:11-286:75) */ (/* CQL 'and' (285:17-285:121) */ ((CqlBoolean)ad_
                    && (CqlBoolean)ae_())
                    && (CqlBoolean)af_()));
            }
            ...
            bool? r_() {
                ...
                bool? ay_(Observation BloodPressure) {
                    ...
                    bool? bv_ = context.Operators.In<CqlDateTime>(bo_, bu_, (string)default);
                    ...
                    bool? bx_() {
                        ...
                        return (bool?)((CqlBoolean)cf_);
                    }

                    return (bool?)(/* CQL 'and' (285:11-286:75) */ (/* CQL 'and' (285:17-285:121) */ ((CqlBoolean)bv_
                        && (CqlBoolean)bw_())
                        && (CqlBoolean)bx_()));
                }
                ...
                bool? bk_ = context.Operators.Greater(bi_ as CqlQuantity, bj_);
            ...
            bool? s_() {
                ...
                bool? cq_(Observation BloodPressure) {
                    ...
                    bool? do_ = context.Operators.In<CqlDateTime>(dh_, dn_, (string)default);
                    ...
                    bool? dp_() {
                        ...
                        return (bool?)((CqlBoolean)(!((bool?)(dt_ is null))));
                    }
                    ...
                    bool? dq_() {
                        ...
                        return (bool?)((CqlBoolean)dy_);
                    }

                    return (bool?)(/* CQL 'and' (285:11-286:75) */ (/* CQL 'and' (285:17-285:121) */ ((CqlBoolean)do_
                        && (CqlBoolean)dp_())
                        && (CqlBoolean)dq_()));
                }
                ...
                bool? dc_ = context.Operators.GreaterOrEqual(da_ as CqlQuantity, db_);
                ...
                bool? dd_() {
                    ...
                    bool? ej_(Observation BloodPressure) {
                        ...
                        bool? fg_ = context.Operators.In<CqlDateTime>(ez_, ff_, (string)default);
                        ...
                        bool? fh_() {
                            ...
                            return (bool?)((CqlBoolean)(!((bool?)(fl_ is null))));
                        }
                        ...
                        bool? fi_() {
                            ...
                            bool? fq_ = context.Operators.In<string>(fo_, (IEnumerable<string>)fp_);
                            return (bool?)((CqlBoolean)fq_);
                        }

                        return (bool?)(/* CQL 'and' (285:11-286:75) */ (/* CQL 'and' (285:17-285:121) */ ((CqlBoolean)fg_
                            && (CqlBoolean)fh_())
                            && (CqlBoolean)fi_()));
                    }
                    ...
                    bool? ep_(Observation.ComponentComponent C) {
                        ...
                        bool? fz_ = context.Operators.Equivalent(fw_, fy_);
                        return fz_;
                    }
                    ...
                    bool? ev_ = context.Operators.GreaterOrEqual(et_ as CqlQuantity, eu_);
                    return (bool?)((CqlBoolean)ev_);
                }

                return (bool?)(/* CQL 'or' (297:15-305:11) */ ((CqlBoolean)dc_
                    || (CqlBoolean)dd_()));
            }

            return (bool?)(/* CQL 'and' (289:7-306:7) */ (/* CQL 'and' (289:15-296:30) */ ((CqlBoolean)q_
                && (CqlBoolean)r_())
                && (CqlBoolean)s_()));
        }
    ...
    private IEnumerable<Encounter> Encounter_with_First_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_130_OR_DBP_Greater_than_or_Equal_to_80_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? g_(Observation BloodPressure) {
                ...
                return (bool?)(/* CQL 'and' (256:11-257:75) */ ((CqlBoolean)ab_
                    && (CqlBoolean)ac_()));
            }
            ...
            bool? t_() {
                ...
                bool? as_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (256:11-257:75) */ ((CqlBoolean)bl_
                        && (CqlBoolean)bm_()));
                }
                ...
                bool? be_ = context.Operators.Greater(bc_ as CqlQuantity, bd_);
            ...
            bool? u_() {
                ...
                bool? cc_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (256:11-257:75) */ ((CqlBoolean)cw_
                        && (CqlBoolean)cx_()));
                }
                ...
                bool? co_ = context.Operators.GreaterOrEqual(cm_ as CqlQuantity, cn_);
                ...
                bool? cp_() {
                    ...
                    bool? dn_(Observation BloodPressure) {
                        ...
                        return (bool?)(/* CQL 'and' (256:11-257:75) */ ((CqlBoolean)eg_
                            && (CqlBoolean)eh_()));
                    }
                    ...
                    return (bool?)((CqlBoolean)dz_);
                }

                return (bool?)(/* CQL 'or' (269:15-277:11) */ ((CqlBoolean)co_
                    || (CqlBoolean)cp_()));
            }

            return (bool?)(/* CQL 'and' (260:7-278:7) */ (/* CQL 'and' (260:15-268:9) */ ((CqlBoolean)s_
                && (CqlBoolean)t_())
                && (CqlBoolean)u_()));
        }
    ...
    private IEnumerable<ServiceRequest> First_Hypertensive_Reading_Interventions_or_Referral_to_Alternate_Professional_Compute(CqlContext context)
    {
        ...
        bool? c_(ServiceRequest FourWeekRescreen) {
            ...
            bool? h_(ServiceRequest NonPharmInterventionsHTN) {
                ...
                return (bool?)(/* CQL 'and' (110:19-112:120) */ (/* CQL 'and' (110:19-111:84) */ ((CqlBoolean)m_
                    && (CqlBoolean)n_())
                    && (CqlBoolean)o_()));
            }
    ...
    private IEnumerable<Encounter> Encounter_with_Second_Hypertensive_Reading_SBP_130_to_139_OR_DBP_80_to_89_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? g_(Observation BloodPressure) {
                ...
                return (bool?)(/* CQL 'and' (226:13-227:77) */ ((CqlBoolean)ad_
                    && (CqlBoolean)ae_()));
            }
            ...
            bool? v_() {
                ...
                bool? au_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (226:13-227:77) */ ((CqlBoolean)bp_
                        && (CqlBoolean)bq_()));
                }
                ...
                bool? bi_ = context.Operators.In<CqlQuantity>(be_ as CqlQuantity, bh_, (string)default);
            ...
            bool? w_() {
                ...
                bool? cg_(Observation BloodPressure) {
                    ...
                    bool? da_ = context.Operators.In<CqlDateTime>(cx_, cz_, "day");
                    ...
                    return (bool?)(/* CQL 'and' (226:13-227:77) */ ((CqlBoolean)da_
                        && (CqlBoolean)db_()));
                }
                ...
                bool? cm_(Observation.ComponentComponent C) {
                    ...
                    bool? dp_ = context.Operators.Equivalent(dm_, do_);
                    return dp_;
                }
                ...
                bool? cs_ = context.Operators.GreaterOrEqual(cq_ as CqlQuantity, cr_);
                ...
                bool? ct_() {
                    ...
                    bool? dr_(Observation BloodPressure) {
                        ...
                        bool? el_() {
                            ...
                            return (bool?)((CqlBoolean)eq_);
                        }

                        return (bool?)(/* CQL 'and' (226:13-227:77) */ ((CqlBoolean)ek_
                            && (CqlBoolean)el_()));
                    }
                    ...
                    bool? ed_ = context.Operators.GreaterOrEqual(eb_ as CqlQuantity, ec_);
                    return (bool?)((CqlBoolean)ed_);
                }

                return (bool?)((CqlBoolean)(!((bool?)(/* CQL 'or' (239:21-247:13) */ ((CqlBoolean)cs_
                    || (CqlBoolean)ct_())))));
            }

            return (bool?)(/* CQL 'and' (230:9-248:9) */ (/* CQL 'or' (230:17-238:11) */ ((CqlBoolean)u_
                || (CqlBoolean)v_())
                && (CqlBoolean)w_()));
        }
    ...
    private IEnumerable<ServiceRequest> Second_Hypertensive_Reading_SBP_130_to_139_OR_DBP_80_to_89_and_Interventions_Compute(CqlContext context)
    {
        ...
        bool? b_(ServiceRequest Rescreen2to6) {
            ...
            bool? g_(ServiceRequest LabECGIntervention) {
                ...
                return (bool?)(/* CQL 'and' (138:17-139:76) */ ((CqlBoolean)l_
                    && (CqlBoolean)m_()));
            }
    ...
    private IEnumerable<Encounter> Encounter_with_Second_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_140_OR_DBP_Greater_than_or_Equal_to_90_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? g_(Observation BloodPressure) {
                ...
                return (bool?)(/* CQL 'and' (197:13-198:77) */ ((CqlBoolean)ab_
                    && (CqlBoolean)ac_()));
            }
            ...
            bool? t_() {
                ...
                bool? as_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (197:13-198:77) */ ((CqlBoolean)bl_
                        && (CqlBoolean)bm_()));
                }
            ...
            bool? u_() {
                ...
                bool? cc_(Observation BloodPressure) {
                    ...
                    return (bool?)(/* CQL 'and' (197:13-198:77) */ ((CqlBoolean)cw_
                        && (CqlBoolean)cx_()));
                }
                ...
                bool? cp_() {
                    ...
                    bool? dn_(Observation BloodPressure) {
                        ...
                        return (bool?)(/* CQL 'and' (197:13-198:77) */ ((CqlBoolean)eg_
                            && (CqlBoolean)eh_()));
                    }
                ...
                return (bool?)(/* CQL 'or' (209:17-217:13) */ ((CqlBoolean)co_
                    || (CqlBoolean)cp_()));
            }

            return (bool?)(/* CQL 'and' (201:9-218:9) */ (/* CQL 'and' (201:17-208:32) */ ((CqlBoolean)s_
                && (CqlBoolean)t_())
                && (CqlBoolean)u_()));
        }
    ...
    private IEnumerable<ServiceRequest> Second_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_140_OR_DBP_Greater_than_or_Equal_to_90_Interventions_Compute(CqlContext context)
    {
        ...
        bool? c_(ServiceRequest WeeksRescreen) {
            ...
            bool? j_(ServiceRequest ECGLabTest) {
                ...
                return (bool?)(/* CQL 'and' (124:19-127:114) */ (/* CQL 'and' (124:19-126:117) */ (/* CQL 'and' (124:19-125:70) */ ((CqlBoolean)o_
                    && (CqlBoolean)p_())
                    && (CqlBoolean)q_())
                    && (CqlBoolean)r_()));
            }
        ...
        bool? e_(ServiceRequest WeeksRescreen) {
            ...
            bool? ak_ = context.Operators.WhereAny<ServiceRequest>(ai_, aj_);
            return ak_;
        }
        ...
        bool? g_(ServiceRequest WeeksRescreen) {
            ...
            bool? av_(MedicationRequest Medications) {
                ...
                return (bool?)(/* CQL 'and' (131:19-132:61) */ ((CqlBoolean)bn_
                    && (CqlBoolean)bo_()));
            }
            ...
            bool? o_(Observation NoBPScreen) {
                ...
                bool? w_() {
                    ...
                    bool? x_(Extension @this) {
                        ...
                        bool? ah_ = context.Operators.Equal(ag_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-notDoneReason");
                        return ah_;
                    }
                    ...
                    return (bool?)(/* CQL 'or' (324:13-326:9) */ ((CqlBoolean)ad_
                        || (CqlBoolean)ae_()));
                }

                return (bool?)(/* CQL 'and' (323:17-326:9) */ ((CqlBoolean)v_
                    && (CqlBoolean)w_()));
            }
    ...
    private IEnumerable<ServiceRequest> NonPharmacological_Intervention_Not_Ordered_Compute(CqlContext context)
    {
        ...
        bool? t_(ServiceRequest NonPharmIntervention) {
            ...
            return (bool?)(/* CQL 'and' (315:5-316:66) */ ((CqlBoolean)aa_
                && (CqlBoolean)ab_()));
        }
    ...
    private IEnumerable<ServiceRequest> Laboratory_Test_or_ECG_for_Hypertension_Not_Ordered_Compute(CqlContext context)
    {
        ...
        bool? l_(ServiceRequest LabECGNotDone) {
            ...
            return (bool?)(/* CQL 'and' (387:5-388:59) */ ((CqlBoolean)s_
                && (CqlBoolean)t_()));
        }
    ...
    private IEnumerable<ServiceRequest> Second_Hypertensive_Reading_SBP_130_to_139_OR_DBP_80_to_89_Interventions_Declined_Compute(CqlContext context)
    {
        ...
        bool? h_(ServiceRequest SecondHTNDeclinedReferralAndFollowUp) {
            ...
            return (bool?)(/* CQL 'and' (364:7-365:84) */ ((CqlBoolean)s_
                && (CqlBoolean)t_()));
        }
    ...
    private IEnumerable<object> Second_Hypertensive_Reading_SBP_Greater_than_or_Equal_to_140_OR_DBP_Greater_than_or_Equal_to_90_Interventions_Declined_Compute(CqlContext context)
    {
        ...
        bool? h_(ServiceRequest SecondHTN140Over90ReferralFollowUpNotDone) {
            ...
            return (bool?)(/* CQL 'and' (373:9-374:91) */ ((CqlBoolean)y_
                && (CqlBoolean)z_()));
        }
    ...
    private IEnumerable<Encounter> Encounter_with_Order_for_Hypertension_Follow_Up_Declined_by_Patient_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter ElevatedBPEncounter) {
            ...
            bool? ac_(ServiceRequest ElevatedBPDeclinedInterventions) {
                ...
                return (bool?)(/* CQL 'and' (332:21-334:83) */ (/* CQL 'and' (332:21-333:94) */ ((CqlBoolean)ai_
                    && (CqlBoolean)aj_())
                    && (CqlBoolean)ak_()));
            }
        ...
        bool? h_(Encounter FirstHTNEncounter) {
            ...
            bool? br_(ServiceRequest FirstHTNDeclinedInterventions) {
                ...
                return (bool?)(/* CQL 'and' (343:23-345:83) */ (/* CQL 'and' (343:23-344:94) */ ((CqlBoolean)bx_
                    && (CqlBoolean)by_())
                    && (CqlBoolean)bz_()));
            }
