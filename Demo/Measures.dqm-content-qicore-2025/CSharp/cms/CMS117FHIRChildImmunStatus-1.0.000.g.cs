...
public partial class CMS117FHIRChildImmunStatus_1_0_000 : ILibrary, ISingleton<CMS117FHIRChildImmunStatus_1_0_000>
{
    ...
    private IEnumerable<CqlDate?>? Three_Polio_Vaccinations_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, CqlDate? PolioVaccination1, CqlDate? PolioVaccination2, CqlDate? PolioVaccination3)?>? e_ = context.Operators.SelectWhere<ValueTuple<CqlDate?, CqlDate?, CqlDate?>, (CqlTupleMetadata, CqlDate? PolioVaccination1, CqlDate? PolioVaccination2, CqlDate? PolioVaccination3)?>((IEnumerable<ValueTuple<CqlDate, CqlDate, CqlDate>>?)b_, c_, d_);
    ...
    private bool? Has_Appropriate_Number_of_Hib_Immunizations_Compute(CqlContext context)
    {
        ...
        bool? b_(CqlDate? HibImmunization) {
            ...
            bool? l_ = context.Operators.GreaterOrEqual(k_, 4);
            bool? m_ = context.Operators.And(f_, l_);
            ...
            IEnumerable<CqlDate?>? p_ = context.Operators.SelectDistinct<CqlDate?, CqlDate?>(g_, o_);
            IEnumerable<CqlDate?>? q_ = context.Operators.Distinct<CqlDate?>(p_!);
            int? r_ = context.Operators.Count<CqlDate?>(q_);
            bool? s_ = context.Operators.GreaterOrEqual(r_, 3);
    ...
    private IEnumerable<CqlDate?>? Three_Hepatitis_B_Vaccinations_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, CqlDate? HepatitisBVaccination1, CqlDate? HepatitisBVaccination2, CqlDate? HepatitisBVaccination3)?>? e_ = context.Operators.SelectWhere<ValueTuple<CqlDate?, CqlDate?, CqlDate?>, (CqlTupleMetadata, CqlDate? HepatitisBVaccination1, CqlDate? HepatitisBVaccination2, CqlDate? HepatitisBVaccination3)?>((IEnumerable<ValueTuple<CqlDate, CqlDate, CqlDate>>?)b_, c_, d_);
    ...
    private IEnumerable<CqlDate?>? Meets_HepB_Vaccination_Requirement_Compute(CqlContext context)
    {
        ...
        bool? e_((CqlTupleMetadata, CqlDate? HepatitisBVaccination1, CqlDate? HepatitisBVaccination2, CqlDate? NewBornVaccine3)? tuple_hdfambzgbwdpfetgqnfbceeeg) {
            ...
            bool? w_ = context.Operators.SameOrAfter(o_, v_, (string?)default);
            bool? x_ = context.Operators.And(r_, w_);
            bool? y_ = context.Operators.SameOrAfter(l_, v_, (string?)default);
            bool? z_ = context.Operators.And(x_, y_);
            return z_;
        }

        IEnumerable<(CqlTupleMetadata, CqlDate? HepatitisBVaccination1, CqlDate? HepatitisBVaccination2, CqlDate? NewBornVaccine3)?>? f_ = context.Operators.SelectWhere<ValueTuple<CqlDate?, CqlDate?, CqlDate?>, (CqlTupleMetadata, CqlDate? HepatitisBVaccination1, CqlDate? HepatitisBVaccination2, CqlDate? NewBornVaccine3)?>((IEnumerable<ValueTuple<CqlDate, CqlDate, CqlDate>>?)c_, d_, e_);
    ...
    private bool? Has_Appropriate_Number_of_Rotavirus_Immunizations_Compute(CqlContext context)
    {
        ...
        bool? b_(CqlDate? RotavirusImmunization) {
            ...
            IEnumerable<CqlDate?>? q_ = context.Operators.Distinct<CqlDate?>(p_!);
            int? r_ = context.Operators.Count<CqlDate?>(q_);
            bool? s_ = context.Operators.GreaterOrEqual(r_, 2);
            bool? t_ = context.Operators.And(n_, s_);
            bool? u_ = context.Operators.Or(m_, t_);
            return u_;
        }
    ...
    private IEnumerable<CqlDate?>? Two_Influenza_Vaccinations_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, CqlDate? FluVaccination1, CqlDate? FluVaccination2)?>? e_ = context.Operators.SelectWhere<ValueTuple<CqlDate?, CqlDate?>, (CqlTupleMetadata, CqlDate? FluVaccination1, CqlDate? FluVaccination2)?>((IEnumerable<ValueTuple<CqlDate, CqlDate>>?)b_, c_, d_);
