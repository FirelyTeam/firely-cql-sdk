...
public partial class CMS154FHIRAppropriateTxforURI_1_0_000 : ILibrary, ISingleton<CMS154FHIRAppropriateTxforURI_1_0_000>
{
    ...
    private IEnumerable<Encounter?>? Encounter_with_Upper_Respiratory_Infection_Compute(CqlContext context)
    {
        ...
        IEnumerable<(CqlTupleMetadata, Encounter? QualifyingEncounters, Condition? URI)?>? j_ = context.Operators.SelectWhere<ValueTuple<Encounter?, Condition?>, (CqlTupleMetadata, Encounter? QualifyingEncounters, Condition? URI)?>((IEnumerable<ValueTuple<Encounter, Condition>>?)g_, h_, i_);
