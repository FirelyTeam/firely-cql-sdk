        ...
        bool? d_(Procedure NoCervixProcedure) {
            ...
            else
            {
                ...
                if (aa_)
                {
                    ...
                    n_ = ac_ as CqlInterval<CqlDateTime>;
                }
                else
                {
        ...
        bool? d_(Observation HPVTest) {
            ...
            else
            {
                ...
                if (aj_)
                {
                    ...
                    j_ = al_ as CqlInterval<CqlDateTime>;
                }
                else
                {
            ...
            else
            {
                ...
                if (ay_)
                {
                    ...
                    o_ = ba_ as CqlInterval<CqlDateTime>;
                }
                else
                {
