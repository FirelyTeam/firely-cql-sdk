...
public partial class CMS1157FHIRHIVRetention_1_0_000 : ILibrary, ISingleton<CMS1157FHIRHIVRetention_1_0_000>
{
    ...
    public bool? isVerified(CqlContext context, Condition condition)
    {
        ...
        // CQL 'implies' (96:3-100:3): right operand skipped when left is false
        if (c_ is false)
        {
            return true;
        }
        else
        {
            ...
            bool? g_;
            // CQL 'or' (96:54-97:66): right operand skipped when left is true
            if (f_ is true)
            {
                g_ = true;
            }
    ...
    private bool? Has_Active_HIV_Diagnosis_Starts_On_or_Before_First_240_Days_of_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? e_(Condition HIVDx) {
            ...
            // CQL 'and' (62:7-63:32): right operand skipped when left is false
            if (m_ is false)
            {
                return false;
            }
    ...
    private bool? Initial_Population_Compute(CqlContext context)
    {
        ...
        // CQL 'and' (29:3-30:78): right operand skipped when left is false
        if (a_ is false)
        {
            return false;
        }
    ...
    private IEnumerable<Encounter> Encounter_During_Measurement_Period_With_HIV_Compute(CqlContext context)
    {
        ...
        bool? ag_(Encounter ValidEncounter) {
            ...
            bool? am_(Condition HIVDiagnosis) {
                ...
                bool? as_;
                // CQL 'and' (53:19-54:48): right operand skipped when left is false
                if (ar_ is false)
                {
                    as_ = false;
                }
                ...
                bool? at_;
                // CQL 'and' (53:19-55:107): right operand skipped when left is false
                if (as_ is false)
                {
                    at_ = false;
                }
    ...
    private bool? Has_One_Encounter_With_HIV_and_One_Viral_Load_Test_At_Least_90_Days_Apart_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter EncounterWithHIV) {
            ...
            bool? f_(Observation ViralLoadTest) {
                ...
                bool? m_;
                // CQL 'and' (69:17-70:85): right operand skipped when left is false
                if (l_ is false)
                {
                    m_ = false;
                }
                ...
                else
                {
                    ...
                    bool? ab_ = context.Operators.SameOrAfter(v_, aa_, "day");
                    bool? ac_;
                    // CQL 'or' (71:13-73:9): right operand skipped when left is true
                    if (ab_ is true)
                    {
                        ac_ = true;
                    }
    ...
    private bool? Has_Two_Encounters_With_HIV_At_Least_90_Days_Apart_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter EncounterWithHIV) {
            ...
            bool? e_(Encounter AnotherEncounterWithHIV) {
                ...
                bool? h_ = !g_;
                // CQL 'and' (92:17-93:109): right operand skipped when left is false
                if (h_ is false)
                {
                    return false;
                }
    ...
    private bool? Numerator_Compute(CqlContext context)
    {
        ...
        // CQL 'or' (36:3-37:59): right operand skipped when left is true
        if (a_ is true)
        {
            return true;
        }
