...
public partial class CMS986FHIRMalnutritionScore_1_0_000 : ILibrary, ISingleton<CMS986FHIRMalnutritionScore_1_0_000>
{
            ...
            bool? f_(Observation NutritionAssessment) {
                ...
                bool? n_() {
                    ...
                    bool? z_() {
                        ...
                        bool? ah_ = context.Operators.ConceptInValueSet(af_ as CqlConcept, ag_);
                        return (bool?)((CqlBoolean)ah_);
                    }

                    return (bool?)(/* CQL 'or' (195:15-198:11) */ (/* CQL 'or' (195:17-196:125) */ ((CqlBoolean)x_
                        || (CqlBoolean)y_())
                        || (CqlBoolean)z_()));
                }
        ...
        bool? b_(Encounter QualifyingEncounter) {
            ...
            bool? f_(Observation NutritionAssessment) {
                ...
                bool? n_() {
                    ...
                    return (bool?)(/* CQL 'or' (207:13-209:9) */ ((CqlBoolean)x_
                        || (CqlBoolean)y_()));
                }
    ...
    public bool? isVerified(CqlContext context, Condition condition)
    {
        ...
        bool? c_() {
            ...
            return (bool?)(/* CQL 'or' (240:52-244:3) */ (/* CQL 'or' (240:54-242:66) */ (/* CQL 'or' (240:54-241:66) */ ((CqlBoolean)h_
                || (CqlBoolean)i_())
                || (CqlBoolean)j_())
                || (CqlBoolean)k_()));
        }
    ...
    public int? Total_Malnutrition_Care_Score_Eligible_Occurrences(CqlContext context, Encounter QualifyingEncounter)
    {
        ...
        if (((bool?)(/* CQL 'and' (279:6-281:81) */ (/* CQL 'and' (279:6-280:94) */ ((CqlBoolean)b_
            && (CqlBoolean)c_())
            && (CqlBoolean)d_()))) ?? false)
        {
            return 1;
        ...
        else
        {
            ...
            if (((bool?)(/* CQL 'or' (282:13-287:115) */ (/* CQL 'and' (282:13-286:123) */ (/* CQL 'or' (282:13-285:3) */ (/* CQL 'and' (282:15-283:92) */ ((CqlBoolean)b_
                && (CqlBoolean)i_())
                || (CqlBoolean)j_())
                && (CqlBoolean)k_())
                || (CqlBoolean)l_()))) ?? false)
