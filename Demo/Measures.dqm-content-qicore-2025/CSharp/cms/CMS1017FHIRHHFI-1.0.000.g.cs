...
public partial class CMS1017FHIRHHFI_1_0_000 : ILibrary, ISingleton<CMS1017FHIRHHFI_1_0_000>
{
    ...
    public bool? hasDiagnosisNotPresentOnAdmissionOrNull(CqlContext context, Encounter encounter, CqlValueSet diagnosisValueSet)
    {
        ...
        bool? b_(Claim C) {
            ...
            return /* CQL 'and' (300:7-304:9) */ (/* CQL 'and' (300:13-301:27) */ (j_
                && k_())
                && l_());
        }
        ...
        IEnumerable<Claim.DiagnosisComponent> c_(Claim C) {
            ...
            bool? w_(Claim.DiagnosisComponent D) {
                ...
                bool? z_(Claim.ItemComponent I) {
                    ...
                    return /* CQL 'and' (307:13-308:51) */ (ae_
                        && af_());
                }
                ...
                return /* CQL 'and' (306:9-313:46) */ (/* CQL 'and' (306:15-312:11) */ (aa_
                    && ab_())
                    && ac_());
            }
    ...
    private IEnumerable<CqlQuantity> Risk_Variable_Body_Mass_Index__BMI__Compute(CqlContext context)
    {
        ...
        bool? b_(Observation BMI) {
            ...
            bool? g_(Encounter InpatientEncounter) {
                ...
                return /* CQL 'and' (116:17-118:61) */ (/* CQL 'and' (116:17-117:33) */ (n_
                    && o_())
                    && p_());
            }
    ...
    private IEnumerable<(CqlTupleMetadata, string encounterId, IEnumerable<Claim.DiagnosisComponent> diagnosis, IEnumerable<int?> rank, IEnumerable<Claim.DiagnosisComponent> POA)?> Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication_Compute(CqlContext context)
    {
        ...
        (CqlTupleMetadata, string encounterId, IEnumerable<Claim.DiagnosisComponent> diagnosis, IEnumerable<int?> rank, IEnumerable<Claim.DiagnosisComponent> POA)? b_(Encounter InpatientEncounter) {
            ...
            bool? g_(Claim C) {
                ...
                return /* CQL 'and' (125:9-129:11) */ (/* CQL 'and' (125:15-126:29) */ (ah_
                    && ai_())
                    && aj_());
            }
            ...
            bool? m_(Claim C) {
                ...
                return /* CQL 'and' (125:9-129:11) */ (/* CQL 'and' (125:15-126:29) */ (ay_
                    && az_())
                    && ba_());
            }
            ...
            bool? v_(Claim C) {
                ...
                return /* CQL 'and' (125:9-129:11) */ (/* CQL 'and' (125:15-126:29) */ (bt_
                    && bu_())
                    && bv_());
            }
            ...
            bool? ab_(Claim.DiagnosisComponent Diag) {
                ...
                return /* CQL 'or' (139:9-140:102) */ (ck_
                    || cl_());
            }
    ...
    private IEnumerable<Encounter> Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter InpatientEncounter) {
            ...
            return /* CQL 'or' (145:5-146:127) */ (f_
                || g_());
        }
            ...
            bool? j_(MedicationRequest Anticoagulants) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (153:16-155:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (152:13-156:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (151:17-158:103) */ (/* CQL 'and' (151:17-157:42) */ (/* CQL 'and' (151:17-156:9) */ (ac_
                    && ad_())
    ...
    private IEnumerable<Encounter> Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter InpatientEncounter) {
            ...
            bool? j_(MedicationAdministration Anticoagulants) {
                ...
                return /* CQL 'and' (163:17-164:67) */ (ad_
                    && ae_());
            }
            ...
            bool? j_(MedicationRequest AntidepressantMed) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (171:16-173:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (170:13-174:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (169:17-176:106) */ (/* CQL 'and' (169:17-175:45) */ (/* CQL 'and' (169:17-174:9) */ (ac_
                    && ad_())
            ...
            bool? j_(MedicationRequest BPMed) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (183:16-185:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (182:13-186:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (181:17-188:94) */ (/* CQL 'and' (181:17-187:33) */ (/* CQL 'and' (181:17-186:9) */ (ac_
                    && ad_())
            ...
            bool? j_(MedicationRequest CNSMed) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (195:16-197:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (194:13-198:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (193:17-200:95) */ (/* CQL 'and' (193:17-199:34) */ (/* CQL 'and' (193:17-198:9) */ (ac_
                    && ad_())
            ...
            bool? j_(MedicationRequest DiureticMed) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (207:16-209:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (206:13-210:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (205:17-212:100) */ (/* CQL 'and' (205:17-211:39) */ (/* CQL 'and' (205:17-210:9) */ (ac_
                    && ad_())
            ...
            bool? j_(MedicationRequest OpioidMed) {
                ...
                CqlBoolean ad_() {
                    ...
                    CqlBoolean aj_() {
                        ...
                        return /* CQL 'and' (219:16-221:13) */ (an_
                            && ao_());
                    }

                    return /* CQL 'or' (218:13-222:9) */ (ai_
                        || aj_());
                }
                ...
                return /* CQL 'and' (217:17-224:98) */ (/* CQL 'and' (217:17-223:37) */ (/* CQL 'and' (217:17-222:9) */ (ac_
                    && ad_())
