...
public partial class CMS1017FHIRHHFI_1_0_000 : ILibrary, ISingleton<CMS1017FHIRHHFI_1_0_000>
{
    ...
    public bool? hasDiagnosisNotPresentOnAdmissionOrNull(CqlContext context, Encounter? encounter, CqlValueSet? diagnosisValueSet)
    {
        ...
        IEnumerable<IEnumerable<Claim.DiagnosisComponent?>?>? e_ = context.Operators.Distinct<IEnumerable<Claim.DiagnosisComponent?>?>(((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)d_)!);
        bool? f_ = context.Operators.Exists<IEnumerable<Claim.DiagnosisComponent?>?>(((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)e_)!);
        return f_;
    }
    ...
    private IEnumerable<(CqlTupleMetadata, string? encounterId, IEnumerable<Claim.DiagnosisComponent?>? diagnosis, IEnumerable<int?>? rank, IEnumerable<Claim.DiagnosisComponent?>? POA)?>? Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication_Compute(CqlContext context)
    {
        ...
        (CqlTupleMetadata, string? encounterId, IEnumerable<Claim.DiagnosisComponent?>? diagnosis, IEnumerable<int?>? rank, IEnumerable<Claim.DiagnosisComponent?>? POA)? b_(Encounter? InpatientEncounter) {
            ...
            IEnumerable<Claim.DiagnosisComponent?>? l_ = context.Operators.Flatten<Claim.DiagnosisComponent?>((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)((IEnumerable<IEnumerable<Claim.DiagnosisComponent?>?>?)k_)!);
            ...
            IEnumerable<Claim.DiagnosisComponent?>? r_ = context.Operators.Flatten<Claim.DiagnosisComponent?>((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)((IEnumerable<IEnumerable<Claim.DiagnosisComponent?>?>?)q_)!);
            ...
            IEnumerable<Claim.DiagnosisComponent?>? aa_ = context.Operators.Flatten<Claim.DiagnosisComponent?>((IEnumerable<IEnumerable<Claim.DiagnosisComponent>>)((IEnumerable<IEnumerable<Claim.DiagnosisComponent?>?>?)z_)!);
