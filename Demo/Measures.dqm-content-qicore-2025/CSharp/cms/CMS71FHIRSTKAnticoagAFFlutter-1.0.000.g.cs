        ...
        bool? d_(Encounter IschemicStrokeEncounter) {
            ...
            bool? ak_(Condition AtrialAblationDiagnosis) {
                ...
                bool? ao_() {
                    ...
                    return (bool?)(/* CQL 'and' (44:84-47:114) */ (/* CQL 'and' (44:84-46:11) */ ((CqlBoolean)!at_
                        && (CqlBoolean)au_())
                        && (CqlBoolean)av_()));
                }
        ...
        bool? i_(Encounter IschemicStrokeEncounter) {
            ...
            bool? cf_(Condition AtrialAblationEncDiagnosis) {
                ...
                bool? cj_() {
                    ...
                    return (bool?)(/* CQL 'and' (56:87-59:117) */ (/* CQL 'and' (56:87-58:11) */ ((CqlBoolean)!co_
                        && (CqlBoolean)cp_())
                        && (CqlBoolean)cq_()));
                }
        ...
        bool? b_(Encounter IschemicStrokeEncounter) {
            ...
            bool? i_(Condition AtrialFibrillationFlutter) {
                ...
                bool? m_() {
                    ...
                    return (bool?)(/* CQL 'and' (65:84-68:118) */ (/* CQL 'and' (65:84-67:9) */ ((CqlBoolean)!r_
                        && (CqlBoolean)s_())
                        && (CqlBoolean)t_()));
                }
    ...
    private IEnumerable<Encounter> Denominator_Exclusions_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter Encounter) {
            ...
            bool? j_() {
                ...
                return (bool?)(/* CQL 'or' (78:13-83:9) */ (/* CQL 'or' (78:15-81:102) */ (/* CQL 'or' (78:15-80:82) */ (/* CQL 'or' (78:15-79:94) */ ((CqlBoolean)o_
                    || (CqlBoolean)p_())
                    || (CqlBoolean)q_())
                    || (CqlBoolean)r_())
                    || (CqlBoolean)s_()));
        ...
        bool? b_(Encounter Encounter) {
            ...
            bool? j_(MedicationRequest DischargeAnticoagulant) {
                ...
                bool? ae_() {
                    ...
                    return (bool?)(/* CQL 'or' (97:13-99:9) */ ((CqlBoolean)am_
    ...
    private IEnumerable<MedicationRequest> Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge_Compute(CqlContext context)
    {
        ...
        bool? d_(MedicationRequest NoAnticoagulant) {
            ...
            bool? t_() {
                ...
                return (bool?)(/* CQL 'or' (116:13-118:9) */ ((CqlBoolean)ad_
        ...
        bool? k_(MedicationRequest MedReqAntiCoagulant) {
            ...
            bool? bc_(Task TaskReject) {
                ...
                bool? bg_() {
                    ...
                    return (bool?)(/* CQL 'or' (125:17-127:13) */ ((CqlBoolean)bm_
                        || (CqlBoolean)bn_()));
                }
