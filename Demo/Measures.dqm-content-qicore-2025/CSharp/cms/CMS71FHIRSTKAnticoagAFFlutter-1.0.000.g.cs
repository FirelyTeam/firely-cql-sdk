    ...
    private IEnumerable<Encounter> Encounter_With_A_History_Of_Atrial_Ablation_Compute(CqlContext context)
    {
        ...
        bool? d_(Encounter IschemicStrokeEncounter) {
            ...
            bool? ax_(Condition AtrialAblationDiagnosis) {
                ...
                bool? bb_ = !((bool?)(ba_ is null));
                // CQL 'implies' (44:21-47:114): right operand skipped when left is false
                if (bb_ is false)
                {
                    return true;
                }
                else
                {
                    ...
                    bool? be_ = context.Operators.Equivalent(ba_, bd_);
                    bool? bf_ = !be_;
                    bool? bg_;
        ...
        bool? i_(Encounter IschemicStrokeEncounter) {
            ...
            bool? db_(Condition AtrialAblationEncDiagnosis) {
                ...
                bool? df_ = !((bool?)(de_ is null));
                // CQL 'implies' (56:21-59:117): right operand skipped when left is false
                if (df_ is false)
                {
                    return true;
                }
                ...
                {
                    CqlCode dg_ = QICoreCommon_4_0_000.Instance.refuted(context);
                    CqlConcept dh_ = context.Operators.ConvertCodeToConcept(dg_);
                    bool? di_ = context.Operators.Equivalent(de_, dh_);
                    bool? dj_ = !di_;
                    bool? dk_;
    ...
    private IEnumerable<Encounter> Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter IschemicStrokeEncounter) {
            ...
            bool? i_(Condition AtrialFibrillationFlutter) {
                ...
                // CQL 'implies' (65:19-68:118): right operand skipped when left is false
                if (m_ is false)
                {
                    return true;
                }
