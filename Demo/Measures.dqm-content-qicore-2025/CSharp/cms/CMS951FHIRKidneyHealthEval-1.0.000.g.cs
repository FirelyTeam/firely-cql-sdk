...
public partial class CMS951FHIRKidneyHealthEval_1_0_000 : ILibrary, ISingleton<CMS951FHIRKidneyHealthEval_1_0_000>
{
        ...
        bool? e_(Condition DiabetesDiagnosis) {
            ...
            bool? j_() {
                ...
                bool? m_() {
                    ...
                    return (bool?)(/* CQL 'and' (64:70-66:9) */ ((CqlBoolean)!r_
                        && (CqlBoolean)s_()));
                }

                return (bool?)(/* CQL 'implies' (64:11-67:7) */ ((CqlBoolean)(!(!((bool?)(l_ is null))))
                    || (CqlBoolean)m_()));
            }
        ...
        bool? j_(Condition CKDOrESRD) {
            ...
            bool? o_() {
                ...
                bool? r_() {
                    ...
                    return (bool?)(/* CQL 'and' (77:62-79:9) */ ((CqlBoolean)!w_
                        && (CqlBoolean)x_()));
                }

                return (bool?)(/* CQL 'implies' (77:11-80:7) */ ((CqlBoolean)(!(!((bool?)(q_ is null))))
                    || (CqlBoolean)r_()));
            }
    ...
    private bool? Has_Urine_Albumin_Creatinine_Ratio_Test_Performed_During_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? c_(Observation uACRTest) {
            ...
            bool? k_() {
                ...
                return (bool?)(/* CQL 'or' (111:13-113:9) */ ((CqlBoolean)(s_ as bool?)
                    || (CqlBoolean)t_()));
            }
    ...
    private bool? Kidney_Panel_Performed_During_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? b_() {
            ...
            return (bool?)(/* CQL 'or' (96:9-98:5) */ ((CqlBoolean)c_
