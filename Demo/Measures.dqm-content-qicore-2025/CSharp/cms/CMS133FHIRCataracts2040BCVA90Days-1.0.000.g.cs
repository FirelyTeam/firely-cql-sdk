    ...
    private IEnumerable<Procedure> Cataract_Surgery_Between_January_and_September_of_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? c_(Procedure CataractSurgery) {
            ...
            else
            {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (bb_)
                            {
                                ...
                                ad_ = bd_ as CqlInterval<CqlQuantity>;
                            }
                            else
                            {
                                ad_ = null;
                ...
                CqlDateTime ag_ = context.Operators.End(e_);
                CqlQuantity ah_ = context.Operators.Quantity(92m, "days");
            ...
            {
                Code<EventStatus> be_ = CataractSurgery?.StatusElement;
