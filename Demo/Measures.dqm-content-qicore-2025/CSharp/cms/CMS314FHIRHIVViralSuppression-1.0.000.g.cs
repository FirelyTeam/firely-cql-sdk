...
public partial class CMS314FHIRHIVViralSuppression_1_0_000 : ILibrary, ISingleton<CMS314FHIRHIVViralSuppression_1_0_000>
{
    ...
    public bool? isVerified(CqlContext context, Condition condition)
    {
        ...
        // CQL 'implies' (76:3-80:3): right operand skipped when left is false
        if (c_ is false)
        {
            return true;
        }
        else
        {
            ...
            return /* CQL 'implies' (76:3-80:3) */ !c_ | i_;
        }
    }
    ...
    private bool? Numerator_Compute(CqlContext context)
    {
        ...
        {
            CqlCode g_ = this.Below_threshold_level__qualifier_value_(context);
            CqlConcept h_ = context.Operators.ConvertCodeToConcept(g_);
            bool? i_ = context.Operators.Equivalent(c_ as CqlConcept, h_);
            f_ = e_ | i_;
        }
