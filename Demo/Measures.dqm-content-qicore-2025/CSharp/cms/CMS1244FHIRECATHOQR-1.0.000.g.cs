...
public partial class CMS1244FHIRECATHOQR_1_0_000 : ILibrary, ISingleton<CMS1244FHIRECATHOQR_1_0_000>
{
    ...
    private IEnumerable<Encounter> ED_Evaluation_and_Management_Compute(CqlContext context)
    {
        ...
        bool? c_(Encounter EDEvalManagementVisit) {
            ...
            return (bool?)(/* CQL 'and' (113:5-114:51) */ ((CqlBoolean)i_
                && (CqlBoolean)j_()));
        }
    ...
    private IEnumerable<Encounter> ED_Triage_Compute(CqlContext context)
    {
        ...
        bool? c_(Encounter EDTriage) {
            ...
            return (bool?)(/* CQL 'and' (143:7-144:56) */ ((CqlBoolean)i_
                && (CqlBoolean)j_()));
        }
        ...
        bool? b_(Encounter EDTriageinMP) {
            ...
            bool? e_(Encounter EDEvalManagementInMP) {
                ...
                bool? n_() {
                    ...
                    return (bool?)(/* CQL 'and' (153:16-153:107) */ ((CqlBoolean)ah_
                        && (CqlBoolean)ai_()));
                }

                return (bool?)(/* CQL 'or' (150:9-154:9) */ (/* CQL 'or' (150:17-152:73) */ (/* CQL 'or' (150:17-151:73) */ ((CqlBoolean)k_
                    || (CqlBoolean)l_())
                    || (CqlBoolean)m_())
                    || (CqlBoolean)n_()));
            }
    ...
    public CqlDateTime edArrivalTime(CqlContext context, Encounter EDEncounter)
    {
        ...
        bool? f_(Encounter.LocationComponent Location) {
            ...
            bool? r_(CqlConcept LocationType) {
                ...
                return (bool?)(/* CQL 'or' (222:11-225:11) */ (/* CQL 'or' (222:17-223:48) */ ((CqlBoolean)y_
                    || (CqlBoolean)z_())
                    || (CqlBoolean)aa_()));
            }
            ...
            bool? v_() {
                ...
                return (bool?)(/* CQL 'or' (228:12-232:9) */ (/* CQL 'or' (228:13-230:65) */ (/* CQL 'or' (228:13-229:65) */ (/* CQL 'and' (228:13-228:87) */ ((CqlBoolean)at_
                    && (CqlBoolean)au_())
                    || (CqlBoolean)av_())
                    || (CqlBoolean)aw_())
                    || (CqlBoolean)ax_()));
            ...
            return (bool?)(/* CQL 'and' (221:7-232:9) */ (/* CQL 'and' (221:13-227:48) */ ((CqlBoolean)t_
                && (CqlBoolean)u_())
                && (CqlBoolean)v_()));
        }
        ...
        bool? b_(Encounter EDTriageinMP) {
            ...
            bool? e_(Encounter EDEncounter) {
                ...
                bool? n_() {
                    ...
                    return (bool?)(/* CQL 'and' (163:14-163:96) */ ((CqlBoolean)ah_
                        && (CqlBoolean)ai_()));
                }

                return (bool?)(/* CQL 'or' (160:17-164:7) */ (/* CQL 'or' (160:19-162:62) */ (/* CQL 'or' (160:19-161:62) */ ((CqlBoolean)k_
                    || (CqlBoolean)l_())
                    || (CqlBoolean)m_())
                    || (CqlBoolean)n_()));
            }
    ...
    public CqlDateTime edTreatmentRoomTimeArrivalTime(CqlContext context, Encounter EDEncounter)
    {
        ...
        bool? b_(Encounter.LocationComponent Location) {
            ...
            return (bool?)(/* CQL 'and' (259:7-260:48) */ ((CqlBoolean)n_
                && (CqlBoolean)o_()));
        }
    ...
    public CqlDateTime admitDecisionUsingEncounterOrder(CqlContext context, Encounter EncounterInpatient)
    {
        ...
        bool? b_(ServiceRequest AdmitOrder) {
            ...
            return (bool?)(/* CQL 'and' (200:7-201:39) */ ((CqlBoolean)m_
                && (CqlBoolean)n_()));
        }
    ...
    public Encounter lastEDEncounter(CqlContext context, Encounter EncounterInpatient)
    {
        ...
        bool? b_(Encounter EDEvalManagementInMP) {
            ...
            bool? r_() {
                ...
                bool? ad_ = context.Operators.Before(z_, ac_, (string)default);
                return (bool?)((CqlBoolean)ad_);
            }
            ...
            return (bool?)(/* CQL 'and' (275:7-278:52) */ (/* CQL 'and' (275:13-277:74) */ (/* CQL 'and' (275:13-276:88) */ (/* CQL 'and' (275:13-275:108) */ ((CqlBoolean)p_
                && (CqlBoolean)q_())
                && (CqlBoolean)r_())
                && (CqlBoolean)s_())
                && (CqlBoolean)t_()));
    ...
    public CqlDateTime edDepartureTime(CqlContext context, Encounter EDEncounter)
    {
        ...
        bool? f_(Encounter.LocationComponent Location) {
            ...
            bool? r_(CqlConcept LocationType) {
                ...
                return (bool?)(/* CQL 'or' (240:11-243:11) */ (/* CQL 'or' (240:17-241:48) */ ((CqlBoolean)y_
                    || (CqlBoolean)z_())
                    || (CqlBoolean)aa_()));
            }
            ...
            bool? v_() {
                ...
                return (bool?)(/* CQL 'or' (247:12-251:9) */ (/* CQL 'or' (247:13-249:65) */ (/* CQL 'or' (247:13-248:65) */ (/* CQL 'and' (247:13-247:87) */ ((CqlBoolean)at_
                    && (CqlBoolean)au_())
                    || (CqlBoolean)av_())
                    || (CqlBoolean)aw_())
                    || (CqlBoolean)ax_()));
            ...
            return (bool?)(/* CQL 'and' (239:7-251:9) */ (/* CQL 'and' (239:13-246:42) */ ((CqlBoolean)t_
                && (CqlBoolean)u_())
                && (CqlBoolean)v_()));
        }
    ...
    public CqlDateTime admitDecisionUsingAssessment(CqlContext context, Encounter EncounterInpatient)
    {
        ...
        bool? b_(Observation EDEvaluation) {
            ...
            return (bool?)(/* CQL 'and' (187:7-188:70) */ ((CqlBoolean)o_
                && (CqlBoolean)p_()));
        }
    ...
    private IEnumerable<Encounter> ED_Observation_Status_Compute(CqlContext context)
    {
        ...
        bool? c_(Encounter EDObsEncounter) {
            ...
            bool? f_(Encounter EDEncounter) {
                ...
                return (bool?)(/* CQL 'and' (138:17-139:46) */ ((CqlBoolean)l_
                    && (CqlBoolean)m_()));
            }
