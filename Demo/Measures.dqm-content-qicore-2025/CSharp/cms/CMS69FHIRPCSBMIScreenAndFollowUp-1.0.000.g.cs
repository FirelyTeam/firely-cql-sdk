                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (bi_)
                        {
                            ...
                            w_ = bk_ as CqlInterval<CqlDateTime>;
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (ba_)
                        {
                            ...
                            object bc_ = FHIRHelpers_4_4_000.Instance.ToValue(context, bb_);
                            x_ = bc_ as CqlInterval<CqlDateTime>;
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (bu_)
                        {
                            ...
                            ad_ = bw_ as CqlInterval<CqlDateTime>;
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (co_)
                        {
                            ...
                            ai_ = cq_ as CqlInterval<CqlDateTime>;
                        }
                        else
                        {
