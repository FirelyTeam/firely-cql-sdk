    ...
    private IEnumerable<MedicationRequest?>? Immunosuppressive_Drugs_Compute(CqlContext context)
    {
        ...
        bool? g_(MedicationRequest? ImmunosuppressiveDrugs) {
            ...
            bool? z_(Procedure? FirstBladderCancerStaging) {
                ...
                IEnumerable<CqlInterval<CqlDateTime?>?>? ax_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)av_, aw_, System.ComponentModel.ListSortDirection.Ascending);
                CqlInterval<CqlDateTime?>? ay_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)ax_)!);
