...
public partial class CMS135FHIRACEIorARBorARNIforHF_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS135FHIRACEIorARBorARNIforHF_1_0_000>
{
    #region ValueSets (8)
    ...
    public bool? Has_ACEI_or_ARB_or_ARNI_Ordered(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered,
            Has_ACEI_or_ARB_or_ARNI_Ordered_Compute);
    ...
    public bool? Is_Currently_Taking_ACEI_or_ARB_or_ARNI(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI,
            Is_Currently_Taking_ACEI_or_ARB_or_ARNI_Compute);
    ...
    public bool? Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI,
            Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI_Compute);
    ...
    public bool? Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient,
            Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient_Compute);
    ...
    public bool? Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB,
            Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB_Compute);
    ...
    public bool? Has_Diagnosis_of_Pregnancy(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Diagnosis_of_Pregnancy,
            Has_Diagnosis_of_Pregnancy_Compute);
    ...
    public bool? Has_Diagnosis_of_Renal_Failure_Due_to_ACEI(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI,
            Has_Diagnosis_of_Renal_Failure_Due_to_ACEI_Compute);
    ...
    private int _cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered = -1;
    private int _cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI = -1;
    private int _cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient = -1;
    private int _cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB = -1;
    private int _cacheIndex_Has_Diagnosis_of_Pregnancy = -1;
    private int _cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI}}. Cache indices can only be initialized once.");
        _cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Diagnosis_of_Pregnancy != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Diagnosis_of_Pregnancy' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Diagnosis_of_Pregnancy}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Diagnosis_of_Pregnancy = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI = initializer.GetNextIndex();
        count++;
