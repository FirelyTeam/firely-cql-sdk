...
public partial class CMS135FHIRACEIorARBorARNIforHF_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS135FHIRACEIorARBorARNIforHF_1_0_000>
{
    ...
    public bool? Has_ACEI_or_ARB_or_ARNI_Ordered(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered, Has_ACEI_or_ARB_or_ARNI_Ordered_Compute, context) ?? Has_ACEI_or_ARB_or_ARNI_Ordered_Compute(context);
    ...
    public bool? Is_Currently_Taking_ACEI_or_ARB_or_ARNI(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI, Is_Currently_Taking_ACEI_or_ARB_or_ARNI_Compute, context) ?? Is_Currently_Taking_ACEI_or_ARB_or_ARNI_Compute(context);
    ...
    public bool? Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI, Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI_Compute, context) ?? Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI_Compute(context);
    ...
    public bool? Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient, Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient_Compute, context) ?? Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient_Compute(context);
    ...
    public bool? Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB, Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB_Compute, context) ?? Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB_Compute(context);
    ...
    public bool? Has_Diagnosis_of_Pregnancy(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Diagnosis_of_Pregnancy, Has_Diagnosis_of_Pregnancy_Compute, context) ?? Has_Diagnosis_of_Pregnancy_Compute(context);
    ...
    public bool? Has_Diagnosis_of_Renal_Failure_Due_to_ACEI(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI, Has_Diagnosis_of_Renal_Failure_Due_to_ACEI_Compute, context) ?? Has_Diagnosis_of_Renal_Failure_Due_to_ACEI_Compute(context);
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Has_ACEI_or_ARB_or_ARNI_Ordered = index++;
        _cacheIndex_Is_Currently_Taking_ACEI_or_ARB_or_ARNI = index++;
        _cacheIndex_Numerator = index++;
        _cacheIndex_Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI = index++;
        _cacheIndex_Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient = index++;
        _cacheIndex_Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB = index++;
        _cacheIndex_Has_Diagnosis_of_Pregnancy = index++;
        _cacheIndex_Has_Diagnosis_of_Renal_Failure_Due_to_ACEI = index++;
