...
public partial class CMS135FHIRACEIorARBorARNIforHF_1_0_000 : ILibrary, ISingleton<CMS135FHIRACEIorARBorARNIforHF_1_0_000>
{
    ...
    private Cached<bool?> _Has_ACEI_or_ARB_or_ARNI_Ordered_Cached = new();
    ...
    private Cached<bool?> _Is_Currently_Taking_ACEI_or_ARB_or_ARNI_Cached = new();
    ...
    private Cached<bool?> _Has_Medical_or_Patient_Reason_for_Not_Ordering_ACEI_or_ARB_or_ARNI_Cached = new();
    ...
    private Cached<bool?> _Has_Allergy_or_Intolerance_to_ACEI_or_ARB_or_ARNI_Ingredient_Cached = new();
    ...
    private Cached<bool?> _Has_Diagnosis_of_Allergy_or_Intolerance_to_ACEI_or_ARB_Cached = new();
    ...
    private Cached<bool?> _Has_Diagnosis_of_Pregnancy_Cached = new();
    ...
    private Cached<bool?> _Has_Diagnosis_of_Renal_Failure_Due_to_ACEI_Cached = new();
