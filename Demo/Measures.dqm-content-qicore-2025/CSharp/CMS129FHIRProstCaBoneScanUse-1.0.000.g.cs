...
public partial class CMS129FHIRProstCaBoneScanUse_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS129FHIRProstCaBoneScanUse_1_0_000>
{
    ...
    public Procedure First_Prostate_Cancer_Treatment_during_day_of_Measurement_Period(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_First_Prostate_Cancer_Treatment_during_day_of_Measurement_Period, First_Prostate_Cancer_Treatment_during_day_of_Measurement_Period_Compute, context) ?? First_Prostate_Cancer_Treatment_during_day_of_Measurement_Period_Compute(context);
    ...
    public Observation Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a, Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a_Compute, context) ?? Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a_Compute(context);
    ...
    public bool? Most_Recent_PSA_Test_Result_is_Low(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Most_Recent_PSA_Test_Result_is_Low, Most_Recent_PSA_Test_Result_is_Low_Compute, context) ?? Most_Recent_PSA_Test_Result_is_Low_Compute(context);
    ...
    public bool? Most_Recent_Gleason_Score_is_Low(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Most_Recent_Gleason_Score_is_Low, Most_Recent_Gleason_Score_is_Low_Compute, context) ?? Most_Recent_Gleason_Score_is_Low_Compute(context);
    ...
    public IEnumerable<Observation> Bone_Scan_Study_Performed(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Bone_Scan_Study_Performed, Bone_Scan_Study_Performed_Compute, context) ?? Bone_Scan_Study_Performed_Compute(context);
    ...
    public bool? Has_Diagnosis_of_Pain_related_to_Prostate_Cancer(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Diagnosis_of_Pain_related_to_Prostate_Cancer, Has_Diagnosis_of_Pain_related_to_Prostate_Cancer_Compute, context) ?? Has_Diagnosis_of_Pain_related_to_Prostate_Cancer_Compute(context);
    ...
    public bool? Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis, Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis_Compute, context) ?? Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis_Compute(context);
    ...
    public bool? Has_Bone_Scan_Study_Performed_with_Documented_Reason(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Bone_Scan_Study_Performed_with_Documented_Reason, Has_Bone_Scan_Study_Performed_with_Documented_Reason_Compute, context) ?? Has_Bone_Scan_Study_Performed_with_Documented_Reason_Compute(context);
        ...
        int startIndex)
    {
        ...
        _cacheIndex_First_Prostate_Cancer_Treatment_during_day_of_Measurement_Period = index++;
        _cacheIndex_Most_Recent_Prostate_Cancer_Staging_Tumor_Size_T1a_to_T2a = index++;
        _cacheIndex_Most_Recent_PSA_Test_Result_is_Low = index++;
        _cacheIndex_Most_Recent_Gleason_Score_is_Low = index++;
        _cacheIndex_Denominator = index++;
        _cacheIndex_Bone_Scan_Study_Performed = index++;
        _cacheIndex_Numerator = index++;
        _cacheIndex_Has_Diagnosis_of_Pain_related_to_Prostate_Cancer = index++;
        _cacheIndex_Has_Salvage_Therapy_Performed_after_Prostate_Cancer_Diagnosis = index++;
        _cacheIndex_Has_Bone_Scan_Study_Performed_with_Documented_Reason = index++;
