...
public partial class CMS2FHIRPCSDepScreenAndFollowUp_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS2FHIRPCSDepScreenAndFollowUp_1_0_000>
{
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Patient_Age_12_Years_or_Older_at_Start_of_Measurement_Period = index++;
        ...
        _cacheIndex_History_of_Bipolar_Diagnosis_Before_Qualifying_Encounter = index++;
        _cacheIndex_Denominator_Exclusions = index++;
        _cacheIndex_Patient_Age_12_to_16_Years_at_Start_of_Measurement_Period = index++;
        _cacheIndex_Most_Recent_Adolescent_Depression_Screening = index++;
        _cacheIndex_Has_Most_Recent_Adolescent_Screening_Negative = index++;
        _cacheIndex_Follow_Up_Intervention_for_Positive_Adolescent_Depression_Screening = index++;
        _cacheIndex_Most_Recent_Adolescent_Depression_Screening_Positive_and_Follow_Up_Provided = index++;
        _cacheIndex_Patient_Age_17_Years_at_Start_of_Measurement_Period = index++;
        _cacheIndex_Most_Recent_Adult_Depression_Screening = index++;
        _cacheIndex_Has_Most_Recent_Adult_Screening_Negative = index++;
        _cacheIndex_Follow_Up_Intervention_for_Positive_Adult_Depression_Screening = index++;
        _cacheIndex_Most_Recent_Adult_Depression_Screening_Positive_and_Follow_Up_Provided = index++;
        _cacheIndex_Patient_Age_18_Years_or_Older_at_Start_of_Measurement_Period = index++;
        _cacheIndex_Numerator = index++;
        _cacheIndex_Medical_or_Patient_Reason_for_Not_Screening_Adolescent_for_Depression = index++;
        _cacheIndex_Has_Adolescent_Depression_Screening = index++;
        _cacheIndex_Medical_or_Patient_Reason_for_Not_Screening_Adult_for_Depression = index++;
        _cacheIndex_Has_Adult_Depression_Screening = index++;
