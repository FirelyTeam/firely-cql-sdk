...
public partial class CMS56FHIRFuncStatHipReplacement_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS56FHIRFuncStatHipReplacement_1_0_000>
{
    ...
    public CqlDateTime August_1_Year_Prior_to_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlDateTime>(
            _cacheIndex_August_1_Year_Prior_to_the_Measurement_Period,
            August_1_Year_Prior_to_the_Measurement_Period_Compute);
    ...
    public CqlDateTime November_1_Two_Years_Prior_to_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlDateTime>(
            _cacheIndex_November_1_Two_Years_Prior_to_the_Measurement_Period,
            November_1_Two_Years_Prior_to_the_Measurement_Period_Compute);
    ...
    public CqlDateTime October_31_Year_Prior_to_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlDateTime>(
            _cacheIndex_October_31_Year_Prior_to_the_Measurement_Period,
            October_31_Year_Prior_to_the_Measurement_Period_Compute);
    ...
    public IEnumerable<Procedure> Total_Hip_Arthroplasty_Procedure(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Procedure>>(
            _cacheIndex_Total_Hip_Arthroplasty_Procedure,
            Total_Hip_Arthroplasty_Procedure_Compute);
    ...
    public bool? Has_Severe_Cognitive_Impairment(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Severe_Cognitive_Impairment,
            Has_Severe_Cognitive_Impairment_Compute);
    ...
    public bool? Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures,
            Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures_Compute);
    ...
    public bool? Has_Partial_Hip_Arthroplasty_Procedure(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Partial_Hip_Arthroplasty_Procedure,
            Has_Partial_Hip_Arthroplasty_Procedure_Compute);
    ...
    public bool? Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure,
            Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure_Compute);
    ...
    public bool? Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs,
            Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs_Compute);
    ...
    public bool? Has_Mechanical_Complication(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Mechanical_Complication,
            Has_Mechanical_Complication_Compute);
    ...
    public bool? Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed,
            Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed_Compute);
    ...
    public bool? Death_Within_300_Days_of_the_THA_Procedure(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Death_Within_300_Days_of_the_THA_Procedure,
            Death_Within_300_Days_of_the_THA_Procedure_Compute);
    ...
    public IEnumerable<CqlDate> Date_HOOS_Total_Assessment_Completed(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<CqlDate>>(
            _cacheIndex_Date_HOOS_Total_Assessment_Completed,
            Date_HOOS_Total_Assessment_Completed_Compute);
    ...
    public bool? Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments,
            Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments_Compute);
    ...
    public IEnumerable<CqlDate> Date_HOOSJr_Total_Assessment_Completed(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<CqlDate>>(
            _cacheIndex_Date_HOOSJr_Total_Assessment_Completed,
            Date_HOOSJr_Total_Assessment_Completed_Compute);
    ...
    public bool? Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments,
            Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments_Compute);
    ...
    public bool? Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments,
            Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments_Compute);
    ...
    public bool? Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments,
            Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments_Compute);
    ...
    public bool? Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments,
            Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments_Compute);
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_August_1_Year_Prior_to_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_August_1_Year_Prior_to_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_August_1_Year_Prior_to_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_August_1_Year_Prior_to_the_Measurement_Period = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_November_1_Two_Years_Prior_to_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_November_1_Two_Years_Prior_to_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_November_1_Two_Years_Prior_to_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_November_1_Two_Years_Prior_to_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_October_31_Year_Prior_to_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_October_31_Year_Prior_to_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_October_31_Year_Prior_to_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_October_31_Year_Prior_to_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Total_Hip_Arthroplasty_Procedure != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Total_Hip_Arthroplasty_Procedure' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Total_Hip_Arthroplasty_Procedure}}. Cache indices can only be initialized once.");
        _cacheIndex_Total_Hip_Arthroplasty_Procedure = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_Severe_Cognitive_Impairment != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Severe_Cognitive_Impairment' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Severe_Cognitive_Impairment}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Severe_Cognitive_Impairment = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Total_Hip_Arthroplasty_with_1_or_More_Lower_Body_Fractures = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Partial_Hip_Arthroplasty_Procedure != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Partial_Hip_Arthroplasty_Procedure' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Partial_Hip_Arthroplasty_Procedure}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Partial_Hip_Arthroplasty_Procedure = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Revision_Hip_Arthroplasty_Procedure_or_Implanted_Device_or_Prosthesis_Removal_Procedure = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Malignant_Neoplasm_of_Lower_and_Unspecified_Limbs = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Mechanical_Complication != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Mechanical_Complication' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Mechanical_Complication}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Mechanical_Complication = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_More_Than_One_Elective_Primary_Total_Hip_Arthroplasty_Performed = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Death_Within_300_Days_of_the_THA_Procedure != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Death_Within_300_Days_of_the_THA_Procedure' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Death_Within_300_Days_of_the_THA_Procedure}}. Cache indices can only be initialized once.");
        _cacheIndex_Death_Within_300_Days_of_the_THA_Procedure = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Date_HOOS_Total_Assessment_Completed != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Date_HOOS_Total_Assessment_Completed' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Date_HOOS_Total_Assessment_Completed}}. Cache indices can only be initialized once.");
        _cacheIndex_Date_HOOS_Total_Assessment_Completed = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOS_Assessments = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Date_HOOSJr_Total_Assessment_Completed != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Date_HOOSJr_Total_Assessment_Completed' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Date_HOOSJr_Total_Assessment_Completed}}. Cache indices can only be initialized once.");
        _cacheIndex_Date_HOOSJr_Total_Assessment_Completed = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_THA_with_Initial_and_Follow_Up_HOOSJr_Assessments = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_THA_with_Initial_and_Follow_Up_PROMIS10_Assessments = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Oblique_Assessments = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_THA_with_Initial_and_Follow_Up_VR12_Orthogonal_Assessments = initializer.GetNextIndex();
        count++;
