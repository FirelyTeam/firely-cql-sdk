...
public partial class CMS1188FHIRHIVSTITesting_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS1188FHIRHIVSTITesting_1_0_000>
{
    #region ValueSets (15)
    ...
    public bool? Has_Qualifying_Encounter_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period,
            Has_Qualifying_Encounter_During_Measurement_Period_Compute);
    ...
    public bool? Has_HIV_Diagnosis_Before_End_of_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period,
            Has_HIV_Diagnosis_Before_End_of_Measurement_Period_Compute);
    ...
    public bool? Has_Chlamydia_Testing(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Chlamydia_Testing,
            Has_Chlamydia_Testing_Compute);
    ...
    public bool? Has_Gonorrhea_Testing(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Gonorrhea_Testing,
            Has_Gonorrhea_Testing_Compute);
    ...
    public bool? Has_Syphilis_Testing(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Syphilis_Testing,
            Has_Syphilis_Testing_Compute);
    ...
    private int _cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period = -1;
    private int _cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period = -1;
    private int _cacheIndex_Initial_Population = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Has_Chlamydia_Testing = -1;
    private int _cacheIndex_Has_Gonorrhea_Testing = -1;
    private int _cacheIndex_Has_Syphilis_Testing = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_Chlamydia_Testing != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Chlamydia_Testing' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Chlamydia_Testing}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Chlamydia_Testing = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Gonorrhea_Testing != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Gonorrhea_Testing' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Gonorrhea_Testing}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Gonorrhea_Testing = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Syphilis_Testing != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Syphilis_Testing' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Syphilis_Testing}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Syphilis_Testing = initializer.GetNextIndex();
        count++;
