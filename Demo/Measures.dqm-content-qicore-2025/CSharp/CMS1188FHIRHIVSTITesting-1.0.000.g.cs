...
public partial class CMS1188FHIRHIVSTITesting_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS1188FHIRHIVSTITesting_1_0_000>
{
    ...
    public bool? Has_Qualifying_Encounter_During_Measurement_Period(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period, Has_Qualifying_Encounter_During_Measurement_Period_Compute, context) ?? Has_Qualifying_Encounter_During_Measurement_Period_Compute(context);
    ...
    public bool? Has_HIV_Diagnosis_Before_End_of_Measurement_Period(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period, Has_HIV_Diagnosis_Before_End_of_Measurement_Period_Compute, context) ?? Has_HIV_Diagnosis_Before_End_of_Measurement_Period_Compute(context);
    ...
    public bool? Has_Chlamydia_Testing(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Chlamydia_Testing, Has_Chlamydia_Testing_Compute, context) ?? Has_Chlamydia_Testing_Compute(context);
    ...
    public bool? Has_Gonorrhea_Testing(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Gonorrhea_Testing, Has_Gonorrhea_Testing_Compute, context) ?? Has_Gonorrhea_Testing_Compute(context);
    ...
    public bool? Has_Syphilis_Testing(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Has_Syphilis_Testing, Has_Syphilis_Testing_Compute, context) ?? Has_Syphilis_Testing_Compute(context);
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Has_Qualifying_Encounter_During_Measurement_Period = index++;
        _cacheIndex_Has_HIV_Diagnosis_Before_End_of_Measurement_Period = index++;
        _cacheIndex_Initial_Population = index++;
        _cacheIndex_Denominator = index++;
        _cacheIndex_Has_Chlamydia_Testing = index++;
        _cacheIndex_Has_Gonorrhea_Testing = index++;
        _cacheIndex_Has_Syphilis_Testing = index++;
