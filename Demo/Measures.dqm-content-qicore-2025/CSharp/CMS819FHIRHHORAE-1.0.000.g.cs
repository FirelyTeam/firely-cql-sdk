...
public partial class CMS819FHIRHHORAE_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS819FHIRHHORAE_1_0_000>
{
    #region ValueSets (5)
    ...
    private int _cacheIndex_Opioid_Administration = -1;
    private int _cacheIndex_Encounter_With_Opioid_Administration_Outside_Of_Operating_Room = -1;
    private int _cacheIndex_Initial_Population = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Non_Enteral_Opioid_Antagonist_Administration = -1;
    private int _cacheIndex_Encounter_With_NonOperating_Room_Opioid_And_Antagonist_Administration = -1;
