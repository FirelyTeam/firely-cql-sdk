...
public partial class CMS146FHIRApproTestPharyngitis_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS146FHIRApproTestPharyngitis_1_0_000>
{
    ...
    public IEnumerable<Encounter> Encounter_With_Antibiotic_Ordered_Within_Three_Days(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Antibiotic_Ordered_Within_Three_Days,
            Encounter_With_Antibiotic_Ordered_Within_Three_Days_Compute);
    ...
    public IEnumerable<object> Pharyngitis_or_Tonsillitis(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Pharyngitis_or_Tonsillitis,
            Pharyngitis_or_Tonsillitis_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic,
            Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic_Compute);
    ...
    public IEnumerable<Encounter> Encounters_and_Assessments_with_Hospice_Patient(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounters_and_Assessments_with_Hospice_Patient,
            Encounters_and_Assessments_with_Hospice_Patient_Compute);
    ...
    public IEnumerable<Observation> Group_A_Streptococcus_Lab_Test_With_Result(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Group_A_Streptococcus_Lab_Test_With_Result,
            Group_A_Streptococcus_Lab_Test_With_Result_Compute);
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Encounter_With_Antibiotic_Ordered_Within_Three_Days != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Antibiotic_Ordered_Within_Three_Days' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Antibiotic_Ordered_Within_Three_Days}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Antibiotic_Ordered_Within_Three_Days = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Pharyngitis_or_Tonsillitis != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Pharyngitis_or_Tonsillitis' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Pharyngitis_or_Tonsillitis}}. Cache indices can only be initialized once.");
        _cacheIndex_Pharyngitis_or_Tonsillitis = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Pharyngitis_or_Tonsillitis_With_Antibiotic = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Encounters_and_Assessments_with_Hospice_Patient != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounters_and_Assessments_with_Hospice_Patient' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounters_and_Assessments_with_Hospice_Patient}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounters_and_Assessments_with_Hospice_Patient = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Group_A_Streptococcus_Lab_Test_With_Result != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Group_A_Streptococcus_Lab_Test_With_Result' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Group_A_Streptococcus_Lab_Test_With_Result}}. Cache indices can only be initialized once.");
        _cacheIndex_Group_A_Streptococcus_Lab_Test_With_Result = initializer.GetNextIndex();
        count++;
