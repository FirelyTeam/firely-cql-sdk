...
public partial class CMS646FHIRIntravesicalBCGTherapy_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS646FHIRIntravesicalBCGTherapy_1_0_000>
{
    #region ValueSets (11)
    ...
    public IEnumerable<object> Bladder_Cancer_Diagnosis(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Bladder_Cancer_Diagnosis,
            Bladder_Cancer_Diagnosis_Compute);
    ...
    public Procedure First_Bladder_Cancer_Staging_Procedure(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<Procedure>(
            _cacheIndex_First_Bladder_Cancer_Staging_Procedure,
            First_Bladder_Cancer_Staging_Procedure_Compute);
    ...
    public CqlDate July_1_of_Year_Prior_to_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlDate>(
            _cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period,
            July_1_of_Year_Prior_to_the_Measurement_Period_Compute);
    ...
    public CqlDate June_30_of_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlDate>(
            _cacheIndex_June_30_of_the_Measurement_Period,
            June_30_of_the_Measurement_Period_Compute);
    ...
    public Procedure First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<Procedure>(
            _cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period,
    ...
    public bool? Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG,
            Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG_Compute);
    ...
    public IEnumerable<object> Acute_Tuberculosis_Diagnosis(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Acute_Tuberculosis_Diagnosis,
            Acute_Tuberculosis_Diagnosis_Compute);
    ...
    public IEnumerable<MedicationRequest> Immunosuppressive_Drugs(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<MedicationRequest>>(
            _cacheIndex_Immunosuppressive_Drugs,
            Immunosuppressive_Drugs_Compute);
    ...
    public IEnumerable<Procedure> Cystectomy_Done(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Procedure>>(
            _cacheIndex_Cystectomy_Done,
            Cystectomy_Done_Compute);
    ...
    public bool? Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging,
            Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging_Compute);
    ...
    public bool? Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging,
            Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging_Compute);
    ...
    public IEnumerable<MedicationAdministration> BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<MedicationAdministration>>(
            _cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging,
            BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging_Compute);
    ...
    public MedicationAdministration First_BCG_Administered(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<MedicationAdministration>(
            _cacheIndex_First_BCG_Administered,
            First_BCG_Administered_Compute);
    ...
    #region Cache Index Fields (25)

    private int _cacheIndex_Measurement_Period = -1;
    private int _cacheIndex_Patient = -1;
    private int _cacheIndex_Bladder_Cancer_Diagnosis = -1;
    private int _cacheIndex_First_Bladder_Cancer_Staging_Procedure = -1;
    private int _cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period = -1;
    private int _cacheIndex_June_30_of_the_Measurement_Period = -1;
    private int _cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period = -1;
    private int _cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG = -1;
    ...
    private int _cacheIndex_Acute_Tuberculosis_Diagnosis = -1;
    private int _cacheIndex_Immunosuppressive_Drugs = -1;
    private int _cacheIndex_Cystectomy_Done = -1;
    private int _cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging = -1;
    private int _cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging = -1;
    private int _cacheIndex_Denominator_Exclusion = -1;
    private int _cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging = -1;
    private int _cacheIndex_Denominator_Exception = -1;
    private int _cacheIndex_First_BCG_Administered = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Bladder_Cancer_Diagnosis != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Bladder_Cancer_Diagnosis' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Bladder_Cancer_Diagnosis}}. Cache indices can only be initialized once.");
        _cacheIndex_Bladder_Cancer_Diagnosis = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_First_Bladder_Cancer_Staging_Procedure != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_First_Bladder_Cancer_Staging_Procedure' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_First_Bladder_Cancer_Staging_Procedure}}. Cache indices can only be initialized once.");
        _cacheIndex_First_Bladder_Cancer_Staging_Procedure = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_July_1_of_Year_Prior_to_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_June_30_of_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_June_30_of_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_June_30_of_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_June_30_of_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_First_Bladder_Cancer_Staging_Procedure_during_6_Months_Prior_to_Measurement_Period_through_the_First_6_Months_of_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Most_Recent_Bladder_Cancer_Tumor_Staging_is_T1__Tis__Ta_HG = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Acute_Tuberculosis_Diagnosis != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Acute_Tuberculosis_Diagnosis' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Acute_Tuberculosis_Diagnosis}}. Cache indices can only be initialized once.");
        _cacheIndex_Acute_Tuberculosis_Diagnosis = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Immunosuppressive_Drugs != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Immunosuppressive_Drugs' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Immunosuppressive_Drugs}}. Cache indices can only be initialized once.");
        _cacheIndex_Immunosuppressive_Drugs = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Cystectomy_Done != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Cystectomy_Done' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Cystectomy_Done}}. Cache indices can only be initialized once.");
        _cacheIndex_Cystectomy_Done = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Excluding_HIV__Immunocompromised_Conditions_or_Mixed_Histology_Before_Staging = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Excluding_Chemotherapy_or_Radiotherapy_Procedure_Before_Staging = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging}}. Cache indices can only be initialized once.");
        _cacheIndex_BCG_Not_Available_Within_6_Months_After_Bladder_Cancer_Staging = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_First_BCG_Administered != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_First_BCG_Administered' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_First_BCG_Administered}}. Cache indices can only be initialized once.");
        _cacheIndex_First_BCG_Administered = initializer.GetNextIndex();
        count++;
