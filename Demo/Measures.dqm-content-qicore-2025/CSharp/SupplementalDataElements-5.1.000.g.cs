                    ...
                    bool c_()
                    {
                        List<Extension> t_()
                        {
                            bool aa_()
                            {
                                ...
                                bool ac_ = ab_ is DomainResource;
                                return ac_;
                            };
                            if (aa_())
                            {
                                Patient ad_ = this.Patient(context);
                                return (ad_ as DomainResource).Extension;
                            }
                            else
                            {
                                return default;
                        ...
                        IEnumerable<Extension> v_ = context.Operators.Where<Extension>((IEnumerable<Extension>)(t_()), u_);
                        ...
                        bool? z_ = context.Operators.Equal(y_, "248152002");
                        return z_ ?? false;
                    };
                    if (b_())
                    {
                        CqlCode aj_ = this.Male__finding_(context);
                        return aj_;
                    }
                    else if (c_())
                    {
                        CqlCode ak_ = this.Female__finding_(context);
                        return ak_;
                    }
                    else
                    {
