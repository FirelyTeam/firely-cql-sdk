    ...
    private IEnumerable<Encounter> Delivery_Encounter_With_Age_Range_Compute(CqlContext context)
    {
        ...
        bool? b_(Encounter EncounterWithAge) {
            ...
            bool? f_(Procedure DeliveryProcedure) {
                ...
                object m_;
                DataType s_ = DeliveryProcedure?.Performed;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            DataType ah_ = DeliveryProcedure?.Performed;
        ...
        bool? c_(Observation EstimatedGestationalAge) {
            ...
            else
            {
                ...
                if (at_)
                {
                    ...
                    object av_ = FHIRHelpers_4_4_000.Instance.ToValue(context, au_);
                    j_ = av_ as CqlInterval<CqlDateTime>;
                }
                else
                {
            ...
            else
            {
                ...
                if (bi_)
                {
                    ...
                    ac_ = bk_ as CqlInterval<CqlDateTime>;
                }
                else
                {
            ...
            else
            {
                ...
                if (bx_)
                {
                    ...
                    af_ = bz_ as CqlInterval<CqlDateTime>;
                }
                else
                {
