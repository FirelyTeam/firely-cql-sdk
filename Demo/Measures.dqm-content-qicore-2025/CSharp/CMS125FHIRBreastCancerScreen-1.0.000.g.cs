...
public partial class CMS125FHIRBreastCancerScreen_1_0_000 : ILibrary, ISingleton<CMS125FHIRBreastCancerScreen_1_0_000>
{
    ...
    private Cached<IEnumerable<object>> _Right_Mastectomy_Diagnosis_Cached = new();
    ...
    private Cached<IEnumerable<object>> _Left_Mastectomy_Diagnosis_Cached = new();
    ...
    private Cached<IEnumerable<object>> _Bilateral_Mastectomy_Diagnosis_Cached = new();
