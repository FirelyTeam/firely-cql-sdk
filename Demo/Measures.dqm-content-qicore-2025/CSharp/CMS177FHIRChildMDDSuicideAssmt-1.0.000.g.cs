...
public partial class CMS177FHIRChildMDDSuicideAssmt_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS177FHIRChildMDDSuicideAssmt_1_0_000>
{
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Encounter_With_Condition_Major_Depressive_Disorder = index++;
        _cacheIndex_Encounter_With_Reason_Major_Depressive_Disorder = index++;
        _cacheIndex_Major_Depressive_Disorder_Encounter = index++;
        _cacheIndex_Initial_Population = index++;
        _cacheIndex_Denominator = index++;
        _cacheIndex_Encounter_With_Procedure_For_Suicide_Risk_Assessment = index++;
