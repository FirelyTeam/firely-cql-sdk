...
public partial class CMS71FHIRSTKAnticoagAFFlutter_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS71FHIRSTKAnticoagAFFlutter_1_0_000>
{
    #region ValueSets (11)
    ...
    public IEnumerable<Encounter> Encounter_With_A_History_Of_Atrial_Ablation(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation,
            Encounter_With_A_History_Of_Atrial_Ablation_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter,
            Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter,
            Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter_Compute);
    ...
    public IEnumerable<object> Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge,
            Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge_Compute);

    private IEnumerable<object> Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge_Compute(CqlContext context)
    {
    ...
    private int _cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation = -1;
    private int _cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter = -1;
    private int _cacheIndex_Denominator_Exclusions = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_A_History_Of_Atrial_Ablation = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Prior_Or_Present_Diagnosis_Of_Atrial_Fibrillation_Or_Flutter = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Comfort_Measures_During_Hospitalization_For_Patients_With_Documented_Atrial_Fibrillation_Or_Flutter = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge}}. Cache indices can only be initialized once.");
        _cacheIndex_Documented_Reason_For_Not_Giving_Anticoagulant_At_Discharge = initializer.GetNextIndex();
        count++;
