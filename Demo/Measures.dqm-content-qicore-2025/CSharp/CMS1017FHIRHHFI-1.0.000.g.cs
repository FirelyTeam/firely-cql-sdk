...
public partial class CMS1017FHIRHHFI_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS1017FHIRHHFI_1_0_000>
{
    #region ValueSets (28)
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Diagnosis(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_A_Fall_Diagnosis,
            Encounter_With_A_Fall_Diagnosis_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Event(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_A_Fall_Event,
            Encounter_With_A_Fall_Event_Compute);
    ...
    public IEnumerable<Encounter> Encounter_Where_A_Fall_Occurred(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_Where_A_Fall_Occurred,
            Encounter_Where_A_Fall_Occurred_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Not_Present_On_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission,
            Encounter_With_A_Fall_Not_Present_On_Admission_Compute);
    ...
    public IEnumerable<Encounter> Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA,
            Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA_Compute);
    ...
    public IEnumerable<Encounter> Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA,
            Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_A_Fall_Present_On_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_A_Fall_Present_On_Admission,
            Encounter_With_A_Fall_Present_On_Admission_Compute);
    ...
    public IEnumerable<(CqlTupleMetadata, string encounterId, IEnumerable<Claim.DiagnosisComponent> diagnosis, IEnumerable<int?> rank, IEnumerable<Claim.DiagnosisComponent> POA)?> Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<(CqlTupleMetadata, string encounterId, IEnumerable<Claim.DiagnosisComponent> diagnosis, IEnumerable<int?> rank, IEnumerable<Claim.DiagnosisComponent> POA)?>>(
            _cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication,
            Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission,
            Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission,
            Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter,
            Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission,
            Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission,
            Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission,
            Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Diuretic_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission,
            Risk_Variable_Encounter_with_Diuretic_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission,
            Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission,
            Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission,
            Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Depression_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission,
            Risk_Variable_Encounter_with_Depression_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission,
            Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission,
            Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission,
            Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission,
            Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission,
            Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Obesity_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission,
            Risk_Variable_Encounter_with_Obesity_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission,
            Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission,
            Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Stroke_Present_on_Admission(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission,
            Risk_Variable_Encounter_with_Stroke_Present_on_Admission_Compute);
    ...
    public IEnumerable<Encounter> Risk_Variable_Encounter_with_Suicide_Attempt(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt,
            Risk_Variable_Encounter_with_Suicide_Attempt_Compute);
    ...
    private int _cacheIndex_Encounter_With_A_Fall_Diagnosis = -1;
    private int _cacheIndex_Encounter_With_A_Fall_Event = -1;
    private int _cacheIndex_Encounter_Where_A_Fall_Occurred = -1;
    private int _cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission = -1;
    private int _cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA = -1;
    private int _cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Encounter_With_A_Fall_Present_On_Admission = -1;
    private int _cacheIndex_Denominator_Exclusions = -1;
    private int _cacheIndex_Numerator_Exclusions = -1;
    private int _cacheIndex_Risk_Variable_Body_Mass_Index__BMI_ = -1;
    private int _cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission = -1;
    private int _cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Encounter_With_A_Fall_Diagnosis != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_A_Fall_Diagnosis' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_A_Fall_Diagnosis}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_A_Fall_Diagnosis = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_A_Fall_Event != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_A_Fall_Event' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_A_Fall_Event}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_A_Fall_Event = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_Where_A_Fall_Occurred != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_Where_A_Fall_Occurred' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_Where_A_Fall_Occurred}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_Where_A_Fall_Occurred = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_A_Fall_Not_Present_On_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_Where_A_Fall_And_Major_Injury_Occurred_Not_POA = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_Where_A_Fall_And_Moderate_Injury_Occurred_Not_POA = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Encounter_With_A_Fall_Present_On_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_A_Fall_Present_On_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_A_Fall_Present_On_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_A_Fall_Present_On_Admission = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_All_Encounter_Diagnoses_with_Rank_and_POA_Indication = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Abnormal_Weight_Loss_or_Malnutrition_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Anticoagulant_Administration_During_Encounter = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Antidepressant_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Antihypertensive_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_CNS_Depressant_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Diuretic_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Opioid_Medication_Active_at_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Coagulation_Disorder_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Delirium_or_Dementia_or_Other_Psychosis_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Depression_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Epilepsy_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Leukemia_or_Lymphoma_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Liver_Disease_Moderate_to_Severe_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Malignant_Bone_Disease_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Neurologic_Disorder_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Obesity_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Osteoporosis_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Peripheral_Neuropathy_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Stroke_Present_on_Admission = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt}}. Cache indices can only be initialized once.");
        _cacheIndex_Risk_Variable_Encounter_with_Suicide_Attempt = initializer.GetNextIndex();
        count++;
