...
public partial class Hospice_6_18_000 : ILibrary, ILibraryInternals, ISingleton<Hospice_6_18_000>
{
    ...
    public bool? Has_Hospice_Services(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Hospice_Services,
            Has_Hospice_Services_Compute);
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Has_Hospice_Services != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Hospice_Services' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Hospice_Services}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Hospice_Services = initializer.GetNextIndex();
        count++;
