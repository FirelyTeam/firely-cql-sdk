...
public partial class CQMCommon_4_1_000 : ILibrary, ISingleton<CQMCommon_4_1_000>
{
    ...
    public IEnumerable<Encounter.LocationComponent?>? Hospitalization_Locations(CqlContext context, Encounter? TheEncounter)
    {
        ...
        IEnumerable<Encounter.LocationComponent?>? c_(Encounter? EDEncounter) {
            ...
            else
            {
                ...
                IEnumerable<Encounter.LocationComponent?>? j_ = context.Operators.Flatten<Encounter.LocationComponent?>((IEnumerable<IEnumerable<Encounter.LocationComponent>>)((IEnumerable<IEnumerable<Encounter.LocationComponent?>?>?)i_)!);
                return j_;
            }
        }
    ...
    public Claim.ProcedureComponent? principalProcedure(CqlContext context, Encounter? encounter)
    {
        ...
        Claim.ProcedureComponent? b_(Encounter? E) {
            ...
            IEnumerable<Claim.ProcedureComponent?>? k_ = context.Operators.Flatten<Claim.ProcedureComponent?>((IEnumerable<IEnumerable<Claim.ProcedureComponent>>)((IEnumerable<IEnumerable<Claim.ProcedureComponent?>?>?)j_)!);
            ...
            bool? l_(Claim.ProcedureComponent? P) {
                ...
                IEnumerable<Claim.ItemComponent?>? ao_ = context.Operators.Flatten<Claim.ItemComponent?>((IEnumerable<IEnumerable<Claim.ItemComponent>>)((IEnumerable<IEnumerable<Claim.ItemComponent?>?>?)an_)!);
                ...
                IEnumerable<int?>? au_ = context.Operators.Flatten<int?>(((IEnumerable<IEnumerable<int?>>)at_)!);
