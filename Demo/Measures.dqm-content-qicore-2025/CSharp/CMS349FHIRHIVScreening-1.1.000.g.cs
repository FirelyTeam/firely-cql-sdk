...
public partial class CMS349FHIRHIVScreening_1_1_000 : ILibrary, ILibraryInternals, ISingleton<CMS349FHIRHIVScreening_1_1_000>
{
    #region ValueSets (7)
    ...
    public bool? Has_HIV_Test_Performed(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_HIV_Test_Performed,
            Has_HIV_Test_Performed_Compute);
    ...
    private int _cacheIndex_Has_HIV_Test_Performed = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Has_HIV_Test_Performed != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_HIV_Test_Performed' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_HIV_Test_Performed}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_HIV_Test_Performed = initializer.GetNextIndex();
        count++;
