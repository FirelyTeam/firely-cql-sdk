...
public partial class CMS122FHIRDiabetesAssessGT9Pct_1_0_000 : ILibrary, ISingleton<CMS122FHIRDiabetesAssessGT9Pct_1_0_000>
{
    ...
    private readonly Cached<IEnumerable<Observation>> _Glycemic_Status_Assessment_Cached = new();
    ...
    public IEnumerable<Observation> Glycemic_Status_Assessment(CqlContext context) =>
        _Glycemic_Status_Assessment_Cached.GetOrReplace(
            context,
            () => {
    ...
    private readonly Cached<CqlDate> _Most_Recent_Glycemic_Status_Date_Cached = new();
    ...
    public CqlDate Most_Recent_Glycemic_Status_Date(CqlContext context) =>
        _Most_Recent_Glycemic_Status_Date_Cached.GetOrReplace(
            context,
            () => {
    ...
    private readonly Cached<Observation> _Lowest_Glycemic_Status_Assessment_Reading_on_Most_Recent_Day_Cached = new();
    ...
    public Observation Lowest_Glycemic_Status_Assessment_Reading_on_Most_Recent_Day(CqlContext context) =>
        _Lowest_Glycemic_Status_Assessment_Reading_on_Most_Recent_Day_Cached.GetOrReplace(
            context,
            () => {
                IEnumerable<Observation> a_ = this.Glycemic_Status_Assessment(context);
    ...
    private readonly Cached<bool?> _Has_Most_Recent_Glycemic_Status_Assessment_Without_Result_Cached = new();
    ...
    public bool? Has_Most_Recent_Glycemic_Status_Assessment_Without_Result(CqlContext context) =>
        _Has_Most_Recent_Glycemic_Status_Assessment_Without_Result_Cached.GetOrReplace(
            context,
            () => {
    ...
    private readonly Cached<bool?> _Has_Most_Recent_Elevated_Glycemic_Status_Assessment_Cached = new();
    ...
    public bool? Has_Most_Recent_Elevated_Glycemic_Status_Assessment(CqlContext context) =>
        _Has_Most_Recent_Elevated_Glycemic_Status_Assessment_Cached.GetOrReplace(
            context,
            () => {
                Observation a_ = this.Lowest_Glycemic_Status_Assessment_Reading_on_Most_Recent_Day(context);
    ...
    private readonly Cached<bool?> _Has_No_Record_Of_Glycemic_Status_Assessment_Cached = new();
    ...
    public bool? Has_No_Record_Of_Glycemic_Status_Assessment(CqlContext context) =>
        _Has_No_Record_Of_Glycemic_Status_Assessment_Cached.GetOrReplace(
            context,
            () => {
                IEnumerable<Observation> a_ = this.Glycemic_Status_Assessment(context);
