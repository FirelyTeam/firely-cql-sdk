...
public partial class CMS122FHIRDiabetesAssessGT9Pct_1_0_000 : ILibrary, ISingleton<CMS122FHIRDiabetesAssessGT9Pct_1_0_000>
{
    ...
    private Cached<IEnumerable<Observation>> _Glycemic_Status_Assessment_Cached = new();
    ...
    private Cached<CqlDate> _Most_Recent_Glycemic_Status_Date_Cached = new();
    ...
    private Cached<Observation> _Lowest_Glycemic_Status_Assessment_Reading_on_Most_Recent_Day_Cached = new();
    ...
    private Cached<bool?> _Has_Most_Recent_Glycemic_Status_Assessment_Without_Result_Cached = new();
    ...
    private Cached<bool?> _Has_Most_Recent_Elevated_Glycemic_Status_Assessment_Cached = new();
    ...
    private Cached<bool?> _Has_No_Record_Of_Glycemic_Status_Assessment_Cached = new();
