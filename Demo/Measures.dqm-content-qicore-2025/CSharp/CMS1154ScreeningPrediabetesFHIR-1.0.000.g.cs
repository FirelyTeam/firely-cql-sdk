...
public partial class CMS1154ScreeningPrediabetesFHIR_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS1154ScreeningPrediabetesFHIR_1_0_000>
{
    #region ValueSets (10)
    ...
    public IEnumerable<object> Has_Advanced_Illness_or_Limited_Life_Expectancy(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy,
            Has_Advanced_Illness_or_Limited_Life_Expectancy_Compute);
    ...
    public IEnumerable<Encounter> Preventive_Care_Outpatient_Visits_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period,
            Preventive_Care_Outpatient_Visits_During_Measurement_Period_Compute);
    ...
    public IEnumerable<Encounter> Office_Visit_During_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Office_Visit_During_the_Measurement_Period,
            Office_Visit_During_the_Measurement_Period_Compute);
    ...
    public bool? Aged_35_to_70_at_Start_of_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period,
            Aged_35_to_70_at_Start_of_Measurement_Period_Compute);
    ...
    public bool? Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period,
            Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period_Compute);
    ...
    public Observation Most_Recent_BMI(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<Observation>(
            _cacheIndex_Most_Recent_BMI,
            Most_Recent_BMI_Compute);
    ...
    public bool? Patient_is_Asian(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Patient_is_Asian,
            Patient_is_Asian_Compute);
    ...
    public bool? Patient_is_not_Asian(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Patient_is_not_Asian,
            Patient_is_not_Asian_Compute);
    ...
    public bool? Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian,
            Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian_Compute);
    ...
    public bool? Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian,
            Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian_Compute);
    ...
    public IEnumerable<Observation> Glycemic_Laboratory_Test_Performed_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period,
            Glycemic_Laboratory_Test_Performed_During_Measurement_Period_Compute);
    ...
    public bool? Has_Pregnancy_Observation_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period,
            Has_Pregnancy_Observation_During_Measurement_Period_Compute);
    ...
    public IEnumerable<object> Has_Pregnancy_Diagnosis_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period,
            Has_Pregnancy_Diagnosis_During_Measurement_Period_Compute);
    ...
    public CqlInterval<CqlDateTime> Look_Back_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<CqlInterval<CqlDateTime>>(
            _cacheIndex_Look_Back_Period,
            Look_Back_Period_Compute);
    ...
    public IEnumerable<object> Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period,
            Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period_Compute);
    ...
    public IEnumerable<object> Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<object>>(
            _cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period,
            Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period_Compute);
    ...
    public bool? Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period,
            Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period_Compute);
    ...
    #region Cache Index Fields (27)

    private int _cacheIndex_Measurement_Period = -1;
    private int _cacheIndex_Patient = -1;
    private int _cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy = -1;
    private int _cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period = -1;
    private int _cacheIndex_Office_Visit_During_the_Measurement_Period = -1;
    private int _cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period = -1;
    private int _cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period = -1;
    private int _cacheIndex_Most_Recent_BMI = -1;
    private int _cacheIndex_Patient_is_Asian = -1;
    private int _cacheIndex_Patient_is_not_Asian = -1;
    private int _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian = -1;
    private int _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian = -1;
    private int _cacheIndex_Initial_Population = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period = -1;
    private int _cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period = -1;
    private int _cacheIndex_Look_Back_Period = -1;
    private int _cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period = -1;
    private int _cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period = -1;
    private int _cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Advanced_Illness_or_Limited_Life_Expectancy = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Preventive_Care_Outpatient_Visits_During_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Office_Visit_During_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Office_Visit_During_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Office_Visit_During_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Office_Visit_During_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Aged_35_to_70_at_Start_of_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Patients_Aged_35_to_70_with_an_Office_Visit_During_the_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Most_Recent_BMI != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Most_Recent_BMI' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Most_Recent_BMI}}. Cache indices can only be initialized once.");
        _cacheIndex_Most_Recent_BMI = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Patient_is_Asian != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Patient_is_Asian' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Patient_is_Asian}}. Cache indices can only be initialized once.");
        _cacheIndex_Patient_is_Asian = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Patient_is_not_Asian != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Patient_is_not_Asian' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Patient_is_not_Asian}}. Cache indices can only be initialized once.");
        _cacheIndex_Patient_is_not_Asian = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian}}. Cache indices can only be initialized once.");
        _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_25_and_Is_Not_Asian = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian}}. Cache indices can only be initialized once.");
        _cacheIndex_Most_Recent_BMI_Equal_to_or_Greater_Than_23_and_Is_Asian = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Glycemic_Laboratory_Test_Performed_During_Measurement_Period = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Pregnancy_Observation_During_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Pregnancy_Diagnosis_During_Measurement_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Look_Back_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Look_Back_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Look_Back_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Look_Back_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Prediabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Diabetes_Diagnosis_Overlaps_2_Year_Look_Back_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Has_Glycemic_Laboratory_Test_Performed_During_2_Year_Look_Back_Period = initializer.GetNextIndex();
        count++;
