...
public partial class AlaraCommonFunctions_1_10_000 : ILibrary, ISingleton<AlaraCommonFunctions_1_10_000>
{
    ...
    public bool? CT_Scan_Qualifies(CqlContext context, Observation Result)
    {
        ...
        decimal? b_ = context.Operators.ConvertIntegerToDecimal((int?)64);
        decimal? c_ = context.Operators.ConvertIntegerToDecimal((int?)598);
        bool? d_ = this.qualifies(context, Result, a_, b_, c_);
        CqlCode e_ = this.Abdomen_and_Pelvis_Routine_Dose(context);
        decimal? f_ = context.Operators.ConvertIntegerToDecimal((int?)29);
        decimal? g_ = context.Operators.ConvertIntegerToDecimal((int?)644);
        ...
        decimal? l_ = context.Operators.ConvertIntegerToDecimal((int?)1260);
        bool? m_ = this.qualifies(context, Result, j_, f_, l_);
        bool? n_ = context.Operators.Or(i_, m_);
        CqlCode o_ = this.Cardiac_Low_Dose(context);
        decimal? p_ = context.Operators.ConvertIntegerToDecimal((int?)55);
        decimal? q_ = context.Operators.ConvertIntegerToDecimal((int?)93);
        ...
        decimal? u_ = context.Operators.ConvertIntegerToDecimal((int?)32);
        decimal? v_ = context.Operators.ConvertIntegerToDecimal((int?)576);
        bool? w_ = this.qualifies(context, Result, t_, u_, v_);
        bool? x_ = context.Operators.Or(s_, w_);
        CqlCode y_ = this.Chest_Low_Dose(context);
        decimal? aa_ = context.Operators.ConvertIntegerToDecimal((int?)377);
        ...
        decimal? ae_ = context.Operators.ConvertIntegerToDecimal((int?)49);
        ...
        decimal? ak_ = context.Operators.ConvertIntegerToDecimal((int?)1282);
        ...
        decimal? ao_ = context.Operators.ConvertIntegerToDecimal((int?)115);
        decimal? ap_ = context.Operators.ConvertIntegerToDecimal((int?)582);
        ...
        decimal? au_ = context.Operators.ConvertIntegerToDecimal((int?)1025);
        ...
        decimal? az_ = context.Operators.ConvertIntegerToDecimal((int?)1832);
        ...
        decimal? bd_ = context.Operators.ConvertIntegerToDecimal((int?)73);
        decimal? be_ = context.Operators.ConvertIntegerToDecimal((int?)320);
        ...
        decimal? bi_ = context.Operators.ConvertIntegerToDecimal((int?)25);
        ...
        decimal? bt_ = context.Operators.ConvertIntegerToDecimal((int?)1637);
        ...
        decimal? by_ = context.Operators.ConvertIntegerToDecimal((int?)2520);
        ...
        decimal? cd_ = context.Operators.ConvertIntegerToDecimal((int?)2285);
        ...
        decimal? ci_ = context.Operators.ConvertIntegerToDecimal((int?)3092);
