...
public partial class CMS816FHIRHHHypo_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS816FHIRHHHypo_1_0_000>
{
    ...
    public IEnumerable<Encounter> Encounter_With_Hypoglycemic_Medication_Administration(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration, Encounter_With_Hypoglycemic_Medication_Administration_Compute, context) ?? Encounter_With_Hypoglycemic_Medication_Administration_Compute(context);
    ...
    public IEnumerable<Observation> Glucose_Test_With_Result_Less_Than_40(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Glucose_Test_With_Result_Less_Than_40, Glucose_Test_With_Result_Less_Than_40_Compute, context) ?? Glucose_Test_With_Result_Less_Than_40_Compute(context);
    ...
    public IEnumerable<Observation> Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80, Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80_Compute, context) ?? Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80_Compute(context);
    ...
    public IEnumerable<Encounter> Encounter_With_Severe_Hypoglycemic_Harm_Event(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event, Encounter_With_Severe_Hypoglycemic_Harm_Event_Compute, context) ?? Encounter_With_Severe_Hypoglycemic_Harm_Event_Compute(context);
