...
public partial class CMS816FHIRHHHypo_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS816FHIRHHHypo_1_0_000>
{
    ...
    public IEnumerable<MedicationAdministration> Hypoglycemic_Medication_Administration(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<MedicationAdministration>>(
            _cacheIndex_Hypoglycemic_Medication_Administration,
            Hypoglycemic_Medication_Administration_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_Hypoglycemic_Medication_Administration(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration,
            Encounter_With_Hypoglycemic_Medication_Administration_Compute);
    ...
    public IEnumerable<Observation> Glucose_Test_With_Result_Less_Than_40(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Glucose_Test_With_Result_Less_Than_40,
            Glucose_Test_With_Result_Less_Than_40_Compute);
    ...
    public IEnumerable<Observation> Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80,
            Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80_Compute);
    ...
    public IEnumerable<Observation> Severe_Hypoglycemic_Harm_Event(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Severe_Hypoglycemic_Harm_Event,
            Severe_Hypoglycemic_Harm_Event_Compute);
    ...
    public IEnumerable<Encounter> Encounter_With_Severe_Hypoglycemic_Harm_Event(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event,
            Encounter_With_Severe_Hypoglycemic_Harm_Event_Compute);
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Hypoglycemic_Medication_Administration != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Hypoglycemic_Medication_Administration' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Hypoglycemic_Medication_Administration}}. Cache indices can only be initialized once.");
        _cacheIndex_Hypoglycemic_Medication_Administration = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Hypoglycemic_Medication_Administration = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Glucose_Test_With_Result_Less_Than_40 != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Glucose_Test_With_Result_Less_Than_40' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Glucose_Test_With_Result_Less_Than_40}}. Cache indices can only be initialized once.");
        _cacheIndex_Glucose_Test_With_Result_Less_Than_40 = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80 != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80}}. Cache indices can only be initialized once.");
        _cacheIndex_Low_Glucose_Test_Followed_By_Glucose_Test_Result_Greater_Than_80 = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Severe_Hypoglycemic_Harm_Event != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Severe_Hypoglycemic_Harm_Event' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Severe_Hypoglycemic_Harm_Event}}. Cache indices can only be initialized once.");
        _cacheIndex_Severe_Hypoglycemic_Harm_Event = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_With_Severe_Hypoglycemic_Harm_Event = initializer.GetNextIndex();
        count++;
