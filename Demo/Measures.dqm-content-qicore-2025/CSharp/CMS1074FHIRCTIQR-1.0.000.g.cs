...
public partial class CMS1074FHIRCTIQR_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS1074FHIRCTIQR_1_0_000>
{
    ...
    public IEnumerable<Encounter> Qualifying_Inpatient_Encounters(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Qualifying_Inpatient_Encounters, Qualifying_Inpatient_Encounters_Compute, context) ?? Qualifying_Inpatient_Encounters_Compute(context);
    ...
    public IEnumerable<Observation> Qualifying_Scan_During_Inpatient_Encounter(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Qualifying_Scan_During_Inpatient_Encounter, Qualifying_Scan_During_Inpatient_Encounter_Compute, context) ?? Qualifying_Scan_During_Inpatient_Encounter_Compute(context);
    ...
    public IEnumerable<Observation> Qualifying_Scan_With_Values(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Qualifying_Scan_With_Values, Qualifying_Scan_With_Values_Compute, context) ?? Qualifying_Scan_With_Values_Compute(context);
