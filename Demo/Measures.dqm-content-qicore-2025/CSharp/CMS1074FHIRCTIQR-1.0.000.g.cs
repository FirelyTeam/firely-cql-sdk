...
public partial class CMS1074FHIRCTIQR_1_0_000 : ILibrary, ISingleton<CMS1074FHIRCTIQR_1_0_000>
{
    ...
    private Cached<IEnumerable<Encounter>> _Qualifying_Inpatient_Encounters_Cached = new();
    ...
    private Cached<IEnumerable<Observation>> _Qualifying_Scan_During_Inpatient_Encounter_Cached = new();
    ...
    private Cached<IEnumerable<Observation>> _Qualifying_Scan_With_Values_Cached = new();
