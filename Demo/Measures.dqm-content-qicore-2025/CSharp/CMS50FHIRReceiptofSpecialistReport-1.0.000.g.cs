...
public partial class CMS50FHIRReceiptofSpecialistReport_1_0_000 : ILibrary, ISingleton<CMS50FHIRReceiptofSpecialistReport_1_0_000>
{
    ...
    private Cached<bool?> _Has_Encounter_during_Measurement_Period_Cached = new();
    ...
    private Cached<bool?> _Has_Intervention_during_Measurement_Period_Cached = new();
    ...
    private Cached<ServiceRequest> _First_Referral_during_First_10_Months_of_Measurement_Period_Cached = new();
    ...
    private Cached<bool?> _Referring_Clinician_Receives_Consultant_Report_to_Close_Referral_Loop_Cached = new();
