...
public partial class CMS50FHIRReceiptofSpecialistReport_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS50FHIRReceiptofSpecialistReport_1_0_000>
{
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Has_Encounter_during_Measurement_Period = index++;
        _cacheIndex_Has_Intervention_during_Measurement_Period = index++;
        _cacheIndex_First_Referral_during_First_10_Months_of_Measurement_Period = index++;
