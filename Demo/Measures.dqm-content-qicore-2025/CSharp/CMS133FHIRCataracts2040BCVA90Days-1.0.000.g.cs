...
public partial class CMS133FHIRCataracts2040BCVA90Days_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS133FHIRCataracts2040BCVA90Days_1_0_000>
{
    ...
    public IEnumerable<Procedure> Cataract_Surgery_Between_January_and_September_of_Measurement_Period(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Cataract_Surgery_Between_January_and_September_of_Measurement_Period, Cataract_Surgery_Between_January_and_September_of_Measurement_Period_Compute, context) ?? Cataract_Surgery_Between_January_and_September_of_Measurement_Period_Compute(context);
    ...
    public IEnumerable<Procedure> Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery, Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery_Compute, context) ?? Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery_Compute(context);
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Cataract_Surgery_Between_January_and_September_of_Measurement_Period = index++;
        _cacheIndex_Initial_Population = index++;
        _cacheIndex_Denominator = index++;
        _cacheIndex_Cataract_Surgeries_in_Patients_with_Significant_Ocular_Conditions_Impacting_the_Visual_Outcome_of_Surgery = index++;
