...
public partial class CMS149FHIRDementiaCognitiveAssess_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS149FHIRDementiaCognitiveAssess_1_0_000>
{
    #region ValueSets (15)
    ...
    public IEnumerable<Encounter> Encounter_to_Assess_Cognition(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Encounter_to_Assess_Cognition,
            Encounter_to_Assess_Cognition_Compute);
    ...
    public IEnumerable<Encounter> Dementia_Encounter_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Dementia_Encounter_During_Measurement_Period,
            Dementia_Encounter_During_Measurement_Period_Compute);
    ...
    public IEnumerable<Observation> Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods,
            Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods_Compute);
    ...
    public IEnumerable<Observation> Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Observation>>(
            _cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods,
            Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods_Compute);
    ...
    private int _cacheIndex_Encounter_to_Assess_Cognition = -1;
    private int _cacheIndex_Dementia_Encounter_During_Measurement_Period = -1;
    ...
    private int _cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Encounter_to_Assess_Cognition != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Encounter_to_Assess_Cognition' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Encounter_to_Assess_Cognition}}. Cache indices can only be initialized once.");
        _cacheIndex_Encounter_to_Assess_Cognition = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Dementia_Encounter_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Dementia_Encounter_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Dementia_Encounter_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Dementia_Encounter_During_Measurement_Period = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods}}. Cache indices can only be initialized once.");
        _cacheIndex_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods}}. Cache indices can only be initialized once.");
        _cacheIndex_Patient_Reason_for_Not_Performing_Assessment_of_Cognition_Using_Standardized_Tools_or_Alternate_Methods = initializer.GetNextIndex();
        count++;
