...
public partial class AHAOverall_4_1_000 : ILibrary, ISingleton<AHAOverall_4_1_000>
{
    ...
    public bool? overlapsAfterHeartFailureOutpatientEncounter(CqlContext context, MedicationRequest? MedicationRequest)
    {
        ...
        bool? b_(Encounter? ModerateOrSevereLVSDHFOutpatientEncounter) {
            ...
            IEnumerable<CqlInterval<CqlDateTime?>?>? r_ = context.Operators.SortBy<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)p_, q_, System.ComponentModel.ListSortDirection.Ascending);
            CqlInterval<CqlDateTime?>? s_ = context.Operators.First<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)r_)!);
