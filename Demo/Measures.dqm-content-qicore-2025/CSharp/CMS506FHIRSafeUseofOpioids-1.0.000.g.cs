...
public partial class CMS506FHIRSafeUseofOpioids_1_0_000 : ILibrary, ILibraryInternals, ISingleton<CMS506FHIRSafeUseofOpioids_1_0_000>
{
    #region ValueSets (12)
    ...
    private int _cacheIndex_Inpatient_Encounter_With_Age_Greater_Than_Or_Equal_To_18 = -1;
    private int _cacheIndex_Opioid_At_Discharge = -1;
    private int _cacheIndex_Benzodiazepine_At_Discharge = -1;
    private int _cacheIndex_Inpatient_Encounters_With_An_Opioid_Or_Benzodiazepine_At_Discharge = -1;
    private int _cacheIndex_Initial_Population = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Numerator = -1;
    private int _cacheIndex_Inpatient_Encounter_With_Encounter_Diagnosis_Of_Cancer_Pain = -1;
    private int _cacheIndex_Medications_For_Opioid_Use_Disorder = -1;
    private int _cacheIndex_Treatment_For_Opioid_Use_Disorders = -1;
    private int _cacheIndex_Intervention_Palliative_Or_Hospice_Care = -1;
