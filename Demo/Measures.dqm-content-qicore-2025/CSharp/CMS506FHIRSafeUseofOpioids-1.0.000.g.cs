...
public partial class CMS506FHIRSafeUseofOpioids_1_0_000 : ILibrary, ISingleton<CMS506FHIRSafeUseofOpioids_1_0_000>
{
    ...
    private readonly Cached<IEnumerable<Encounter>> _Inpatient_Encounter_With_Age_Greater_Than_Or_Equal_To_18_Cached = new();
    ...
    private readonly Cached<IEnumerable<MedicationRequest>> _Opioid_At_Discharge_Cached = new();
    ...
    private readonly Cached<IEnumerable<MedicationRequest>> _Benzodiazepine_At_Discharge_Cached = new();
    ...
    private readonly Cached<IEnumerable<Encounter>> _Inpatient_Encounters_With_An_Opioid_Or_Benzodiazepine_At_Discharge_Cached = new();
    ...
    private readonly Cached<IEnumerable<Encounter>> _Inpatient_Encounter_With_Encounter_Diagnosis_Of_Cancer_Pain_Cached = new();
    ...
    private readonly Cached<IEnumerable<MedicationRequest>> _Medications_For_Opioid_Use_Disorder_Cached = new();
    ...
    private readonly Cached<IEnumerable<MedicationRequest>> _Treatment_For_Opioid_Use_Disorders_Cached = new();
    ...
    private readonly Cached<IEnumerable<object>> _Intervention_Palliative_Or_Hospice_Care_Cached = new();
    ...
    private readonly Cached<IEnumerable<Encounter>> _Denominator_Exclusion_Cached = new();
