...
public class ChildhoodImmunizationStatusFHIR_0_1_000
{
	...
	private IEnumerable<Encounter> Qualifying_Encounters_Value()
	{
		...
		bool? m_(Encounter E)
		{
			...
			IEnumerable<CqlConcept> z_ = context.Operators.Select<CodeableConcept, CqlConcept>(E?.Type, y_);
			bool? aa_(CqlConcept T)
			{
				CqlCode ae_ = this.Office_or_other_outpatient_visit_for_the_evaluation_and_management_of_an_established_patient_that_may_not_require_the_presence_of_a_physician_or_other_qualified_health_care_professional();
		...
		IEnumerable<Encounter> r_ = context.Operators.ListUnion<Encounter>(k_, q_);
		...
		bool? w_(Encounter ValidEncounters)
		{
			...
			CqlInterval<CqlDateTime> ai_ = FHIRHelpers_4_3_000.ToInterval(ValidEncounters?.Period);
	...
	{
		Patient a_ = this.Patient();
		CqlDate b_ = context.Operators.ConvertStringToDate(a_?.BirthDateElement?.Value);
		CqlQuantity c_ = context.Operators.Quantity(2m, "years");
		CqlDate d_ = context.Operators.Add(b_, c_);
	...
	private CqlInterval<CqlDate> First_Two_Years_Value()
	{
		...
		CqlDate e_ = this.Date_of_Second_Birthday();
		CqlInterval<CqlDate> f_ = context.Operators.Interval(d_, e_, true, true);
	...
	private CqlInterval<CqlDate> Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old_Value()
	{
		...
		CqlDateTime c_ = context.Operators.ConvertDateToDateTime(b_);
		CqlDate d_ = context.Operators.DateFrom(c_);
		CqlQuantity e_ = context.Operators.Quantity(42m, "days");
	...
	private IEnumerable<CqlDate> DTaP_Immunizations_or_Procedures_Value()
	{
		...
		bool? d_(Immunization DTaPVaccination)
		{
			...
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(DTaPVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(DTaPVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(DTaPProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(DTaPProcedure?.Performed);
		...
		IEnumerable<CqlDate> o_ = context.Operators.ListUnion<CqlDate>(g_, n_);
	...
	private IEnumerable<CqlDate> Four_DTaP_Vaccinations_Value()
	{
		...
		{
			Tuple_EDFAENKgHPZdhfZCdMcGebfcS l_ = new Tuple_EDFAENKgHPZdhfZCdMcGebfcS
			{
		...
		IEnumerable<Tuple_EDFAENKgHPZdhfZCdMcGebfcS> g_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate,CqlDate,CqlDate>, Tuple_EDFAENKgHPZdhfZCdMcGebfcS>(e_, f_);
		bool? h_(Tuple_EDFAENKgHPZdhfZCdMcGebfcS tuple_edfaenkghpzdhfzcdmcgebfcs)
		{
			CqlQuantity m_ = context.Operators.Quantity(1m, "day");
			CqlDate n_ = context.Operators.Add(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination1, m_);
			bool? o_ = context.Operators.SameOrAfter(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination2, n_, "day");
			CqlDate q_ = context.Operators.Add(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination2, m_);
			bool? r_ = context.Operators.SameOrAfter(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination3, q_, "day");
			bool? s_ = context.Operators.And(o_, r_);
			CqlDate u_ = context.Operators.Add(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination3, m_);
			bool? v_ = context.Operators.SameOrAfter(tuple_edfaenkghpzdhfzcdmcgebfcs.DTaPVaccination4, u_, "day");
			bool? w_ = context.Operators.And(s_, v_);

			return w_;
		};
		IEnumerable<Tuple_EDFAENKgHPZdhfZCdMcGebfcS> i_ = context.Operators.Where<Tuple_EDFAENKgHPZdhfZCdMcGebfcS>(g_, h_);
		...
		IEnumerable<CqlDate> k_ = context.Operators.Select<Tuple_EDFAENKgHPZdhfZCdMcGebfcS, CqlDate>(i_, j_);
	...
	private IEnumerable<CqlDate> Polio_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(PolioVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(PolioVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(PolioProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(PolioProcedure?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private IEnumerable<CqlDate> Three_Polio_Vaccinations_Value()
	{
		...
		{
			Tuple_GOXKBgTPjADgQhXfdgXgTMIJS k_ = new Tuple_GOXKBgTPjADgQhXfdgXgTMIJS
			{
		...
		IEnumerable<Tuple_GOXKBgTPjADgQhXfdgXgTMIJS> f_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate,CqlDate>, Tuple_GOXKBgTPjADgQhXfdgXgTMIJS>(d_, e_);
		bool? g_(Tuple_GOXKBgTPjADgQhXfdgXgTMIJS tuple_goxkbgtpjadgqhxfdgxgtmijs)
		{
			CqlQuantity l_ = context.Operators.Quantity(1m, "day");
			CqlDate m_ = context.Operators.Add(tuple_goxkbgtpjadgqhxfdgxgtmijs.PolioVaccination1, l_);
			bool? n_ = context.Operators.SameOrAfter(tuple_goxkbgtpjadgqhxfdgxgtmijs.PolioVaccination2, m_, "day");
			CqlDate p_ = context.Operators.Add(tuple_goxkbgtpjadgqhxfdgxgtmijs.PolioVaccination2, l_);
			bool? q_ = context.Operators.SameOrAfter(tuple_goxkbgtpjadgqhxfdgxgtmijs.PolioVaccination3, p_, "day");
			bool? r_ = context.Operators.And(n_, q_);

			return r_;
		};
		IEnumerable<Tuple_GOXKBgTPjADgQhXfdgXgTMIJS> h_ = context.Operators.Where<Tuple_GOXKBgTPjADgQhXfdgXgTMIJS>(f_, g_);
		...
		IEnumerable<CqlDate> j_ = context.Operators.Select<Tuple_GOXKBgTPjADgQhXfdgXgTMIJS, CqlDate>(h_, i_);
	...
	private CqlDate Date_of_First_Birthday_Value()
	{
		...
		CqlDateTime c_ = context.Operators.ConvertDateToDateTime(b_);
		CqlDate d_ = context.Operators.DateFrom(c_);
		CqlQuantity e_ = context.Operators.Quantity(1m, "year");
		CqlDate f_ = context.Operators.Add(d_, e_);
	...
	private IEnumerable<object> One_MMR_Vaccination_Value()
	{
		...
		bool? d_(Immunization MMRVaccination)
		{
			...
			CqlDateTime m_ = context.Operators.LateBoundProperty<CqlDateTime>(MMRVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> n_ = QICoreCommon_2_0_000.ToInterval((m_ as object));
			CqlInterval<CqlDate> o_ = CQMCommon_2_0_000.ToDateInterval(n_);
			bool? p_ = context.Operators.IntervalIncludesInterval<CqlDate>(l_, o_, null);
		...
		{
			CqlInterval<CqlDate> q_ = this.Date_of_First_Birthday_to_Date_of_Second_Birthday();
			object r_ = FHIRHelpers_4_3_000.ToValue(MMRProcedure?.Performed);
			CqlInterval<CqlDateTime> s_ = QICoreCommon_2_0_000.ToInterval(r_);
			CqlInterval<CqlDate> t_ = CQMCommon_2_0_000.ToDateInterval(s_);
			bool? u_ = context.Operators.IntervalIncludesInterval<CqlDate>(q_, t_, null);
	...
	private IEnumerable<CqlDate> Hib_3_Dose_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(ThreeDoseHibVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(ThreeDoseHibVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(ThreeDoseHibProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(ThreeDoseHibProcedure?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private IEnumerable<CqlDate> Hib_4_Dose_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(HibVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(HibVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(HibProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(HibProcedure?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private IEnumerable<CqlDate> Hib_3_or_4_Dose_Immunizations_Value()
	{
		...
		IEnumerable<CqlDate> c_ = context.Operators.ListUnion<CqlDate>(a_, b_);
	...
	private IEnumerable<CqlDate> Hepatitis_B_Immunizations_or_Procedures_Value()
	{
		...
		bool? d_(Immunization HepatitisBVaccination)
		{
			...
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(HepatitisBVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(HepatitisBVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.First_Two_Years();
			object ab_ = FHIRHelpers_4_3_000.ToValue(HepatitisBProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(HepatitisBProcedure?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private IEnumerable<CqlDate> Three_Hepatitis_B_Vaccinations_Value()
	{
		...
		{
			Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg k_ = new Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg
			{
		...
		IEnumerable<Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg> f_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate,CqlDate>, Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg>(d_, e_);
		bool? g_(Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg tuple_bgioadwjfavaafwakdfwjcfog)
		{
			CqlQuantity l_ = context.Operators.Quantity(1m, "day");
			CqlDate m_ = context.Operators.Add(tuple_bgioadwjfavaafwakdfwjcfog.HepatitisBVaccination1, l_);
			bool? n_ = context.Operators.SameOrAfter(tuple_bgioadwjfavaafwakdfwjcfog.HepatitisBVaccination2, m_, "day");
			CqlDate p_ = context.Operators.Add(tuple_bgioadwjfavaafwakdfwjcfog.HepatitisBVaccination2, l_);
			bool? q_ = context.Operators.SameOrAfter(tuple_bgioadwjfavaafwakdfwjcfog.HepatitisBVaccination3, p_, "day");
			bool? r_ = context.Operators.And(n_, q_);

			return r_;
		};
		IEnumerable<Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg> h_ = context.Operators.Where<Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg>(f_, g_);
		...
		IEnumerable<CqlDate> j_ = context.Operators.Select<Tuple_BGiOaDWjFAVaAFWAKdFWJcFOg, CqlDate>(h_, i_);
	...
	private IEnumerable<CqlDate> NewBorn_Vaccine_Requirement_Value()
	{
		...
		bool? e_(Procedure NewBornVaccine)
		{
			...
			CqlDate j_ = context.Operators.ConvertStringToDate(i_?.BirthDateElement?.Value);
			CqlDateTime k_ = context.Operators.ConvertDateToDateTime(j_);
			CqlDate l_ = context.Operators.DateFrom(k_);
			CqlDate n_ = context.Operators.ConvertStringToDate(i_?.BirthDateElement?.Value);
			...
			object t_ = FHIRHelpers_4_3_000.ToValue(NewBornVaccine?.Performed);
		...
		{
			object x_ = FHIRHelpers_4_3_000.ToValue(NewBornVaccine?.Performed);
	...
	private IEnumerable<CqlDate> Meets_HepB_Vaccination_Requirement_Value()
	{
		...
		{
			Tuple_BbghRjaMVeQThBCTRUcdHSBQH k_ = new Tuple_BbghRjaMVeQThBCTRUcdHSBQH
			{
				HepatitisBVaccination1 = _valueTuple.Item1,
				HepatitisBVaccination2 = _valueTuple.Item2,
		...
		IEnumerable<Tuple_BbghRjaMVeQThBCTRUcdHSBQH> f_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate,CqlDate>, Tuple_BbghRjaMVeQThBCTRUcdHSBQH>(d_, e_);
		bool? g_(Tuple_BbghRjaMVeQThBCTRUcdHSBQH tuple_bbghrjamveqthbctrucdhsbqh)
		{
			CqlQuantity l_ = context.Operators.Quantity(1m, "day");
			CqlDate m_ = context.Operators.Add(tuple_bbghrjamveqthbctrucdhsbqh.HepatitisBVaccination1, l_);
			bool? n_ = context.Operators.SameOrAfter(tuple_bbghrjamveqthbctrucdhsbqh.HepatitisBVaccination2, m_, "day");
			CqlDate p_ = context.Operators.Add(tuple_bbghrjamveqthbctrucdhsbqh.NewBornVaccine3, l_);
			bool? q_ = context.Operators.SameOrAfter(tuple_bbghrjamveqthbctrucdhsbqh.HepatitisBVaccination1, p_, "day");
			bool? r_ = context.Operators.And(n_, q_);
			CqlDate t_ = context.Operators.Add(tuple_bbghrjamveqthbctrucdhsbqh.NewBornVaccine3, l_);
			bool? u_ = context.Operators.SameOrAfter(tuple_bbghrjamveqthbctrucdhsbqh.HepatitisBVaccination2, t_, "day");
			bool? v_ = context.Operators.And(r_, u_);

			return v_;
		};
		IEnumerable<Tuple_BbghRjaMVeQThBCTRUcdHSBQH> h_ = context.Operators.Where<Tuple_BbghRjaMVeQThBCTRUcdHSBQH>(f_, g_);
		...
		IEnumerable<CqlDate> j_ = context.Operators.Select<Tuple_BbghRjaMVeQThBCTRUcdHSBQH, CqlDate>(h_, i_);
	...
	private IEnumerable<object> One_Chicken_Pox_Vaccination_Value()
	{
		...
		{
			CqlInterval<CqlDate> l_ = this.Date_of_First_Birthday_to_Date_of_Second_Birthday();
			CqlDateTime m_ = context.Operators.LateBoundProperty<CqlDateTime>(ChickenPoxVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> n_ = QICoreCommon_2_0_000.ToInterval((m_ as object));
			CqlInterval<CqlDate> o_ = CQMCommon_2_0_000.ToDateInterval(n_);
			bool? p_ = context.Operators.IntervalIncludesInterval<CqlDate>(l_, o_, null);
		...
		{
			CqlInterval<CqlDate> q_ = this.Date_of_First_Birthday_to_Date_of_Second_Birthday();
			object r_ = FHIRHelpers_4_3_000.ToValue(ChickenPoxProcedure?.Performed);
			CqlInterval<CqlDateTime> s_ = QICoreCommon_2_0_000.ToInterval(r_);
			CqlInterval<CqlDate> t_ = CQMCommon_2_0_000.ToDateInterval(s_);
			bool? u_ = context.Operators.IntervalIncludesInterval<CqlDate>(q_, t_, null);
	...
	private IEnumerable<Condition> Varicella_Zoster_Numerator_Inclusion_Conditions_Value()
	{
		...
		IEnumerable<Condition> f_ = context.Operators.ListUnion<Condition>(b_, e_);
		IEnumerable<Condition> g_ = Status_1_6_000.Active_Condition(f_);
	...
	private IEnumerable<CqlDate> Pneumococcal_Conjugate_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(PneumococcalVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(PneumococcalVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(PneumococcalProcedure?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(PneumococcalProcedure?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private IEnumerable<CqlDate> Four_Pneumococcal_Conjugate_Vaccinations_Value()
	{
		...
		{
			Tuple_BVCGRhSDCRLNScbMJUKidNAJh l_ = new Tuple_BVCGRhSDCRLNScbMJUKidNAJh
			{
		...
		IEnumerable<Tuple_BVCGRhSDCRLNScbMJUKidNAJh> g_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate,CqlDate,CqlDate>, Tuple_BVCGRhSDCRLNScbMJUKidNAJh>(e_, f_);
		bool? h_(Tuple_BVCGRhSDCRLNScbMJUKidNAJh tuple_bvcgrhsdcrlnscbmjukidnajh)
		{
			CqlQuantity m_ = context.Operators.Quantity(1m, "day");
			CqlDate n_ = context.Operators.Add(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination1, m_);
			bool? o_ = context.Operators.SameOrAfter(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination2, n_, "day");
			CqlDate q_ = context.Operators.Add(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination2, m_);
			bool? r_ = context.Operators.SameOrAfter(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination3, q_, "day");
			bool? s_ = context.Operators.And(o_, r_);
			CqlDate u_ = context.Operators.Add(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination3, m_);
			bool? v_ = context.Operators.SameOrAfter(tuple_bvcgrhsdcrlnscbmjukidnajh.PneumococcalVaccination4, u_, "day");
			bool? w_ = context.Operators.And(s_, v_);

			return w_;
		};
		IEnumerable<Tuple_BVCGRhSDCRLNScbMJUKidNAJh> i_ = context.Operators.Where<Tuple_BVCGRhSDCRLNScbMJUKidNAJh>(g_, h_);
		...
		IEnumerable<CqlDate> k_ = context.Operators.Select<Tuple_BVCGRhSDCRLNScbMJUKidNAJh, CqlDate>(i_, j_);
	...
	private IEnumerable<object> One_Hepatitis_A_Vaccinations_Value()
	{
		...
		{
			CqlInterval<CqlDate> l_ = this.Date_of_First_Birthday_to_Date_of_Second_Birthday();
			CqlDateTime m_ = context.Operators.LateBoundProperty<CqlDateTime>(HepatitisAVaccination?.Occurrence, "value");
			CqlInterval<CqlDateTime> n_ = QICoreCommon_2_0_000.ToInterval((m_ as object));
			CqlInterval<CqlDate> o_ = CQMCommon_2_0_000.ToDateInterval(n_);
			bool? p_ = context.Operators.IntervalIncludesInterval<CqlDate>(l_, o_, null);
		...
		{
			CqlInterval<CqlDate> q_ = this.Date_of_First_Birthday_to_Date_of_Second_Birthday();
			object r_ = FHIRHelpers_4_3_000.ToValue(HepatitisAProcedure?.Performed);
			CqlInterval<CqlDateTime> s_ = QICoreCommon_2_0_000.ToInterval(r_);
			CqlInterval<CqlDate> t_ = CQMCommon_2_0_000.ToDateInterval(s_);
			bool? u_ = context.Operators.IntervalIncludesInterval<CqlDate>(q_, t_, null);
	...
	private IEnumerable<CqlDate> Rotavirus_2_Dose_Immunizations_or_Procedures_Value()
	{
		...
		bool? e_(Immunization TwoDoseRotavirusVaccine)
		{
			...
			CqlDateTime r_ = context.Operators.LateBoundProperty<CqlDateTime>(TwoDoseRotavirusVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> s_ = QICoreCommon_2_0_000.ToInterval((r_ as object));
			CqlInterval<CqlDate> t_ = CQMCommon_2_0_000.ToDateInterval(s_);
			bool? u_ = context.Operators.IntervalIncludesInterval<CqlDate>(q_, t_, "day");
		...
		{
			CqlDateTime v_ = context.Operators.LateBoundProperty<CqlDateTime>(TwoDoseRotavirusVaccine?.Occurrence, "value");
			...
			CqlDate y_ = context.Operators.Start(x_);
		...
		{
			CqlInterval<CqlDate> ab_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ac_ = FHIRHelpers_4_3_000.ToValue(TwoDoseRotavirusProcedure?.Performed);
			CqlInterval<CqlDateTime> ad_ = QICoreCommon_2_0_000.ToInterval(ac_);
			CqlInterval<CqlDate> ae_ = CQMCommon_2_0_000.ToDateInterval(ad_);
			bool? af_ = context.Operators.IntervalIncludesInterval<CqlDate>(ab_, ae_, "day");
		...
		{
			object ag_ = FHIRHelpers_4_3_000.ToValue(TwoDoseRotavirusProcedure?.Performed);
			CqlInterval<CqlDateTime> ah_ = QICoreCommon_2_0_000.ToInterval(ag_);
			CqlInterval<CqlDate> ai_ = CQMCommon_2_0_000.ToDateInterval(ah_);
		...
		IEnumerable<CqlDate> p_ = context.Operators.ListUnion<CqlDate>(h_, o_);
	...
	private IEnumerable<CqlDate> Rotavirus_3_Dose_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(ThreeDoseRotavirusVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(ThreeDoseRotavirusVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			object ab_ = FHIRHelpers_4_3_000.ToValue(ThreeDoseRotavirusAdministered?.Performed);
			CqlInterval<CqlDateTime> ac_ = QICoreCommon_2_0_000.ToInterval(ab_);
			CqlInterval<CqlDate> ad_ = CQMCommon_2_0_000.ToDateInterval(ac_);
			bool? ae_ = context.Operators.IntervalIncludesInterval<CqlDate>(aa_, ad_, "day");
		...
		{
			object af_ = FHIRHelpers_4_3_000.ToValue(ThreeDoseRotavirusAdministered?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			CqlDate ai_ = context.Operators.Start(ah_);
			CqlDateTime aj_ = context.Operators.ConvertDateToDateTime(ai_);
	...
	private CqlInterval<CqlDate> Vaccine_Administration_Interval___180_Days_up_to_2_Years_Old_Value()
	{
		...
		CqlDateTime c_ = context.Operators.ConvertDateToDateTime(b_);
		CqlDate d_ = context.Operators.DateFrom(c_);
		CqlQuantity e_ = context.Operators.Quantity(180m, "days");
		CqlDate f_ = context.Operators.Add(d_, e_);
		CqlDate g_ = this.Date_of_Second_Birthday();
		CqlInterval<CqlDate> h_ = context.Operators.Interval(f_, g_, true, true);
	...
	private IEnumerable<CqlDate> Influenza_Immunizations_or_Procedures_Value()
	{
		...
		{
			CqlInterval<CqlDate> p_ = this.Vaccine_Administration_Interval___42_Days_up_to_2_Years_Old();
			CqlDateTime q_ = context.Operators.LateBoundProperty<CqlDateTime>(InfluenzaVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> r_ = QICoreCommon_2_0_000.ToInterval((q_ as object));
			CqlInterval<CqlDate> s_ = CQMCommon_2_0_000.ToDateInterval(r_);
			bool? t_ = context.Operators.IntervalIncludesInterval<CqlDate>(p_, s_, "day");
		...
		{
			CqlDateTime u_ = context.Operators.LateBoundProperty<CqlDateTime>(InfluenzaVaccine?.Occurrence, "value");
			CqlInterval<CqlDateTime> v_ = QICoreCommon_2_0_000.ToInterval((u_ as object));
			CqlInterval<CqlDate> w_ = CQMCommon_2_0_000.ToDateInterval(v_);
			CqlDate x_ = context.Operators.Start(w_);
			CqlDateTime y_ = context.Operators.ConvertDateToDateTime(x_);
		...
		{
			CqlInterval<CqlDate> aa_ = this.Vaccine_Administration_Interval___180_Days_up_to_2_Years_Old();
			CqlDateTime ab_ = context.Operators.ConvertDateToDateTime(aa_?.low);
			CqlDateTime ad_ = context.Operators.ConvertDateToDateTime(aa_?.high);
			CqlInterval<CqlDateTime> ag_ = context.Operators.Interval(ab_, ad_, aa_?.lowClosed, aa_?.highClosed);
			object ah_ = FHIRHelpers_4_3_000.ToValue(InfluenzaAdministration?.Performed);
		...
		{
			object ak_ = FHIRHelpers_4_3_000.ToValue(InfluenzaAdministration?.Performed);
	...
	private IEnumerable<CqlDate> Two_Influenza_Vaccinations_Value()
	{
		...
		{
			Tuple_ESUAOONTBOMCFNSgVCeZOQUbj j_ = new Tuple_ESUAOONTBOMCFNSgVCeZOQUbj
			{
		...
		IEnumerable<Tuple_ESUAOONTBOMCFNSgVCeZOQUbj> e_ = context.Operators.Select<ValueTuple<CqlDate,CqlDate>, Tuple_ESUAOONTBOMCFNSgVCeZOQUbj>(c_, d_);
		bool? f_(Tuple_ESUAOONTBOMCFNSgVCeZOQUbj tuple_esuaoontbomcfnsgvcezoqubj)
		{
			CqlQuantity k_ = context.Operators.Quantity(1m, "day");
			CqlDate l_ = context.Operators.Add(tuple_esuaoontbomcfnsgvcezoqubj.FluVaccination1, k_);
			bool? m_ = context.Operators.SameOrAfter(tuple_esuaoontbomcfnsgvcezoqubj.FluVaccination2, l_, "day");

			return m_;
		};
		IEnumerable<Tuple_ESUAOONTBOMCFNSgVCeZOQUbj> g_ = context.Operators.Where<Tuple_ESUAOONTBOMCFNSgVCeZOQUbj>(e_, f_);
		...
		IEnumerable<CqlDate> i_ = context.Operators.Select<Tuple_ESUAOONTBOMCFNSgVCeZOQUbj, CqlDate>(g_, h_);
	...
	private IEnumerable<CqlDate> LAIV_Vaccinations_Value()
	{
		...
		bool? d_(Immunization LAIVVaccine)
		{
			...
			CqlDateTime s_ = context.Operators.LateBoundProperty<CqlDateTime>(LAIVVaccine?.Occurrence, "value");
		...
		{
			CqlDateTime w_ = context.Operators.LateBoundProperty<CqlDateTime>(LAIVVaccine?.Occurrence, "value");
		...
		bool? k_(Procedure InfluenzaAdministration)
		{
			CqlDate ac_ = this.Date_of_Second_Birthday();
			CqlInterval<CqlDate> ae_ = context.Operators.Interval(ac_, ac_, true, true);
			object af_ = FHIRHelpers_4_3_000.ToValue(InfluenzaAdministration?.Performed);
			CqlInterval<CqlDateTime> ag_ = QICoreCommon_2_0_000.ToInterval(af_);
			CqlInterval<CqlDate> ah_ = CQMCommon_2_0_000.ToDateInterval(ag_);
			bool? ai_ = context.Operators.IntervalIncludesInterval<CqlDate>(ae_, ah_, "day");
		...
		CqlDate m_(Procedure InfluenzaAdministration)
		{
			object aj_ = FHIRHelpers_4_3_000.ToValue(InfluenzaAdministration?.Performed);
