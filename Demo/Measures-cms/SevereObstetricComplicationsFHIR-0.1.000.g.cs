...
public class SevereObstetricComplicationsFHIR_0_1_000
{
    ...
    internal Lazy<IEnumerable<Tuple_EFBGjIXaZYEMVfdOTOBUTCaMX>> __Risk_Variable_First_Hematocrit_Lab_Test;
    internal Lazy<IEnumerable<Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB>> __Risk_Variable_First_White_Blood_Cell_Count_Lab_Test;
    internal Lazy<IEnumerable<Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO>> __Risk_Variable_Heart_Rate;
    internal Lazy<IEnumerable<Tuple_CZMKBbaMITIjUVWNdeFPOjPTB>> __Risk_Variable_Systolic_Blood_Pressure;
    ...
    public SevereObstetricComplicationsFHIR_0_1_000(CqlContext context)
    {
        ...
        __Risk_Variable_First_Hematocrit_Lab_Test = new Lazy<IEnumerable<Tuple_EFBGjIXaZYEMVfdOTOBUTCaMX>>(this.Risk_Variable_First_Hematocrit_Lab_Test_Value);
        __Risk_Variable_First_White_Blood_Cell_Count_Lab_Test = new Lazy<IEnumerable<Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB>>(this.Risk_Variable_First_White_Blood_Cell_Count_Lab_Test_Value);
        __Risk_Variable_Heart_Rate = new Lazy<IEnumerable<Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO>>(this.Risk_Variable_Heart_Rate_Value);
        __Risk_Variable_Systolic_Blood_Pressure = new Lazy<IEnumerable<Tuple_CZMKBbaMITIjUVWNdeFPOjPTB>>(this.Risk_Variable_Systolic_Blood_Pressure_Value);
    }
    #region Dependencies
...
;
		...
		bool? b_(Encounter TwentyWeeksPlusEncounter)
		{
			bool? d_(Encounter.DiagnosisComponent EncounterDiagnoses)
			{
				...
				bool? q_(Extension @this)
				{
					...
					var ac_ = context.Operators.Equal(ab_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-encounter-diagnosisPresentOnAdmission");
			...
			{
				var ad_ = context.Operators.Convert<string>(EncounterSMMProcedures?.StatusElement?.Value);
				var ae_ = context.Operators.Equal(ad_, "completed");
				var af_ = FHIRHelpers_4_3_000.ToValue(EncounterSMMProcedures?.Performed);
	...
	public IEnumerable<CqlConcept> pOAIsYesOrExempt(Encounter TheEncounter)
	{
		bool? a_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			...
			{
				var n_ = context.Operators.Convert<FhirUri>(@this?.Url);
				var o_ = FHIRHelpers_4_3_000.ToString(n_);
				var p_ = context.Operators.Equal(o_, "http://hl7.org/fhir/us/qicore/StructureDefinition/qicore-encounter-diagnosisPresentOnAdmission");
		...
		CqlConcept c_(Encounter.DiagnosisComponent EncounterDiagnoses)
		{
			...
			var r_ = FHIRHelpers_4_3_000.ToConcept(q_?.Code);
	...
	private IEnumerable<Tuple_EFBGjIXaZYEMVfdOTOBUTCaMX> Risk_Variable_First_Hematocrit_Lab_Test_Value()
	{
		var a_ = this.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation();
		Tuple_EFBGjIXaZYEMVfdOTOBUTCaMX b_(Encounter TwentyWeeksPlusEncounter)
		{
	...
	public IEnumerable<Tuple_EFBGjIXaZYEMVfdOTOBUTCaMX> Risk_Variable_First_Hematocrit_Lab_Test() => 
		__Risk_Variable_First_Hematocrit_Lab_Test.Value;

	private IEnumerable<Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB> Risk_Variable_First_White_Blood_Cell_Count_Lab_Test_Value()
	{
		var a_ = this.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation();
		Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			var r_ = context.Operators.First<Observation>(q_);
			var s_ = context.Operators.Convert<CqlDateTime>(r_?.IssuedElement?.Value);
			var t_ = new Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB
			{
				EncounterId = TwentyWeeksPlusEncounter?.IdElement?.Value,
		...
		var c_ = context.Operators.Select<Encounter, Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB>(a_, b_);

		return c_;
	}

    [CqlDeclaration("Risk Variable First White Blood Cell Count Lab Test")]
	public IEnumerable<Tuple_GBWQTCiHPjQIOSQJfTPRHNOHB> Risk_Variable_First_White_Blood_Cell_Count_Lab_Test() => 
		__Risk_Variable_First_White_Blood_Cell_Count_Lab_Test.Value;

	private IEnumerable<Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO> Risk_Variable_Heart_Rate_Value()
	{
		var a_ = this.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation();
		Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO b_(Encounter TwentyWeeksPlusEncounter)
		{
			...
			var t_ = new Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO
			{
				EncounterId = TwentyWeeksPlusEncounter?.IdElement?.Value,
				FirstHRResult = k_,
				Timing = s_,
		...
		var c_ = context.Operators.Select<Encounter, Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO>(a_, b_);

		return c_;
	}

    [CqlDeclaration("Risk Variable Heart Rate")]
	public IEnumerable<Tuple_DMeLNGJbgMjJaOZDNVFKRHMQO> Risk_Variable_Heart_Rate() => 
		__Risk_Variable_Heart_Rate.Value;

	private IEnumerable<Tuple_CZMKBbaMITIjUVWNdeFPOjPTB> Risk_Variable_Systolic_Blood_Pressure_Value()
	{
		var a_ = this.Delivery_Encounters_At_Greater_than_or_Equal_to_20_Weeks_Gestation();
		Tuple_CZMKBbaMITIjUVWNdeFPOjPTB b_(Encounter TwentyWeeksPlusEncounter)
		{
			var d_ = context.Operators.RetrieveByValueSet<Observation>(null, null);
			...
			var v_ = new Tuple_CZMKBbaMITIjUVWNdeFPOjPTB
			{
				EncounterId = TwentyWeeksPlusEncounter?.IdElement?.Value,
				FirstSBPResult = m_,
				Timing = u_,
		...
		var c_ = context.Operators.Select<Encounter, Tuple_CZMKBbaMITIjUVWNdeFPOjPTB>(a_, b_);

		return c_;
	}

    [CqlDeclaration("Risk Variable Systolic Blood Pressure")]
	public IEnumerable<Tuple_CZMKBbaMITIjUVWNdeFPOjPTB> Risk_Variable_Systolic_Blood_Pressure() => 
