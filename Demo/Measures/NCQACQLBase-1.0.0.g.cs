...
;
			...
			{
				Tuple_OEKPWcbWSIEiOiUCNZejPNMI g_(CqlInterval<CqlDate> I)
				{
					CqlDate m_()
					{
					...
					var n_ = new Tuple_OEKPWcbWSIEiOiUCNZejPNMI
					{
						interval = I,
						startOfInterval = m_(),
					};
				...
				var h_ = context.Operators.Select<CqlInterval<CqlDate>, Tuple_OEKPWcbWSIEiOiUCNZejPNMI>(intervals, g_);
				object i_(Tuple_OEKPWcbWSIEiOiUCNZejPNMI @this) => 
					@this?.startOfInterval;
				var j_ = context.Operators.SortBy<Tuple_OEKPWcbWSIEiOiUCNZejPNMI>(h_, i_, System.ComponentModel.ListSortDirection.Ascending);
				CqlInterval<CqlDate> k_(Tuple_OEKPWcbWSIEiOiUCNZejPNMI sortedIntervals) => 
					sortedIntervals?.interval;
				var l_ = context.Operators.Select<Tuple_OEKPWcbWSIEiOiUCNZejPNMI, CqlInterval<CqlDate>>(j_, k_);
...
;
			...
			{
				Tuple_GDbZhifHXiUeDTVWOFQETObGi g_(CqlInterval<CqlDateTime> I)
				{
					CqlDateTime m_()
					{
						if ((context.Operators.Start(I) is null))
					...
					var n_ = new Tuple_GDbZhifHXiUeDTVWOFQETObGi
					{
						interval = I,
						startOfInterval = m_(),
					};
				...
				var h_ = context.Operators.Select<CqlInterval<CqlDateTime>, Tuple_GDbZhifHXiUeDTVWOFQETObGi>(intervals, g_);
				object i_(Tuple_GDbZhifHXiUeDTVWOFQETObGi @this) => 
					@this?.startOfInterval;
				var j_ = context.Operators.SortBy<Tuple_GDbZhifHXiUeDTVWOFQETObGi>(h_, i_, System.ComponentModel.ListSortDirection.Ascending);
				CqlInterval<CqlDateTime> k_(Tuple_GDbZhifHXiUeDTVWOFQETObGi sortedIntervals) => 
					sortedIntervals?.interval;
				var l_ = context.Operators.Select<Tuple_GDbZhifHXiUeDTVWOFQETObGi, CqlInterval<CqlDateTime>>(j_, k_);
...
;
	...
	public IEnumerable<CqlInterval<CqlDate>> Date_Interval_Gaps_Relative_to_Base_Interval(CqlInterval<CqlDate> baseInterval, IEnumerable<CqlInterval<CqlDate>> coveringIntervals)
	{
		...
		var b_ = new Tuple_GEiGfNBgYYhOGcIaOLZIOMIFU
		{
			sortedCoverings = a_,
		};
		var c_ = new Tuple_GEiGfNBgYYhOGcIaOLZIOMIFU[]
		{
			b_,
		};
		IEnumerable<CqlInterval<CqlDate>> d_(Tuple_GEiGfNBgYYhOGcIaOLZIOMIFU variableDeclarations)
		{
...
;
			...
			var i_ = new Tuple_CGNcBKGVRCWXPPfQUcLZgKBJa
			{
				frontgaps = g_(),
				endgap = h_(),
			};
			var j_ = new Tuple_CGNcBKGVRCWXPPfQUcLZgKBJa[]
			{
				i_,
			};
			IEnumerable<CqlInterval<CqlDate>> k_(Tuple_CGNcBKGVRCWXPPfQUcLZgKBJa calculations)
			{
			...
			var l_ = context.Operators.Select<Tuple_CGNcBKGVRCWXPPfQUcLZgKBJa, IEnumerable<CqlInterval<CqlDate>>>(j_, k_);
			var m_ = context.Operators.SingletonFrom<IEnumerable<CqlInterval<CqlDate>>>(l_);

			return m_;
		};
		var e_ = context.Operators.Select<Tuple_GEiGfNBgYYhOGcIaOLZIOMIFU, IEnumerable<CqlInterval<CqlDate>>>(c_, d_);
	...
	public IEnumerable<CqlInterval<CqlDateTime>> DateTime_Interval_Gaps_Relative_to_Base_Interval(CqlInterval<CqlDateTime> baseInterval, IEnumerable<CqlInterval<CqlDateTime>> coveringIntervals)
	{
		...
		var b_ = new Tuple_FcADffeRJVVZHPVCaDQXDgUEi
		{
			sortedCoverings = a_,
		};
		var c_ = new Tuple_FcADffeRJVVZHPVCaDQXDgUEi[]
		{
			b_,
		};
		IEnumerable<CqlInterval<CqlDateTime>> d_(Tuple_FcADffeRJVVZHPVCaDQXDgUEi variableDeclarations)
		{
...
;
			...
			var i_ = new Tuple_DRjChcIIMdjMLVBCJNfTTadeY
			{
				frontgaps = g_(),
				endgap = h_(),
			};
			var j_ = new Tuple_DRjChcIIMdjMLVBCJNfTTadeY[]
			{
				i_,
			};
			IEnumerable<CqlInterval<CqlDateTime>> k_(Tuple_DRjChcIIMdjMLVBCJNfTTadeY calculations)
			{
			...
			var l_ = context.Operators.Select<Tuple_DRjChcIIMdjMLVBCJNfTTadeY, IEnumerable<CqlInterval<CqlDateTime>>>(j_, k_);
			var m_ = context.Operators.SingletonFrom<IEnumerable<CqlInterval<CqlDateTime>>>(l_);

			return m_;
		};
		var e_ = context.Operators.Select<Tuple_FcADffeRJVVZHPVCaDQXDgUEi, IEnumerable<CqlInterval<CqlDateTime>>>(c_, d_);
	...
	public Tuple_CEGhDPVQjMJORWNSOVWRJIZBI Collapsed_Date_Interval_Stats(IEnumerable<CqlInterval<CqlDate>> collapsedIntervals)
	{
		...
		CqlInterval<CqlDate> c_()
		{
			...
			{
				Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA v_(CqlInterval<CqlDate> I)
				{
					...
					var ag_ = new Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA
					{
						interval = I,
						days = af_,
					};
				...
				var w_ = context.Operators.Select<CqlInterval<CqlDate>, Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(collapsedIntervals, v_);
				object x_(Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA @this) => 
@this?.days;
				var y_ = context.Operators.SortBy<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(w_, x_, System.ComponentModel.ListSortDirection.Descending);
				var z_ = context.Operators.First<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(y_);
		...
		int? d_()
		{
			...
			{
				Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA ak_(CqlInterval<CqlDate> I)
				{
					...
					var bg_ = new Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA
					{
						interval = I,
						days = bf_,
					};
				...
				var al_ = context.Operators.Select<CqlInterval<CqlDate>, Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(collapsedIntervals, ak_);
				object am_(Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA @this) => 
@this?.days;
				var an_ = context.Operators.SortBy<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(al_, am_, System.ComponentModel.ListSortDirection.Descending);
				var ao_ = context.Operators.First<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(an_);
				var ap_ = context.Operators.Start(ao_?.interval);
				Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA aq_(CqlInterval<CqlDate> I)
				{
					...
					var bn_ = new Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA
					{
						interval = I,
						days = bm_,
					};
				...
				var ar_ = context.Operators.Select<CqlInterval<CqlDate>, Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(collapsedIntervals, aq_);
				var at_ = context.Operators.SortBy<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(ar_, am_, System.ComponentModel.ListSortDirection.Descending);
				var au_ = context.Operators.First<Tuple_BYTZMWUKMFDdjgVcGbZNdDOYA>(at_);
		...
		var e_ = new Tuple_CEGhDPVQjMJORWNSOVWRJIZBI
		{
	...
	public Tuple_CEGhDPVQjMJORWNSOVWRJIZBI Date_Interval_Covering_Relative_to_Base_Interval_Stats(CqlInterval<CqlDate> baseInterval, IEnumerable<CqlInterval<CqlDate>> coveringIntervals)
	{
		var a_ = this.Date_Interval_Covering_Relative_to_Base_Interval(baseInterval, coveringIntervals);
		var b_ = new Tuple_DZVIaDUDHNYhEcEABULRVEAYP
		{
			Covering_Intervals = a_,
		};
		var c_ = new Tuple_DZVIaDUDHNYhEcEABULRVEAYP[]
		{
			b_,
		};
		Tuple_CEGhDPVQjMJORWNSOVWRJIZBI d_(Tuple_DZVIaDUDHNYhEcEABULRVEAYP variableDeclarations)
		{
			var g_ = this.Collapsed_Date_Interval_Stats(variableDeclarations?.Covering_Intervals);

			return g_;
		};
		var e_ = context.Operators.Select<Tuple_DZVIaDUDHNYhEcEABULRVEAYP, Tuple_CEGhDPVQjMJORWNSOVWRJIZBI>(c_, d_);
		var f_ = context.Operators.SingletonFrom<Tuple_CEGhDPVQjMJORWNSOVWRJIZBI>(e_);

		return f_;
	}

    [CqlDeclaration("Date Interval Gaps Relative to Base Interval Stats")]
	public Tuple_CEGhDPVQjMJORWNSOVWRJIZBI Date_Interval_Gaps_Relative_to_Base_Interval_Stats(CqlInterval<CqlDate> baseInterval, IEnumerable<CqlInterval<CqlDate>> coveringIntervals)
	{
		var a_ = this.Date_Interval_Gaps_Relative_to_Base_Interval(baseInterval, coveringIntervals);
		var b_ = new Tuple_EOcLTYfjSbJAMGeQcLURebgWB
		{
			Gap_Intervals = a_,
		};
		var c_ = new Tuple_EOcLTYfjSbJAMGeQcLURebgWB[]
		{
			b_,
		};
		Tuple_CEGhDPVQjMJORWNSOVWRJIZBI d_(Tuple_EOcLTYfjSbJAMGeQcLURebgWB variableDeclarations)
		{
			var g_ = this.Collapsed_Date_Interval_Stats(variableDeclarations?.Gap_Intervals);

			return g_;
		};
		var e_ = context.Operators.Select<Tuple_EOcLTYfjSbJAMGeQcLURebgWB, Tuple_CEGhDPVQjMJORWNSOVWRJIZBI>(c_, d_);
		var f_ = context.Operators.SingletonFrom<Tuple_CEGhDPVQjMJORWNSOVWRJIZBI>(e_);
	...
	public CqlInterval<CqlDateTime> DateTime_Interval_Set_Nulls_to_Zero(CqlInterval<CqlDateTime> interval)
	{
		...
		var q_ = new Tuple_DeFAGgTicLTeZRhLHCUZIOBcI
		{
			StartYear = b_,
			StartMonth = c_(),
			StartDay = d_(),
		...
		var r_ = new Tuple_DeFAGgTicLTeZRhLHCUZIOBcI[]
		{
			q_,
		};
		CqlInterval<CqlDateTime> s_(Tuple_DeFAGgTicLTeZRhLHCUZIOBcI i)
		{
		...
		var t_ = context.Operators.Select<Tuple_DeFAGgTicLTeZRhLHCUZIOBcI, CqlInterval<CqlDateTime>>(r_, s_);
	...
	public Tuple_EGJNFRfWJbBHIWINfgdbTShHZ Collapsed_DateTime_Interval_Stats(IEnumerable<CqlInterval<CqlDateTime>> collapsedIntervals)
	{
		...
		CqlInterval<CqlDateTime> c_()
		{
			...
			{
				Tuple_HMMaBVZcGheUZUjDMVhGjKEIK x_(CqlInterval<CqlDateTime> I)
				{
					...
					var ak_ = new Tuple_HMMaBVZcGheUZUjDMVhGjKEIK
					{
						interval = I,
						days = aj_,
					};
				...
				var y_ = context.Operators.Select<CqlInterval<CqlDateTime>, Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(collapsedIntervals, x_);
				object z_(Tuple_HMMaBVZcGheUZUjDMVhGjKEIK @this) => 
@this?.days;
				var aa_ = context.Operators.SortBy<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(y_, z_, System.ComponentModel.ListSortDirection.Descending);
				var ab_ = context.Operators.First<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(aa_);
		...
		int? d_()
		{
			...
			{
				Tuple_HMMaBVZcGheUZUjDMVhGjKEIK ao_(CqlInterval<CqlDateTime> I)
				{
					...
					var bo_ = new Tuple_HMMaBVZcGheUZUjDMVhGjKEIK
					{
						interval = I,
						days = bn_,
					};
				...
				var ap_ = context.Operators.Select<CqlInterval<CqlDateTime>, Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(collapsedIntervals, ao_);
				object aq_(Tuple_HMMaBVZcGheUZUjDMVhGjKEIK @this) => 
@this?.days;
				var ar_ = context.Operators.SortBy<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(ap_, aq_, System.ComponentModel.ListSortDirection.Descending);
				var as_ = context.Operators.First<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(ar_);
				var at_ = this.DateTime_Interval_Set_Nulls_to_Zero(as_?.interval);
				var au_ = context.Operators.Start(at_);
				Tuple_HMMaBVZcGheUZUjDMVhGjKEIK av_(CqlInterval<CqlDateTime> I)
				{
					...
					var bx_ = new Tuple_HMMaBVZcGheUZUjDMVhGjKEIK
					{
						interval = I,
						days = bw_,
					};
				...
				var aw_ = context.Operators.Select<CqlInterval<CqlDateTime>, Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(collapsedIntervals, av_);
				var ay_ = context.Operators.SortBy<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(aw_, aq_, System.ComponentModel.ListSortDirection.Descending);
				var az_ = context.Operators.First<Tuple_HMMaBVZcGheUZUjDMVhGjKEIK>(ay_);
		...
		var e_ = new Tuple_EGJNFRfWJbBHIWINfgdbTShHZ
		{
			Intervals = collapsedIntervals,
			Interval_Count = a_,
			Total_Days_In_Intervals = b_(),
	...
	public Tuple_EGJNFRfWJbBHIWINfgdbTShHZ DateTime_Interval_Covering_Relative_to_Base_Interval_Stats(CqlInterval<CqlDateTime> baseInterval, IEnumerable<CqlInterval<CqlDateTime>> coveringIntervals)
	{
		var a_ = this.DateTime_Interval_Covering_Relative_to_Base_Interval(baseInterval, coveringIntervals);
		var b_ = new Tuple_GYfiJShWDbQjgGNTcAgSHOUQT
		{
			Covering_Intervals = a_,
		};
		var c_ = new Tuple_GYfiJShWDbQjgGNTcAgSHOUQT[]
		{
			b_,
		};
		Tuple_EGJNFRfWJbBHIWINfgdbTShHZ d_(Tuple_GYfiJShWDbQjgGNTcAgSHOUQT variableDeclarations)
		{
			var g_ = this.Collapsed_DateTime_Interval_Stats(variableDeclarations?.Covering_Intervals);

			return g_;
		};
		var e_ = context.Operators.Select<Tuple_GYfiJShWDbQjgGNTcAgSHOUQT, Tuple_EGJNFRfWJbBHIWINfgdbTShHZ>(c_, d_);
		var f_ = context.Operators.SingletonFrom<Tuple_EGJNFRfWJbBHIWINfgdbTShHZ>(e_);

		return f_;
	}

    [CqlDeclaration("DateTime Interval Gaps Relative to Base Interval Stats")]
	public Tuple_EGJNFRfWJbBHIWINfgdbTShHZ DateTime_Interval_Gaps_Relative_to_Base_Interval_Stats(CqlInterval<CqlDateTime> baseInterval, IEnumerable<CqlInterval<CqlDateTime>> coveringIntervals)
	{
		var a_ = this.DateTime_Interval_Gaps_Relative_to_Base_Interval(baseInterval, coveringIntervals);
		var b_ = new Tuple_FbdIDGfVbigBhXjVjYTfYcFdd
		{
			Gap_Intervals = a_,
		};
		var c_ = new Tuple_FbdIDGfVbigBhXjVjYTfYcFdd[]
		{
			b_,
		};
		Tuple_EGJNFRfWJbBHIWINfgdbTShHZ d_(Tuple_FbdIDGfVbigBhXjVjYTfYcFdd variableDeclarations)
		{
			var g_ = this.Collapsed_DateTime_Interval_Stats(variableDeclarations?.Gap_Intervals);

			return g_;
		};
		var e_ = context.Operators.Select<Tuple_FbdIDGfVbigBhXjVjYTfYcFdd, Tuple_EGJNFRfWJbBHIWINfgdbTShHZ>(c_, d_);
		var f_ = context.Operators.SingletonFrom<Tuple_EGJNFRfWJbBHIWINfgdbTShHZ>(e_);
	...
	public CqlDateTime Convert_To_UTC_DateTime(CqlDate d)
	{
		...
		var d_ = new Tuple_DeFAGgTicLTeZRhLHCUZIOBcI
		{
			StartYear = a_,
			StartMonth = b_(),
			StartDay = c_(),
		};
		var e_ = new Tuple_DeFAGgTicLTeZRhLHCUZIOBcI[]
		{
			d_,
		};
		CqlDateTime f_(Tuple_DeFAGgTicLTeZRhLHCUZIOBcI i)
		{
		...
		var g_ = context.Operators.Select<Tuple_DeFAGgTicLTeZRhLHCUZIOBcI, CqlDateTime>(e_, f_);
