...
public class HybridHWRFHIR_1_3_005
{
	...
	private IEnumerable<Encounter> Inpatient_Encounters_Value()
	{
		...
		{
			Tuple_EFSKhGUTUCLEXZENTURVLjeND l_ = new Tuple_EFSKhGUTUCLEXZENTURVLjeND
			{
		...
		IEnumerable<Tuple_EFSKhGUTUCLEXZENTURVLjeND> g_ = context.Operators.Select<ValueTuple<Encounter, Coverage>, Tuple_EFSKhGUTUCLEXZENTURVLjeND>(e_, f_);
		bool? h_(Tuple_EFSKhGUTUCLEXZENTURVLjeND tuple_efskhgutuclexzenturvljend)
		{
			...
			CqlDate ac_ = context.Operators.Convert<CqlDate>(ab_);
		...
		IEnumerable<Tuple_EFSKhGUTUCLEXZENTURVLjeND> i_ = context.Operators.Where<Tuple_EFSKhGUTUCLEXZENTURVLjeND>(g_, h_);
		...
		IEnumerable<Encounter> k_ = context.Operators.Select<Tuple_EFSKhGUTUCLEXZENTURVLjeND, Encounter>(i_, j_);
	...
	private IEnumerable<string> Results_Value()
	{
		...
		IEnumerable<string>[] ar_ = new IEnumerable<string>[]
		{
			d_,
			h_,
			l_,
