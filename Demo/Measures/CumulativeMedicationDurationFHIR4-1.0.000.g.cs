...
public class CumulativeMedicationDurationFHIR4_1_0_000
{
	...
	public IEnumerable<CqlInterval<CqlDateTime>> RolloutIntervals(IEnumerable<CqlInterval<CqlDateTime>> intervals)
	{
		...
		{
			CqlInterval<CqlDateTime>[] c_ = new CqlInterval<CqlDateTime>[]
			{
				I,
			};
			CqlInterval<CqlDateTime> d_(CqlInterval<CqlDateTime> X)
			{
				...
				CqlDateTime[] n_ = new CqlDateTime[]
				{
					l_,
					m_,
				};
				...
				CqlDateTime[] u_ = new CqlDateTime[]
				{
					s_,
					m_,
				};
			...
			CqlInterval<CqlDateTime>[] g_ = new CqlInterval<CqlDateTime>[]
			{
				f_,
			};
			IEnumerable<CqlInterval<CqlDateTime>> h_ = context.Operators.ListUnion<CqlInterval<CqlDateTime>>(R, (g_ as IEnumerable<CqlInterval<CqlDateTime>>));
