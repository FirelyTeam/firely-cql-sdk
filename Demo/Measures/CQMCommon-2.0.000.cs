...
public class CQMCommon_2_0_000
{
	...
	public IEnumerable<IEnumerable<Encounter.LocationComponent>> Hospitalization_Locations(Encounter TheEncounter)
	{
		var a_ = this.ED_Visit(TheEncounter);
		var b_ = new Encounter[]
		{
		...
		{
			IEnumerable<Encounter.LocationComponent> e_()
			{
				...
				{
					var f_ = new IEnumerable<Encounter.LocationComponent>[]
					{
					...
					var g_ = context.Operators.FlattenList<Encounter.LocationComponent>((f_ as IEnumerable<IEnumerable<Encounter.LocationComponent>>));
    ...
    [CqlTag("description", "Returns list of all locations within an encounter, including locations for immediately prior ED visit.")]
	public IEnumerable<IEnumerable<Encounter.LocationComponent>> hospitalizationLocations(Encounter TheEncounter)
	{
		var a_ = this.edVisit(TheEncounter);
		var b_ = new Encounter[]
		{
