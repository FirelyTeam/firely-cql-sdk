...
public class FHIR347_0_1_021
{
    ...
    private CqlValueSet Atherosclerosis_and_Peripheral_Arterial_Disease_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.21", 
			null);
    ...
    private CqlValueSet Breastfeeding_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.73", 
			null);
    ...
    private CqlValueSet CABG_Surgeries_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.666.5.694", 
			null);
    ...
    private CqlValueSet CABG__PCI_Procedure_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1138.566", 
			null);
    ...
    private CqlValueSet Carotid_Intervention_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.117.1.7.1.204", 
			null);
    ...
    private CqlValueSet Cerebrovascular_Disease__Stroke__TIA_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.44", 
			null);
    ...
    private CqlValueSet End_Stage_Renal_Disease_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.353", 
			null);
    ...
    private CqlValueSet Hepatitis_A_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.464.1003.110.12.1024", 
			null);
    ...
    private CqlValueSet Hepatitis_B_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.67.1.101.1.269", 
			null);
    ...
    private CqlValueSet High_Intensity_Statin_Therapy_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1572", 
			null);
    ...
    private CqlValueSet Hospice_Care_Ambulatory_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1584", 
			null);
    ...
    private CqlValueSet Hypercholesterolemia_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.100", 
			null);
    ...
    private CqlValueSet Ischemic_Heart_Disease_or_Other_Related_Diagnoses_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.46", 
			null);
    ...
    private CqlValueSet LDL_Cholesterol_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1573", 
			null);
    ...
    private CqlValueSet Liver_Disease_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.42", 
			null);
    ...
    private CqlValueSet Low_Intensity_Statin_Therapy_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1574", 
			null);
    ...
    private CqlValueSet Moderate_Intensity_Statin_Therapy_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1575", 
			null);
    ...
    private CqlValueSet Myocardial_Infarction_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.403", 
			null);
    ...
    private CqlValueSet Outpatient_Encounters_for_Preventive_Care_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.526.3.1576", 
			null);
    ...
    private CqlValueSet Palliative_Care_Encounter_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.600.1.1575", 
			null);
    ...
    private CqlValueSet PCI_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1045.67", 
			null);
    ...
    private CqlValueSet Pregnancy_or_Other_Related_Diagnoses_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.600.1.1623", 
			null);
    ...
    private CqlValueSet Preventive_Care_Services___Other_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.464.1003.101.12.1030", 
			null);
    ...
    private CqlValueSet Preventive_Care_Services_Individual_Counseling_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.3.464.1003.101.12.1026", 
			null);
    ...
    private CqlValueSet Rhabdomyolysis_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.102", 
			null);
    ...
    private CqlValueSet Stable_and_Unstable_Angina_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1047.47", 
			null);
    ...
    private CqlValueSet Statin_Allergen_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1110.42", 
			null);
    ...
    private CqlValueSet Statin_Associated_Muscle_Symptoms_Value() =>
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1108.85", 
			null);
    ...
    private IEnumerable<object> ASCVD_Diagnosis_or_Procedure_before_End_of_Measurement_Period_Value()
	{
		...
		var o_ = (Condition ASCVDDiagnosis) =>
		{
		...
		var q_ = (p_ as IEnumerable<object>);
		var r_ = this.PCI();
		var s_ = context?.DataRetriever.RetrieveByValueSet<Procedure>(r_, null);
		var t_ = this.CABG_Surgeries();
		var u_ = context?.DataRetriever.RetrieveByValueSet<Procedure>(t_, null);
		var v_ = context?.Operators.ListUnion<Procedure>(s_, u_);
		var w_ = this.Carotid_Intervention();
		var x_ = context?.DataRetriever.RetrieveByValueSet<Procedure>(w_, null);
		var y_ = this.CABG__PCI_Procedure();
		var z_ = context?.DataRetriever.RetrieveByValueSet<Procedure>(y_, null);
		var aa_ = context?.Operators.ListUnion<Procedure>(x_, z_);
		var ab_ = context?.Operators.ListUnion<Procedure>(v_, aa_);
		var ac_ = (Procedure ASCVDProcedure) =>
		{
			var a_ = (ASCVDProcedure?.Performed as object);
			...
			var g_ = (f_ as object);
			var h_ = context?.Operators.Before(d_, g_, null);
			var i_ = (ASCVDProcedure?.StatusElement as object);
		...
		var ad_ = context?.Operators.WhereOrNull<Procedure>(ab_, ac_);
		var ae_ = (ad_ as IEnumerable<object>);

		return context?.Operators.ListUnion<object>(q_, ae_);
	}
    ...
    private IEnumerable<Condition> Hypercholesterolemia_Diagnosis_Value()
	{
		...
		var b_ = context?.DataRetriever.RetrieveByValueSet<Condition>(a_, null);
		var c_ = (Condition Hypercholesterolemia) =>
		{
    ...
    private bool? Has_Diabetes_Diagnosis_Value()
	{
		...
		return context?.Operators.ExistsInList<Condition>(d_);
	}
    ...
    private bool? Has_Allergy_to_Statin_Value()
	{
		...
		var b_ = context?.DataRetriever.RetrieveByValueSet<AllergyIntolerance>(a_, null);
		var c_ = (AllergyIntolerance StatinAllergy) =>
		{
		...
		return context?.Operators.ExistsInList<AllergyIntolerance>(d_);
	}
    ...
    private bool? Has_Order_or_Receiving_Hospice_Care_or_Palliative_Care_Value()
	{
		...
		var b_ = context?.DataRetriever.RetrieveByValueSet<ServiceRequest>(a_, null);
		var c_ = this.Palliative_or_Hospice_Care();
		var d_ = context?.DataRetriever.RetrieveByValueSet<ServiceRequest>(c_, null);
		var e_ = context?.Operators.ListUnion<ServiceRequest>(b_, d_);
		var f_ = (ServiceRequest PalliativeOrHospiceCareOrder) =>
		{
		...
		var n_ = (Procedure PalliativeOrHospiceCarePerformed) =>
		{
			...
			var d_ = this.Measurement_Period();
			var e_ = context?.Operators.End(d_);
			var f_ = context?.Operators.SameOrBefore(c_, e_, null);
			var g_ = (PalliativeOrHospiceCarePerformed?.StatusElement as object);
			var h_ = (context.Deeper(new CallStackEntry("ToString", 
		null, 
		null))?.Operators?.TypeConverter).Convert<string>(g_);
			var i_ = (h_ as object);
			var j_ = context?.Operators.Equal(i_, ("completed" as object));

			return context?.Operators.And(f_, j_);
		};
		...
		var t_ = context?.DataRetriever.RetrieveByCodes<Encounter>(s_, null);
		var u_ = (Encounter PalliativeEncounter) =>
		{
			var a_ = PalliativeEncounter?.Period;
			var b_ = FHIRHelpers_4_0_001.ToInterval(a_);
			var c_ = context?.Operators.Start(b_);
			var d_ = this.Measurement_Period();
			var e_ = context?.Operators.End(d_);
			var f_ = context?.Operators.SameOrBefore(c_, e_, null);
			var g_ = (PalliativeEncounter?.StatusElement as object);
			var h_ = (context.Deeper(new CallStackEntry("ToString", 
		null, 
		null))?.Operators?.TypeConverter).Convert<string>(g_);
			var i_ = (h_ as object);
		...
		return context?.Operators.Or(q_, w_);
	}
    ...
    private bool? Has_Hepatitis_or_Liver_Disease_Diagnosis_Value()
	{
		...
		var i_ = (Condition HepatitisLiverDisease) =>
		{
    ...
    private bool? Has_Statin_Associated_Muscle_Symptoms_Value()
	{
		...
		var b_ = context?.DataRetriever.RetrieveByValueSet<Condition>(a_, null);
		var c_ = (Condition StatinMuscleSymptom) =>
		{
	...
	{
		var a_ = this.Statin_Allergen();
		var b_ = context?.DataRetriever.RetrieveByValueSet<AdverseEvent>(a_, null);
		var c_ = (AdverseEvent StatinReaction) =>
		{
		...
		return context?.Operators.ExistsInList<AdverseEvent>(d_);
	}
    ...
    private bool? Denominator_Exclusions_Value()
	{
		...
		var g_ = context?.DataRetriever.RetrieveByValueSet<Condition>(f_, null);
		var h_ = context?.Operators.ListUnion<Condition>(e_, g_);
		var i_ = (Condition ExclusionDiagnosis) =>
		{
    ...
    private IEnumerable<MedicationRequest> Statin_Therapy_Ordered_during_Measurement_Period_Value()
	{
		...
		var c_ = this.Low_Intensity_Statin_Therapy();
		...
		var m_ = context?.DataRetriever.RetrieveByValueSet<MedicationRequest>(l_, null);
		var n_ = this.High_Intensity_Statin_Therapy();
		var o_ = context?.DataRetriever.RetrieveByValueSet<MedicationRequest>(n_, null);
		var p_ = context?.Operators.ListUnion<MedicationRequest>(m_, o_);
		var q_ = context?.Operators.ListUnion<MedicationRequest>(k_, p_);
		var r_ = (MedicationRequest StatinOrdered) =>
		{
		...
		return context?.Operators.WhereOrNull<MedicationRequest>(q_, r_);
	}
    ...
    private IEnumerable<MedicationRequest> Prescribed_Statin_Therapy_Any_Time_during_Measurement_Period_Value()
	{
		...
		var p_ = context?.Operators.ListUnion<MedicationRequest>(m_, o_);
		var q_ = context?.Operators.ListUnion<MedicationRequest>(k_, p_);
		var r_ = (MedicationRequest ActiveStatin) =>
		{
			var a_ = ActiveStatin?.DosageInstruction;
			var b_ = (Dosage @this) =>
			{
			...
			var c_ = context?.Operators.WhereOrNull<Dosage>(a_, b_);
			var d_ = (Dosage @this) => @this?.Timing;
			var e_ = context?.Operators.SelectOrNull<Dosage, Timing>(c_, d_);
			var f_ = (Timing T) =>
			{
				var a_ = (((((T?.Repeat?.Bounds as object) is Range as bool?) ?? false))
...
;
			...
			var g_ = context?.Operators.WhereOrNull<Timing>(e_, f_);
			var h_ = context?.Operators.ExistsInList<Timing>(g_);
			var i_ = (ActiveStatin?.StatusElement as object);
			var j_ = (context.Deeper(new CallStackEntry("ToString", 
		null, 
		null))?.Operators?.TypeConverter).Convert<string>(i_);
			var k_ = "active";
			...
			var o_ = context?.Operators.InList<string>(j_, n_);
