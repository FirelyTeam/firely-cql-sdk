...
public class NCQAClaims_1_0_0
{
	...
	public IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> Medical_Claims_With_Procedure_and_POS(IEnumerable<Claim> claim, IEnumerable<CqlCode> posCodes, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> h_(Tuples.Tuple_EWMRhBHgcOUGZLgIBDbjPHISO ClaimWithPosCode)
		{
			Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA k_(Claim ClaimofInterest)
			{
				...
				var t_ = context.Operators.SingletonFrom<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(s_);
		...
		var j_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>>(i_);
	...
	public IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> Medical_Claims_With_Procedure_in_Header_or_on_Line_Item(IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> f_(Tuples.Tuple_EWMRhBHgcOUGZLgIBDbjPHISO ClaimWithProcedure)
		{
			Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA i_(Claim ClaimofInterest)
			{
				IEnumerable<Claim.ItemComponent> m_()
				{
					...
					else
					{
						bool? t_(Claim.ItemComponent ItemOnLine)
						{
							...
							var am_ = context.Operators.Exists<Coding>(al_);
				...
				var r_ = context.Operators.SingletonFrom<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(q_);
		...
		var h_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>>(g_);
	...
	public Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI Medical_Claims_With_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI f_(Tuples.Tuple_HGJgSEUEXcXLiIPXgcJWiVdUX ClaimWithDiagnosis)
		{
			...
			Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI l_(Tuples.Tuple_FcALBBGFXRhKjhIaDWMVWUhJg HeaderDefinition)
			{
				...
				var ao_ = context.Operators.SingletonFrom<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI>(an_);
			...
			var n_ = context.Operators.SingletonFrom<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI>(m_);
		...
		var h_ = context.Operators.SingletonFrom<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI>(g_);
	...
	public IEnumerable<Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC> Pharmacy_Claim_With_Medication(IEnumerable<Claim> claim, IEnumerable<CqlCode> MedicationCodes)
	{
			...
			Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC i_(Claim Pharmacy)
			{
				...
				Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC q_(Tuples.Tuple_CNibCQZPIWCUUGeAXcXWGiTgj LineItemDefinition)
				{
					...
					Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC z_(Claim ClaimLines)
					{
						...
						var ak_ = context.Operators.SingletonFrom<Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC>(aj_);

						return ak_;
					};
					var aa_ = context.Operators.SelectOrNull<Claim, Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC>(y_, z_);
					var ab_ = context.Operators.SingletonFrom<Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC>(aa_);
				...
				var s_ = context.Operators.SingletonFrom<Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC>(r_);
		...
		var h_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_FOLKddIQBPRMYYfjeMUjEIBhC>>(g_);
		...
		IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> h_(Tuples.Tuple_EUYHPiEZNTBOHPgZNKhGAORRb ClaimWithDiagnosis)
		{
			...
			IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA> n_(Tuples.Tuple_FcALBBGFXRhKjhIaDWMVWUhJg ClaimWithProcedure)
			{
				Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA am_(Claim ClaimofInterest)
				{
					Claim aq_()
					{
						...
						else
						{
							...
							bool? ax_(Claim ItemOnLine)
							{
								...
								var bn_ = context.Operators.Exists<Coding>(bm_);
								...
								var bz_ = context.Operators.Exists<Coding>(by_);
								var ca_ = context.Operators.Or(bn_, bz_);

								return ca_;
							};
							var ay_ = context.Operators.WhereOrNull<Claim>(aw_, ax_);
							var az_ = context.Operators.SingletonFrom<Claim>(ay_);
					...
					var av_ = context.Operators.SingletonFrom<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(au_);
			...
			var p_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>>(o_);
			...
			Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA k_(Claim ClaimofInterest)
			{
				Claim o_()
				{
					...
					else
					{
						...
						bool? v_(Claim ItemOnLine)
						{
							...
							var ax_ = context.Operators.Exists<Coding>(aw_);
				...
				Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA r_(Tuples.Tuple_CIIbRNfJieBVcNIWHEUWMVhOB DiagnosisCheck)
				{
					...
					Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA bi_(Claim ClaimforDiagnosis)
					{
							...
							else
							{
								...
								bool? bs_(Claim RightClaim)
								{
									bool? bv_(Claim.DiagnosisComponent RightDiagnosis)
									{
										...
										var ce_ = context.Operators.Exists<Coding>(cd_);
									...
									var bx_ = context.Operators.Exists<Claim.DiagnosisComponent>(bw_);

									return bx_;
								};
								var bt_ = context.Operators.WhereOrNull<Claim>(br_, bs_);
								var bu_ = context.Operators.SingletonFrom<Claim>(bt_);
						...
						var bq_ = context.Operators.SingletonFrom<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(bp_);

						return bq_;
					};
					var bj_ = context.Operators.SelectOrNull<Claim, Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(bh_, bi_);
					var bk_ = context.Operators.SingletonFrom<Tuples.Tuple_DTeHhjMPXBSEFRBcdiBHhKQDA>(bj_);
	...
	public IEnumerable<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI> Medical_Claims_With_Principal_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		IEnumerable<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI> f_(Tuples.Tuple_HGJgSEUEXcXLiIPXgcJWiVdUX ClaimWithDiagnosis)
		{
			...
			var n_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI>>(m_);
		...
		var h_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_HLLRUdKceDPKeIXGFiiNKjMKI>>(g_);
	...
	public IEnumerable<Tuples.Tuple_EbJRLQXEhRCeIIZLcXEYbTEDL> Get_All_Paid_Claim_Reponses(IEnumerable<ClaimResponse> claimResponse)
	{
		...
		var g_ = context.Operators.SingletonFrom<IEnumerable<Tuples.Tuple_EbJRLQXEhRCeIIZLcXEYbTEDL>>(f_);
	...
	public IEnumerable<Tuples.Tuple_DXaYeZVOEAELKIhLMVHZBeASM> Get_All_Claims_With_Procedure_and_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		bool? a_(Claim AllClaims)
		{
			...
			var ad_ = context.Operators.Exists<Coding>(ac_);
	...
	public Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO Get_Corresponding_Claim_for_Services_and_Conditions(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO e_(Tuples.Tuple_ELXXNjRZXJcQDXjEEQXFeNQKZ ClaimAndResponse)
		{
			Tuples.Tuple_CAKcSTUVVXcPjYRXATiiRAEMg h_(Tuples.Tuple_DXaYeZVOEAELKIhLMVHZBeASM medClaim)
			{
				bool? o_(Claim.ItemComponent medClaimLineItem)
				{
					...
					var t_ = context.Operators.Exists<Tuples.Tuple_EbJRLQXEhRCeIIZLcXEYbTEDL>(s_);
			...
			Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO l_(Tuples.Tuple_CTafBejCOJKDPBQMRaUKGZGDD ClaimWithPaidResponse)
			{
				...
				var ak_ = context.Operators.SingletonFrom<Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO>(aj_);
			...
			var n_ = context.Operators.SingletonFrom<Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO>(m_);
		...
		var g_ = context.Operators.SingletonFrom<Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO>(f_);
	...
	public Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO Get_Paid_Claims_for_Provided_Service_and_Condition(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		var e_ = context.Operators.SingletonFrom<Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO>(d_);
		...
		var i_ = context.Operators.SingletonFrom<Tuples.Tuple_FbAEUOYETObSHBafYbFNIeSNO>(h_);
	...
	public Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO Get_Corresponding_Claim_for_Pharmacy_Services(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO e_(Tuples.Tuple_EDASHZgEHSQJbecPJIZegfOIB ClaimAndResponse)
		{
			...
			Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO l_(Tuples.Tuple_DOALBUVOFWRHAUjdPUNBfNdUB ClaimWithPaidResponse)
			{
				...
				var ak_ = context.Operators.SingletonFrom<Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO>(aj_);
			...
			var n_ = context.Operators.SingletonFrom<Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO>(m_);
		...
		var g_ = context.Operators.SingletonFrom<Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO>(f_);
	...
	public Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO Get_Paid_Claims_for_Pharmacy_Services(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		var e_ = context.Operators.SingletonFrom<Tuples.Tuple_BOANHMYNiCIfFjRZRMEXCcXTO>(d_);
	...
	public Tuples.Tuple_CYfZbbEjJgLODachBhLiZaXQE Medical_Claims_With_Nonacute_or_Acute_Inpatient_Discharge(IEnumerable<Claim> claim)
	{
		...
		Tuples.Tuple_CYfZbbEjJgLODachBhLiZaXQE d_(Tuples.Tuple_EWMRhBHgcOUGZLgIBDbjPHISO ClaimWithInpatientStay)
		{
			...
			var m_ = context.Operators.SingletonFrom<Tuples.Tuple_CYfZbbEjJgLODachBhLiZaXQE>(l_);
		...
		var f_ = context.Operators.SingletonFrom<Tuples.Tuple_CYfZbbEjJgLODachBhLiZaXQE>(e_);
	...
	public Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY Get_Prescriber_NPI_from_Claims(IEnumerable<Claim> claim)
	{
		...
		Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY e_(Tuples.Tuple_GMJgYefQcULgUcRJJAbTfRThR ClaimProperties)
		{
			...
			Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY ap_(Tuples.Tuple_DIQeTbDBBRFOAGiGbFgLLFZOe PractitionerMatch)
			{
				...
				var bi_ = context.Operators.SingletonFrom<Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY>(bh_);
			...
			var ar_ = context.Operators.SingletonFrom<Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY>(aq_);
		...
		var g_ = context.Operators.SingletonFrom<Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY>(f_);
	...
	public Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY Get_Pharmacy_NPI_from_Claims(IEnumerable<Claim> claim)
	{
		...
		Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY e_(Tuples.Tuple_FbiEbRAPBSZAgWUQOLFeLJQTa ClaimProperties)
		{
			...
			Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY ar_(Tuples.Tuple_CZQfDISCFaOQaLKEbbAcDRfcP GetLocation)
			{
				...
				var bk_ = context.Operators.SingletonFrom<Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY>(bj_);
			...
			var at_ = context.Operators.SingletonFrom<Tuples.Tuple_CEXhgaFKbhdeeAYTYBhHTGXUY>(as_);
