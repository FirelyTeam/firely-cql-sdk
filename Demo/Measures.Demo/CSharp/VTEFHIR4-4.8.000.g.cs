...
public static class VTEFHIR4_4_8_000
{
	...
	public static Encounter.LocationComponent FirstInpatientIntensiveCareUnit(CqlContext context, Encounter Encounter)
	{
		...
		bool? b_(Encounter.LocationComponent HospitalLocation)
		{
			...
			CqlValueSet l_ = VTEFHIR4_4_8_000.Intensive_Care_Unit(context);
	...
	public static Period FirstICULocationPeriod(CqlContext context, Encounter Encounter)
	{
		Encounter.LocationComponent a_ = VTEFHIR4_4_8_000.FirstInpatientIntensiveCareUnit(context, Encounter);
		Period b_ = a_?.Period;
	...
	{
		Period a_ = VTEFHIR4_4_8_000.FirstICULocationPeriod(context, Encounter);
	...
	public static CqlInterval<CqlDate> FromDayOfStartOfHospitalizationToDayAfterFirstICU(CqlContext context, Encounter Encounter)
	{
		...
		CqlDateTime b_ = context.Operators.Start(a_);
		CqlDate c_ = context.Operators.DateFrom(b_);
		CqlDateTime d_ = VTEFHIR4_4_8_000.StartOfFirstICU(context, Encounter);
