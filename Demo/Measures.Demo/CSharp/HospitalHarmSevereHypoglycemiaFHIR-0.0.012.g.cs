...
public class HospitalHarmSevereHypoglycemiaFHIR_0_0_012
{
	...
	private IEnumerable<Encounter> Severe_Hypoglycemic_Harm_Event_Value()
	{
		...
		bool? b_(Encounter QualifyingEncounter)
		{
			...
			IEnumerable<Observation> e_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, d_, default));
			...
			IEnumerable<Observation> i_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, d_, default));
			...
			IEnumerable<Observation> l_(Observation BloodGlucoseLab)
			{
				...
				IEnumerable<Observation> cq_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, cp_, default));
