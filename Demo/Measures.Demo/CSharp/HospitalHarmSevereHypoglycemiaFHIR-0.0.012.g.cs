...
public partial class HospitalHarmSevereHypoglycemiaFHIR_0_0_012 : ILibrary, ISingleton<HospitalHarmSevereHypoglycemiaFHIR_0_0_012>
{
    ...
    private readonly Cached<IEnumerable<Encounter>> _Qualifying_Encounter_with_Hypoglycemic_Medication_Administration_Cached = new();
    ...
    public IEnumerable<Encounter> Qualifying_Encounter_with_Hypoglycemic_Medication_Administration(CqlContext context) =>
        _Qualifying_Encounter_with_Hypoglycemic_Medication_Administration_Cached.GetOrReplace(
            context,
            () => {
    ...
    private readonly Cached<IEnumerable<Encounter>> _Severe_Hypoglycemic_Harm_Event_Cached = new();
