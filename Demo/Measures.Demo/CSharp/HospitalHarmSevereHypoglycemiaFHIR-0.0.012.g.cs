...
public partial class HospitalHarmSevereHypoglycemiaFHIR_minus_0_0_012 : ILibrary, ISingleton<HospitalHarmSevereHypoglycemiaFHIR_minus_0_0_012>
{
    private HospitalHarmSevereHypoglycemiaFHIR_minus_0_0_012() {}

    public static HospitalHarmSevereHypoglycemiaFHIR_minus_0_0_012 Instance { get; } = new();
    ...
    public IEnumerable<Encounter> Qualifying_Encounter(CqlContext context)
    {
        ...
        bool? b_(Encounter InpatientEncounter)
        {
            ...
            CqlInterval<CqlDateTime> h_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, InpatientEncounter);
    ...
    public IEnumerable<MedicationAdministration> Hypoglycemic_Medication_Administration(CqlContext context)
    {
        ...
        IEnumerable<MedicationAdministration> d_(MedicationAdministration MR)
        {
            ...
            bool? j_(Medication M)
            {
                ...
                string q_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, p_ as FhirString);
                ...
                CqlConcept v_ = FHIRHelpers_minus_4_0_001.Instance.ToConcept(context, u_);
        ...
        bool? g_(MedicationAdministration HypoMedication)
        {
            ...
            string aa_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, z_);
            bool? ab_ = context.Operators.Equal(aa_, "completed");
            string ad_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, z_);
    ...
    public IEnumerable<Encounter> Qualifying_Encounter_with_Hypoglycemic_Medication_Administration(CqlContext context)
    {
        ...
        IEnumerable<Encounter> b_(Encounter QualifyingEncounter)
        {
            ...
            bool? e_(MedicationAdministration HypoglycemicMedication)
            {
                ...
                CqlInterval<CqlDateTime> l_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, QualifyingEncounter);
        ...
        bool? b_(Encounter QualifyingEncounter)
        {
            ...
            IEnumerable<Observation> f_(Observation BloodGlucoseLab)
            {
                ...
                bool? s_(MedicationAdministration HypoglycemicMeds)
                {
                    ...
                    CqlInterval<CqlDateTime> x_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, w_);
                    ...
                    CqlInterval<CqlDateTime> af_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, z_);
                    ...
                    CqlInterval<CqlDateTime> ak_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, z_);
                    ...
                    string at_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, ao_);
                    bool? au_ = context.Operators.Equal(at_, "cancelled");
                    bool? av_ = context.Operators.Not(au_);
                    bool? aw_ = context.Operators.And(ar_, av_);
                    CqlInterval<CqlDateTime> ay_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, w_);
                    CqlDateTime az_ = context.Operators.Start(ay_);
                    CqlInterval<CqlDateTime> ba_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, QualifyingEncounter);
            ...
            IEnumerable<Observation> j_(Observation BloodGlucoseLab)
            {
                ...
                bool? be_(MedicationAdministration HypoglycemicMeds)
                {
                    ...
                    CqlInterval<CqlDateTime> bj_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, bi_);
                    CqlDateTime bk_ = context.Operators.Start(bj_);
                    DataType bl_ = BloodGlucoseLab?.Effective;
                    CqlInterval<CqlDateTime> bm_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, bl_);
                    ...
                    CqlInterval<CqlDateTime> br_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, bl_);
                    ...
                    CqlInterval<CqlDateTime> bw_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, bl_);
                    ...
                    string cb_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, ca_);
                    bool? cc_ = context.Operators.Equal(cb_, "final");
                    bool? cd_ = context.Operators.And(bz_, cc_);
                    string cf_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, ca_);
                    bool? cg_ = context.Operators.Equal(cf_, "cancelled");
                    bool? ch_ = context.Operators.Not(cg_);
                    bool? ci_ = context.Operators.And(cd_, ch_);
                    CqlInterval<CqlDateTime> ck_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, bi_);
                    CqlDateTime cl_ = context.Operators.Start(ck_);
                    CqlInterval<CqlDateTime> cm_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, QualifyingEncounter);
            ...
            IEnumerable<Observation> l_(Observation BloodGlucoseLab)
            {
                ...
                bool? cr_(Observation FollowupBloodGlucoseLab)
                {
                    ...
                    CqlInterval<CqlDateTime> cw_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, cv_);
                    CqlDateTime cx_ = context.Operators.Start(cw_);
                    CqlInterval<CqlDateTime> cy_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, QualifyingEncounter);
                    bool? cz_ = context.Operators.In<CqlDateTime>(cx_, cy_, default);
                    CqlInterval<CqlDateTime> db_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, cv_);
                    CqlDateTime dc_ = context.Operators.Start(db_);
                    DataType dd_ = BloodGlucoseLab?.Effective;
                    CqlInterval<CqlDateTime> de_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, dd_);
                    CqlDateTime df_ = context.Operators.Start(de_);
                    CqlInterval<CqlDateTime> dh_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, dd_);
                    ...
                    CqlInterval<CqlDateTime> do_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, dd_);
                    ...
                    string du_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, dt_);
                    bool? dv_ = context.Operators.Equal(du_, "final");
                    bool? dw_ = context.Operators.And(ds_, dv_);
                    string dy_ = FHIRHelpers_minus_4_0_001.Instance.ToString(context, dt_);
                    ...
                    CqlQuantity ed_ = FHIRHelpers_minus_4_0_001.Instance.ToQuantity(context, ec_ as Quantity);
            ...
            bool? o_(Observation BloodGlucoseLab)
            {
                ...
                CqlInterval<CqlDateTime> ei_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.Normalize_Interval(context, eh_);
                CqlDateTime ej_ = context.Operators.Start(ei_);
                CqlInterval<CqlDateTime> ek_ = MATGlobalCommonFunctionsFHIR4_minus_6_1_000.Instance.HospitalizationWithObservation(context, QualifyingEncounter);
                bool? el_ = context.Operators.In<CqlDateTime>(ej_, ek_, default);
                DataType em_ = BloodGlucoseLab?.Value;
                CqlQuantity en_ = FHIRHelpers_minus_4_0_001.Instance.ToQuantity(context, em_ as Quantity);
