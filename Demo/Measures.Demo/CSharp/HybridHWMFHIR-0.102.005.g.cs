...
public class HybridHWMFHIR_0_102_005
{
	...
	private IEnumerable<string> Results_Value()
	{
		...
		IEnumerable<Observation> j_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, i_, default));
		...
		IEnumerable<Observation> n_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, default, m_));
		IEnumerable<string> o_ = this.FirstPhysicalExamWithEncounterId(n_, "FirstO2Saturation");
		CqlValueSet p_ = this.Hematocrit_lab_test();
		IEnumerable<Observation> q_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, p_, default));
		IEnumerable<string> r_ = this.FirstLabTestWithEncounterId(q_, "FirstHematocrit");
		CqlValueSet s_ = this.Platelet_count_lab_test();
		IEnumerable<Observation> t_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, s_, default));
		...
		IEnumerable<Observation> w_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, v_, default));
		IEnumerable<string> x_ = this.FirstLabTestWithEncounterId(w_, "FirstWhiteBloodCell");
		CqlValueSet y_ = this.Sodium_lab_test();
		IEnumerable<Observation> z_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, y_, default));
		IEnumerable<string> aa_ = this.FirstLabTestWithEncounterId(z_, "FirstSodium");
		CqlValueSet ab_ = this.Bicarbonate_lab_test();
		IEnumerable<Observation> ac_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, ab_, default));
