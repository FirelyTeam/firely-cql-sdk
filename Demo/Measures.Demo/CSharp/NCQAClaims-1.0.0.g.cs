...
public class NCQAClaims_1_0_0
{
	...
	public IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> Medical_Claims_With_Procedure_and_POS(IEnumerable<Claim> claim, IEnumerable<CqlCode> posCodes, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) f_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)
		{
			MedicalClaim = a_,
			ProceduresAsStrings = c_,
			POSAsString = e_,
		};
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[] g_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[]
		{
			f_,
		};
		IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> h_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) ClaimWithPosCode)
		{
			...
			(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) n_(Claim ClaimofInterest)
			{
				...
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) s_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)
				{
					Claim = ClaimofInterest,
					LineItems = r_(),
				};
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)[] t_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)[]
				{
					s_,
				};
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) u_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) LineItemDefinition)
				{
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) at_()
					{
						...
						if (au_())
						{
							...
							(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) bf_ = new (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
							{
								Claim = ax_,
								ServicePeriod = be_,
							};
	...
	public IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> Medical_Claims_With_Procedure_in_Header_or_on_Line_Item(IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		IEnumerable<string> c_ = context.Operators.Select<CqlCode, string>(ProductOrServiceValueSet, b_);
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) d_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)
		{
			MedicalClaim = a_,
			ProceduresAsStrings = c_,
		};
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[] e_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[]
		{
			d_,
		};
		IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> f_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) ClaimWithProcedure)
		{
			...
			(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) k_(Claim ClaimofInterest)
			{
				...
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) p_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)
				{
					Claim = ClaimofInterest,
					LineItems = o_(),
				};
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)[] q_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)[]
				{
					p_,
				};
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) r_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) LineItemDefinition)
				{
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) be_()
					{
						...
						if (bf_())
						{
							...
							(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) bq_ = new (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
							{
								Claim = bi_,
								ServicePeriod = bp_,
							};
	...
	public (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) Medical_Claims_With_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings) d_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings)
		{
			MedicalClaim = a_,
			DiagnosesAsStrings = c_,
		};
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings)[] e_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings)[]
		{
			d_,
		};
		(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) f_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings) ClaimWithDiagnosis)
		{
			...
			(IEnumerable<Claim> DiagnosisItems) k_ = new (IEnumerable<Claim> DiagnosisItems)
			{
				DiagnosisItems = j_(),
			};
			(IEnumerable<Claim> DiagnosisItems)[] l_ = new (IEnumerable<Claim> DiagnosisItems)[]
			{
				k_,
			};
			(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) m_((IEnumerable<Claim> DiagnosisItems) HeaderDefinition)
			{
				(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) ap_()
				{
					...
					if (au_())
					{
						...
						(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) bg_ = new (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
						{
							Claim = ax_,
							ServicePeriod = bf_,
						};
				...
				(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[] aq_ = new (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[]
				{
					ap_(),
				};
				...
				IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> as_ = context.Operators.Where<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(((IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>)aq_), ar_);
				(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) at_ = context.Operators.SingletonFrom<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(as_);

				return at_;
			};
			IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> n_ = context.Operators.Select<(IEnumerable<Claim> DiagnosisItems), (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(((IEnumerable<(IEnumerable<Claim> DiagnosisItems)>)l_), m_);
	...
	public IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> Pharmacy_Claim_With_Medication(IEnumerable<Claim> claim, IEnumerable<CqlCode> MedicationCodes)
	{
		...
		(IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings) d_ = new (IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings)
		{
			PharmacyClaim = a_,
			MedicationsAsStrings = c_,
		};
		(IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings)[] e_ = new (IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings)[]
		{
			d_,
		};
		IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> f_((IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings) ClaimWithMedication)
		{
			...
			(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) k_(Claim Pharmacy)
			{
				...
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) r_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)
				{
					Claim = Pharmacy,
					LineItems = q_,
				};
				...
				(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) t_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItems) LineItemDefinition)
				{
					...
					(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) ah_(Claim ClaimLines)
					{
						...
						(CqlInterval<CqlDateTime> DaysSupplyInterval) an_(Claim.ItemComponent i)
						{
							...
							(CqlInterval<CqlDateTime> DaysSupplyInterval) be_ = new (CqlInterval<CqlDateTime> DaysSupplyInterval)
							{
						...
						IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> ao_ = context.Operators.Select<Claim.ItemComponent, (CqlInterval<CqlDateTime> DaysSupplyInterval)>(am_, an_);
						(IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> CoveredDays) ap_ = new (IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> CoveredDays)
						{
							CoveredDays = ao_,
						};
						(IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> CoveredDays)[] aq_ = new (IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> CoveredDays)[]
						{
							ap_,
						};
						(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) ar_((IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> CoveredDays) ItemCalculation)
						{
							(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) dy_()
							{
								...
								if (dz_())
								{
									...
									IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval)> el_ = ItemCalculation?.CoveredDays;
									CqlInterval<CqlDateTime> em_((CqlInterval<CqlDateTime> DaysSupplyInterval) d)
									{
										CqlInterval<CqlDateTime> et_ = d?.DaysSupplyInterval;

										return et_;
									};
									IEnumerable<CqlInterval<CqlDateTime>> en_ = context.Operators.Select<(CqlInterval<CqlDateTime> DaysSupplyInterval), CqlInterval<CqlDateTime>>(el_, em_);
									(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) eo_ = new (Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)
									{
										Claim = ec_,
										LineItem = ed_,
										ServicePeriod = ek_,
	...
	public IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> Medical_Claims_With_Diagnosis_and_Procedure(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings) f_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings)
		{
			MedicalClaim = a_,
			DiagnosesAsStrings = c_,
			ProceduresAsStrings = e_,
		};
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings)[] g_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings)[]
		{
			f_,
		};
		IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> h_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings) ClaimWithDiagnosis)
		{
			...
			(IEnumerable<Claim> DiagnosisItems) n_ = new (IEnumerable<Claim> DiagnosisItems)
			{
				DiagnosisItems = m_(),
			};
			(IEnumerable<Claim> DiagnosisItems)[] o_ = new (IEnumerable<Claim> DiagnosisItems)[]
			{
				n_,
			};
			IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> p_((IEnumerable<Claim> DiagnosisItems) ClaimWithProcedure)
			{
				...
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) at_(Claim ClaimofInterest)
				{
					...
					(Claim ProcedureItems) ay_ = new (Claim ProcedureItems)
					{
						ProcedureItems = ax_(),
					};
					(Claim ProcedureItems)[] az_ = new (Claim ProcedureItems)[]
					{
						ay_,
					};
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) ba_((Claim ProcedureItems) HeaderDefinition)
					{
						(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) dc_()
						{
							...
							if (dd_())
							{
								...
								(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) dl_ = new (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
								{
									Claim = dg_,
									ServicePeriod = dk_,
								};
					...
					IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> bb_ = context.Operators.Select<(Claim ProcedureItems), (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(((IEnumerable<(Claim ProcedureItems)>)az_), ba_);
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) bc_ = context.Operators.SingletonFrom<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(bb_);

					return bc_;
				};
				IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> au_ = context.Operators.Select<Claim, (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(as_, at_);
				...
				IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> aw_ = context.Operators.Where<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(au_, av_);

				return aw_;
			};
			IEnumerable<IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>> q_ = context.Operators.Select<(IEnumerable<Claim> DiagnosisItems), IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>>(((IEnumerable<(IEnumerable<Claim> DiagnosisItems)>)o_), p_);
	...
	public IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> Medical_Claims_With_Principal_Diagnosis_and_Procedure(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> h_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings, IEnumerable<string> ProceduresAsStrings) ClaimWithProcedure)
		{
			...
			(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) n_(Claim ClaimofInterest)
			{
				...
				(Claim Claim, Claim ProcedureItems) s_ = new (Claim Claim, Claim ProcedureItems)
				{
					Claim = ClaimofInterest,
					ProcedureItems = r_(),
				};
				(Claim Claim, Claim ProcedureItems)[] t_ = new (Claim Claim, Claim ProcedureItems)[]
				{
					s_,
				};
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) u_((Claim Claim, Claim ProcedureItems) DiagnosisCheck)
				{
					...
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) by_(Claim ClaimforDiagnosis)
					{
						...
						(IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems) cd_ = new (IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems)
						{
							Procedure = (IEnumerable<Claim.ItemComponent>)cb_,
							LineItems = cc_(),
						};
						(IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems)[] ce_ = new (IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems)[]
						{
							cd_,
						};
						(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) cf_((IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems) LineItemDefinition)
						{
							(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) de_()
							{
								...
								if (df_())
								{
									...
									(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) dp_ = new (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
									{
										Claim = dk_,
										ServicePeriod = do_,
									};
						...
						IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> cg_ = context.Operators.Select<(IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems), (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(((IEnumerable<(IEnumerable<Claim.ItemComponent> Procedure, Claim LineItems)>)ce_), cf_);
						(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) ch_ = context.Operators.SingletonFrom<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(cg_);

						return ch_;
					};
					IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> bz_ = context.Operators.Select<Claim, (Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>((IEnumerable<Claim>)bx_, by_);
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) ca_ = context.Operators.SingletonFrom<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(bz_);
	...
	public IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> Medical_Claims_With_Principal_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> f_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> DiagnosesAsStrings) ClaimWithDiagnosis)
		{
			...
			(IEnumerable<Claim> LineItems) k_ = new (IEnumerable<Claim> LineItems)
			{
				LineItems = j_(),
			};
			(IEnumerable<Claim> LineItems)[] l_ = new (IEnumerable<Claim> LineItems)[]
			{
				k_,
			};
			IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> m_((IEnumerable<Claim> LineItems) LineItemDefinition)
			{
				...
				(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) al_(Claim ClaimWithDiagnosis)
				{
					(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) ap_()
					{
						if ((context.Operators.Not((bool?)(ClaimWithDiagnosis is null)) ?? false))
						{
							...
							(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) az_ = new (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
							{
								Claim = aq_,
								ServicePeriod = ay_,
							};
			...
			IEnumerable<IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>> n_ = context.Operators.Select<(IEnumerable<Claim> LineItems), IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>>(((IEnumerable<(IEnumerable<Claim> LineItems)>)l_), m_);
	...
	public (IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim) Get_All_Professional_and_Institutional_Claims_and_Claim_Responses(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		...
		(IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim) c_ = new (IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)
		{
	...
	public IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> Get_All_Paid_Claim_Reponses(IEnumerable<ClaimResponse> claimResponse)
	{
		...
		IEnumerable<ClaimResponse> b_ = context.Operators.Where<ClaimResponse>(claimResponse, a_);
		(IEnumerable<ClaimResponse> PaidResponse) c_ = new (IEnumerable<ClaimResponse> PaidResponse)
		{
			PaidResponse = b_,
		};
		(IEnumerable<ClaimResponse> PaidResponse)[] d_ = new (IEnumerable<ClaimResponse> PaidResponse)[]
		{
			c_,
		};
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> e_((IEnumerable<ClaimResponse> PaidResponse) ClaimResponse)
		{
			...
			(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems) m_(ClaimResponse ClmResp)
			{
				...
				(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems) v_ = new (ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)
				{
					Response = ClmResp,
					ResponseID = r_,
					LineItems = u_,
	...
	public IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> Get_All_Claims_With_Procedure_and_Diagnosis(IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) c_(Claim ProcedureClaims)
		{
			...
			(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) az_ = new (Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)
			{
	...
	public (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) Get_Corresponding_Claim_for_Services_and_Conditions(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> MedicalClaim) c_ = new (IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> MedicalClaim)
		{
			PaidMedicalClaimResponse = a_,
			MedicalClaim = b_,
		};
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> MedicalClaim)[] d_ = new (IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> MedicalClaim)[]
		{
			c_,
		};
		(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) e_((IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> MedicalClaim) ClaimAndResponse)
		{
			...
			((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem) i_((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) medClaim)
			{
				...
				((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem) s_ = new ((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)
				{
					PaidClaim = medClaim,
					ClaimItem = r_,
				};
			...
			(IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim) k_ = new (IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim)
			{
				AggregateClaim = j_,
			};
			(IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim)[] l_ = new (IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim)[]
			{
				k_,
			};
			(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) m_((IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim) ClaimWithPaidResponse)
			{
				(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) au_()
				{
					...
					if (az_())
					{
						...
						(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) bx_ = new (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)
						{
							originalClaim = bo_,
							ServicePeriod = bw_,
						};
				...
				(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[] av_ = new (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[]
				{
					au_(),
				};
			...
			IEnumerable<(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)> n_ = context.Operators.Select<(IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim), (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)>(((IEnumerable<(IEnumerable<((Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim)>)l_), m_);
	...
	public (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod) Get_Paid_Claims_for_Provided_Service_and_Condition(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		...
		(IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)[] b_ = new (IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)[]
		{
			a_,
		};
		...
		(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[] f_ = new (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)[]
		{
			e_,
		};
		...
		(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) c_(Claim ProcedureClaims)
		{
			(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) av_()
			{
				...
				if (aw_())
				{
					...
					(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) bm_ = new (Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)
					{
						ClaimofInterest = ProcedureClaims,
						ClaimID = bi_,
						LineItems = bl_,
				...
				else
				{
					...
					(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) by_ = new (Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)
					{
						ClaimofInterest = ProcedureClaims,
						ClaimID = bu_,
						LineItems = bx_,
	...
	public IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)> Get_All_Claims_With_Procedure_Only(IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) c_(Claim AllClaims)
		{
			...
			(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems) ad_ = new (Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)
			{
	...
	public (IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim) Get_All_Pharmacy_Claims_and_Claim_Responses(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		...
		(IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim) c_ = new (IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)
		{
	...
	public (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) Get_Corresponding_Claim_for_Pharmacy_Services(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) e_((IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)> PaidPharmacyClaimResponse, IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> MedicalClaim) ClaimAndResponse)
		{
			...
			((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem) i_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) medClaim)
			{
				...
				IEnumerable<Claim.ItemComponent> r_ = context.Operators.Where<Claim.ItemComponent>(p_, q_);
				((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem) s_ = new ((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)
				{
					PaidClaim = medClaim,
					ClaimItem = r_,
				};
			...
			(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) m_((IEnumerable<((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim) ClaimWithPaidResponse)
			{
				(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) au_()
				{
					...
					if (az_())
					{
						...
						(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) cf_ = new (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)
						{
							originalClaim = bo_,
							ServicePeriod = bw_,
							CoveredDays = ce_,
				...
				(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)[] av_ = new (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)[]
				{
					au_(),
				};
			...
			IEnumerable<(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)> n_ = context.Operators.Select<(IEnumerable<((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim), (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)>(((IEnumerable<(IEnumerable<((Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays) PaidClaim, IEnumerable<Claim.ItemComponent> ClaimItem)> AggregateClaim)>)l_), m_);
	...
	public (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays) Get_Paid_Claims_for_Pharmacy_Services(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		...
		(IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)[] b_ = new (IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)[]
		{
			a_,
		};
	...
	public IEnumerable<(IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim)> Get_Claim_With_Corresponding_Claim_Response(IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		(IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim) a_(Claim Claim)
		{
			...
			(IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim) g_ = new (IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim)
			{
				ClaimResponse = d_,
				OriginalClaim = f_,
			};
	...
	{
		IEnumerable<Claim> a_ = this.Professional_or_Institutional_Claims(claim);
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) b_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)
		{
			MedicalClaim = a_,
		};
		(IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[] c_ = new (IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString)[]
		{
			b_,
		};
		(IEnumerable<Claim> InpatientDischarge, IEnumerable<Claim> NonacuteInpatientDischarge, IEnumerable<Claim> AcuteInpatientDischarge) d_((IEnumerable<Claim> MedicalClaim, IEnumerable<string> ProceduresAsStrings, IEnumerable<string> POSAsString) ClaimWithInpatientStay)
		{
			...
			(IEnumerable<Claim> InpatientStayLineItems, IEnumerable<Claim> NonacuteInpatientLineItems) i_ = new (IEnumerable<Claim> InpatientStayLineItems, IEnumerable<Claim> NonacuteInpatientLineItems)
			{
				InpatientStayLineItems = g_(),
				NonacuteInpatientLineItems = h_(),
			};
			(IEnumerable<Claim> InpatientStayLineItems, IEnumerable<Claim> NonacuteInpatientLineItems)[] j_ = new (IEnumerable<Claim> InpatientStayLineItems, IEnumerable<Claim> NonacuteInpatientLineItems)[]
			{
				i_,
			};
			(IEnumerable<Claim> InpatientDischarge, IEnumerable<Claim> NonacuteInpatientDischarge, IEnumerable<Claim> AcuteInpatientDischarge) k_((IEnumerable<Claim> InpatientStayLineItems, IEnumerable<Claim> NonacuteInpatientLineItems) LineItemDefinition)
			{
				...
				(IEnumerable<Claim> InpatientDischarge, IEnumerable<Claim> NonacuteInpatientDischarge, IEnumerable<Claim> AcuteInpatientDischarge) bm_ = new (IEnumerable<Claim> InpatientDischarge, IEnumerable<Claim> NonacuteInpatientDischarge, IEnumerable<Claim> AcuteInpatientDischarge)
				{
	...
	public (int? IdentifierCount) Get_Prescriber_NPI_from_Claims(IEnumerable<Claim> claim)
	{
		(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID) a_(Claim C)
		{
			...
			(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID) x_ = new (Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)
			{
				SingleCareTeam = C,
		...
		(IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams) c_ = new (IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams)
		{
			CareTeams = b_,
		};
		(IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams)[] d_ = new (IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams)[]
		{
			c_,
		};
		(int? IdentifierCount) e_((IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams) ClaimProperties)
		{
			...
			(IEnumerable<Practitioner> Practitioners) aw_ = new (IEnumerable<Practitioner> Practitioners)
			{
				Practitioners = av_,
			};
			(IEnumerable<Practitioner> Practitioners)[] ax_ = new (IEnumerable<Practitioner> Practitioners)[]
			{
				aw_,
			};
			(int? IdentifierCount) ay_((IEnumerable<Practitioner> Practitioners) PractitionerMatch)
			{
				...
				(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers) bq_(Practitioner P)
				{
					...
					(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers) ci_ = new (IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)
					{
						AllIdentifiers = cc_,
						NullIdentifiers = ch_,
					};
				...
				(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple) bs_ = new (IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)
				{
					IdentifierTuple = br_,
				};
				(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)[] bt_ = new (IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)[]
				{
					bs_,
				};
				(int? IdentifierCount) bu_((IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple) GetIdentifiers)
				{
					int? dj_()
					{
						bool dl_()
					...
					(int? IdentifierCount) dk_ = new (int? IdentifierCount)
					{
						IdentifierCount = dj_(),
					};
				...
				IEnumerable<(int? IdentifierCount)> bv_ = context.Operators.Select<(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)>)bt_), bu_);
				(int? IdentifierCount) bw_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(bv_);

				return bw_;
			};
			IEnumerable<(int? IdentifierCount)> az_ = context.Operators.Select<(IEnumerable<Practitioner> Practitioners), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<Practitioner> Practitioners)>)ax_), ay_);
			(int? IdentifierCount) ba_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(az_);

			return ba_;
		};
		IEnumerable<(int? IdentifierCount)> f_ = context.Operators.Select<(IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)> CareTeams)>)d_), e_);
		(int? IdentifierCount) g_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(f_);

		return g_;
	}

    [CqlDeclaration("Get Pharmacy NPI from Claims")]
	public (int? IdentifierCount) Get_Pharmacy_NPI_from_Claims(IEnumerable<Claim> claim)
	{
		(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID) a_(Claim C)
		{
			...
			(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID) aa_ = new (IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)
			{
		...
		(IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)> ItemsLocationReferences) c_ = new (IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)> ItemsLocationReferences)
		{
		...
		(int? IdentifierCount) e_((IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)> ItemsLocationReferences) ClaimProperties)
		{
			...
			(IEnumerable<Location> CorrespondingLocations) az_ = new (IEnumerable<Location> CorrespondingLocations)
			{
				CorrespondingLocations = ay_,
			};
			(IEnumerable<Location> CorrespondingLocations)[] ba_ = new (IEnumerable<Location> CorrespondingLocations)[]
			{
				az_,
			};
			(int? IdentifierCount) bb_((IEnumerable<Location> CorrespondingLocations) GetLocation)
			{
				...
				(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers) bt_(Location C)
				{
					...
					(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers) cl_ = new (IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)
					{
						AllIdentifiers = cf_,
						NullIdentifiers = ck_,
					};
				...
				(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple) bv_ = new (IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)
				{
					IdentifierTuple = bu_,
				};
				(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)[] bw_ = new (IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)[]
				{
					bv_,
				};
				(int? IdentifierCount) bx_((IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple) GetIdentifiers)
				{
					int? dm_()
					{
						bool do_()
					...
					(int? IdentifierCount) dn_ = new (int? IdentifierCount)
					{
						IdentifierCount = dm_(),
					};
				...
				IEnumerable<(int? IdentifierCount)> by_ = context.Operators.Select<(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)> IdentifierTuple)>)bw_), bx_);
				(int? IdentifierCount) bz_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(by_);

				return bz_;
			};
			IEnumerable<(int? IdentifierCount)> bc_ = context.Operators.Select<(IEnumerable<Location> CorrespondingLocations), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<Location> CorrespondingLocations)>)ba_), bb_);
			(int? IdentifierCount) bd_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(bc_);

			return bd_;
		};
		IEnumerable<(int? IdentifierCount)> f_ = context.Operators.Select<(IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)> ItemsLocationReferences), (int? IdentifierCount)>(((IEnumerable<(IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)> ItemsLocationReferences)>)d_), e_);
		(int? IdentifierCount) g_ = context.Operators.SingletonFrom<(int? IdentifierCount)>(f_);
