...
public static class NCQAClaims_1_0_0
{
	...
	public static CqlValueSet Nonacute_Inpatient_Stay(CqlContext context) => 
	...
	public static IEnumerable<Claim> Professional_or_Institutional_Claims(CqlContext context, IEnumerable<Claim> claim)
	{
		bool? a_(Claim MedicalClaim)
		{
			...
			CqlCode[] e_ = d_?.codes;
			CqlCode f_ = NCQATerminology_1_0_0.Professional(context);
			bool? g_ = context.Operators.Contains<CqlCode>((IEnumerable<CqlCode>)e_, f_);
			CqlConcept i_ = FHIRHelpers_4_0_001.ToConcept(context, c_);
			CqlCode[] j_ = i_?.codes;
			CqlCode k_ = NCQATerminology_1_0_0.Institutional(context);
	...
	public static IEnumerable<Claim> Pharmacy_Claims(CqlContext context, IEnumerable<Claim> claim)
	{
		bool? a_(Claim PharmacyClaim)
		{
			...
			CqlConcept d_ = FHIRHelpers_4_0_001.ToConcept(context, c_);
			CqlCode[] e_ = d_?.codes;
			CqlCode f_ = NCQATerminology_1_0_0.Pharmacy(context);
			bool? g_ = context.Operators.Contains<CqlCode>((IEnumerable<CqlCode>)e_, f_);
	...
	public static IEnumerable<ClaimResponse> Professional_or_Institutional_Claims_Response(CqlContext context, IEnumerable<ClaimResponse> claimResponse)
	{
	...
	public static IEnumerable<ClaimResponse> Pharmacy_Claims_Response(CqlContext context, IEnumerable<ClaimResponse> claimResponse)
	{
	...
	public static IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)?> Medical_Claims_With_Procedure_and_POS(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> posCodes, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode p)
		{
			string k_ = p?.code;
				...
				IEnumerable<Claim.ItemComponent> r_()
				{
					...
					else
					{
						...
						bool? y_(Claim.ItemComponent ItemOnLine)
						{
							...
							CqlConcept ah_ = FHIRHelpers_4_0_001.ToConcept(context, ag_ as CodeableConcept);
				...
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? u_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)? LineItemDefinition)
				{
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? at_()
					{
						...
						if (au_())
						{
							...
							{
								CqlInterval<CqlDateTime> bj_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, NormalDate);
	...
	public static IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)?> Medical_Claims_With_Procedure_in_Header_or_on_Line_Item(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode p)
		{
				...
				IEnumerable<Claim.ItemComponent> o_()
				{
					...
					else
					{
						...
						bool? v_(Claim.ItemComponent ItemOnLine)
						{
							...
							CqlConcept y_ = FHIRHelpers_4_0_001.ToConcept(context, x_);
							CqlCode[] z_ = y_?.codes;
				...
				(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? r_((Claim Claim, IEnumerable<Claim.ItemComponent> LineItems)? LineItemDefinition)
				{
					(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? bg_()
					{
						...
						if (bh_())
						{
							...
							{
								CqlInterval<CqlDateTime> bw_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, NormalDate);
	...
	public static (IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? Medical_Claims_With_Diagnosis(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode d)
		{
				...
				(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? ar_()
				{
					...
					if (aw_())
					{
						...
						CqlInterval<CqlDateTime> bg_(Claim.ItemComponent NormalDate)
						{
							...
							CqlInterval<CqlDateTime> bn_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, bm_);
	...
	public static IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> Pharmacy_Claim_With_Medication(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> MedicationCodes)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Pharmacy_Claims(context, claim);
		string b_(CqlCode p)
		{
			string i_ = p?.code;
		...
		IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> f_((IEnumerable<Claim> PharmacyClaim, IEnumerable<string> MedicationsAsStrings)? ClaimWithMedication)
		{
			...
			(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)? k_(Claim Pharmacy)
			{
				...
				bool? p_(Claim.ItemComponent ItemOnLine)
				{
					...
					CqlConcept x_ = FHIRHelpers_4_0_001.ToConcept(context, w_);
					CqlCode[] y_ = x_?.codes;
								...
								if (bf_())
								{
									CqlInterval<CqlDateTime> bi_()
									{
										...
										if (bj_())
										{
											...
											CqlInterval<CqlDateTime> bq_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, bm_);
											CqlDateTime br_ = context.Operators.Start(bq_);
											Quantity bs_ = i?.Quantity;
											FhirDecimal bt_ = bs_?.ValueElement;
											decimal? bu_ = FHIRHelpers_4_0_001.ToDecimal(context, bt_);
										...
										else
										{
											...
											CqlDate ca_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											CqlDate cc_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											Quantity cd_ = i?.Quantity;
											FhirDecimal ce_ = cd_?.ValueElement;
											decimal? cf_ = FHIRHelpers_4_0_001.ToDecimal(context, ce_);
											...
											CqlDate cn_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											CqlDate cp_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											FhirDecimal cr_ = cd_?.ValueElement;
											decimal? cs_ = FHIRHelpers_4_0_001.ToDecimal(context, cr_);
											...
											CqlDate da_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											CqlDate dc_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											FhirDecimal de_ = cd_?.ValueElement;
											decimal? df_ = FHIRHelpers_4_0_001.ToDecimal(context, de_);
											...
											CqlDate dm_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											CqlDate do_ = FHIRHelpers_4_0_001.ToDate(context, bz_ as Date);
											FhirDecimal dq_ = cd_?.ValueElement;
											decimal? dr_ = FHIRHelpers_4_0_001.ToDecimal(context, dq_);
						...
						(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)? ar_((IEnumerable<(CqlInterval<CqlDateTime> DaysSupplyInterval, nint _)?> CoveredDays, nint _)? ItemCalculation)
						{
							(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)? dy_()
							{
								...
								if (dz_())
								{
									...
									{
										CqlInterval<CqlDateTime> es_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, NormalDate);
	...
	public static IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)?> Medical_Claims_With_Diagnosis_and_Procedure(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode d)
		{
						...
						(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? dg_()
						{
							...
							if (dh_())
							{
								...
								CqlInterval<CqlDateTime> dn_(Claim.ItemComponent NormalDate)
								{
									...
									CqlInterval<CqlDateTime> dr_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, dq_);
	...
	public static IEnumerable<(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)?> Medical_Claims_With_Principal_Diagnosis_and_Procedure(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode d)
		{
							...
							else
							{
								...
								bool? cl_(Claim RightClaim)
								{
									...
									bool? cp_(Claim.DiagnosisComponent RightDiagnosis)
									{
										...
										int? cu_ = FHIRHelpers_4_0_001.ToInteger(context, ct_);
							...
							(Claim Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? dg_()
							{
								...
								if (dh_())
								{
									...
									CqlInterval<CqlDateTime> dp_(Claim.ItemComponent NormalDate)
									{
										...
										CqlInterval<CqlDateTime> dt_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, ds_);
	...
	public static IEnumerable<(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)?> Medical_Claims_With_Principal_Diagnosis(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
		string b_(CqlCode d)
		{
				...
				else
				{
					...
					bool? q_(Claim RightClaim)
					{
						...
						bool? t_(Claim.DiagnosisComponent RightDiagnosis)
						{
							...
							int? y_ = FHIRHelpers_4_0_001.ToInteger(context, x_);
					...
					(IEnumerable<Claim> Claim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? ap_()
					{
						if ((context.Operators.Not((bool?)(ClaimWithDiagnosis is null))) ?? false)
						{
							...
							CqlInterval<CqlDateTime> ax_(Claim.ItemComponent NormalDate)
							{
								...
								CqlInterval<CqlDateTime> be_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, bd_);
	...
	public static (IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)? Get_All_Professional_and_Institutional_Claims_and_Claim_Responses(CqlContext context, IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		IEnumerable<ClaimResponse> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims_Response(context, claimResponse);
		IEnumerable<Claim> b_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
	...
	public static IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> Get_All_Paid_Claim_Reponses(CqlContext context, IEnumerable<ClaimResponse> claimResponse)
	{
		...
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> e_((IEnumerable<ClaimResponse> PaidResponse, nint _)? ClaimResponse)
		{
			...
			(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)? m_(ClaimResponse ClmResp)
			{
				...
				string r_ = NCQAFHIRBase_1_0_0.GetId(context, q_);
				...
				bool? t_(ClaimResponse.ItemComponent ResponseItem)
				{
					...
					bool? ao_(Money DollarAmount)
					{
						...
						decimal? bf_ = FHIRHelpers_4_0_001.ToDecimal(context, be_);
	...
	public static IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> Get_All_Claims_With_Procedure_and_Diagnosis(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		bool? a_(Claim AllClaims)
		{
			...
			{
				CqlCode an_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
			...
			{
				CqlCode av_ = FHIRHelpers_4_0_001.ToCode(context, DiagnosisCode);
		...
		(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)? c_(Claim ProcedureClaims)
		{
			...
			bool? az_(Claim.ItemComponent ResponseItem)
			{
				...
				{
					CqlCode bh_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
	...
	public static (IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? Get_Corresponding_Claim_for_Services_and_Conditions(CqlContext context, IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> a_ = NCQAClaims_1_0_0.Get_All_Paid_Claim_Reponses(context, claimResponse);
		IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> b_ = NCQAClaims_1_0_0.Get_All_Claims_With_Procedure_and_Diagnosis(context, claim, ProductOrServiceValueSet, DiagnosisValueSet);
				...
				bool? q_(Claim.ItemComponent medClaimLineItem)
				{
					...
					IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> u_((ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)? pClaim)
					{
						...
						bool? y_(ClaimResponse.ItemComponent pClaimLineItem)
						{
							...
							string ah_ = FHIRHelpers_4_0_001.ToString(context, ag_);
							string ai_ = NCQAFHIRBase_1_0_0.GetId(context, ah_);
				...
				(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? au_()
				{
					...
					if (az_())
					{
						...
						CqlInterval<CqlDateTime> bv_(Claim.ItemComponent PaidItem)
						{
							...
							CqlInterval<CqlDateTime> cf_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, ce_);
	...
	{
		(IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)? a_ = NCQAClaims_1_0_0.Get_All_Professional_and_Institutional_Claims_and_Claim_Responses(context, claimResponse, claim);
		...
		(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? c_((IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)? MedicalClaimAndResponse)
		{
			(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? j_()
			{
				...
				else
				{
					...
					(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? q_ = NCQAClaims_1_0_0.Get_Corresponding_Claim_for_Services_and_Conditions(context, o_, p_, ProductOrServiceValueSet, DiagnosisValueSet);
	...
	public static IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> Get_All_Claims_With_Procedure_or_Diagnosis(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet, IEnumerable<CqlCode> DiagnosisValueSet)
	{
		bool? a_(Claim AllClaims)
		{
			List<Claim.ItemComponent> e_ = AllClaims?.Item;
			...
			(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)? ax_()
			{
				bool ay_()
				{
					...
					bool? ba_(Claim.ItemComponent ResponseItem)
					{
						...
						{
							CqlCode bi_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
				...
				if (ay_())
				{
					...
					bool? bm_(Claim.ItemComponent ResponseItem)
					{
						...
						{
							CqlCode bu_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
	...
	{
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> a_ = NCQAClaims_1_0_0.Get_All_Paid_Claim_Reponses(context, claimResponse);
		IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> b_ = NCQAClaims_1_0_0.Get_All_Claims_With_Procedure_or_Diagnosis(context, claim, ProductOrServiceValueSet, DiagnosisValueSet);
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> MedicalClaim)? c_ = (a_, b_);
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> MedicalClaim)?[] d_ = [
			c_,
		];
		...
		(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? c_((IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)? MedicalClaimAndResponse)
		{
			(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? f_()
			{
				...
				else
				{
					...
					(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? m_ = NCQAClaims_1_0_0.Get_Corresponding_Claim_for_Services_or_Conditions(context, k_, l_, ProductOrServiceValueSet, DiagnosisValueSet);
	...
	public static IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> Get_All_Claims_With_Procedure_Only(CqlContext context, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		bool? a_(Claim AllClaims)
		{
			List<Claim.ItemComponent> e_ = AllClaims?.Item;
			...
			bool? o_(Coding ProductOrServiceCode)
			{
				CqlCode x_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
		...
		(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)? c_(Claim AllClaims)
		{
			...
			bool? ab_(Claim.ItemComponent ResponseItem)
			{
				...
				{
					CqlCode aj_ = FHIRHelpers_4_0_001.ToCode(context, ProductOrServiceCode);
	...
	{
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> a_ = NCQAClaims_1_0_0.Get_All_Paid_Claim_Reponses(context, claimResponse);
		IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> b_ = NCQAClaims_1_0_0.Get_All_Claims_With_Procedure_Only(context, claim, ProductOrServiceValueSet);
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> MedicalClaim)? c_ = (a_, b_);
		(IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> PaidMedicalClaimResponse, IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> MedicalClaim)?[] d_ = [
			c_,
		];
		...
		(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? c_((IEnumerable<ClaimResponse> MedicalClaimResponse, IEnumerable<Claim> MedicalClaim)? MedicalClaimAndResponse)
		{
			(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? f_()
			{
				...
				else
				{
					IEnumerable<ClaimResponse> k_ = MedicalClaimAndResponse?.MedicalClaimResponse;
					IEnumerable<Claim> l_ = MedicalClaimAndResponse?.MedicalClaim;
					(IEnumerable<(Claim ClaimofInterest, Id ClaimID, IEnumerable<Claim.ItemComponent> LineItems)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod)? m_ = NCQAClaims_1_0_0.Get_Corresponding_Claim_for_Services_Only(context, k_, l_, ProductOrServiceValueSet);
	...
	public static (IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)? Get_All_Pharmacy_Claims_and_Claim_Responses(CqlContext context, IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		IEnumerable<ClaimResponse> a_ = NCQAClaims_1_0_0.Pharmacy_Claims_Response(context, claimResponse);
		IEnumerable<Claim> b_ = NCQAClaims_1_0_0.Pharmacy_Claims(context, claim);
	...
	public static (IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)? Get_Corresponding_Claim_for_Pharmacy_Services(CqlContext context, IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim, IEnumerable<CqlCode> ProductOrServiceValueSet)
	{
		IEnumerable<(ClaimResponse Response, string ResponseID, IEnumerable<ClaimResponse.ItemComponent> LineItems)?> a_ = NCQAClaims_1_0_0.Get_All_Paid_Claim_Reponses(context, claimResponse);
		IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> b_ = NCQAClaims_1_0_0.Pharmacy_Claim_With_Medication(context, claim, ProductOrServiceValueSet);
				...
				(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)? au_()
				{
					...
					if (az_())
					{
						...
						CqlInterval<CqlDateTime> bv_(Claim.ItemComponent PaidItem)
						{
							...
							CqlInterval<CqlDateTime> cn_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, cm_);
						...
						CqlInterval<CqlDate> cd_(Claim.ItemComponent i)
						{
							CqlInterval<CqlDate> cr_()
							{
								...
								if (cs_())
								{
									...
									CqlInterval<CqlDateTime> cw_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, cv_);
									CqlDateTime cx_ = context.Operators.Start(cw_);
									CqlDate cy_ = context.Operators.ConvertDateTimeToDate(cx_);
									CqlInterval<CqlDateTime> da_ = NCQAFHIRBase_1_0_0.Normalize_Interval(context, cv_);
	...
	{
		(IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)? a_ = NCQAClaims_1_0_0.Get_All_Pharmacy_Claims_and_Claim_Responses(context, claimResponse, claim);
		...
		(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)? c_((IEnumerable<ClaimResponse> PharmacyClaimResponse, IEnumerable<Claim> PharmacyClaim)? PharmacyClaimAndResponse)
		{
			(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)? f_()
			{
				...
				else
				{
					...
					(IEnumerable<(Claim Claim, IEnumerable<Claim.ItemComponent> LineItem, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDateTime>> CoveredDays)?> originalClaim, IEnumerable<CqlInterval<CqlDateTime>> ServicePeriod, IEnumerable<CqlInterval<CqlDate>> CoveredDays)? m_ = NCQAClaims_1_0_0.Get_Corresponding_Claim_for_Pharmacy_Services(context, k_, l_, ProductOrServiceValueSet);
	...
	public static IEnumerable<(IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim)?> Get_Claim_With_Corresponding_Claim_Response(CqlContext context, IEnumerable<ClaimResponse> claimResponse, IEnumerable<Claim> claim)
	{
		(IEnumerable<ClaimResponse> ClaimResponse, IEnumerable<Claim> OriginalClaim)? a_(Claim Claim)
		{
			bool? c_(ClaimResponse CR)
			{
				...
				string l_ = FHIRHelpers_4_0_001.ToString(context, k_);
				string m_ = NCQAFHIRBase_1_0_0.GetId(context, l_);
			...
			bool? e_(Claim C)
			{
				...
				string ab_ = FHIRHelpers_4_0_001.ToString(context, aa_);
				string ac_ = NCQAFHIRBase_1_0_0.GetId(context, ab_);
	...
	public static (IEnumerable<Claim> InpatientDischarge, IEnumerable<Claim> NonacuteInpatientDischarge, IEnumerable<Claim> AcuteInpatientDischarge)? Medical_Claims_With_Nonacute_or_Acute_Inpatient_Discharge(CqlContext context, IEnumerable<Claim> claim)
	{
		IEnumerable<Claim> a_ = NCQAClaims_1_0_0.Professional_or_Institutional_Claims(context, claim);
				...
				else
				{
					...
					bool? o_(Claim c)
					{
						...
						bool? r_(Claim.ItemComponent i)
						{
							...
							CqlConcept v_ = FHIRHelpers_4_0_001.ToConcept(context, u_);
							CqlCode[] w_ = v_?.codes;
							bool? x_(CqlCode rev)
							{
								string aa_ = rev?.code;
								CqlValueSet ab_ = NCQAClaims_1_0_0.Inpatient_Stay(context);
				...
				else
				{
					...
					bool? ae_(Claim c)
					{
						...
						bool? ah_(Claim.ItemComponent i)
						{
							...
							CqlConcept ar_ = FHIRHelpers_4_0_001.ToConcept(context, aq_);
							CqlCode[] as_ = ar_?.codes;
							bool? at_(CqlCode rev)
							{
								string aw_ = rev?.code;
								CqlValueSet ax_ = NCQAClaims_1_0_0.Nonacute_Inpatient_Stay(context);
						...
						bool? am_(Coding tob)
						{
							...
							CqlValueSet bb_ = NCQAClaims_1_0_0.Nonacute_Inpatient_Stay(context);
	...
	public static (int? IdentifierCount, nint _)? Get_Prescriber_NPI_from_Claims(CqlContext context, IEnumerable<Claim> claim)
	{
		(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)? a_(Claim C)
		{
			...
			bool? i_(Claim.CareTeamComponent ct)
			{
				...
				int? aa_ = FHIRHelpers_4_0_001.ToInteger(context, z_);
			...
			bool? p_(Claim.CareTeamComponent ct)
			{
				...
				int? ah_ = FHIRHelpers_4_0_001.ToInteger(context, ag_);
			...
			string v_(ResourceReference p)
			{
				...
				{
					string ar_ = FHIRHelpers_4_0_001.ToString(context, r);
					string as_ = NCQAFHIRBase_1_0_0.GetId(context, ar_);
		...
		(int? IdentifierCount, nint _)? e_((IEnumerable<(Claim SingleCareTeam, IEnumerable<ResourceReference> CareTeamsProvider, IEnumerable<string> CareTeamsProviderID)?> CareTeams, nint _)? ClaimProperties)
		{
			...
			{
				Id bb_ = p?.IdElement;
				string bc_ = FHIRHelpers_4_0_001.ToString(context, bb_);
			...
			(int? IdentifierCount, nint _)? ay_((IEnumerable<Practitioner> Practitioners, nint _)? PractitionerMatch)
			{
				...
				(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)? bq_(Practitioner P)
				{
					...
					bool? bz_(Identifier l)
					{
						...
						CqlConcept cn_ = FHIRHelpers_4_0_001.ToConcept(context, cm_);
						CqlCode co_ = NCQATerminology_1_0_0.Provider_number(context);
					...
					bool? ce_(Identifier l)
					{
						...
						CqlConcept db_ = FHIRHelpers_4_0_001.ToConcept(context, da_);
						CqlCode dc_ = NCQATerminology_1_0_0.Provider_number(context);
	...
	public static (int? IdentifierCount, nint _)? Get_Pharmacy_NPI_from_Claims(CqlContext context, IEnumerable<Claim> claim)
	{
		(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)? a_(Claim C)
		{
			...
			bool? j_(Claim.ItemComponent i)
			{
				...
				int? ad_ = FHIRHelpers_4_0_001.ToInteger(context, ac_);
			...
			bool? s_(Claim.ItemComponent i)
			{
				...
				int? ak_ = FHIRHelpers_4_0_001.ToInteger(context, aj_);
			...
			string y_(object l)
			{
				...
				{
					string au_ = FHIRHelpers_4_0_001.ToString(context, r);
					string av_ = NCQAFHIRBase_1_0_0.GetId(context, au_);
		...
		(int? IdentifierCount, nint _)? e_((IEnumerable<(IEnumerable<Claim.ItemComponent> SingleItem, IEnumerable<ResourceReference> ItemLocation, IEnumerable<string> ItemLocationID)?> ItemsLocationReferences, nint _)? ClaimProperties)
		{
			...
			{
				Id be_ = l?.IdElement;
				string bf_ = FHIRHelpers_4_0_001.ToString(context, be_);
			...
			(int? IdentifierCount, nint _)? bb_((IEnumerable<Location> CorrespondingLocations, nint _)? GetLocation)
			{
				...
				(IEnumerable<FhirString> AllIdentifiers, IEnumerable<Identifier> NullIdentifiers)? bt_(Location C)
				{
					...
					bool? cc_(Identifier l)
					{
						...
						CqlConcept cq_ = FHIRHelpers_4_0_001.ToConcept(context, cp_);
						CqlCode cr_ = NCQATerminology_1_0_0.Provider_number(context);
					...
					bool? ch_(Identifier l)
					{
						...
						CqlConcept de_ = FHIRHelpers_4_0_001.ToConcept(context, dd_);
						CqlCode df_ = NCQATerminology_1_0_0.Provider_number(context);
