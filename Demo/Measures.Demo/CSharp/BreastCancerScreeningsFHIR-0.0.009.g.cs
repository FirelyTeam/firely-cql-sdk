...
public partial class BreastCancerScreeningsFHIR_0_0_009 : ILibrary, ILibraryInternals, ISingleton<BreastCancerScreeningsFHIR_0_0_009>
{
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Observation_with_status = index++;
        _cacheIndex_Diagnostic_Report_with_status = index++;
        _cacheIndex_Numerator = index++;
        _cacheIndex_Final_Numerator_Population = index++;
        _cacheIndex_Observation_without_appropriate_status = index++;
        _cacheIndex_Diagnostic_Report_without_appropriate_status = index++;
