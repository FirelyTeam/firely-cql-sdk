    ...
    public IEnumerable<CqlInterval<CqlDate?>?>? Collapse_Date_Interval_Workaround(CqlContext context, IEnumerable<CqlInterval<CqlDate?>?>? intervals)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                IEnumerable<CqlInterval<CqlDate?>?>? f_ = context.Operators.Where<CqlInterval<CqlDate?>?>((IEnumerable<CqlInterval<CqlDate>>?)intervals, e_);
    ...
    public IEnumerable<CqlInterval<CqlDateTime?>?>? Collapse_DateTime_Interval_Workaround(CqlContext context, IEnumerable<CqlInterval<CqlDateTime?>?>? intervals)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                IEnumerable<CqlInterval<CqlDateTime?>?>? f_ = context.Operators.Where<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)intervals, e_);
        ...
        IEnumerable<CqlInterval<CqlDate?>?>? d_((CqlTupleMetadata, IEnumerable<CqlInterval<CqlDate?>?>? sortedCoverings)? variableDeclarations) {
            ...
            else
            {
                ...
                CqlInterval<CqlDate?>? s_(CqlInterval<CqlDate?>? sortedCovering) {
                    ...
                    int? v_ = context.Operators.IndexOf<CqlInterval<CqlDate?>?>((IEnumerable<CqlInterval<CqlDate>>?)u_, (CqlInterval<CqlDate>?)sortedCovering);
                    ...
                    else
                    {
                        ...
                        int? ad_ = context.Operators.IndexOf<CqlInterval<CqlDate?>?>((IEnumerable<CqlInterval<CqlDate>>?)ac_, (CqlInterval<CqlDate>?)sortedCovering);
            ...
            else
            {
                ...
                CqlInterval<CqlDate?>? aq_ = context.Operators.Last<CqlInterval<CqlDate?>?>(((IEnumerable<CqlInterval<CqlDate>>)ap_)!);
        ...
        IEnumerable<CqlInterval<CqlDateTime?>?>? d_((CqlTupleMetadata, IEnumerable<CqlInterval<CqlDateTime?>?>? sortedCoverings)? variableDeclarations) {
            ...
            else
            {
                ...
                CqlInterval<CqlDateTime?>? s_(CqlInterval<CqlDateTime?>? sortedCovering) {
                    ...
                    int? v_ = context.Operators.IndexOf<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)u_, (CqlInterval<CqlDateTime>?)sortedCovering);
                    bool? w_ = context.Operators.Equal(v_, 0);
                    if (w_ ?? false)
                    {
                    ...
                    else
                    {
                        ...
                        int? ad_ = context.Operators.IndexOf<CqlInterval<CqlDateTime?>?>((IEnumerable<CqlInterval<CqlDateTime>>?)ac_, (CqlInterval<CqlDateTime>?)sortedCovering);
                        int? ae_ = context.Operators.Subtract(ad_, 1);
            ...
            else
            {
                ...
                CqlInterval<CqlDateTime?>? aq_ = context.Operators.Last<CqlInterval<CqlDateTime?>?>(((IEnumerable<CqlInterval<CqlDateTime>>)ap_)!);
