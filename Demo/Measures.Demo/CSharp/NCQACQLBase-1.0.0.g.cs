...
public partial class NCQACQLBase_1_0_0 : ILibrary, ISingleton<NCQACQLBase_1_0_0>
{
    ...
    ;
            ...
            IEnumerable<CqlInterval<CqlDate>> o_ = context.Operators.Flatten<CqlInterval<CqlDate>>(n_);
    ...
    ;
            ...
            IEnumerable<CqlInterval<CqlDateTime>> o_ = context.Operators.Flatten<CqlInterval<CqlDateTime>>(n_);
        ...
        IEnumerable<CqlInterval<CqlDateTime>> g_ = context.Operators.Flatten<CqlInterval<CqlDateTime>>(f_);
