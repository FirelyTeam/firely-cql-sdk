...
public partial class DischargedonAntithromboticTherapyFHIR_0_0_010 : ILibrary, ISingleton<DischargedonAntithromboticTherapyFHIR_0_0_010>
{
    ...
    [CqlValueSetDeclaration(
        declarationName: "Antithrombotic Therapy",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Comfort Measures",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Hemorrhagic Stroke",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Non-Elective Inpatient Encounter",
    ...
    [CqlValueSetDeclaration(
        declarationName: "Pharmacological Contraindications For Antithrombotic Therapy",
