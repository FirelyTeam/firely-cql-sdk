...
public partial class Exam125FHIR_0_0_009 : ILibrary, ISingleton<Exam125FHIR_0_0_009>
{
    ...
    private IEnumerable<Encounter> Telehealth_Services_Compute(CqlContext context)
    {
        ...
        bool? f_(Encounter TelehealthEncounter) {
            ...
            return (bool?)(/* CQL 'and' (50:19-51:110) */ ((CqlBoolean)j_
                && (CqlBoolean)k_()));
        }
    ...
    private bool? Initial_Population_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'and' (58:3-62:19) */ (/* CQL 'and' (58:3-59:47) */ ((CqlBoolean)j_
            && (CqlBoolean)k_())
            && (CqlBoolean)l_()));
    }
    ...
    private IEnumerable<Procedure> Right_Mastectomy_Procedure_Compute(CqlContext context)
    {
        ...
        bool? c_(Procedure UnilateralMastectomyRightPerformed) {
            ...
            return (bool?)(/* CQL 'and' (154:19-156:47) */ ((CqlBoolean)g_
                && (CqlBoolean)h_()));
        }
    ...
    private IEnumerable<Procedure> Left_Mastectomy_Procedure_Compute(CqlContext context)
    {
        ...
        bool? c_(Procedure UnilateralMastectomyLeftPerformed) {
            ...
            return (bool?)(/* CQL 'and' (168:19-170:47) */ ((CqlBoolean)g_
                && (CqlBoolean)h_()));
        }
    ...
    private IEnumerable<Procedure> Bilateral_Mastectomy_Procedure_Compute(CqlContext context)
    {
        ...
        bool? c_(Procedure BilateralMastectomyPerformed) {
            ...
            return (bool?)(/* CQL 'and' (179:19-181:47) */ ((CqlBoolean)g_
                && (CqlBoolean)h_()));
        }
    ...
    private bool? Denominator_Exclusions_Compute(CqlContext context)
    {
        ...
        bool? b_() {
            ...
            bool? i_() {
                ...
                return (bool?)(/* CQL 'or' (72:29-74:25) */ ((CqlBoolean)m_
                    || (CqlBoolean)n_()));
            }

            return (bool?)(/* CQL 'and' (69:24-75:21) */ (/* CQL 'or' (69:26-71:23) */ ((CqlBoolean)g_
                || (CqlBoolean)h_())
                && (CqlBoolean)i_()));
        }
        ...
        bool? e_() {
            ...
            return (bool?)(/* CQL 'and' (79:24-81:21) */ ((CqlBoolean)ac_
        ...
        return (bool?)(/* CQL 'or' (68:3-83:17) */ (/* CQL 'or' (68:5-81:21) */ (/* CQL 'or' (68:5-78:104) */ (/* CQL 'or' (68:5-77:62) */ (/* CQL 'or' (68:5-76:62) */ (/* CQL 'or' (68:5-75:21) */ ((CqlBoolean)a_
            || (CqlBoolean)b_())
            || (CqlBoolean)c_())
            || (CqlBoolean)d_())
    ...
    private bool? Observation_with_status_Compute(CqlContext context)
    {
        ...
        bool? c_(Observation Mammogram) {
            ...
            bool? i_() {
                ...
                return (bool?)(/* CQL 'and' (112:27-114:23) */ ((CqlBoolean)r_
                    && (CqlBoolean)s_()));
            }

            return (bool?)(/* CQL 'and' (111:21-114:23) */ ((CqlBoolean)h_
                && (CqlBoolean)i_()));
        }
    ...
    private bool? Diagnostic_Report_with_status_Compute(CqlContext context)
    {
        ...
        bool? c_(DiagnosticReport Mammogram) {
            ...
            bool? i_() {
                ...
                return (bool?)(/* CQL 'and' (130:27-132:23) */ ((CqlBoolean)r_
                    && (CqlBoolean)s_()));
            }

            return (bool?)(/* CQL 'and' (129:21-132:23) */ ((CqlBoolean)h_
                && (CqlBoolean)i_()));
        }
    ...
    private bool? Numerator_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'or' (98:3-99:38) */ ((CqlBoolean)a_
            || (CqlBoolean)(this.Diagnostic_Report_with_status(context))));
    }
    ...
    private bool? Final_Numerator_Population_Compute(CqlContext context)
    {
        ...
        return (bool?)(/* CQL 'and' (103:3-106:34) */ (/* CQL 'and' (103:3-105:19) */ (/* CQL 'and' (103:3-104:26) */ ((CqlBoolean)a_
    ...
    private bool? Observation_without_appropriate_status_Compute(CqlContext context)
    {
        ...
        bool? c_(Observation Mammogram) {
            ...
            bool? i_() {
                ...
                return (bool?)(/* CQL 'and' (121:27-123:23) */ ((CqlBoolean)r_
                    && (CqlBoolean)s_()));
            }

            return (bool?)(/* CQL 'and' (120:21-123:23) */ ((CqlBoolean)!h_
                && (CqlBoolean)i_()));
        }
    ...
    private bool? Diagnostic_Report_without_appropriate_status_Compute(CqlContext context)
    {
        ...
        bool? c_(DiagnosticReport Mammogram) {
            ...
            bool? i_() {
                ...
                return (bool?)(/* CQL 'and' (139:27-141:23) */ ((CqlBoolean)r_
                    && (CqlBoolean)s_()));
            }

            return (bool?)(/* CQL 'and' (138:21-141:23) */ ((CqlBoolean)!h_
                && (CqlBoolean)i_()));
        }
