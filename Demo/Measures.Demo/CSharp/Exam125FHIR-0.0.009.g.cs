...
public partial class Exam125FHIR_0_0_009 : ILibrary, ISingleton<Exam125FHIR_0_0_009>
{
    ...
    private bool? Initial_Population_Compute(CqlContext context)
    {
        ...
        CqlBoolean l_() {
            ...
            CqlBoolean t_ = context.Operators.Exists<Encounter>(s_);
            return t_;
        }
    ...
    private IEnumerable<Condition> Right_Mastectomy_Diagnosis_Compute(CqlContext context)
    {
        ...
        bool? h_(Condition RightMastectomy) {
            ...
            CqlBoolean t_ = context.Operators.SameOrBefore(q_, s_, (string)default);
            return t_;
        }
    ...
    private bool? Denominator_Exclusions_Compute(CqlContext context)
    {
        ...
        CqlBoolean b_() {
            ...
            CqlBoolean h_() {
                ...
                CqlBoolean k_ = context.Operators.Exists<Procedure>(j_);
                return k_;
            }
            ...
            CqlBoolean i_() {
                ...
                CqlBoolean n_() {
                    ...
                    CqlBoolean p_ = context.Operators.Exists<Procedure>(o_);
                    return p_;
                }
        ...
        CqlBoolean d_() {
            ...
            CqlBoolean t_ = context.Operators.Exists<Procedure>(s_);
            return t_;
        }
