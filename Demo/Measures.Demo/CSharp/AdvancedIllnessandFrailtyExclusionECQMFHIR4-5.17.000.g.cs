...
public class AdvancedIllnessandFrailtyExclusionECQMFHIR4_5_17_000
{
	...
	private bool? Has_Criteria_Indicating_Frailty_Value()
	{
		...
		IEnumerable<Observation> j_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, a_, default));
		...
		IEnumerable<Observation> ab_ = context.Operators.Retrieve<Observation>(new RetrieveParameters(default, aa_, default));
