...
public static class PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008
{
	...
	public static CqlValueSet Fluoride_Varnish_Application_for_Children(CqlContext context) => 
	...
	public static CqlValueSet Preventive_Care___Established_Office_Visit__0_to_17(CqlContext context) => 
	...
	public static CqlValueSet Preventive_Care__Initial_Office_Visit__0_to_17(CqlContext context) => 
	...
	{
		CqlValueSet a_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Preventive_Care___Established_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Preventive_Care__Initial_Office_Visit__0_to_17(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Preventive_Care_Services___Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Clinical_Oral_Evaluation(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Telephone_Visits(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Online_Assessments(context);
		...
		{
			CqlInterval<CqlDateTime> z_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Measurement_Period(context);
	...
	{
		Patient a_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Measurement_Period(context);
		...
		IEnumerable<Encounter> t_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Qualifying_Encounters(context);
	...
	{
		bool? a_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Initial_Population(context);
	...
	public static bool? Stratification_3(CqlContext context)
	{
		Patient a_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
	...
	{
		CqlValueSet a_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Fluoride_Varnish_Application_for_Children(context);
		IEnumerable<Procedure> b_ = context.Operators.RetrieveByValueSet<Procedure>(a_, default);
		bool? c_(Procedure FluorideApplication)
		{
			CqlInterval<CqlDateTime> f_ = PrimaryCariesPreventionasOfferedbyPCPsincludingDentistsFHIR_0_0_008.Measurement_Period(context);
