...
public static class NCQAHealthPlanEnrollment_1_0_0
{

    [CqlDeclaration("CoverageIntervals")]
	public static IEnumerable<CqlInterval<CqlDate>> CoverageIntervals(CqlContext context, IEnumerable<Coverage> Coverage, CqlInterval<CqlDate> participationPeriod)
	{
	...
	public static IEnumerable<CqlInterval<CqlDate>> Collapsed_Coverage_Intervals(CqlContext context, IEnumerable<CqlInterval<CqlDate>> Intervals)
	{
	...
	public static IEnumerable<CqlInterval<CqlDate>> Collapsed_Coverage_Adjacent_Intervals(CqlContext context, IEnumerable<CqlInterval<CqlDate>> Intervals)
	{
	...
	public static IEnumerable<CqlInterval<CqlDate>> Collapsed_Final_Coverage_Intervals(CqlContext context, IEnumerable<CqlInterval<CqlDate>> collapsedI, IEnumerable<CqlInterval<CqlDate>> adjacentI)
	{
		IEnumerable<CqlInterval<CqlDate>> a_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Intervals(context, collapsedI);
		IEnumerable<CqlInterval<CqlDate>> b_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Adjacent_Intervals(context, adjacentI);
	...
	public static IEnumerable<(IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)?> All_Coverage_Info(CqlContext context, IEnumerable<Coverage> Coverage, CqlInterval<CqlDate> participationPeriod)
	{
		...
		{
			IEnumerable<CqlInterval<CqlDate>> c_ = NCQAHealthPlanEnrollment_1_0_0.CoverageIntervals(context, Coverage, participationPeriod);
			IEnumerable<CqlInterval<CqlDate>> e_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Intervals(context, c_);
			IEnumerable<CqlInterval<CqlDate>> g_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Intervals(context, c_);
			IEnumerable<CqlInterval<CqlDate>> h_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Adjacent_Intervals(context, g_);
			IEnumerable<CqlInterval<CqlDate>> j_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Intervals(context, c_);
			IEnumerable<CqlInterval<CqlDate>> l_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Intervals(context, c_);
			IEnumerable<CqlInterval<CqlDate>> m_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Coverage_Adjacent_Intervals(context, l_);
			IEnumerable<CqlInterval<CqlDate>> n_ = NCQAHealthPlanEnrollment_1_0_0.Collapsed_Final_Coverage_Intervals(context, j_, m_);
	...
	public static IEnumerable<Coverage> Health_Plan_Coverage_Resources(CqlContext context, IEnumerable<Coverage> Coverage)
	{
		bool? a_(Coverage C)
		{
	...
	public static bool? Anchor_Date_Criteria(CqlContext context, IEnumerable<Coverage> Coverage, CqlDate AnchorDate, CqlInterval<CqlDate> participationPeriod)
	{
		bool? a_()
		{
			bool b_()
			...
			{
				IEnumerable<(IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)?> e_ = NCQAHealthPlanEnrollment_1_0_0.All_Coverage_Info(context, Coverage, participationPeriod);
	...
	public static bool? Health_Plan_Enrollment_Criteria(CqlContext context, IEnumerable<Coverage> Coverage, CqlDate AnchorDate, CqlInterval<CqlDate> participationPeriod, int? AllowedGapDays)
	{
		IEnumerable<Coverage> a_ = NCQAHealthPlanEnrollment_1_0_0.Health_Plan_Coverage_Resources(context, Coverage);
		IEnumerable<(IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)?> b_ = NCQAHealthPlanEnrollment_1_0_0.All_Coverage_Info(context, a_, participationPeriod);
		...
		bool? j_((IEnumerable<CqlInterval<CqlDate>> Intervals, int? Interval_Count, int? Total_Days_In_Intervals, CqlInterval<CqlDate> Longest_Interval, int? Total_Days_In_Longest_Interval)? GapsInEnrollment)
		{
			...
			bool? t_ = context.Operators.And(q_, s_);
			bool? u_ = NCQAHealthPlanEnrollment_1_0_0.Anchor_Date_Criteria(context, Coverage, AnchorDate, participationPeriod);
	...
	public static IEnumerable<Coverage> Pharmacy_Benefit_Coverage_Resources(CqlContext context, IEnumerable<Coverage> Coverage)
	{
		bool? a_(Coverage C)
		{
			CodeableConcept e_ = C?.Type;
	...
	public static bool? Pharmacy_Benefit_Enrollment_Criteria(CqlContext context, IEnumerable<Coverage> PharmCoverage, CqlDate AnchorDate, CqlInterval<CqlDate> participationPeriod, int? AllowedGapDays)
	{
		IEnumerable<Coverage> a_ = NCQAHealthPlanEnrollment_1_0_0.Pharmacy_Benefit_Coverage_Resources(context, PharmCoverage);
		IEnumerable<(IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)?> b_ = NCQAHealthPlanEnrollment_1_0_0.All_Coverage_Info(context, a_, participationPeriod);
		bool? c_((IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)? @this)
		{
			IEnumerable<CqlInterval<CqlDate>> m_ = @this?.CollapsedFinal;
		...
		bool? j_((IEnumerable<CqlInterval<CqlDate>> Intervals, int? Interval_Count, int? Total_Days_In_Intervals, CqlInterval<CqlDate> Longest_Interval, int? Total_Days_In_Longest_Interval)? GapsInEnrollment)
		{
			...
			bool? s_ = context.Operators.LessOrEqual(r_, AllowedGapDays);
			bool? t_ = context.Operators.And(q_, s_);
			bool? u_ = NCQAHealthPlanEnrollment_1_0_0.Anchor_Date_Criteria(context, PharmCoverage, AnchorDate, participationPeriod);
			bool? v_ = context.Operators.And(t_, u_);
	...
	public static IEnumerable<Coverage> Mental_Health_Benefit_Coverage_Resources(CqlContext context, IEnumerable<Coverage> Coverage)
	{
		bool? a_(Coverage C)
		{
			CodeableConcept e_ = C?.Type;
	...
	public static bool? Mental_Health_Benefit_Enrollment_Criteria(CqlContext context, IEnumerable<Coverage> MHCoverage, CqlDate AnchorDate, CqlInterval<CqlDate> participationPeriod, int? AllowedGapDays)
	{
		IEnumerable<Coverage> a_ = NCQAHealthPlanEnrollment_1_0_0.Mental_Health_Benefit_Coverage_Resources(context, MHCoverage);
		IEnumerable<(IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)?> b_ = NCQAHealthPlanEnrollment_1_0_0.All_Coverage_Info(context, a_, participationPeriod);
		bool? c_((IEnumerable<CqlInterval<CqlDate>> IntervalInfo, IEnumerable<CqlInterval<CqlDate>> Collapsed, IEnumerable<CqlInterval<CqlDate>> Adjacent, IEnumerable<CqlInterval<CqlDate>> CollapsedFinal)? @this)
		{
			IEnumerable<CqlInterval<CqlDate>> m_ = @this?.CollapsedFinal;
		...
		bool? j_((IEnumerable<CqlInterval<CqlDate>> Intervals, int? Interval_Count, int? Total_Days_In_Intervals, CqlInterval<CqlDate> Longest_Interval, int? Total_Days_In_Longest_Interval)? GapsInEnrollment)
		{
			...
			bool? s_ = context.Operators.LessOrEqual(r_, AllowedGapDays);
			bool? t_ = context.Operators.And(q_, s_);
			bool? u_ = NCQAHealthPlanEnrollment_1_0_0.Anchor_Date_Criteria(context, MHCoverage, AnchorDate, participationPeriod);
			bool? v_ = context.Operators.And(t_, u_);
