...
namespace Tuples
{
    ...
    public class Tuple_EKheTMICVWAQgjLNCMeFLGUGF: TupleBaseType
    {
        [CqlDeclaration("Intervals")]
        public IEnumerable<CqlInterval<CqlDate>> Intervals { get; set; }
        ...
        public CqlInterval<CqlDate> Longest_Interval { get; set; }
