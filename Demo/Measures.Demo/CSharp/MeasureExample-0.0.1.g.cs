...
public partial class MeasureExample_0_0_1 : ILibrary, ISingleton<MeasureExample_0_0_1>
{
    ...
    [CqlTag("description", "Stratifies by patient gender")]
    public Code<AdministrativeGender> Gender_Stratifier(CqlContext context) =>
    ...
    private Code<AdministrativeGender> Gender_Stratifier_Compute(CqlContext context)
    {
