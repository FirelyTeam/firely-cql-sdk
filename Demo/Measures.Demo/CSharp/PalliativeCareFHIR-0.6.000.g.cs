...
public partial class PalliativeCareFHIR_0_6_000 : ILibrary, ILibraryInternals, ISingleton<PalliativeCareFHIR_0_6_000>
{
    #region ValueSets (2)
    ...
    public bool? Palliative_Care_in_the_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<bool?>(
            _cacheIndex_Palliative_Care_in_the_Measurement_Period,
            Palliative_Care_in_the_Measurement_Period_Compute);
    ...
    private int _cacheIndex_Palliative_Care_in_the_Measurement_Period = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Palliative_Care_in_the_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Palliative_Care_in_the_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Palliative_Care_in_the_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Palliative_Care_in_the_Measurement_Period = initializer.GetNextIndex();
        count++;
