...
public partial class HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_0_0_006 : ILibrary, ILibraryInternals, ISingleton<HospitalHarmHyperglycemiainHospitalizedPatientsFHIR_0_0_006>
{
    #region ValueSets (5)
    ...
    public IEnumerable<Encounter> Inpatient_Encounter_During_Measurement_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Inpatient_Encounter_During_Measurement_Period,
            Inpatient_Encounter_During_Measurement_Period_Compute);
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)?> Qualifying_Encounters_With_Hospitalization_Period(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod)?>>(
            _cacheIndex_Qualifying_Encounters_With_Hospitalization_Period,
            Qualifying_Encounters_With_Hospitalization_Period_Compute);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters_With_Existing_Diabetes_Diagnosis(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis,
            Qualifying_Encounters_With_Existing_Diabetes_Diagnosis_Compute);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters_With_Hypoglycemic_Medication(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication,
            Qualifying_Encounters_With_Hypoglycemic_Medication_Compute);
    ...
    public IEnumerable<Encounter> Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<Encounter>>(
            _cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab,
            Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab_Compute);
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod)?> relevantDays)?> Pertinent_Encounters_With_Days(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> hospitalizationPeriod, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod)?> relevantDays)?>>(
            _cacheIndex_Pertinent_Encounters_With_Days,
            Pertinent_Encounters_With_Days_Compute);
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod, bool? hasSevereResult, bool? hasElevatedResult, bool? hasNoResult)?> relevantDays)?> Pertinent_Encounters_With_Glucose_Result_Days(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod, bool? hasSevereResult, bool? hasElevatedResult, bool? hasNoResult)?> relevantDays)?>>(
            _cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days,
            Pertinent_Encounters_With_Glucose_Result_Days_Compute);
    ...
    public IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod, bool? hasHyperglycemicEvent)?> eligibleEventDays)?> Pertinent_Encounters_With_Hyperglycemic_Event_Days(CqlContext context) =>
        ((ICqlContextInternals)context).GetOrCompute<IEnumerable<(CqlTupleMetadata, Encounter encounter, CqlInterval<CqlDateTime> relevantPeriod, IEnumerable<(CqlTupleMetadata, int? dayIndex, CqlInterval<CqlDateTime> dayPeriod, bool? hasHyperglycemicEvent)?> eligibleEventDays)?>>(
            _cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days,
            Pertinent_Encounters_With_Hyperglycemic_Event_Days_Compute);
    ...
    private int _cacheIndex_Qualifying_Encounters_With_Hospitalization_Period = -1;
    private int _cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis = -1;
    private int _cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication = -1;
    private int _cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab = -1;
    private int _cacheIndex_Initial_Population = -1;
    private int _cacheIndex_Denominator = -1;
    private int _cacheIndex_Pertinent_Encounters_With_Days = -1;
    private int _cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days = -1;
    private int _cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days = -1;
    ...
    int ILibraryInternals.InitializeCacheIndices(CacheIndexInitializer initializer)
    {
        ...
        if (_cacheIndex_Inpatient_Encounter_During_Measurement_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Inpatient_Encounter_During_Measurement_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Inpatient_Encounter_During_Measurement_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Inpatient_Encounter_During_Measurement_Period = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Qualifying_Encounters_With_Hospitalization_Period != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Qualifying_Encounters_With_Hospitalization_Period' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Qualifying_Encounters_With_Hospitalization_Period}}. Cache indices can only be initialized once.");
        _cacheIndex_Qualifying_Encounters_With_Hospitalization_Period = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis}}. Cache indices can only be initialized once.");
        _cacheIndex_Qualifying_Encounters_With_Existing_Diabetes_Diagnosis = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication}}. Cache indices can only be initialized once.");
        _cacheIndex_Qualifying_Encounters_With_Hypoglycemic_Medication = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab}}. Cache indices can only be initialized once.");
        _cacheIndex_Qualifying_Encounters_With_Elevated_Blood_Glucose_Lab = initializer.GetNextIndex();
        count++;
        ...
        if (_cacheIndex_Pertinent_Encounters_With_Days != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Pertinent_Encounters_With_Days' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Pertinent_Encounters_With_Days}}. Cache indices can only be initialized once.");
        _cacheIndex_Pertinent_Encounters_With_Days = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days}}. Cache indices can only be initialized once.");
        _cacheIndex_Pertinent_Encounters_With_Glucose_Result_Days = initializer.GetNextIndex();
        count++;

        if (_cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days != -1)
            throw new InvalidOperationException($"Cache index field '_cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days' in library '{{Name}}' version '{{Version}}' is already initialized to {{_cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days}}. Cache indices can only be initialized once.");
        _cacheIndex_Pertinent_Encounters_With_Hyperglycemic_Event_Days = initializer.GetNextIndex();
        count++;
