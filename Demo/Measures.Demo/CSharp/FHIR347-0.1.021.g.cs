...
public static class FHIR347_0_1_021
{
	...
	public static CqlValueSet Atherosclerosis_and_Peripheral_Arterial_Disease(CqlContext context) => 
	...
	public static CqlValueSet Breastfeeding(CqlContext context) => 
	...
	public static CqlValueSet CABG_Surgeries(CqlContext context) => 
	...
	public static CqlValueSet CABG__PCI_Procedure(CqlContext context) => 
	...
	public static CqlValueSet Carotid_Intervention(CqlContext context) => 
	...
	public static CqlValueSet Cerebrovascular_Disease__Stroke__TIA(CqlContext context) => 
	...
	public static CqlValueSet High_Intensity_Statin_Therapy(CqlContext context) => 
	...
	public static CqlValueSet Hypercholesterolemia(CqlContext context) => 
	...
	public static CqlValueSet Ischemic_Heart_Disease_or_Other_Related_Diagnoses(CqlContext context) => 
	...
	public static CqlValueSet LDL_Cholesterol(CqlContext context) => 
	...
	public static CqlValueSet Liver_Disease(CqlContext context) => 
	...
	public static CqlValueSet Low_Intensity_Statin_Therapy(CqlContext context) => 
	...
	public static CqlValueSet Moderate_Intensity_Statin_Therapy(CqlContext context) => 
	...
	public static CqlValueSet Myocardial_Infarction(CqlContext context) => 
	...
	public static CqlValueSet Outpatient_Encounters_for_Preventive_Care(CqlContext context) => 
	...
	public static CqlValueSet Palliative_or_Hospice_Care(CqlContext context) => 
	...
	public static CqlValueSet PCI(CqlContext context) => 
	...
	public static CqlValueSet Pregnancy_or_Other_Related_Diagnoses(CqlContext context) => 
	...
	public static CqlValueSet Preventive_Care_Services___Other(CqlContext context) => 
	...
	public static CqlValueSet Rhabdomyolysis(CqlContext context) => 
	...
	public static CqlValueSet Stable_and_Unstable_Angina(CqlContext context) => 
	...
	public static CqlValueSet Statin_Allergen(CqlContext context) => 
	...
	public static CqlValueSet Statin_Associated_Muscle_Symptoms(CqlContext context) => 
	...
	public static CqlCode Encounter_for_palliative_care(CqlContext context) => 
	...
	public static IEnumerable<object> ASCVD_Diagnosis_or_Procedure_before_End_of_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Myocardial_Infarction(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = FHIR347_0_1_021.Cerebrovascular_Disease__Stroke__TIA(context);
		IEnumerable<Condition> d_ = context.Operators.RetrieveByValueSet<Condition>(c_, default);
		IEnumerable<Condition> e_ = context.Operators.Union<Condition>(b_, d_);
		CqlValueSet f_ = FHIR347_0_1_021.Atherosclerosis_and_Peripheral_Arterial_Disease(context);
		IEnumerable<Condition> g_ = context.Operators.RetrieveByValueSet<Condition>(f_, default);
		CqlValueSet h_ = FHIR347_0_1_021.Ischemic_Heart_Disease_or_Other_Related_Diagnoses(context);
		...
		CqlValueSet l_ = FHIR347_0_1_021.Stable_and_Unstable_Angina(context);
		...
		bool? o_(Condition ASCVDDiagnosis)
		{
			...
			CqlInterval<CqlDateTime> ag_ = FHIR347_0_1_021.Measurement_Period(context);
		...
		CqlValueSet q_ = FHIR347_0_1_021.PCI(context);
		IEnumerable<Procedure> r_ = context.Operators.RetrieveByValueSet<Procedure>(q_, default);
		CqlValueSet s_ = FHIR347_0_1_021.CABG_Surgeries(context);
		...
		CqlValueSet v_ = FHIR347_0_1_021.Carotid_Intervention(context);
		IEnumerable<Procedure> w_ = context.Operators.RetrieveByValueSet<Procedure>(v_, default);
		CqlValueSet x_ = FHIR347_0_1_021.CABG__PCI_Procedure(context);
		...
		bool? ab_(Procedure ASCVDProcedure)
		{
			...
			CqlInterval<CqlDateTime> am_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	{
		CqlValueSet a_ = FHIR347_0_1_021.Annual_Wellness_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = FHIR347_0_1_021.Office_Visit(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = FHIR347_0_1_021.Outpatient_Consultation(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = FHIR347_0_1_021.Outpatient_Encounters_for_Preventive_Care(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = FHIR347_0_1_021.Preventive_Care_Services___Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = FHIR347_0_1_021.Preventive_Care_Services___Other(context);
		IEnumerable<Encounter> o_ = context.Operators.RetrieveByValueSet<Encounter>(n_, default);
		IEnumerable<Encounter> p_ = context.Operators.Union<Encounter>(m_, o_);
		IEnumerable<Encounter> q_ = context.Operators.Union<Encounter>(k_, p_);
		CqlValueSet r_ = FHIR347_0_1_021.Preventive_Care_Services_Individual_Counseling(context);
		IEnumerable<Encounter> s_ = context.Operators.RetrieveByValueSet<Encounter>(r_, default);
		CqlValueSet t_ = FHIR347_0_1_021.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		...
		{
			CqlInterval<CqlDateTime> z_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	{
		IEnumerable<object> a_ = FHIR347_0_1_021.ASCVD_Diagnosis_or_Procedure_before_End_of_Measurement_Period(context);
		bool? b_ = context.Operators.Exists<object>(a_);
		IEnumerable<Encounter> c_ = FHIR347_0_1_021.Qualifying_Encounter_during_Measurement_Period(context);
	...
	{
		bool? a_ = FHIR347_0_1_021.Initial_Population_1(context);

		return a_;
	}

    [CqlDeclaration("Patients Age 20 or Older at Start of Measurement Period")]
	public static bool? Patients_Age_20_or_Older_at_Start_of_Measurement_Period(CqlContext context)
	{
		Patient a_ = FHIR347_0_1_021.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDateTime d_ = context.Operators.ConvertStringToDateTime(c_);
		CqlInterval<CqlDateTime> e_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static IEnumerable<Observation> LDL_Result_Greater_Than_or_Equal_To_190(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.LDL_Cholesterol(context);
		...
		bool? c_(Observation LDL)
		{
			...
			CqlInterval<CqlDateTime> l_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static IEnumerable<Condition> Hypercholesterolemia_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Hypercholesterolemia(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		bool? c_(Condition Hypercholesterolemia)
		{
			...
			CqlDateTime f_ = context.Operators.Start(e_);
			CqlInterval<CqlDateTime> g_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static bool? Patients_Age_20_Years_and_Older_with_LDL_Cholesterol_Result_Greater_than_or_Equal_to_190_or_Hypercholesterolemia_without_ASCVD(CqlContext context)
	{
		bool? a_ = FHIR347_0_1_021.Patients_Age_20_or_Older_at_Start_of_Measurement_Period(context);
		IEnumerable<Observation> b_ = FHIR347_0_1_021.LDL_Result_Greater_Than_or_Equal_To_190(context);
		IEnumerable<Condition> c_ = FHIR347_0_1_021.Hypercholesterolemia_Diagnosis(context);
		...
		IEnumerable<object> g_ = FHIR347_0_1_021.ASCVD_Diagnosis_or_Procedure_before_End_of_Measurement_Period(context);
	...
	{
		bool? a_ = FHIR347_0_1_021.Patients_Age_20_Years_and_Older_with_LDL_Cholesterol_Result_Greater_than_or_Equal_to_190_or_Hypercholesterolemia_without_ASCVD(context);
		IEnumerable<Encounter> b_ = FHIR347_0_1_021.Qualifying_Encounter_during_Measurement_Period(context);
	...
	{
		bool? a_ = FHIR347_0_1_021.Initial_Population_2(context);

		return a_;
	}

    [CqlDeclaration("Has Diabetes Diagnosis")]
	public static bool? Has_Diabetes_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Diabetes(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
	...
	public static bool? Patients_Age_40_to_75_Years_with_Diabetes_without_ASCVD_or_LDL_Greater_than_190_or_Hypercholesterolemia(CqlContext context)
	{
		Patient a_ = FHIR347_0_1_021.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		...
		bool? j_ = FHIR347_0_1_021.Has_Diabetes_Diagnosis(context);
		bool? k_ = context.Operators.And(i_, j_);
		IEnumerable<object> l_ = FHIR347_0_1_021.ASCVD_Diagnosis_or_Procedure_before_End_of_Measurement_Period(context);
		bool? m_ = context.Operators.Exists<object>(l_);
		bool? n_ = context.Operators.Not(m_);
		bool? o_ = context.Operators.And(k_, n_);
		IEnumerable<Observation> p_ = FHIR347_0_1_021.LDL_Result_Greater_Than_or_Equal_To_190(context);
		bool? q_ = context.Operators.Exists<Observation>(p_);
		bool? r_ = context.Operators.Not(q_);
		bool? s_ = context.Operators.And(o_, r_);
		IEnumerable<Condition> t_ = FHIR347_0_1_021.Hypercholesterolemia_Diagnosis(context);
	...
	public static bool? Initial_Population_3(CqlContext context)
	{
		bool? a_ = FHIR347_0_1_021.Patients_Age_40_to_75_Years_with_Diabetes_without_ASCVD_or_LDL_Greater_than_190_or_Hypercholesterolemia(context);
		IEnumerable<Encounter> b_ = FHIR347_0_1_021.Qualifying_Encounter_during_Measurement_Period(context);
		bool? c_ = context.Operators.Exists<Encounter>(b_);
		bool? d_ = context.Operators.And(a_, c_);
	...
	public static bool? Denominator_3(CqlContext context)
	{
		bool? a_ = FHIR347_0_1_021.Initial_Population_3(context);
	...
	public static bool? Has_Allergy_to_Statin(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Statin_Allergen(context);
		...
		bool? c_(AllergyIntolerance StatinAllergy)
		{
			...
			CqlInterval<CqlDateTime> i_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static bool? Has_Order_or_Receiving_Hospice_Care_or_Palliative_Care(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Hospice_Care_Ambulatory(context);
		IEnumerable<ServiceRequest> b_ = context.Operators.RetrieveByValueSet<ServiceRequest>(a_, default);
		CqlValueSet c_ = FHIR347_0_1_021.Palliative_or_Hospice_Care(context);
		...
		bool? f_(ServiceRequest PalliativeOrHospiceCareOrder)
		{
			...
			CqlInterval<CqlDateTime> aa_ = FHIR347_0_1_021.Measurement_Period(context);
		...
		bool? n_(Procedure PalliativeOrHospiceCarePerformed)
		{
			...
			CqlInterval<CqlDateTime> ap_ = FHIR347_0_1_021.Measurement_Period(context);
		...
		CqlCode r_ = FHIR347_0_1_021.Encounter_for_palliative_care(context);
		...
		bool? u_(Encounter PalliativeEncounter)
		{
			...
			CqlInterval<CqlDateTime> az_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static bool? Has_Hepatitis_or_Liver_Disease_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Hepatitis_A(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = FHIR347_0_1_021.Hepatitis_B(context);
		IEnumerable<Condition> d_ = context.Operators.RetrieveByValueSet<Condition>(c_, default);
		IEnumerable<Condition> e_ = context.Operators.Union<Condition>(b_, d_);
		CqlValueSet f_ = FHIR347_0_1_021.Liver_Disease(context);
		IEnumerable<Condition> g_ = context.Operators.RetrieveByValueSet<Condition>(f_, default);
		...
		bool? i_(Condition HepatitisLiverDisease)
		{
			...
			CqlInterval<CqlDateTime> m_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static bool? Has_Statin_Associated_Muscle_Symptoms(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Statin_Associated_Muscle_Symptoms(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		bool? c_(Condition StatinMuscleSymptom)
		{
			...
			CqlInterval<CqlDateTime> h_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static bool? Has_ESRD_Diagnosis(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.End_Stage_Renal_Disease(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
	...
	public static bool? Has_Adverse_Reaction_to_Statin(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Statin_Allergen(context);
	...
	{
		bool? a_ = FHIR347_0_1_021.Has_Allergy_to_Statin(context);
		bool? b_ = FHIR347_0_1_021.Has_Order_or_Receiving_Hospice_Care_or_Palliative_Care(context);
		bool? c_ = context.Operators.Or(a_, b_);
		bool? d_ = FHIR347_0_1_021.Has_Hepatitis_or_Liver_Disease_Diagnosis(context);
		bool? e_ = context.Operators.Or(c_, d_);
		bool? f_ = FHIR347_0_1_021.Has_Statin_Associated_Muscle_Symptoms(context);
		bool? g_ = context.Operators.Or(e_, f_);
		bool? h_ = FHIR347_0_1_021.Has_ESRD_Diagnosis(context);
		bool? i_ = context.Operators.Or(g_, h_);
		bool? j_ = FHIR347_0_1_021.Has_Adverse_Reaction_to_Statin(context);
	...
	{
		CqlValueSet a_ = FHIR347_0_1_021.Pregnancy_or_Other_Related_Diagnoses(context);
		IEnumerable<Condition> b_ = context.Operators.RetrieveByValueSet<Condition>(a_, default);
		CqlValueSet c_ = FHIR347_0_1_021.Breastfeeding(context);
		IEnumerable<Condition> d_ = context.Operators.RetrieveByValueSet<Condition>(c_, default);
		IEnumerable<Condition> e_ = context.Operators.Union<Condition>(b_, d_);
		CqlValueSet f_ = FHIR347_0_1_021.Rhabdomyolysis(context);
		IEnumerable<Condition> g_ = context.Operators.RetrieveByValueSet<Condition>(f_, default);
		IEnumerable<Condition> h_ = context.Operators.Union<Condition>(e_, g_);
	...
	public static IEnumerable<MedicationRequest> Statin_Therapy_Ordered_during_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Low_Intensity_Statin_Therapy(context);
		...
		CqlValueSet f_ = FHIR347_0_1_021.Moderate_Intensity_Statin_Therapy(context);
		...
		CqlValueSet l_ = FHIR347_0_1_021.High_Intensity_Statin_Therapy(context);
		...
		bool? r_(MedicationRequest StatinOrdered)
		{
			...
			CqlInterval<CqlDateTime> v_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	public static IEnumerable<MedicationRequest> Prescribed_Statin_Therapy_Any_Time_during_Measurement_Period(CqlContext context)
	{
		CqlValueSet a_ = FHIR347_0_1_021.Low_Intensity_Statin_Therapy(context);
		IEnumerable<MedicationRequest> b_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		IEnumerable<MedicationRequest> d_ = context.Operators.RetrieveByValueSet<MedicationRequest>(a_, default);
		...
		bool? r_(MedicationRequest ActiveStatin)
		{
			...
			bool? y_(Timing T)
			{
				...
				CqlInterval<CqlDateTime> ak_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Normalize_Interval(context, aj_());
				CqlInterval<CqlDateTime> al_ = FHIR347_0_1_021.Measurement_Period(context);
	...
	{
		IEnumerable<MedicationRequest> a_ = FHIR347_0_1_021.Statin_Therapy_Ordered_during_Measurement_Period(context);
		bool? b_ = context.Operators.Exists<MedicationRequest>(a_);
		IEnumerable<MedicationRequest> c_ = FHIR347_0_1_021.Prescribed_Statin_Therapy_Any_Time_during_Measurement_Period(context);
