...
public partial class NCQAHospice_1_0_0 : ILibrary, ILibraryInternals, ISingleton<NCQAHospice_1_0_0>
{
    ...
    public bool? Hospice_Intervention_or_Encounter(CqlContext context) =>
        _cache?.GetOrCompute(_cacheIndex_Hospice_Intervention_or_Encounter, Hospice_Intervention_or_Encounter_Compute, context) ?? Hospice_Intervention_or_Encounter_Compute(context);
