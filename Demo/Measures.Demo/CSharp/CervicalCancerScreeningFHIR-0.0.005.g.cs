...
public static class CervicalCancerScreeningFHIR_0_0_005
{
	...
	public static CqlValueSet Congenital_or_Acquired_Absence_of_Cervix(CqlContext context) => 
	...
	public static CqlValueSet HPV_Test(CqlContext context) => 
	...
	public static CqlValueSet Hysterectomy_with_No_Residual_Cervix(CqlContext context) => 
	...
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.Office_Visit(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = CervicalCancerScreeningFHIR_0_0_005.Preventive_Care_Services___Established_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> d_ = context.Operators.RetrieveByValueSet<Encounter>(c_, default);
		IEnumerable<Encounter> e_ = context.Operators.Union<Encounter>(b_, d_);
		CqlValueSet f_ = CervicalCancerScreeningFHIR_0_0_005.Preventive_Care_Services_Initial_Office_Visit__18_and_Up(context);
		IEnumerable<Encounter> g_ = context.Operators.RetrieveByValueSet<Encounter>(f_, default);
		CqlValueSet h_ = CervicalCancerScreeningFHIR_0_0_005.Home_Healthcare_Services(context);
		IEnumerable<Encounter> i_ = context.Operators.RetrieveByValueSet<Encounter>(h_, default);
		IEnumerable<Encounter> j_ = context.Operators.Union<Encounter>(g_, i_);
		IEnumerable<Encounter> k_ = context.Operators.Union<Encounter>(e_, j_);
		CqlValueSet l_ = CervicalCancerScreeningFHIR_0_0_005.Telephone_Visits(context);
		IEnumerable<Encounter> m_ = context.Operators.RetrieveByValueSet<Encounter>(l_, default);
		CqlValueSet n_ = CervicalCancerScreeningFHIR_0_0_005.Online_Assessments(context);
		...
		bool? r_(Encounter ValidEncounter)
		{
			...
			CqlInterval<CqlDateTime> w_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
			Period x_ = ValidEncounter?.Period;
			CqlInterval<CqlDateTime> y_ = FHIRHelpers_4_0_001.ToInterval(context, x_);
	...
	{
		Patient a_ = CervicalCancerScreeningFHIR_0_0_005.Patient(context);
		Date b_ = a_?.BirthDateElement;
		string c_ = b_?.Value;
		CqlDate d_ = context.Operators.ConvertStringToDate(c_);
		CqlInterval<CqlDateTime> e_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
		...
		IEnumerable<Encounter> p_ = CervicalCancerScreeningFHIR_0_0_005.Qualifying_Encounters(context);
	...
	{
		bool? a_ = CervicalCancerScreeningFHIR_0_0_005.Initial_Population(context);

		return a_;
	}

    [CqlDeclaration("Absence of Cervix")]
	public static IEnumerable<object> Absence_of_Cervix(CqlContext context)
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.Hysterectomy_with_No_Residual_Cervix(context);
		...
		bool? c_(Procedure NoCervixProcedure)
		{
			...
			CqlInterval<CqlDateTime> n_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Normalize_Interval(context, m_);
			CqlDateTime o_ = context.Operators.End(n_);
			CqlInterval<CqlDateTime> p_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
		...
		CqlValueSet e_ = CervicalCancerScreeningFHIR_0_0_005.Congenital_or_Acquired_Absence_of_Cervix(context);
		IEnumerable<Condition> f_ = context.Operators.RetrieveByValueSet<Condition>(e_, default);
		bool? g_(Condition NoCervixDiagnosis)
		{
			CqlInterval<CqlDateTime> t_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Prevalence_Period(context, NoCervixDiagnosis);
			CqlDateTime u_ = context.Operators.Start(t_);
			CqlInterval<CqlDateTime> v_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
	...
	public static bool? Denominator_Exclusions(CqlContext context)
	{
		...
		IEnumerable<object> b_ = CervicalCancerScreeningFHIR_0_0_005.Absence_of_Cervix(context);
		bool? c_ = context.Operators.Exists<object>(b_);
		bool? d_ = context.Operators.Or(a_, c_);
		bool? e_ = PalliativeCareFHIR_0_6_000.Palliative_Care_in_the_Measurement_Period(context);
	...
	public static IEnumerable<Observation> Cervical_Cytology_Within_3_Years(CqlContext context)
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.Pap_Test(context);
		...
		bool? c_(Observation CervicalCytology)
		{
			...
			{
				CqlCode af_ = CervicalCancerScreeningFHIR_0_0_005.laboratory(context);
				CqlConcept ag_ = FHIRHelpers_4_0_001.ToConcept(context, CervicalCytologyCategory);
			...
			CqlDateTime o_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Latest(context, n_);
			CqlInterval<CqlDateTime> p_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
			CqlDateTime q_ = context.Operators.End(p_);
	...
	public static IEnumerable<Observation> HPV_Test_Within_5_Years_for_Women_Age_30_and_Older(CqlContext context)
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.HPV_Test(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		bool? c_(Observation HPVTest)
		{
			...
			{
				CqlCode aq_ = CervicalCancerScreeningFHIR_0_0_005.laboratory(context);
				CqlConcept ar_ = FHIRHelpers_4_0_001.ToConcept(context, HPVTestCategory);
			...
			bool? l_ = context.Operators.Exists<CodeableConcept>(k_);
			bool? m_ = context.Operators.And(h_, l_);
			Patient n_ = CervicalCancerScreeningFHIR_0_0_005.Patient(context);
			Date o_ = n_?.BirthDateElement;
			string p_ = o_?.Value;
			CqlDate q_ = context.Operators.ConvertStringToDate(p_);
			DataType r_ = HPVTest?.Effective;
			CqlInterval<CqlDateTime> s_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Normalize_Interval(context, r_);
			...
			CqlDateTime z_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Latest(context, r_);
			CqlInterval<CqlDateTime> aa_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
	...
	{
		IEnumerable<Observation> a_ = CervicalCancerScreeningFHIR_0_0_005.Cervical_Cytology_Within_3_Years(context);
		bool? b_ = context.Operators.Exists<Observation>(a_);
		IEnumerable<Observation> c_ = CervicalCancerScreeningFHIR_0_0_005.HPV_Test_Within_5_Years_for_Women_Age_30_and_Older(context);
	...
	public static bool? isComplete(CqlContext context, Observation observation)
	{
		Code<ObservationStatus> a_ = observation?.StatusElement;
		string b_ = FHIRHelpers_4_0_001.ToString(context, a_);
		string[] c_ = [
			"final",
			"amended",
			"corrected",
	...
	public static bool? isLaboratoryTest(CqlContext context, Observation observation)
	{
		List<CodeableConcept> a_ = observation?.Category;
		bool? b_(CodeableConcept category)
		{
			CqlCode e_ = CervicalCancerScreeningFHIR_0_0_005.laboratory(context);
			CqlConcept f_ = FHIRHelpers_4_0_001.ToConcept(context, category);
			CqlCode[] g_ = f_?.codes;
	...
	{
		CqlDateTime a_ = MATGlobalCommonFunctionsFHIR4_6_1_000.Latest(context, choice);

		return a_;
	}

    [CqlDeclaration("Cervical Cytology Within 3 Years (2)")]
	public static IEnumerable<Observation> Cervical_Cytology_Within_3_Years__2_(CqlContext context)
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.Pap_Test(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		bool? c_(Observation CervicalCytology)
		{
			bool? e_ = CervicalCancerScreeningFHIR_0_0_005.isComplete(context, CervicalCytology);
			bool? f_ = CervicalCancerScreeningFHIR_0_0_005.isLaboratoryTest(context, CervicalCytology);
			bool? g_ = context.Operators.And(e_, f_);
			DataType h_ = CervicalCytology?.Effective;
			CqlDateTime i_ = CervicalCancerScreeningFHIR_0_0_005.latest(context, h_);
			CqlInterval<CqlDateTime> j_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
	...
	public static IEnumerable<Observation> HPV_Test_Within_5_Years_for_Women_Age_30_and_Older__2_(CqlContext context)
	{
		CqlValueSet a_ = CervicalCancerScreeningFHIR_0_0_005.HPV_Test(context);
		IEnumerable<Observation> b_ = context.Operators.RetrieveByValueSet<Observation>(a_, default);
		bool? c_(Observation HPVTest)
		{
			bool? e_ = CervicalCancerScreeningFHIR_0_0_005.isComplete(context, HPVTest);
			bool? f_ = CervicalCancerScreeningFHIR_0_0_005.isLaboratoryTest(context, HPVTest);
			bool? g_ = context.Operators.And(e_, f_);
			Patient h_ = CervicalCancerScreeningFHIR_0_0_005.Patient(context);
			Date i_ = h_?.BirthDateElement;
			string j_ = i_?.Value;
			CqlDate k_ = context.Operators.ConvertStringToDate(j_);
			DataType l_ = HPVTest?.Effective;
			CqlInterval<CqlDateTime> m_ = CervicalCancerScreeningFHIR_0_0_005.toInterval(context, l_);
			...
			CqlDateTime t_ = CervicalCancerScreeningFHIR_0_0_005.latest(context, l_);
			CqlInterval<CqlDateTime> u_ = CervicalCancerScreeningFHIR_0_0_005.Measurement_Period(context);
