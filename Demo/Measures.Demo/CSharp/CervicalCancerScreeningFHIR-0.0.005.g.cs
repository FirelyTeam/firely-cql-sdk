...
public partial class CervicalCancerScreeningFHIR_0_0_005 : ILibrary, ILibraryInternals, ISingleton<CervicalCancerScreeningFHIR_0_0_005>
{
        ...
        int startIndex)
    {
        ...
        _cacheIndex_Absence_of_Cervix = index++;
        _cacheIndex_Denominator_Exclusions = index++;
        _cacheIndex_Cervical_Cytology_Within_3_Years = index++;
        _cacheIndex_HPV_Test_Within_5_Years_for_Women_Age_30_and_Older = index++;
        _cacheIndex_Numerator = index++;
        _cacheIndex_Cervical_Cytology_Within_3_Years__2_ = index++;
        _cacheIndex_HPV_Test_Within_5_Years_for_Women_Age_30_and_Older__2_ = index++;
