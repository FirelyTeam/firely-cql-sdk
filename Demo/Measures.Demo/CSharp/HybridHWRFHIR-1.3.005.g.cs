...
public static class HybridHWRFHIR_1_3_005
{
	...
	public static CqlValueSet Body_temperature(CqlContext context) => 
	...
	public static CqlValueSet Body_weight(CqlContext context) => 
		new CqlValueSet("http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1045.159", default);
	...
	public static CqlValueSet Medicare_payer(CqlContext context) => 
	...
	public static CqlCode Respiratory_rate(CqlContext context) => 
	...
	public static CqlCode[] LOINC_2_69(CqlContext context)
	{
		CqlCode[] a_ = [
			new CqlCode("21112-8", "http://loinc.org", default, default),
			new CqlCode("8867-4", "http://loinc.org", default, default),
	...
	public static CqlInterval<CqlDateTime> HospitalizationWithObservation(CqlContext context, Encounter TheEncounter)
	{
		...
		{
			CqlValueSet e_ = HybridHWRFHIR_1_3_005.Emergency_Department_Visit(context);
			...
			bool? g_(Encounter LastED)
			{
				...
				CqlValueSet ai_ = HybridHWRFHIR_1_3_005.Observation_Services(context);
			...
			CqlValueSet o_ = HybridHWRFHIR_1_3_005.Observation_Services(context);
	...
	{
		CqlValueSet a_ = HybridHWRFHIR_1_3_005.Encounter_Inpatient(context);
		IEnumerable<Encounter> b_ = context.Operators.RetrieveByValueSet<Encounter>(a_, default);
		CqlValueSet c_ = HybridHWRFHIR_1_3_005.Medicare_payer(context);
		...
		bool? h_((Encounter InpatientEncounter, Coverage Payer)? tuple_efskhgutuclexzenturvljend)
		{
			...
			CqlInterval<CqlDateTime> p_ = HybridHWRFHIR_1_3_005.HospitalizationWithObservation(context, tuple_efskhgutuclexzenturvljend?.InpatientEncounter);
			int? q_ = HybridHWRFHIR_1_3_005.LengthInDays(context, p_);
			...
			CqlInterval<CqlDateTime> w_ = HybridHWRFHIR_1_3_005.Measurement_Period(context);
			bool? x_ = context.Operators.In<CqlDateTime>(v_, w_, "day");
			bool? y_ = context.Operators.And(s_, x_);
			Patient z_ = HybridHWRFHIR_1_3_005.Patient(context);
	...
	{
		IEnumerable<Encounter> a_ = HybridHWRFHIR_1_3_005.Inpatient_Encounters(context);

		return a_;
	}

    [CqlDeclaration("FirstPhysicalExamWithEncounterId")]
	public static IEnumerable<string> FirstPhysicalExamWithEncounterId(CqlContext context, IEnumerable<Observation> ExamList, string CCDE)
	{
		IEnumerable<Encounter> a_ = HybridHWRFHIR_1_3_005.Inpatient_Encounters(context);
	...
	public static IEnumerable<string> FirstPhysicalExamWithEncounterIdUsingLabTiming(CqlContext context, IEnumerable<Observation> ExamList, string CCDE)
	{
		IEnumerable<Encounter> a_ = HybridHWRFHIR_1_3_005.Inpatient_Encounters(context);
		string b_(Encounter Encounter)
		{
	...
	public static IEnumerable<string> FirstLabTestWithEncounterId(CqlContext context, IEnumerable<Observation> LabList, string CCDE)
	{
		IEnumerable<Encounter> a_ = HybridHWRFHIR_1_3_005.Inpatient_Encounters(context);
		string b_(Encounter Encounter)
		{
	...
	public static IEnumerable<string> Results(CqlContext context)
	{
		CqlCode a_ = HybridHWRFHIR_1_3_005.Heart_rate(context);
		IEnumerable<CqlCode> b_ = context.Operators.ToList<CqlCode>(a_);
		IEnumerable<Observation> c_ = context.Operators.RetrieveByCodes<Observation>(b_, default);
		IEnumerable<string> d_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterId(context, c_, "FirstHeartRate");
		CqlCode e_ = HybridHWRFHIR_1_3_005.Systolic_blood_pressure(context);
		...
		IEnumerable<string> h_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterId(context, g_, "FirstSystolicBP");
		CqlCode i_ = HybridHWRFHIR_1_3_005.Respiratory_rate(context);
		...
		IEnumerable<string> l_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterId(context, k_, "FirstRespRate");
		CqlValueSet m_ = HybridHWRFHIR_1_3_005.Body_temperature(context);
		IEnumerable<Observation> n_ = context.Operators.RetrieveByValueSet<Observation>(m_, default);
		IEnumerable<string> o_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterId(context, n_, "FirstTemperature");
		CqlCode p_ = HybridHWRFHIR_1_3_005.Oxygen_saturation_in_Arterial_blood_by_Pulse_oximetry(context);
		...
		IEnumerable<string> s_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterId(context, r_, "FirstO2Saturation");
		CqlValueSet t_ = HybridHWRFHIR_1_3_005.Body_weight(context);
		IEnumerable<Observation> u_ = context.Operators.RetrieveByValueSet<Observation>(t_, default);
		IEnumerable<string> v_ = HybridHWRFHIR_1_3_005.FirstPhysicalExamWithEncounterIdUsingLabTiming(context, u_, "FirstWeight");
		CqlValueSet w_ = HybridHWRFHIR_1_3_005.Hematocrit_lab_test(context);
		IEnumerable<Observation> x_ = context.Operators.RetrieveByValueSet<Observation>(w_, default);
		IEnumerable<string> y_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, x_, "FirstHematocrit");
		CqlValueSet z_ = HybridHWRFHIR_1_3_005.White_blood_cells_count_lab_test(context);
		IEnumerable<Observation> aa_ = context.Operators.RetrieveByValueSet<Observation>(z_, default);
		IEnumerable<string> ab_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, aa_, "FirstWhiteBloodCell");
		CqlValueSet ac_ = HybridHWRFHIR_1_3_005.Potassium_lab_test(context);
		IEnumerable<Observation> ad_ = context.Operators.RetrieveByValueSet<Observation>(ac_, default);
		IEnumerable<string> ae_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, ad_, "FirstPotassium");
		CqlValueSet af_ = HybridHWRFHIR_1_3_005.Sodium_lab_test(context);
		IEnumerable<Observation> ag_ = context.Operators.RetrieveByValueSet<Observation>(af_, default);
		IEnumerable<string> ah_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, ag_, "FirstSodium");
		CqlValueSet ai_ = HybridHWRFHIR_1_3_005.Bicarbonate_lab_test(context);
		IEnumerable<Observation> aj_ = context.Operators.RetrieveByValueSet<Observation>(ai_, default);
		IEnumerable<string> ak_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, aj_, "FirstBicarbonate");
		CqlValueSet al_ = HybridHWRFHIR_1_3_005.Creatinine_lab_test(context);
		IEnumerable<Observation> am_ = context.Operators.RetrieveByValueSet<Observation>(al_, default);
		IEnumerable<string> an_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, am_, "FirstCreatinine");
		CqlValueSet ao_ = HybridHWRFHIR_1_3_005.Glucose_lab_test(context);
		IEnumerable<Observation> ap_ = context.Operators.RetrieveByValueSet<Observation>(ao_, default);
		IEnumerable<string> aq_ = HybridHWRFHIR_1_3_005.FirstLabTestWithEncounterId(context, ap_, "FirstGlucose");
	...
	public static int? CalendarAgeInYearsAt(CqlContext context, CqlDateTime BirthDateTime, CqlDateTime AsOf)
	{
	...
	public static CqlDateTime ToDate(CqlContext context, CqlDateTime Value)
	{
	...
	public static int? LengthOfStay(CqlContext context, CqlInterval<CqlDateTime> Stay)
	{
	...
	public static int? HospitalizationWithObservationLengthofStay(CqlContext context, Encounter Encounter)
	{
		CqlInterval<CqlDateTime> a_ = HybridHWRFHIR_1_3_005.HospitalizationWithObservation(context, Encounter);
		int? b_ = HybridHWRFHIR_1_3_005.LengthInDays(context, a_);
