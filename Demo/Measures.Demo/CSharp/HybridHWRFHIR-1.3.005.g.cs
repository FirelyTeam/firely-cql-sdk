...
public class HybridHWRFHIR_1_3_005
{
	...
	private IEnumerable<Encounter> Inpatient_Encounters_Value()
	{
		...
		bool? h_((Encounter InpatientEncounter, Coverage Payer)? tuple_efskhgutuclexzenturvljend)
		{
			...
			var p_ = this.HospitalizationWithObservation(tuple_efskhgutuclexzenturvljend.InpatientEncounter);
			...
			var ai_ = context.Operators.GreaterOrEqual(ah_, 65);
	...
	private IEnumerable<string> Results_Value()
	{
		...
		var as_ = context.Operators.Flatten<string>((ar_ as IEnumerable<IEnumerable<string>>));
