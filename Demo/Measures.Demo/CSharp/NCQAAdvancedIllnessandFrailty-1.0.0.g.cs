...
public partial class NCQAAdvancedIllnessandFrailty_1_0_0 : ILibrary, ISingleton<NCQAAdvancedIllnessandFrailty_1_0_0>
{
    ...
    private bool? Has_Criteria_Indicating_Frailty_Compute(CqlContext context)
    {
        ...
        CqlBoolean f_() {
            ...
            bool? w_(Encounter FrailtyEncounter) {
                ...
                CqlBoolean ab_ = context.Operators.Overlaps(z_, aa_, (string)default);
                return ab_;
            }

            CqlBoolean x_ = context.Operators.WhereAny<Encounter>(v_, w_);
            return x_;
        }
    ...
    private IEnumerable<CqlDate> Outpatient_Encounters_with_Advanced_Illness_Compute(CqlContext context)
    {
        ...
        bool? s_(Encounter OutpatientEncounter) {
            ...
            CqlBoolean y_ = NCQAEncounter_1_0_0.Instance.Encounter_Has_Diagnosis(context, OutpatientEncounter, x_);
            ...
            CqlBoolean z_() {
                ...
                CqlBoolean am_ = context.Operators.In<CqlDate>(ad_, al_, (string)default);
                return am_;
            }

            return y_
                /* CQL 'and' (96:5-98:34) */ && z_();
        }
    ...
    private IEnumerable<CqlDate> Nonacute_Inpatient_Discharge_with_Advanced_Illness_Compute(CqlContext context)
    {
        ...
        bool? h_(CqlInterval<CqlDateTime> DischargeWithDiagnosis) {
            ...
            CqlBoolean v_ = context.Operators.In<CqlDate>(m_, u_, (string)default);
            return v_;
        }
    ...
    private bool? Two_Outpatient_Visits_with_Advanced_Illness_on_Different_Dates_of_Service_Compute(CqlContext context)
    {
        ...
        bool? d_((CqlTupleMetadata, CqlDate OutpatientVisit1, CqlDate OutpatientVisit2)? tuple_cmsergtjgkisksqucnzwkeggv) {
            ...
            CqlBoolean l_ = context.Operators.SameOrAfter(tuple_cmsergtjgkisksqucnzwkeggv?.OutpatientVisit2, k_, (string)default);
            return l_;
        }
        ...
        CqlBoolean h_ = context.Operators.Exists<CqlDate>(g_);
        return h_;
    }
    ...
    private bool? Acute_Inpatient_Encounter_with_Advanced_Illness_Compute(CqlContext context)
    {
        ...
        bool? d_(Encounter InpatientEncounter) {
            ...
            CqlBoolean h_ = NCQAEncounter_1_0_0.Instance.Encounter_Has_Diagnosis(context, InpatientEncounter, g_);
    ...
    private bool? Acute_Inpatient_Discharge_with_Advanced_Illness_Compute(CqlContext context)
    {
        ...
        bool? h_(CqlInterval<CqlDateTime> InpatientDischarge) {
            ...
            CqlBoolean t_ = context.Operators.In<CqlDate>(k_, s_, (string)default);
            return t_;
        }

        CqlBoolean i_ = context.Operators.WhereAny<CqlInterval<CqlDateTime>>(g_, h_);
        return i_;
    }
    ...
    private bool? Dementia_Medications_In_Year_Before_or_During_Measurement_Period_Compute(CqlContext context)
    {
        ...
        bool? d_(MedicationDispense MR) {
            ...
            bool? k_(Medication M) {
                ...
                CqlBoolean s_ = context.Operators.Equal(n_, r_);
        ...
        bool? h_(MedicationDispense DementiaMedDispensed) {
            ...
            CqlBoolean ak_ = context.Operators.In<CqlDate>(ab_, aj_, (string)default);
            return ak_;
        }

        CqlBoolean i_ = context.Operators.WhereAny<MedicationDispense>(g_, h_);
        return i_;
    }
    ...
    private bool? Advanced_Illness_and_Frailty_Exclusion_Including_Over_Age_80_Compute(CqlContext context)
    {
        ...
        CqlBoolean k_() {
            CqlBoolean m_ = this.Two_Outpatient_Visits_with_Advanced_Illness_on_Different_Dates_of_Service(context);
            return m_
                /* CQL 'or' (34:13-35:62) */ || this.Acute_Inpatient_Encounter_with_Advanced_Illness(context)
                /* CQL 'or' (34:13-36:62) */ || this.Acute_Inpatient_Discharge_with_Advanced_Illness(context)
                /* CQL 'or' (34:11-38:7) */ || this.Dementia_Medications_In_Year_Before_or_During_Measurement_Period(context);
        }
    ...
    private bool? Advanced_Illness_and_Frailty_Exclusion_Not_Including_Over_Age_80_Compute(CqlContext context)
    {
        ...
        CqlBoolean j_() {
            CqlBoolean k_ = this.Two_Outpatient_Visits_with_Advanced_Illness_on_Different_Dates_of_Service(context);
            return k_
                /* CQL 'or' (51:11-52:60) */ || this.Acute_Inpatient_Encounter_with_Advanced_Illness(context)
                /* CQL 'or' (51:11-53:60) */ || this.Acute_Inpatient_Discharge_with_Advanced_Illness(context)
                /* CQL 'or' (51:9-55:5) */ || this.Dementia_Medications_In_Year_Before_or_During_Measurement_Period(context);
        }

        return i_
            /* CQL 'and' (47:3-50:41) */ && this.Has_Criteria_Indicating_Frailty(context)
            /* CQL 'and' (47:3-55:5) */ && j_();
    }
